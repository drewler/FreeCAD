...
inline Vector2d::Vector2d(float x, float y) : x(double(x)), y(double(y)) {}
...
inline bool Vector2d::operator==(const Vector2d &v) const { return (x == v.x) && (y == v.y); }

inline Vector2d Vector2d::operator+() const { return Vector2d(x, y); }

inline Vector2d Vector2d::operator+(const Vector2d &v) const { return Vector2d(x + v.x, y + v.y); }
...
inline Vector2d Vector2d::operator*(double c) const { return Vector2d(c * x, c * y); }
...
inline double Vector2d::operator*(const Vector2d &v) const { return x * v.x + y * v.y; }

inline Vector2d operator*(double c, const Vector2d &v) { return Vector2d(c * v.x, c * v.y); }

inline Vector2d Vector2d::operator/(double c) const { return Vector2d(x / c, y / c); }
...
inline double Vector2d::Angle() const { return atan2(y, x); }

inline double Vector2d::Sqr() const { return x * x + y * y; }
...
inline Polygon2d::Polygon2d(const Polygon2d &rclPoly) { *this = rclPoly; }
...
inline void Polygon2d::DeleteAll() { _aclVct.clear(); }

inline size_t Polygon2d::GetCtVectors() const { return _aclVct.size(); }
...
inline const Vector2d &Polygon2d::operator[](size_t ulNdx) const { return _aclVct[ulNdx]; }

inline const Vector2d &Polygon2d::At(size_t ulNdx) const { return _aclVct.at(ulNdx); }

inline Vector2d &Polygon2d::operator[](size_t ulNdx) { return _aclVct[ulNdx]; }

inline Vector2d &Polygon2d::At(size_t ulNdx) { return _aclVct.at(ulNdx); }
...
inline double Line2d::Length() const { return (clV2 - clV1).Length(); }
...
inline bool Line2d::Contains(const Vector2d &rclV) const { return CalcBoundBox().Contains(rclV); }
...
inline BoundBox2d::BoundBox2d(const BoundBox2d &rclBB)
    : MinX(rclBB.MinX), MinY(rclBB.MinY), MaxX(rclBB.MaxX), MaxY(rclBB.MaxY)
{}
...
inline bool BoundBox2d::IsValid() { return (MaxX >= MinX) && (MaxY >= MinY); }
...
inline double BoundBox2d::Width() const { return MaxX - MinX; }

inline double BoundBox2d::Height() const { return MaxY - MinY; }
