...
std::string PersistencePy::representation() const { return std::string("<persistence object>"); }
...
PyObject *PersistencePy::dumpContent(PyObject *args, PyObject *kwds)
{
    ...
    PyErr_Clear();
    if (!PyArg_ParseTupleAndKeywords(args, kwds, "|i", kwds_def, &compression)) { return nullptr; }
...
{
    PyObject *buffer;
    if (!PyArg_ParseTuple(args, "O", &buffer)) return nullptr;
...
PyObject *PersistencePy::getCustomAttributes(const char *) const { return nullptr; }

int PersistencePy::setCustomAttributes(const char *, PyObject *) { return 0; }
