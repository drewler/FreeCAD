...
Translate::Translate() : Py::ExtensionModule<Translate>("__Translate__")
{
    add_varargs_method("translate", &Translate::translate,
    ...
    add_varargs_method("QT_TRANSLATE_NOOP", &Translate::translateNoop,
                       ...
                       "string literal.");
    add_varargs_method("QT_TRANSLATE_NOOP3", &Translate::translateNoop3,
    ...
    add_varargs_method("QT_TRANSLATE_NOOP_UTF8", &Translate::translateNoop,
                       "QT_TRANSLATE_NOOP_UTF8(context, sourcetext)\n"
                       "Same as QT_TRANSLATE_NOOP");
    add_varargs_method("QT_TR_NOOP", &Translate::trNoop,
                       "QT_TR_NOOP(sourcetext)\n"
                       "Marks the UTF-8 encoded string literal sourcetext for delayed translation "
                       "in the current context");
    add_varargs_method("QT_TR_NOOP_UTF8", &Translate::trNoop,
                       "QT_TR_NOOP_UTF8(sourcetext)\n"
                       "Same as QT_TR_NOOP");
    add_varargs_method("installTranslator", &Translate::installTranslator,
                       "Install a translator for testing purposes");
    add_varargs_method("removeTranslators", &Translate::removeTranslators,
...
Py::Object Translate::translateNoop(const Py::Tuple &args)
{
    PyObject *arg1;
    PyObject *arg2;
    if (!PyArg_ParseTuple(args.ptr(), "OO", &arg1, &arg2)) throw Py::Exception();
...
Py::Object Translate::translateNoop3(const Py::Tuple &args)
{
    ...
    PyObject *arg2;
    PyObject *arg3;
    if (!PyArg_ParseTuple(args.ptr(), "OOO", &arg1, &arg2, &arg3)) throw Py::Exception();
    return Py::Object(arg2);
}
...
{
    PyObject *arg1;
    if (!PyArg_ParseTuple(args.ptr(), "O", &arg1)) throw Py::Exception();
...
Py::Object Translate::removeTranslators(const Py::Tuple &args)
{
    ...
    bool ok = true;
    for (const auto &it : translators) { ok &= QCoreApplication::removeTranslator(it.get()); }
