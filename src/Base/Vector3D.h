...
public:
    ...
    */
    void TransformToCoordinateSystem(const Vector3 &rclBase, const Vector3 &rclDirX,
...
template<class _Pr1, class _Pr2> inline Vector3<_Pr1> toVector(const Vector3<_Pr2> &v)
{
