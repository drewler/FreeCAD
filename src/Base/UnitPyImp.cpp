...
PyObject *UnitPy::getCustomAttributes(const char * /*attr*/) const { return nullptr; }
...
PyObject *UnitPy::number_power_handler(PyObject * /*self*/, PyObject * /*other*/,
                                       PyObject * /*modulo*/)
{
    PyErr_SetString(PyExc_NotImplementedError, "Not implemented");
    return nullptr;
...
int UnitPy::number_nonzero_handler(PyObject * /*self*/) { return 1; }
