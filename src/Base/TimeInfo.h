...
inline int64_t TimeInfo::getSeconds() const { return timebuffer.time; }

inline unsigned short TimeInfo::getMiliseconds() const { return timebuffer.millitm; }
...
inline void TimeInfo::operator=(const TimeInfo &time) { timebuffer = time.timebuffer; }
