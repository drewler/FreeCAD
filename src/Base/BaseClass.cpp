...
Type BaseClass::getClassTypeId() { return BaseClass::classTypeId; }

Type BaseClass::getTypeId() const { return BaseClass::classTypeId; }
...
void BaseClass::setPyObject(PyObject *) { assert(0); }
