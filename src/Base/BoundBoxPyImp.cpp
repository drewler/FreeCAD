...
int BoundBoxPy::PyInit(PyObject *args, PyObject * /*kwd*/)
{
    ...
    PyErr_Clear(); // set by PyArg_ParseTuple()
    if (PyArg_ParseTuple(args, "O!O!", &(Base::VectorPy::Type), &object1, &(Base::VectorPy::Type),
                         &object2)) {
...
PyObject *BoundBoxPy::add(PyObject *args)
{
    ...
    PyErr_Clear();
    if (PyArg_ParseTuple(args, "O!;Need a Vector, BoundBox or three floats as argument",
...
PyObject *BoundBoxPy::getPoint(PyObject *args)
{
    ...
    if (!PyArg_ParseTuple(args, "H", &index)) return nullptr;
...
PyObject *BoundBoxPy::intersected(PyObject *args)
{
    ...
    PyObject *object;
    if (!PyArg_ParseTuple(args, "O!", &(Base::BoundBoxPy::Type), &object)) return nullptr;
    if (!static_cast<Base::BoundBoxPy *>(object)->getBoundBoxPtr()->IsValid()) {
        PyErr_SetString(PyExc_FloatingPointError, "Invalid bounding box argument");
        return nullptr;
    }
...
{
    double s;
    if (!PyArg_ParseTuple(args, "d;Need float parameter to enlarge", &s)) return nullptr;
...
PyObject *BoundBoxPy::getIntersectionPoint(PyObject *args)
{
    ...
    if (!PyArg_ParseTuple(args, "O!O!|d;Need base and direction vector", &(Base::VectorPy::Type),
                          &object, &(Base::VectorPy::Type), &object2, &epsilon))
        return nullptr;

    Base::Vector3d point;
    bool ok = getBoundBoxPtr()->IntersectionPoint(
        *(static_cast<Base::VectorPy *>(object)->getVectorPtr()),
        *(static_cast<Base::VectorPy *>(object2)->getVectorPtr()), point, epsilon);
    if (ok) { return new VectorPy(point); }
    else {
...
PyObject *BoundBoxPy::isCutPlane(PyObject *args)
{
    ...
    retVal =
        getBoundBoxPtr()->IsCutPlane(*(static_cast<Base::VectorPy *>(object)->getVectorPtr()),
                                     *(static_cast<Base::VectorPy *>(object2)->getVectorPtr()));
...
Py::Object BoundBoxPy::getCenter() const { return Py::Vector(getBoundBoxPtr()->GetCenter()); }

Py::Float BoundBoxPy::getXMax() const { return Py::Float(getBoundBoxPtr()->MaxX); }

void BoundBoxPy::setXMax(Py::Float arg) { getBoundBoxPtr()->MaxX = arg; }

Py::Float BoundBoxPy::getYMax() const { return Py::Float(getBoundBoxPtr()->MaxY); }

void BoundBoxPy::setYMax(Py::Float arg) { getBoundBoxPtr()->MaxY = arg; }

Py::Float BoundBoxPy::getZMax() const { return Py::Float(getBoundBoxPtr()->MaxZ); }

void BoundBoxPy::setZMax(Py::Float arg) { getBoundBoxPtr()->MaxZ = arg; }

Py::Float BoundBoxPy::getXMin() const { return Py::Float(getBoundBoxPtr()->MinX); }

void BoundBoxPy::setXMin(Py::Float arg) { getBoundBoxPtr()->MinX = arg; }

Py::Float BoundBoxPy::getYMin() const { return Py::Float(getBoundBoxPtr()->MinY); }

void BoundBoxPy::setYMin(Py::Float arg) { getBoundBoxPtr()->MinY = arg; }

Py::Float BoundBoxPy::getZMin() const { return Py::Float(getBoundBoxPtr()->MinZ); }

void BoundBoxPy::setZMin(Py::Float arg) { getBoundBoxPtr()->MinZ = arg; }

Py::Float BoundBoxPy::getXLength() const { return Py::Float(getBoundBoxPtr()->LengthX()); }

Py::Float BoundBoxPy::getYLength() const { return Py::Float(getBoundBoxPtr()->LengthY()); }

Py::Float BoundBoxPy::getZLength() const { return Py::Float(getBoundBoxPtr()->LengthZ()); }
...
PyObject *BoundBoxPy::getCustomAttributes(const char * /*attr*/) const { return nullptr; }
