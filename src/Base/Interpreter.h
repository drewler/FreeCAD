...
{
public:
    PyGILStateLocker() { gstate = PyGILState_Ensure(); }
    ~PyGILStateLocker() { PyGILState_Release(gstate); }
...
public:
    ...
    std::string runStringWithKey(const char *psCmd, const char *key,
    ...
    void runMethod(PyObject *pobject, const char *method, const char *resfmt = nullptr,
                   void *cresult = nullptr, const char *argfmt = "()", ...);
    //@}
    ...
    PyObject *createSWIGPointerObj(const char *Modole, const char *TypeName, void *Pointer,
                                   int own);
    bool convertSWIGPointerObj(const char *Module, const char *TypeName, PyObject *obj, void **ptr,
                               int flags);
 ...
 */
inline InterpreterSingleton &Interpreter() { return InterpreterSingleton::Instance(); }
