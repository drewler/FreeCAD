...
private:
    ...
    static inline void updateGridExtent(ViewProviderSketch &vp, float minx, float maxx, float miny,
                                        float maxy);
...
inline void ViewProviderSketchCoinAttorney::updateGridExtent(ViewProviderSketch &vp, float minx,
