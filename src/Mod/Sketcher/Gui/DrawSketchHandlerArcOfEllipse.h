...
public:
    DrawSketchHandlerArcOfEllipse()
        : Mode(STATUS_SEEK_First), EditCurve(34), rx(0), ry(0), startAngle(0), endAngle(0),
    ...
    void mouseMove(Base::Vector2d onSketchPos) override
    {
        if (Mode == STATUS_SEEK_First) {
            ...
            if (seekAutoConstraint(sugConstr1, onSketchPos,
            ...
            if (showCursorCoords()) {
                ...
                text.sprintf(" (R%s, R%s, %s)", aString.c_str(), bString.c_str(),
                             angleString.c_str());
                setPositionText(onSketchPos, text);
            }
    ...
    bool releaseButton(Base::Vector2d onSketchPos) override
    {
        ...
        if (Mode == STATUS_Close) {
            ...
            if (arcAngle > 0) endAngle = startAngle + arcAngle;
            else {
                endAngle = startAngle;
                startAngle += arcAngle;
            ...
            try {
                ...
                Gui::cmdAppObjectArgs(sketchgui->getObject(),
                                      ...
                                      "Vector(%f,%f,0)),%f,%f),%s)",
                                      majAxisPoint.x, majAxisPoint.y, minAxisPoint.x,
                                      minAxisPoint.y, centerPoint.x, centerPoint.y, startAngle,
                                      endAngle,
            ...
            if (!sugConstr3.empty()) {
                createAutoConstraints(sugConstr3, currentgeoid,
            ...
            // add suggested constraints for start of arc
            if (!sugConstr4.empty()) {
                createAutoConstraints(sugConstr4, currentgeoid,
