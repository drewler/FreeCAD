...
public:
    DrawSketchHandlerArc()
        : Mode(STATUS_SEEK_First), EditCurve(2), rx(0), ry(0), startAngle(0), endAngle(0),
          arcAngle(0)
    {}
        ...
        if (Mode == STATUS_End) {
            ...
            try {
                ...
                Gui::cmdAppObjectArgs(
                    ...
                    CenterPoint.x, CenterPoint.y, sqrt(rx * rx + ry * ry), startAngle, endAngle,
            ...
            if (!sugConstr3.empty()) {
                createAutoConstraints(sugConstr3, getHighestCurveIndex(),
...
public:
    DrawSketchHandler3PointArc()
        : Mode(STATUS_SEEK_First), EditCurve(2), radius(0), startAngle(0), endAngle(0), arcAngle(0),
          arcPos1(Sketcher::PointPos::none), arcPos2(Sketcher::PointPos::none)
    {}
        ...
        if (Mode == STATUS_End) {
            ...
            try {
                ...
                Gui::cmdAppObjectArgs(
                    ...
                    "addGeometry(Part.ArcOfCircle"
                    "(Part.Circle(App.Vector(%f,%f,0),App.Vector(0,0,1),%f),%f,%f),%s)",
                    CenterPoint.x, CenterPoint.y, radius, startAngle, endAngle,
