...
private:
    ...
    template<class T> bool isFilter(T filterValue);
...
private:
    ...
    std::vector<unsigned int>
        associatedConstraintsFilter; // holds the constraint ids of the constraints associated with the selected geometry
};
