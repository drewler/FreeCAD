...
TaskSketcherSolverAdvanced::TaskSketcherSolverAdvanced(ViewProviderSketch *sketchView)
    : TaskBox(Gui::BitmapFactory().pixmap("document-new"), tr("Advanced solver control"), true,
              nullptr),
      sketchView(sketchView), ui(new Ui_TaskSketcherSolverAdvanced)
{
...
void TaskSketcherSolverAdvanced::on_comboBoxRedundantDefaultSolver_currentIndexChanged(int index)
{
    ...
    const_cast<Sketcher::Sketch &>(sketchView->getSketchObject()->getSolvedSketch())
        .defaultSolverRedundant = (GCS::Algorithm)index;
...
void TaskSketcherSolverAdvanced::updateSketchObject()
{
    ...
    const_cast<Sketcher::Sketch &>(sketchView->getSketchObject()->getSolvedSketch())
        ...
        (GCS::Algorithm)ui->comboBoxRedundantDefaultSolver->currentIndex();
    const_cast<Sketcher::Sketch &>(sketchView->getSketchObject()->getSolvedSketch())
    ...
    const_cast<Sketcher::Sketch &>(sketchView->getSketchObject()->getSolvedSketch()).defaultSolver =
        (GCS::Algorithm)ui->comboBoxDefaultSolver->currentIndex();
    const_cast<Sketcher::Sketch &>(sketchView->getSketchObject()->getSolvedSketch())
