...
public:
    ...
    public:
        ...
        ParameterStatus getStatus() const
        {
            return std::all_of(pstatus.begin(), pstatus.end(),
        ...
        {
            if (index >= int(pstatus.size())) pstatus.resize(index + 1, ParameterStatus::Dependent);
    ...
    public:
        ...
        ParameterStatus getPoleXStatus(int poleindex) const
        {
            ...
            if (poleindex < npoles) return pstatus[poleindex * 2];
        ...
        ParameterStatus getPoleYStatus(int poleindex) const
        {
            ...
            if (poleindex < npoles) return pstatus[poleindex * 2 + 1];
        ...
        ParameterStatus getWeightStatus(int weightindex) const
        {
            ...
            if (weightindex < nweights) return pstatus[nweights * 2 + weightindex];
