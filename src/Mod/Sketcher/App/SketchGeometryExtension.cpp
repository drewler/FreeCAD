...
SketchGeometryExtension::SketchGeometryExtension()
    : Id(++SketchGeometryExtension::_GeometryID), InternalGeometryType(InternalType::None),
      GeometryLayer(0)
{}

SketchGeometryExtension::SketchGeometryExtension(long cid)
    : Id(cid), InternalGeometryType(InternalType::None), GeometryLayer(0)
{}
...
void SketchGeometryExtension::restoreAttributes(Base::XMLReader &reader)
{
    ...
    if (reader.hasAttribute("id")) Id = reader.getAttributeAsInteger("id");

    InternalGeometryType =
        (InternalType::InternalType)reader.getAttributeAsInteger("internalGeometryType");
