...
Py::Long GeometryFacadePy::getId() const { return Py::Long(this->getGeometryFacadePtr()->getId()); }

void GeometryFacadePy::setId(Py::Long Id) { this->getGeometryFacadePtr()->setId(long(Id)); }
...
void GeometryFacadePy::setBlocked(Py::Boolean arg) { getGeometryFacadePtr()->setBlocked(arg); }
...
PyObject *GeometryFacadePy::mirror(PyObject *args)
{
    ...
    PyErr_Clear();
    PyObject *axis;
    if (PyArg_ParseTuple(args, "O!O!", &(Base::VectorPy::Type), &o, &(Base::VectorPy::Type),
                         &axis)) {
...
{
    PyObject *o;
    if (!PyArg_ParseTuple(args, "O!", &(Base::PlacementPy::Type), &o)) return nullptr;
...
{
    PyObject *o;
    if (!PyArg_ParseTuple(args, "O!", &(Base::MatrixPy::Type), &o)) return nullptr;
...
PyObject *GeometryFacadePy::getCustomAttributes(const char * /*attr*/) const { return nullptr; }
