...
class TaskShareView:
    def __init__(self):
        ...
        self.form.setWindowTitle(
            QT_TRANSLATE_NOOP("TechDraw_ShareView", "Share View with another Page")
        )
        self.form.lViewName.setText(
            QT_TRANSLATE_NOOP("TechDraw_ShareView", "View to share")
        )
    ...
    def pickView(self):
        ...
        dlg.lPrompt.setText(
            QT_TRANSLATE_NOOP("TechDraw_ShareView", "Select View to share from list.")
        )
    ...
    def pickFromPage(self):
        ...
        self.dialogOpen = True
        dlg.lPrompt.setText(
            QT_TRANSLATE_NOOP("TechDraw_ShareView", "Select From Page.")
        )
