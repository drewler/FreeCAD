...
QString Preferences::defaultTemplate()
{
    ...
    if (prefFileName.empty()) { prefFileName = defaultFileName; }
...
QString Preferences::defaultTemplateDir()
{
    ...
    if (prefTemplateDir.empty()) { prefTemplateDir = defaultDir; }
...
std::string Preferences::lineGroupFile()
{
    ...
    if (lgFileName.empty()) { lgFileName = defaultFileName; }
...
std::string Preferences::svgFile()
{
    ...
    if (prefHatchFile.empty()) { prefHatchFile = defaultFileName; }
...
std::string Preferences::bitmapFill()
{
    ...
    if (prefBitmapFile.empty()) { prefBitmapFile = defaultFileName; }
