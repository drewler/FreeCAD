...
public:
    ...
    static std::vector<LineSet> getTrimmedLines(DrawViewPart *dvp, std::vector<LineSet> lineSets,
                                                int iface, double scale);
    static std::vector<LineSet> getTrimmedLines(DrawViewPart *source, std::vector<LineSet> lineSets,
                                                TopoDS_Face face, double scale);
    ...
    static std::vector<PATLineSpec> getDecodedSpecsFromFile(std::string fileSpec,
