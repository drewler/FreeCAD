...
TaskProjection::TaskProjection() : ui(new Ui_TaskProjection) { ui->setupUi(this); }
...
bool TaskProjection::reject() { return true; }


///////////////////////////////////////////////////////////////////////////

TaskDlgProjection::TaskDlgProjection() : TaskDialog()
{
    widget = new TaskProjection();
    taskbox =
        new Gui::TaskView::TaskBox(Gui::BitmapFactory().pixmap("actions/TechDraw_ProjectShape"),
...
void TaskDlgProjection::clicked(int i) { Q_UNUSED(i); }
