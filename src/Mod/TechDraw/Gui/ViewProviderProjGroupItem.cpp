...
void ViewProviderProjGroupItem::updateData(const App::Property *prop)
{
    ...
    if (strcmp(projType.c_str(), "Front") == 0) { sPixmap = "TechDraw_ProjFront"; }
...
bool ViewProviderProjGroupItem::doubleClicked() { return true; }
...
bool ViewProviderProjGroupItem::onDelete(const std::vector<std::string> &)
{
    ...
    if (isAnchor) {
        ...
        bodyMessageStream << qApp->translate(
            "Std_Delete", "You cannot delete the anchor view of a projection group.");
