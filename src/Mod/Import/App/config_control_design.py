...
set_of_reversible_topology_item = SET(
    0, None, "reversible_topology_item", scope=schema_scope
)
...
# SELECT TYPE shell
shell = SELECT(
    "vertex_shell", "wire_shell", "open_shell", "closed_shell", scope=schema_scope
)
...
supported_item = SELECT(
    "action_directive", "action", "action_method", scope=schema_scope
)
...
list_of_reversible_topology_item = LIST(
    0, None, "reversible_topology_item", scope=schema_scope
)
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument name is mantatory and can not be set to None"
                )
...
class functionally_defined_transformation(BaseEntityClass):
    ...
    def description():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument description is mantatory and can not be set to None"
                )
...
class versioned_action_request(BaseEntityClass):
    ...
    def id():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument id is mantatory and can not be set to None"
                )
    ...
    def version():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument version is mantatory and can not be set to None"
                )
            if not check_type(value, label):
    ...
    def purpose():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument purpose is mantatory and can not be set to None"
                )
            if not check_type(value, text):
...
class representation(BaseEntityClass):
    ...
    def items():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument items is mantatory and can not be set to None"
                )
            if not check_type(
                value, SET(1, None, "representation_item", scope=schema_scope)
            ):
...
class certification(BaseEntityClass):
    ...
    def kind():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument kind is mantatory and can not be set to None"
                )
...
class quantified_assembly_component_usage(assembly_component_usage):
    ...
    def quantity():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument quantity is mantatory and can not be set to None"
                )
...
class manifold_solid_brep(solid_model):
    ...
    def outer():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument outer is mantatory and can not be set to None"
                )
...
class action_directive(BaseEntityClass):
    ...
    def analysis():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument analysis is mantatory and can not be set to None"
                )
            if not check_type(value, text):
    ...
    def comment():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument comment is mantatory and can not be set to None"
                )
            if not check_type(value, text):
    ...
    def requests():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument requests is mantatory and can not be set to None"
                )
            if not check_type(
                value, SET(1, None, "versioned_action_request", scope=schema_scope)
            ):
...
class named_unit(BaseEntityClass):
    ...
    def dimensions():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument dimensions is mantatory and can not be set to None"
                )
...
class plane_angle_unit(named_unit):
    ...
    def wr1(self):
        eval_wr1_wr = (
            (
                (
                    (
                        (
                            (
                                self.self.named_unit.self.dimensions.self.length_exponent
                                == 0
                            )
                            and (
                                self.self.named_unit.self.dimensions.self.mass_exponent
                                == 0
                            )
                        )
                        and (
                            self.self.named_unit.self.dimensions.self.time_exponent == 0
                        )
                    )
                    and (
                        self.self.named_unit.self.dimensions.self.electric_current_exponent
                        == 0
                    )
                )
                and (
            ...
            and (
                self.self.named_unit.self.dimensions.self.amount_of_substance_exponent
                == 0
            )
        ) and (
            self.self.named_unit.self.dimensions.self.luminous_intensity_exponent == 0
        )
        if not eval_wr1_wr:
            raise AssertionError("Rule wr1 violated")
        else:
...
class offset_surface(surface):
    ...
    def distance():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument distance is mantatory and can not be set to None"
                )
...
class placement(geometric_representation_item):
    ...
    def location():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument location is mantatory and can not be set to None"
                )
            if not check_type(value, cartesian_point):
...
class product_related_product_category(product_category):
    ...
    def products():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument products is mantatory and can not be set to None"
                )
...
class conic(curve):
    ...
    def position():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument position is mantatory and can not be set to None"
                )
...
class hyperbola(conic):
    ...
    def semi_axis():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument semi_axis is mantatory and can not be set to None"
                )
...
class b_spline_surface(bounded_surface):
    ...
    def u_degree():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument u_degree is mantatory and can not be set to None"
                )
    ...
    def v_degree():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument v_degree is mantatory and can not be set to None"
                )
            if not check_type(value, INTEGER):
    ...
    def control_points_list():
        ...
        def fset(self, value):
            ...
            if not check_type(
                value,
                LIST(2, None, LIST(2, None, "cartesian_point", scope=schema_scope)),
            ):
    ...
    def u_closed():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument u_closed is mantatory and can not be set to None"
                )
            if not check_type(value, LOGICAL):
    ...
    def v_closed():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument v_closed is mantatory and can not be set to None"
                )
            if not check_type(value, LOGICAL):
...
class axis1_placement(placement):
    ...
    def z():
        def fget(self):
            attribute_eval = NVL(
                normalise(self.axis), self.dummy_gri == direction([0, 0, 1])
            )
            return attribute_eval
...
class b_spline_curve(bounded_curve):
    ...
    def degree():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument degree is mantatory and can not be set to None"
                )
            if not check_type(value, INTEGER):
    ...
    def control_points_list():
        ...
        def fset(self, value):
            ...
            if not check_type(
                value, LIST(2, None, "cartesian_point", scope=schema_scope)
            ):
                self._control_points_list = LIST(value)
            else:
                self._control_points_list = value
    ...
    def curve_form():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument curve_form is mantatory and can not be set to None"
                )
...
class rational_b_spline_curve(b_spline_curve):
    ...
    def weights():
        def fget(self):
            attribute_eval = list_to_array(
                self.weights_data, 0, self.upper_index_on_control_points
            )
            return attribute_eval
...
class face_bound(topological_representation_item):
    ...
    def bound():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument bound is mantatory and can not be set to None"
                )
    ...
    def orientation():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument orientation is mantatory and can not be set to None"
                )
...
class edge(topological_representation_item):
    ...
    def edge_start():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument edge_start is mantatory and can not be set to None"
                )
    ...
    def edge_end():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument edge_end is mantatory and can not be set to None"
                )
            if not check_type(value, vertex):
...
class oriented_edge(edge):
    ...
    def wr1(self):
        eval_wr1_wr = not (
            "CONFIG_CONTROL_DESIGN.ORIENTED_EDGE" == TYPEOF(self.self.edge_element)
        )
        if not eval_wr1_wr:
            raise AssertionError("Rule wr1 violated")
        else:
...
class document_with_class(document):
    ...
    def class_():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument class_ is mantatory and can not be set to None"
                )
            if not check_type(value, identifier):
...
class product_definition_formation(BaseEntityClass):
    ...
    def of_product():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument of_product is mantatory and can not be set to None"
                )
...
class person_and_organization_assignment(BaseEntityClass):
    ...
    def role():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument role is mantatory and can not be set to None"
                )
...
class cc_design_person_and_organization_assignment(person_and_organization_assignment):
    ...
    def items():
        ...
        def fset(self, value):
            ...
            if not check_type(
                value, SET(1, None, "person_organization_item", scope=schema_scope)
            ):
                self._items = SET(value)
            else:
                self._items = value
...
class offset_curve_3d(curve):
    ...
    def basis_curve():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument basis_curve is mantatory and can not be set to None"
                )
    ...
    def wr1(self):
        eval_wr1_wr = (self.basis_curve.self.dim == 3) and (
            self.ref_direction.self.dim == 3
        )
        if not eval_wr1_wr:
            raise AssertionError("Rule wr1 violated")
        else:
...
class approval(BaseEntityClass):
    ...
    def status():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument status is mantatory and can not be set to None"
                )
    ...
    def level():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument level is mantatory and can not be set to None"
                )
            if not check_type(value, label):
...
class composite_curve(bounded_curve):
    ...
    def segments():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument segments is mantatory and can not be set to None"
                )
            if not check_type(
                value, LIST(1, None, "composite_curve_segment", scope=schema_scope)
            ):
    ...
    def closed_curve():
        def fget(self):
            attribute_eval = (
                self.segments[self.n_segments].self.transition != discontinuous
            )
            return attribute_eval
...
class application_context(BaseEntityClass):
    ...
    def application():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument application is mantatory and can not be set to None"
                )
            if not check_type(value, text):
...
class change_request(action_request_assignment):
    ...
    def items():
        ...
        def fset(self, value):
            ...
            if not check_type(
                value, SET(1, None, "change_request_item", scope=schema_scope)
            ):
                self._items = SET(value)
            else:
                self._items = value
...
class approval_date_time(BaseEntityClass):
    ...
    def date_time():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument date_time is mantatory and can not be set to None"
                )
...
class spherical_surface(elementary_surface):
    ...
    def radius():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument radius is mantatory and can not be set to None"
                )
            if not check_type(value, positive_length_measure):
...
class specified_higher_usage_occurrence(assembly_component_usage):
    ...
    def upper_usage():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument upper_usage is mantatory and can not be set to None"
                )
    ...
    def next_usage():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument next_usage is mantatory and can not be set to None"
                )
    ...
    def wr5(self):
        eval_wr5_wr = not (
            "CONFIG_CONTROL_DESIGN.PROMISSORY_USAGE_OCCURRENCE"
            == TYPEOF(self.upper_usage)
        )
        if not eval_wr5_wr:
            raise AssertionError("Rule wr5 violated")
        else:
...
class product_definition_formation_with_specified_source(product_definition_formation):
    ...
    def make_or_buy():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument make_or_buy is mantatory and can not be set to None"
                )
...
class action_request_solution(BaseEntityClass):
    ...
    def method():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument method is mantatory and can not be set to None"
                )
    ...
    def request():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument request is mantatory and can not be set to None"
                )
            if not check_type(value, versioned_action_request):
...
class uncertainty_measure_with_unit(measure_with_unit):
    ...
    def wr1(self):
        eval_wr1_wr = valid_measure_value(
            self.self.measure_with_unit.self.value_component
        )
        if not eval_wr1_wr:
            raise AssertionError("Rule wr1 violated")
        else:
...
class edge_based_wireframe_model(geometric_representation_item):
    ...
    def ebwm_boundary():
        ...
        def fset(self, value):
            ...
            if not check_type(
                value, SET(1, None, "connected_edge_set", scope=schema_scope)
            ):
...
class path(topological_representation_item):
    ...
    def edge_list():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument edge_list is mantatory and can not be set to None"
                )
            if not check_type(
                value, LIST(1, None, "oriented_edge", scope=schema_scope)
            ):
...
class connected_face_set(topological_representation_item):
    ...
    def cfs_faces():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument cfs_faces is mantatory and can not be set to None"
                )
...
class oriented_open_shell(open_shell):
    ...
    def wr1(self):
        eval_wr1_wr = not (
            ...
            == TYPEOF(self.self.open_shell_element)
        )
        if not eval_wr1_wr:
            raise AssertionError("Rule wr1 violated")
        else:
...
class coordinated_universal_time_offset(BaseEntityClass):
    ...
    def hour_offset():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument hour_offset is mantatory and can not be set to None"
                )
    ...
    def sense():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument sense is mantatory and can not be set to None"
                )
...
class surface_curve(curve):
    ...
    def curve_3d():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument curve_3d is mantatory and can not be set to None"
                )
            if not check_type(value, curve):
    ...
    def associated_geometry():
        ...
        def fset(self, value):
            ...
            if not check_type(
                value, LIST(1, 2, "pcurve_or_surface", scope=schema_scope)
            ):
    ...
    def master_representation():
        ...
        def fset(self, value):
            ...
            if not check_type(value, preferred_surface_curve_representation):
                self._master_representation = preferred_surface_curve_representation(
                    value
                )
            else:
    ...
    def wr2(self):
        eval_wr2_wr = (
            "CONFIG_CONTROL_DESIGN.PCURVE" == TYPEOF(self.associated_geometry[1])
        ) or (self.master_representation != pcurve_s1)
        if not eval_wr2_wr:
            raise AssertionError("Rule wr2 violated")
        else:
            return eval_wr2_wr
    ...
    def wr3(self):
        eval_wr3_wr = (
            "CONFIG_CONTROL_DESIGN.PCURVE" == TYPEOF(self.associated_geometry[2])
        ) or (self.master_representation != pcurve_s2)
        if not eval_wr3_wr:
            raise AssertionError("Rule wr3 violated")
        else:
            return eval_wr3_wr
...
class composite_curve_segment(founded_item):
    ...
    def transition():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument transition is mantatory and can not be set to None"
                )
    ...
    def same_sense():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument same_sense is mantatory and can not be set to None"
                )
            if not check_type(value, BOOLEAN):
...
class representation_relationship(BaseEntityClass):
    ...
    def rep_1():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument rep_1 is mantatory and can not be set to None"
                )
    ...
    def rep_2():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument rep_2 is mantatory and can not be set to None"
                )
            if not check_type(value, representation):
...
class swept_surface(surface):
    ...
    def swept_curve():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument swept_curve is mantatory and can not be set to None"
                )
            if not check_type(value, curve):
...
class property_definition(BaseEntityClass):
    ...
    def definition():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument definition is mantatory and can not be set to None"
                )
...
class global_uncertainty_assigned_context(representation_context):
    ...
    def uncertainty():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument uncertainty is mantatory and can not be set to None"
                )
            if not check_type(
...
class parabola(conic):
    ...
    def focal_dist():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument focal_dist is mantatory and can not be set to None"
                )
            if not check_type(value, length_measure):
...
class vector(geometric_representation_item):
    ...
    def magnitude():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument magnitude is mantatory and can not be set to None"
                )
            if not check_type(value, length_measure):
...
class pcurve(curve):
    ...
    def wr1(self):
        eval_wr1_wr = (
            SIZEOF(self.reference_to_curve.self.representation.self.items) == 1
        )
        if not eval_wr1_wr:
            raise AssertionError("Rule wr1 violated")
        else:
...
class trimmed_curve(bounded_curve):
    ...
    def trim_1():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument trim_1 is mantatory and can not be set to None"
                )
    ...
    def trim_2():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument trim_2 is mantatory and can not be set to None"
                )
            if not check_type(value, SET(1, 2, "trimming_select", scope=schema_scope)):
...
class action_method(BaseEntityClass):
    ...
    def consequence():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument consequence is mantatory and can not be set to None"
                )
            if not check_type(value, text):
...
class product_category_relationship(BaseEntityClass):
    ...
    def category():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument category is mantatory and can not be set to None"
                )
    ...
    def wr1(self):
        eval_wr1_wr = acyclic_product_category_relationship(
            self, [self.self.sub_category]
        )
        if not eval_wr1_wr:
            raise AssertionError("Rule wr1 violated")
        else:
...
class representation_map(BaseEntityClass):
    ...
    def wr1(self):
        eval_wr1_wr = item_in_context(
            self.self.mapping_origin,
            self.self.mapped_representation.self.context_of_items,
        )
        if not eval_wr1_wr:
            raise AssertionError("Rule wr1 violated")
        else:
...
class product_definition_effectivity(effectivity):
    ...
    def usage():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument usage is mantatory and can not be set to None"
                )
...
class ellipse(conic):
    ...
    def semi_axis_1():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument semi_axis_1 is mantatory and can not be set to None"
                )
            if not check_type(value, positive_length_measure):
    ...
    def semi_axis_2():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument semi_axis_2 is mantatory and can not be set to None"
                )
            if not check_type(value, positive_length_measure):
...
class alternate_product_relationship(BaseEntityClass):
    ...
    def alternate():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument alternate is mantatory and can not be set to None"
                )
            if not check_type(value, product):
    ...
    def base():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument base is mantatory and can not be set to None"
                )
            if not check_type(value, product):
    ...
    def basis():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument basis is mantatory and can not be set to None"
                )
            if not check_type(value, text):
...
class document_reference(BaseEntityClass):
    ...
    def source():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument source is mantatory and can not be set to None"
                )
            if not check_type(value, label):
...
class start_request(action_request_assignment):
    ...
    def items():
        ...
        def fset(self, value):
            ...
            if not check_type(
                value, SET(1, None, "start_request_item", scope=schema_scope)
            ):
                self._items = SET(value)
            else:
                self._items = value
...
class cc_design_specification_reference(document_reference):
    ...
    def items():
        ...
        def fset(self, value):
            ...
            if not check_type(
                value, SET(1, None, "specified_item", scope=schema_scope)
            ):
                self._items = SET(value)
            else:
                self._items = value
...
class brep_with_voids(manifold_solid_brep):
    ...
    def voids():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument voids is mantatory and can not be set to None"
                )
            if not check_type(
                value, SET(1, None, "oriented_closed_shell", scope=schema_scope)
            ):
...
class face(topological_representation_item):
    ...
    def bounds():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument bounds is mantatory and can not be set to None"
                )
...
class oriented_face(face):
    ...
    def wr1(self):
        eval_wr1_wr = not (
            "CONFIG_CONTROL_DESIGN.ORIENTED_FACE" == TYPEOF(self.self.face_element)
        )
        if not eval_wr1_wr:
            raise AssertionError("Rule wr1 violated")
        else:
...
class point_replica(point):
    ...
    def parent_pt():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument parent_pt is mantatory and can not be set to None"
                )
...
class product(BaseEntityClass):
    ...
    def frame_of_reference():
        ...
        def fset(self, value):
            ...
            if not check_type(
                value, SET(1, None, "product_context", scope=schema_scope)
            ):
...
class rectangular_trimmed_surface(bounded_surface):
    ...
    def u1():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument u1 is mantatory and can not be set to None"
                )
            if not check_type(value, parameter_value):
    ...
    def u2():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument u2 is mantatory and can not be set to None"
                )
            if not check_type(value, parameter_value):
    ...
    def v1():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument v1 is mantatory and can not be set to None"
                )
            if not check_type(value, parameter_value):
    ...
    def v2():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument v2 is mantatory and can not be set to None"
                )
            if not check_type(value, parameter_value):
    ...
    def usense():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument usense is mantatory and can not be set to None"
                )
            if not check_type(value, BOOLEAN):
    ...
    def vsense():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument vsense is mantatory and can not be set to None"
                )
            if not check_type(value, BOOLEAN):
        ...
        eval_wr3_wr = (
            (
                (
                    ...
                    == TYPEOF(self.basis_surface)
                )
                and (not ("CONFIG_CONTROL_DESIGN.PLANE" == TYPEOF(self.basis_surface)))
            )
            or (
                "CONFIG_CONTROL_DESIGN.SURFACE_OF_REVOLUTION"
                == TYPEOF(self.basis_surface)
            )
...
class line(curve):
    ...
    def pnt():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument pnt is mantatory and can not be set to None"
                )
            if not check_type(value, cartesian_point):
    ...
    def dir():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument dir is mantatory and can not be set to None"
                )
            if not check_type(value, vector):
...
class geometric_set(geometric_representation_item):
    ...
    def elements():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument elements is mantatory and can not be set to None"
                )
            if not check_type(
                value, SET(1, None, "geometric_set_select", scope=schema_scope)
            ):
...
class assembly_component_usage_substitute(BaseEntityClass):
    ...
    def substitute():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument substitute is mantatory and can not be set to None"
                )
            if not check_type(value, assembly_component_usage):
...
class connected_edge_set(topological_representation_item):
    ...
    def ces_edges():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument ces_edges is mantatory and can not be set to None"
                )
...
class directed_action(executed_action):
    ...
    def directive():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument directive is mantatory and can not be set to None"
                )
...
class curve_bounded_surface(bounded_surface):
    ...
    def boundaries():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument boundaries is mantatory and can not be set to None"
                )
            if not check_type(
                value, SET(1, None, "boundary_curve", scope=schema_scope)
            ):
    ...
    def wr1(self):
        eval_wr1_wr = not (
            self.implicit_outer
            and (
                "CONFIG_CONTROL_DESIGN.OUTER_BOUNDARY_CURVE" == TYPEOF(self.boundaries)
            )
        )
        if not eval_wr1_wr:
            raise AssertionError("Rule wr1 violated")
...
class definitional_representation(representation):
    ...
    def wr1(self):
        eval_wr1_wr = (
            ...
            == TYPEOF(self.self.representation.self.context_of_items)
        )
        if not eval_wr1_wr:
            raise AssertionError("Rule wr1 violated")
        else:
...
class b_spline_curve_with_knots(b_spline_curve):
    ...
    def knots():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument knots is mantatory and can not be set to None"
                )
            if not check_type(value, LIST(2, None, "REAL", scope=schema_scope)):
    ...
    def knot_spec():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument knot_spec is mantatory and can not be set to None"
                )
...
class cc_design_contract(contract_assignment):
    ...
    def items():
        ...
        def fset(self, value):
            ...
            if not check_type(
                value, SET(1, None, "contracted_item", scope=schema_scope)
            ):
                self._items = SET(value)
            else:
                self._items = value
...
class axis2_placement_3d(placement):
    ...
    def wr3(self):
        eval_wr3_wr = (not EXISTS(self.ref_direction)) or (
            self.ref_direction.self.dim == 3
        )
        if not eval_wr3_wr:
            raise AssertionError("Rule wr3 violated")
...
class rational_b_spline_surface(b_spline_surface):
    ...
    def weights_data():
        ...
        def fset(self, value):
            ...
            if not check_type(
                value, LIST(2, None, LIST(2, None, "REAL", scope=schema_scope))
            ):
                self._weights_data = LIST(value)
            else:
                self._weights_data = value
    ...
    def wr1(self):
        eval_wr1_wr = (
            SIZEOF(self.weights_data)
            == SIZEOF(self.self.b_spline_surface.self.control_points_list)
        ) and (
...
class configuration_design(BaseEntityClass):
    ...
    def design():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument design is mantatory and can not be set to None"
                )
...
class product_definition(BaseEntityClass):
    ...
    def formation():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument formation is mantatory and can not be set to None"
                )
            if not check_type(value, product_definition_formation):
...
class cc_design_certification(certification_assignment):
    ...
    def items():
        ...
        def fset(self, value):
            ...
            if not check_type(
                value, SET(1, None, "certified_item", scope=schema_scope)
            ):
                self._items = SET(value)
            else:
                self._items = value
...
class b_spline_surface_with_knots(b_spline_surface):
    ...
    def u_knots():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument u_knots is mantatory and can not be set to None"
                )
            if not check_type(value, LIST(2, None, "REAL", scope=schema_scope)):
    ...
    def v_knots():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument v_knots is mantatory and can not be set to None"
                )
            if not check_type(value, LIST(2, None, "REAL", scope=schema_scope)):
...
class oriented_path(path):
    ...
    def wr1(self):
        eval_wr1_wr = not (
            "CONFIG_CONTROL_DESIGN.ORIENTED_PATH" == TYPEOF(self.self.path_element)
        )
        if not eval_wr1_wr:
            raise AssertionError("Rule wr1 violated")
        else:
...
class vertex_loop(loop):
    ...
    def loop_vertex():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument loop_vertex is mantatory and can not be set to None"
                )
            if not check_type(value, vertex):
...
class cartesian_point(point):
    ...
    def coordinates():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument coordinates is mantatory and can not be set to None"
                )
...
class surface_patch(founded_item):
    ...
    def u_sense():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument u_sense is mantatory and can not be set to None"
                )
            if not check_type(value, BOOLEAN):
    ...
    def v_sense():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument v_sense is mantatory and can not be set to None"
                )
            if not check_type(value, BOOLEAN):
...
class shape_aspect(BaseEntityClass):
    ...
    def of_shape():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument of_shape is mantatory and can not be set to None"
                )
            if not check_type(value, product_definition_shape):
            ...
            (
                ...
                or (
                    not (
                        "CONFIG_CONTROL_DESIGN.POLYLINE"
                        == TYPEOF(
                            self.face_geometry.self.swept_surface.self.swept_curve
                        )
                    )
                )
            )
...
class polyline(bounded_curve):
    ...
    def points():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument points is mantatory and can not be set to None"
                )
            if not check_type(
                value, LIST(2, None, "cartesian_point", scope=schema_scope)
            ):
...
class cc_design_security_classification(security_classification_assignment):
    ...
    def items():
        ...
        def fset(self, value):
            ...
            if not check_type(
                value, SET(1, None, "classified_item", scope=schema_scope)
            ):
                self._items = SET(value)
            else:
                self._items = value
...
class cc_design_date_and_time_assignment(date_and_time_assignment):
    ...
    def items():
        ...
        def fset(self, value):
            ...
            if not check_type(
                value, SET(1, None, "date_time_item", scope=schema_scope)
            ):
                self._items = SET(value)
            else:
                self._items = value
...
class oriented_closed_shell(closed_shell):
    ...
    def wr1(self):
        eval_wr1_wr = not (
            ...
            == TYPEOF(self.self.closed_shell_element)
        )
        if not eval_wr1_wr:
            raise AssertionError("Rule wr1 violated")
        else:
...
class person_and_organization(BaseEntityClass):
    ...
    def the_person():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument the_person is mantatory and can not be set to None"
                )
...
class local_time(BaseEntityClass):
    ...
    def zone():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument zone is mantatory and can not be set to None"
                )
...
class poly_loop(loop, geometric_representation_item):
    ...
    def polygon():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument polygon is mantatory and can not be set to None"
                )
            if not check_type(
                value, LIST(3, None, "cartesian_point", scope=schema_scope)
            ):
...
class shape_definition_representation(property_definition_representation):
    ...
    def wr1(self):
        eval_wr1_wr = (
            "CONFIG_CONTROL_DESIGN.SHAPE_DEFINITION"
            == TYPEOF(self.self.definition.self.definition)
        ) or (
            "CONFIG_CONTROL_DESIGN.PRODUCT_DEFINITION_SHAPE"
            == TYPEOF(self.self.definition)
        )
        if not eval_wr1_wr:
            raise AssertionError("Rule wr1 violated")
        else:
...
class conical_surface(elementary_surface):
    ...
    def semi_angle():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument semi_angle is mantatory and can not be set to None"
                )
...
class global_unit_assigned_context(representation_context):
    ...
    def units():
        ...
        def fset(self, value):
            ...
            if value == None:
                raise AssertionError(
                    "Argument units is mantatory and can not be set to None"
                )
...
def edge_reversed(
    ...
    if "CONFIG_CONTROL_DESIGN.ORIENTED_EDGE" == TYPEOF(an_edge):
        the_reverse = (
            dummy_tri == edge(an_edge.edge_end, an_edge.edge_start)
        ) == oriented_edge(
...
def gbsf_check_curve(
    ...
    if (
        ...
        if (
            SIZEOF(
                ["CONFIG_CONTROL_DESIGN.CIRCLE", "CONFIG_CONTROL_DESIGN.ELLIPSE"]
                * TYPEOF(cv)
            )
            == 1
        ):
                        ...
                        if (
                            ...
                            if "CONFIG_CONTROL_DESIGN.PCURVE" == TYPEOF(cv):
                                ...
                                if "CONFIG_CONTROL_DESIGN.POLYLINE" == TYPEOF(cv):
                                    ...
                                    if "CONFIG_CONTROL_DESIGN.SURFACE_CURVE" == TYPEOF(
                                        cv
                                    ):
    ...
    if "CONFIG_CONTROL_DESIGN.PCURVE" == TYPEOF(c):
        ...
        if "CONFIG_CONTROL_DESIGN.SURFACE_CURVE" == TYPEOF(c):
            ...
            for i in range(1, n, 1):
                surfs = surfs + associated_surface(
                    c.surface_curve.associated_geometry[i]
                )
...
def msf_curve_check(
    ...
    if (
        ...
        if (
            ...
            if (
                SIZEOF(
                    ["CONFIG_CONTROL_DESIGN.CONIC", "CONFIG_CONTROL_DESIGN.LINE"]
                    * TYPEOF(cv)
                )
                == 1
            ):
                ...
                if "CONFIG_CONTROL_DESIGN.CURVE_REPLICA" == TYPEOF(cv):
                    ...
                    if (
                        ...
                        not ("CONFIG_CONTROL_DESIGN.POLYLINE" == TYPEOF(cv.basis_curve))
                    ):
                        ...
                        if "CONFIG_CONTROL_DESIGN.PCURVE" == TYPEOF(cv):
                            ...
                            if "CONFIG_CONTROL_DESIGN.SURFACE_CURVE" == TYPEOF(cv):
                                if msf_curve_check(cv.surface_curve.curve_3d):
                                    for i in range(
                                        1,
                                        SIZEOF(cv.surface_curve.associated_geometry),
                                        1,
                                    ):
...
def orthogonal_complement(
    ...
    if (vec.dim != 2) or (not EXISTS(vec)):
        ...
        result = dummy_gri == direction(
            [-vec.direction_ratios[2], vec.direction_ratios[1]]
        )
        return result
...
def constraints_geometry_shell_based_wireframe_model(
    ...
    for j in range(1, SIZEOF(m.sbwm_boundary), 1):
        if (
            not ("CONFIG_CONTROL_DESIGN.WIRE_SHELL" == TYPEOF(m.sbwm_boundary[j]))
        ) and (
...
def constraints_geometry_shell_based_surface_model(
    ...
    for j in range(1, SIZEOF(m.sbsm_boundary), 1):
        if (
            not ("CONFIG_CONTROL_DESIGN.OPEN_SHELL" == TYPEOF(m.sbsm_boundary[j]))
        ) and (
...
def face_bound_reversed(
    ...
    if "CONFIG_CONTROL_DESIGN.FACE_OUTER_BOUND" == TYPEOF(a_face_bound):
        the_reverse = (
            dummy_tri
            == face_bound(
                a_face_bound.face_bound.bound, not a_face_bound.face_bound.orientation
            )
        ) == face_outer_bound()
    else:
        the_reverse = dummy_tri == face_bound(
            a_face_bound.bound, not a_face_bound.orientation
        )
    return the_reverse
...
def assembly_shape_is_defined(
    ...
    pr1_set = bag_to_set(
        USEDIN(
            assy.related_product_definition, schma + ".PROPERTY_DEFINITION.DEFINITION"
        )
    )
    ...
    pdrel_set = bag_to_set(
        USEDIN(
            ...
            (schma + ".PRODUCT_DEFINITION_RELATIONSHIP.")
            + "RELATED_PRODUCT_DEFINITION",
        )
    )
    for j in range(1, HIINDEX(pdrel_set), 1):
        pr2_set = pr2_set + USEDIN(
            pdrel_set[j], schma + ".PROPERTY_DEFINITION.DEFINITION"
        )
        ...
        if (
            ...
            if "CONFIG_CONTROL_DESIGN.CURVE_BOUNDED_SURFACE" == TYPEOF(sf):
                ...
                if (
                    ...
                    if "CONFIG_CONTROL_DESIGN.RECTANGULAR_COMPOSITE_SURFACE" == TYPEOF(
                        sf
                    ):
                        for i in range(
                            1, SIZEOF(sf.rectangular_composite_surface.segments), 1
                        ):
                            for j in range(
                                1,
                                SIZEOF(sf.rectangular_composite_surface.segments[i]),
                                1,
                            ):
                                if not gbsf_check_surface(
...
def face_reversed(
    ...
    if "CONFIG_CONTROL_DESIGN.ORIENTED_FACE" == TYPEOF(a_face):
        the_reverse = (
            dummy_tri == face(set_of_topology_reversed(a_face.bounds))
        ) == oriented_face(
...
def using_representations(
    ...
    if SIZEOF(intermediate_items) > 0:
        for i in range(1, HIINDEX(intermediate_items), 1):
            result_bag = USEDIN(
                intermediate_items[i], "CONFIG_CONTROL_DESIGN.REPRESENTATION.ITEMS"
            )
            if SIZEOF(result_bag) > 0:
...
def valid_units(
    ...
    if "CONFIG_CONTROL_DESIGN.ELECTRIC_CURRENT_MEASURE" == TYPEOF(m.value_component):
        if derive_dimensional_exponents(m.unit_component) != dimensional_exponents(
            ...
            return FALSE
    if "CONFIG_CONTROL_DESIGN.THERMODYNAMIC_TEMPERATURE_MEASURE" == TYPEOF(
        m.value_component
    ):
        if derive_dimensional_exponents(m.unit_component) != dimensional_exponents(
            0, 0, 0, 0, 1, 0, 0
    ...
    if "CONFIG_CONTROL_DESIGN.POSITIVE_LENGTH_MEASURE" == TYPEOF(m.value_component):
        if derive_dimensional_exponents(m.unit_component) != dimensional_exponents(
            ...
            return FALSE
    if "CONFIG_CONTROL_DESIGN.POSITIVE_PLANE_ANGLE_MEASURE" == TYPEOF(
        m.value_component
    ):
        if derive_dimensional_exponents(m.unit_component) != dimensional_exponents(
            0, 0, 0, 0, 0, 0, 0
