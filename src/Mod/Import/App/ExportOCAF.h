...
public:
    ...
    virtual ~ExportOCAF();
    int exportObject(App::DocumentObject *obj, std::vector<TDF_Label> &hierarchical_label,
    ...
    void getFreeLabels(std::vector<TDF_Label> &hierarchical_label, std::vector<TDF_Label> &labels,
                       std::vector<int> &label_part_id);
    void createNode(App::Part *part, int &root_it, std::vector<TDF_Label> &hierarchical_label,
                    std::vector<TopLoc_Location> &hierarchical_loc,
                    std::vector<App::DocumentObject *> &hierarchical_part);
