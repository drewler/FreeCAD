...
FCCmdImportReadBREP::FCCmdImportReadBREP() : Command("Import_ReadBREP")
{
    sAppModule = "Import";
    sGroup = "Import";
    sMenuText = "Read BREP";
...
bool FCCmdImportReadBREP::isActive() { return getGuiApplication()->activeDocument() != nullptr; }
...
ImportStep::ImportStep() : Command("Part_ImportStep")
{
    sAppModule = "Part";
    sGroup = "Part";
...
ImportIges::ImportIges() : Command("Import_Iges")
{
    sAppModule = "Import";
    sGroup = "Part";
