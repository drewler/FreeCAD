...
void printShape(JtkShape *partShape, int level)
{
    ...
    for (int set = 0; set < partShape->numOfSets(); set++) {
        ...
        partShape->getInternal(vertex, vertexCount, normal, normCount, color, colorCount, texture,
                               textCount, set);
...
int myPreactionCB_PrintName(JtkHierarchy *CurrNode, int level, JtkClientData *)
{
    ...
    switch (CurrNode->typeID()) {
        case JtkEntity::JtkNONE: InfoOut << "JtkNONE\n"; break;

        case JtkEntity::JtkBREP: InfoOut << "JtkBREP\n"; break;

        case JtkEntity::JtkREGION: InfoOut << "JtkREGION\n"; break;

        case JtkEntity::JtkSHELL: InfoOut << "JtkSHELL\n"; break;

        case JtkEntity::JtkLOOP: InfoOut << "JtkLOOP\n"; break;

        case JtkEntity::JtkCOEDGE: InfoOut << "JtkCOEDGE\n"; break;

        case JtkEntity::JtkEDGE: InfoOut << "JtkEDGE\n"; break;

        case JtkEntity::JtkVERTEX: InfoOut << "JtkVERTEX\n"; break;

        case JtkEntity::JtkNURBSSURFACE: InfoOut << "JtkNURBSSURFACE\n"; break;

        case JtkEntity::JtkUVCURVE: InfoOut << "JtkUVCURVE\n"; break;

        case JtkEntity::JtkXYZCURVE: InfoOut << "JtkXYZCURVE\n"; break;

        case JtkEntity::JtkTRISTRIPSET: InfoOut << "JtkTRISTRIPSET\n"; break;

        case JtkEntity::JtkPOINTSET: InfoOut << "JtkPOINTSET\n"; break;

        case JtkEntity::JtkLINESTRIPSET: InfoOut << "JtkLINESTRIPSET\n"; break;

        case JtkEntity::JtkPOLYGONSET: InfoOut << "JtkPOLYGONSET\n"; break;

        case JtkEntity::JtkPOINT: InfoOut << "JtkPOINT\n"; break;

        case JtkEntity::JtkMATERIAL: InfoOut << "JtkMATERIAL\n"; break;

        case JtkEntity::JtkTRANSFORM: InfoOut << "JtkTRANSFORM\n"; break;

        case JtkEntity::JtkPROPERTY: InfoOut << "JtkPROPERTY\n"; break;
            ...
            if (want_details) {
                ...
                for (int lod = 0; lod < partNumShapeLODs; lod++) {
                    ...
                    for (int shNum = 0; shNum < partNumShapes; shNum++) {
                        ...
                        if (partShape) { printShape(partShape, level + 3); }
                    }
                }
            }
        } break;
        ...
        case JtkEntity::JtkCLIENTDATA: InfoOut << "JtkCLIENTDATA\n"; break;

        case JtkEntity::JtkWIRE: InfoOut << "JtkWIRE\n"; break;
    }
...

            {
                ...
                for (int lod = 0; lod < partNumShapeLODs; lod++) {
                    ...
                    for (int shNum = 0; shNum < partNumShapes; shNum++) {
                        ...
                        JtkShape *partShape = NULL;
                        ((JtkPart *)CurrNode)->getPolyShape(partShape, lod, shNum);
                        if (partShape) { insertShapeFaces(partShape); }
                    }
                }
            }
        } break;
...
const SimpleMeshFacet *iterStart(void)
{
    ...
    if (resultIt != result.end()) return &(*(resultIt));
    else
        return 0;
}
...
unsigned int iterSize(void) { return (unsigned int)result.size(); }
