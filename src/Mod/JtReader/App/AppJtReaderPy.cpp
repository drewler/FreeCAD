...
{
    char *Name;
    if (!PyArg_ParseTuple(args, "et", "utf-8", &Name)) return NULL;
...
static PyObject *open(PyObject * /*self*/, PyObject *args)
{
    ...
    PY_TRY
    {
        ...
        // extract ending
        if (file.extension() == "") Py_Error(Base::PyExc_FC_GeneralError, "no file ending");
...
static PyObject *insert(PyObject * /*self*/, PyObject *args)
{
    char *Name;
    const char *DocName;
    if (!PyArg_ParseTuple(args, "ets", "utf-8", &Name, &DocName)) return NULL;
    std::string EncodedName = std::string(Name);
    PyMem_Free(Name);
