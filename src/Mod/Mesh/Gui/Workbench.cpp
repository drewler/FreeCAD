...
public:
    ...
    bool shouldShow(void) override { return true; }
...
Gui::MenuItem *Workbench::setupMenuBar() const
{
    ...
    *mesh << "Mesh_Import"
    ...
    if (mgr.getCommandByName("MeshPart_CreateFlatMesh")) *mesh << "MeshPart_CreateFlatMesh";
    if (mgr.getCommandByName("MeshPart_CreateFlatFace")) *mesh << "MeshPart_CreateFlatFace";
    return root;
}
