...
{
    const char *Mesh_Feature_xpm[] = {"16 16 4 1",        ".	c None",      "#	c #000000",
                                      "s	c #BEC2FC",   "g	c #00FF00",   ".......##.......",
                                      "....#######.....", "..##ggg#ggg#....", "##ggggg#gggg##..",
                                      "#g#ggg#gggggg##.", "#gg#gg#gggg###s.", "#gg#gg#gg##gg#s.",
                                      "#ggg#####ggg#ss.", "#gggg##gggg#ss..", ".#g##g#gggg#s...",
                                      ".##ggg#ggg#ss...", ".##gggg#g#ss....", "..s#####g#s.....",
                                      "....sss##ss.....", "........ss......", "................"};
...
{
    if (strcmp("Shaded", ModeName) == 0) setDisplayMaskMode("Flat");
...
void ViewProviderMeshNode::unsetEdit(void) { m_bEdit = false; }

const char *ViewProviderMeshNode::getEditModeName(void) { return "Polygon picking"; }
...
bool ViewProviderMeshNode::handleEvent(const SoEvent *const ev, Gui::View3DInventorViewer &Viewer)
{
    if (m_bEdit) {
        ...
        if (!ok) // note: the mouse grabbing needs to be released
            ...
            Base::Console().Message("The picked polygon seems to have self-overlappings. This "
