...
int SoSFMeshPointArray::getNumValuesPerLine() const { return 1; }
...
void SoFCMeshVertexElement::initClass() { SO_ELEMENT_INIT_CLASS(SoFCMeshVertexElement, inherited); }
...
void SoFCMeshVertexElement::set(SoState *const state, SoNode *const node,
                                const MeshCore::MeshPointArray *const coords)
{
    SoFCMeshVertexElement *elem =
        (SoFCMeshVertexElement *)SoReplacedElement::getElement(state, classStackIndex, node);
    if (elem) {
...
// Doc from superclass.
void SoFCMeshVertex::GLRender(SoGLRenderAction *action) { SoFCMeshVertex::doAction(action); }

// Doc from superclass.
void SoFCMeshVertex::callback(SoCallbackAction *action) { SoFCMeshVertex::doAction(action); }

// Doc from superclass.
void SoFCMeshVertex::pick(SoPickAction *action) { SoFCMeshVertex::doAction(action); }
