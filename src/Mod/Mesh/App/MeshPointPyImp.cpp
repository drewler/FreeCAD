...
int MeshPointPy::PyInit(PyObject *args, PyObject * /*kwds*/)
{
    ...
    if (!PyArg_ParseTuple(args, "|ddd", &x, &y, &z)) return -1;
...
Py::Long MeshPointPy::getIndex() const { return Py::Long((long)getMeshPointPtr()->Index); }
...
PyObject *MeshPointPy::getCustomAttributes(const char * /*attr*/) const { return nullptr; }

int MeshPointPy::setCustomAttributes(const char * /*attr*/, PyObject * /*obj*/) { return 0; }
