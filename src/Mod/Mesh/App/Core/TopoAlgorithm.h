...
private:
    ...
    void SplitFacetOnTwoEdges(FacetIndex ulFacetPos, const Base::Vector3f &rP1,
    ...
    void AddFacet(PointIndex P1, PointIndex P2, PointIndex P3, FacetIndex N1, FacetIndex N2,
                  FacetIndex N3);
