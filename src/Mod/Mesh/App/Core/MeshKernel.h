...
public:
    ...
    unsigned long CountFacets() const { return static_cast<unsigned long>(_aclFacetArray.size()); }
    /// Returns the number of edge
    unsigned long CountEdges() const;
    // Returns the number of points
    unsigned long CountPoints() const { return static_cast<unsigned long>(_aclPointArray.size()); }
    ...
    const Base::BoundBox3f &GetBoundBox() const { return _clBoundBox; }
    ...
    inline void GetFacetPoints(FacetIndex ulFaIndex, PointIndex &rclP0, PointIndex &rclP1,
                               PointIndex &rclP2) const;
    /** Returns the point indices of the given facet index. */
    inline void SetFacetPoints(FacetIndex ulFaIndex, PointIndex rclP0, PointIndex rclP1,
                               PointIndex rclP2);
    ...
    inline void GetFacetNeighbours(FacetIndex ulIndex, FacetIndex &rulNIdx0, FacetIndex &rulNIdx1,
    ...
    MeshPointModifier ModifyPoints() { return MeshPointModifier(_aclPointArray); }
    ...
    MeshFacetModifier ModifyFacets() { return MeshFacetModifier(_aclFacetArray); }
     ...
     */
    void Assign(const MeshPointArray &rPoints, const MeshFacetArray &rFaces,
     ...
     * @see CheckFacets().
     */
    void CutFacets(const MeshFacetGrid &rclGrid, const Base::ViewProjMethod *pclP,
...
inline void MeshKernel::AdjustNormal(MeshFacet &rclFacet, const Base::Vector3f &rclNormal)
{
    ...
    if ((clN * rclNormal) < 0.0f) { rclFacet.FlipNormal(); }
}
...
inline Base::Vector3f MeshKernel::GetGravityPoint(const MeshFacet &rclFacet) const
{
    ...
    return Base::Vector3f((p0.x + p1.x + p2.x) / 3.0f, (p0.y + p1.y + p2.y) / 3.0f,
                          (p0.z + p1.z + p2.z) / 3.0f);
}

inline void MeshKernel::GetFacetPoints(FacetIndex ulFaIndex, PointIndex &rclP0, PointIndex &rclP1,
                                       PointIndex &rclP2) const
{
...
inline void MeshKernel::SetFacetPoints(FacetIndex ulFaIndex, PointIndex rclP0, PointIndex rclP1,
                                       PointIndex rclP2)
{
    assert(ulFaIndex < _aclFacetArray.size());
