...
MeshTrimByPlane::MeshTrimByPlane(MeshKernel &rclM) : myMesh(rclM) {}

MeshTrimByPlane::~MeshTrimByPlane() {}

void MeshTrimByPlane::CheckFacets(const MeshFacetGrid &rclGrid, const Base::Vector3f &base,
                                  const Base::Vector3f &normal, std::vector<FacetIndex> &trimFacets,
...
void MeshTrimByPlane::CreateOneFacet(const Base::Vector3f &base, const Base::Vector3f &normal,
                                     unsigned short shift, const MeshGeomFacet &facet,
...
void MeshTrimByPlane::CreateTwoFacet(const Base::Vector3f &base, const Base::Vector3f &normal,
                                     unsigned short shift, const MeshGeomFacet &facet,
                                     std::vector<MeshGeomFacet> &trimmedFacets) const
{
    unsigned short nul = shift % 3;
...
void MeshTrimByPlane::TrimFacets(const std::vector<FacetIndex> &trimFacets,
                                 const Base::Vector3f &base, const Base::Vector3f &normal,
