...
private:
    ...
    public:
        ...
        bool operator==(const Edge &e) const { return (pt1 == e.pt1) && (pt2 == e.pt2); }
    };
    //@}
...
public:
    ...
    /** Add new facet
     */
    void AddFacet(const Base::Vector3f &pt1, const Base::Vector3f &pt2, const Base::Vector3f &pt3,
                  const Base::Vector3f &normal, unsigned char flag = 0, unsigned long prop = 0);
    /** Add new facet
