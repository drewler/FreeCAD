...
public:
    ...
    Matrix3(Real fM00, Real fM01, Real fM02, Real fM10, Real fM11, Real fM12, Real fM20, Real fM21,
            Real fM22);
    ...
    Matrix3(const Vector3<Real> &rkU, const Vector3<Real> &rkV, const Vector3<Real> &rkW,
            bool bColumns);
...
// c * M
template<class Real> Matrix3<Real> operator*(Real fScalar, const Matrix3<Real> &rkM);

// v^T * M
template<class Real> Vector3<Real> operator*(const Vector3<Real> &rkV, const Matrix3<Real> &rkM);
