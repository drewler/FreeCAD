...
template<class Real>
WM4_FOUNDATION_ITEM Box2<Real> ContAlignedBox(int iQuantity, const Vector2<Real> *akPoint);
...
// matrix.
template<class Real>
WM4_FOUNDATION_ITEM Box2<Real> ContOrientedBox(int iQuantity, const Vector2<Real> *akPoint);
...
template<class Real>
WM4_FOUNDATION_ITEM Box2<Real> ContMinBox(int iQuantity, const Vector2<Real> *akPoint,
...
template<class Real>
WM4_FOUNDATION_ITEM bool InBox(const Vector2<Real> &rkPoint, const Box2<Real> &rkBox);
...
// input boxes.
template<class Real>
WM4_FOUNDATION_ITEM Box2<Real> MergeBoxes(const Box2<Real> &rkBox0, const Box2<Real> &rkBox1);
