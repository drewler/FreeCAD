...
template<class Real> class Matrix2
{
public:
...
// c * M
template<class Real> Matrix2<Real> operator*(Real fScalar, const Matrix2<Real> &rkM);

// v^T * M
template<class Real> Vector2<Real> operator*(const Vector2<Real> &rkV, const Matrix2<Real> &rkM);
