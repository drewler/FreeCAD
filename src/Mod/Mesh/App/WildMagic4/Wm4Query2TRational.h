...
template<class Real> class Query2TRational: public Query2<Real>
{
public:
...
private:
    ...
    static Rational Dot(Rational &rkX0, Rational &rkY0, Rational &rkX1, Rational &rkY1);

    static Rational Det2(Rational &rkX0, Rational &rkY0, Rational &rkX1, Rational &rkY1);
