...
template<class Real> class WM4_FOUNDATION_ITEM ParametricSurface: public Surface<Real>
{
public:
    // abstract base class
    ...
    // orthonormal set.
    void GetFrame(Real fU, Real fV, Vector3<Real> &rkPosition, Vector3<Real> &rkTangent0,
    ...
    void ComputePrincipalCurvatureInfo(Real fU, Real fV, Real &rfCurv0, Real &rfCurv1,
