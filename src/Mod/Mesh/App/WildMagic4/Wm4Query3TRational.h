...
template<class Real> class Query3TRational: public Query3<Real>
{
public:
...
private:
    ...
    int ToTetrahedron(const RVector &rkRP, int iV0, int iV1, int iV2, int iV3) const;
    int ToCircumsphere(const RVector &rkRP, int iV0, int iV1, int iV2, int iV3) const;

    static Rational Dot(Rational &rkX0, Rational &rkY0, Rational &rkZ0, Rational &rkX1,
                        Rational &rkY1, Rational &rkZ1);

    static Rational Det3(Rational &rkX0, Rational &rkY0, Rational &rkZ0, Rational &rkX1,
                         Rational &rkY1, Rational &rkZ1, Rational &rkX2, Rational &rkY2,
                         Rational &rkZ2);

    static Rational Det4(Rational &rkX0, Rational &rkY0, Rational &rkZ0, Rational &rkW0,
