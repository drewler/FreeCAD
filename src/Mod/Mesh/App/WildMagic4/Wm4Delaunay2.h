...
template<class Real> class WM4_FOUNDATION_ITEM Delaunay2: public Delaunay<Real>
{
public:
    ...
    Delaunay2(int iVertexQuantity, Vector2<Real> *akVertex, Real fEpsilon, bool bOwner,
