...
{
//----------------------------------------------------------------------------
template<class Real> Line3<Real> OrthogonalLineFit3(int iQuantity, const Vector3<Real> *akPoint)
{
    ...
    int i;
    for (i = 1; i < iQuantity; i++) { kLine.Origin += akPoint[i]; }
...
//----------------------------------------------------------------------------
template WM4_FOUNDATION_ITEM Line3<float> OrthogonalLineFit3<float>(int, const Vector3<float> *);

template WM4_FOUNDATION_ITEM Line3<double> OrthogonalLineFit3<double>(int, const Vector3<double> *);
//----------------------------------------------------------------------------
} // namespace Wm4
