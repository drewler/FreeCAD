...
template<class Real> class Query2Int64: public Query2<Real>
{
public:
...
private:
    ...
    static Integer64 Dot(Integer64 iX0, Integer64 iY0, Integer64 iX1, Integer64 iY1);

    static Integer64 Det2(Integer64 iX0, Integer64 iY0, Integer64 iX1, Integer64 iY1);
