...
template<class Real> class WM4_FOUNDATION_ITEM PolynomialRoots
{
public:
...
private:
    // support for FindB
    bool Bisection(const Polynomial1<Real> &rkPoly, Real fXMin, Real fXMax, int iDigitsAccuracy,
                   Real &rfRoot);

    // support for FindE
    void GetHouseholderVector(int iSize, const Vector3<Real> &rkU, Vector3<Real> &rkV);

    void PremultiplyHouseholder(GMatrix<Real> &rkMat, GVector<Real> &rkW, int iRMin, int iRMax,
                                int iCMin, int iCMax, int iVSize, const Vector3<Real> &rkV);

    void PostmultiplyHouseholder(GMatrix<Real> &rkMat, GVector<Real> &rkW, int iRMin, int iRMax,
                                 int iCMin, int iCMax, int iVSize, const Vector3<Real> &rkV);
    ...
    bool IsBalancedCompanion4(Real fA10, Real fA21, Real fA32, Real fA03, Real fA13, Real fA23,
                              Real fA33);
