...
template<class Real> class Polynomial1
{
public:
    ...
    void Divide(const Polynomial1 &rkDiv, Polynomial1 &rkQuot, Polynomial1 &rkRem,
                Real fEpsilon) const;
...
template<class Real> Polynomial1<Real> operator*(Real fScalar, const Polynomial1<Real> &rkPoly);
