...
//----------------------------------------------------------------------------
template<class Real>
ConvexHull1<Real>::ConvexHull1(int iVertexQuantity, Real *afVertex, Real fEpsilon, bool bOwner,
...
//----------------------------------------------------------------------------
template<class Real> ConvexHull1<Real>::~ConvexHull1()
{
    if (m_bOwner) { WM4_DELETE[] m_afVertex; }
}
//----------------------------------------------------------------------------
template<class Real> const Real *ConvexHull1<Real>::GetVertices() const { return m_afVertex; }
//----------------------------------------------------------------------------
template<class Real>
...
//----------------------------------------------------------------------------
template<class Real> bool ConvexHull1<Real>::Load(const char *acFilename)
{
...
//----------------------------------------------------------------------------
template<class Real> bool ConvexHull1<Real>::Save(const char *acFilename) const
{
...
//----------------------------------------------------------------------------
template WM4_FOUNDATION_ITEM class ConvexHull1<float>;

template WM4_FOUNDATION_ITEM class ConvexHull1<double>;
//----------------------------------------------------------------------------
} // namespace Wm4
