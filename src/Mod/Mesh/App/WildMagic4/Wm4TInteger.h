...
private:
    ...
    static bool GetDivMod(const TInteger &rkNumer, const TInteger &rkDenom, TInteger &rkQuotient,
                          TInteger &rkRemainder);

    static void DivSingle(const TInteger &rkNumer, short usDenom, TInteger &rkQuo, TInteger &rkRem);

    static void DivMultiple(const TInteger &rkNumer, const TInteger &rkDenom, TInteger &rkQuo,
                            TInteger &rkRem);
...
template<int N> TInteger<N> operator*(int i, const TInteger<N> &rkI);
