...
T_DESCR_COMMUNITYHELP2 = translate(
    "StartPage",
    'If it is the first time you are posting on the forum, be sure to <a href="https://forum.freecadweb.org/viewtopic.php?f=3&t=2264">read the guidelines</a> first!',
)
...
T_DESCR_FORUM = translate(
    "StartPage",
    'The latest posts on the <a href="https://forum.freecadweb.org">FreeCAD forum</a>:',
)
