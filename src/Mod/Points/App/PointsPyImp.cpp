...
std::string PointsPy::representation() const { return std::string("<PointKernel object>"); }
...
PyObject *PointsPy::read(PyObject *args)
{
    ...
    PY_TRY { getPointKernelPtr()->load(Name); }
    PY_CATCH;
...
PyObject *PointsPy::write(PyObject *args)
{
    ...
    PY_TRY { getPointKernelPtr()->save(Name); }
    PY_CATCH;
...
PyObject *PointsPy::fromSegment(PyObject *args)
{
    ...
    try {
        ...
        for (Py::Sequence::iterator it = list.begin(); it != list.end(); ++it) {
            ...
            if (index >= 0 && index < numPoints) pts->push_back(points->getPoint(index));
        }
...
Py::Long PointsPy::getCountPoints() const { return Py::Long((long)getPointKernelPtr()->size()); }
...
PyObject *PointsPy::getCustomAttributes(const char * /*attr*/) const { return nullptr; }

int PointsPy::setCustomAttributes(const char * /*attr*/, PyObject * /*obj*/) { return 0; }
