...
class TestLoft(unittest.TestCase):
    ...
    def testSimpleAdditiveLoftCase(self):
        ...
        self.ProfileSketch = self.Doc.addObject(
            "Sketcher::SketchObject", "ProfileSketch"
        )
        ...
        self.Doc.recompute()
        self.AdditiveLoft = self.Doc.addObject(
    ...
    def testSimpleSubtractiveLoftCase(self):
        ...
        TestSketcherApp.CreateRectangleSketch(self.LoftSketch, (0, 1), (1, 1))
        self.Doc.recompute()
        self.SubtractiveLoft = self.Doc.addObject(
            "PartDesign::SubtractiveLoft", "SubtractiveLoft"
        )
