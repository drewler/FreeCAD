...
class TestInvoluteGear(unittest.TestCase):
    ...
    def assertIntersection(self, shape1, shape2, msg=None):
        self.failUnless(
            self._check_intersection(shape1, shape2),
            msg or "Given shapes do not intersect.",
        )

    def assertNoIntersection(self, shape1, shape2, msg=None):
        self.failIf(
            self._check_intersection(shape1, shape2), msg or "Given shapes intersect."
        )
