...
class TestPocket(unittest.TestCase):
    ...
    def testPocketThroughAllCase(self):
        ...
        self.Pocket.Length = 1
        self.Doc.recompute()
        self.PocketSketch1 = self.Doc.addObject(
            "Sketcher::SketchObject", "PocketSketch"
        )
        ...
        TestSketcherApp.CreateRectangleSketch(
            self.PocketSketch1, (2.5, -0.75), (5, 0.50)
        )
        self.Doc.recompute()
    ...
    def testPocketToFaceCase(self):
        ...
        self.Doc.recompute()
        while (
            "Invalid" in self.Pocket001.State
            or round(self.Pocket001.Shape.Volume, 7) != 50.0
