...
standards = {
    ...
    "DIN 13-1": (
        "1999",
        "Metrisches ISO-Gewinde allgemeiner Anwendung (Auszug); Nennmaße für Regelgewinde",
        "klein_14",
        "thread",
    ),
    "DIN 74-A": (
        "2003",
        "Senkungen fur Senkschrauben, ausgenommen Senkschrauben mit Kopfen nach DIN EN 27721; Form A",
        "klein_14",
        "countersink",
    ),
    "DIN 74-E": (
        "2003",
        "Senkungen fur Senkschrauben, ausgenommen Senkschrauben mit Kopfen nach DIN EN 27721; Form E",
        "klein_14",
        "countersink",
    ),
    "DIN 74-F": (
        "2003",
        "Senkungen fur Senkschrauben, ausgenommen Senkschrauben mit Kopfen nach DIN EN 27721; Form F",
        "klein_14",
        "countersink",
    ),
    "DIN 76-2": (
        "1984",
        "Gewindeausläufe und Gewindefreistiche (Auszug); für Metrisches ISO-Gewinde nach DIN 13; Innengewinde (Gewindegrundlöcher)",
        "klein_14",
        "threaded",
    ),
    "DIN 974-1": (
        "1991",
        "Senkdurchmesser für Schrauben mit Zylinderkopf; Konstruktionsmaße (Auszug)",
        "klein_14",
        "counterbore",
    ),
    "DIN 974-2": (
        "1991",
        "Senkdurchmesser fur Sechskantschrauben und Sechskantmuttern; Konstruktionsmaße(Auszug)",
        "klein_14",
        "counterbore",
    ),
    "ISO 273": (
    ...
    "ISO 15065": (
        "2005",
        "Senkungen fur Senkschrauben mit Kopfform nach ISO 7721",
        "klein_14",
        "countersink",
    ),
}
...
standards_counterbore_rows = {
    ...
    "DIN 974-1": {
        ...
        3: (
            "DIN 7980",
            "",
        ),  # single value gives wrong iteration when collecting the standards
...
def getThroughHoleDia(standard, threadDia, tolerance="medium"):
    ...
    if not threadDia in values:
        FreeCAD.Console.PrintMessage(
            "Warning: Diameter %f is not in %s" % (threadDia, standard)
        )
