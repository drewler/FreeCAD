    ...
    def GetResources(self):
        return {
            ...
            "ToolTip": QtCore.QT_TRANSLATE_NOOP(
                ...
                "Creates or edit the involute gear definition.",
            ),
        }
...
class _InvoluteGear:
    ...
    def __init__(self, obj):
        ...
        obj.addProperty(
            "App::PropertyInteger", "NumberOfTeeth", "Gear", "Number of gear teeth"
        )
        ...
        obj.addProperty(
            ...
            "ExternalGear",
            "Gear",
            "True=external Gear False=internal Gear ",
        )
...
class _InvoluteGearTaskPanel:
    ...
    def __init__(self, obj, mode):
        ...
        self.form = FreeCADGui.PySideUic.loadUi(
            FreeCAD.getHomePath() + "Mod/PartDesign/InvoluteGearFeature.ui"
        )
        self.form.setWindowIcon(
            QtGui.QIcon(":/icons/PartDesign_InternalExternalGear.svg")
        )
