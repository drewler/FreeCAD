...
PyObject *ViewProviderPy::getCustomAttributes(const char *) const { return nullptr; }

int ViewProviderPy::setCustomAttributes(const char *, PyObject *) { return 0; }

PyObject *ViewProviderPy::setBodyMode(PyObject *args)
{
    PyObject *b_mode;
    if (!PyArg_ParseTuple(args, "O!", &PyBool_Type, &b_mode)) { return nullptr; }
...
{
    PyObject *b_vis;
    if (!PyArg_ParseTuple(args, "O!", &PyBool_Type, &b_vis)) { return nullptr; }
