...
public:
    explicit TaskPipeParameters(ViewProviderPipe *PipeView, bool newObj = false,
...
private:
    ...
    ViewProviderPipe *getPipeView() const { return static_cast<ViewProviderPipe *>(vp); }
...
public:
    explicit TaskPipeOrientation(ViewProviderPipe *PipeView, bool newObj = false,
                                 QWidget *parent = nullptr);
...
public:
    explicit TaskPipeScaling(ViewProviderPipe *PipeView, bool newObj = false,
                             QWidget *parent = nullptr);
