...
CmdPrimtiveCompAdditive::CmdPrimtiveCompAdditive() : Command("PartDesign_CompPrimitiveAdditive")
{
...
void CmdPrimtiveCompAdditive::activated(int iMsg)
{
    ...
    if (shouldMakeBody) { pcActiveBody = PartDesignGui::makeBody(doc); }
