...
const char *Hole::ThreadTypeEnums[] = {
    "None", "ISOMetricProfile", "ISOMetricFineProfile", "UNC", "UNF", "UNEF", nullptr};
...
const Hole::ThreadDescription Hole::threadDescription[][171] = {
    ...
    {
        {"M1", 1.0, 0.25, 0.75},    {"M1.1", 1.1, 0.25, 0.85},  {"M1.2", 1.2, 0.25, 0.95},
        {"M1.4", 1.4, 0.30, 1.10},  {"M1.6", 1.6, 0.35, 1.25},  {"M1.8", 1.8, 0.35, 1.45},
        {"M2", 2.0, 0.40, 1.60},    {"M2.2", 2.2, 0.45, 1.75},  {"M2.5", 2.5, 0.45, 2.05},
        {"M3", 3.0, 0.50, 2.50},    {"M3.5", 3.5, 0.60, 2.90},  {"M4", 4.0, 0.70, 3.30},
        {"M4.5", 4.5, 0.75, 3.70},  {"M5", 5.0, 0.80, 4.20},    {"M6", 6.0, 1.00, 5.00},
        {"M7", 7.0, 1.00, 6.00},    {"M8", 8.0, 1.25, 6.80},    {"M9", 9.0, 1.25, 7.80},
        {"M10", 10.0, 1.50, 8.50},  {"M11", 11.0, 1.50, 9.50},  {"M12", 12.0, 1.75, 10.20},
        {"M14", 14.0, 2.00, 12.00}, {"M16", 16.0, 2.00, 14.00}, {"M18", 18.0, 2.50, 15.50},
        {"M20", 20.0, 2.50, 17.50}, {"M22", 22.0, 2.50, 19.50}, {"M24", 24.0, 3.00, 21.00},
        {"M27", 27.0, 3.00, 24.00}, {"M30", 30.0, 3.50, 26.50}, {"M33", 33.0, 3.50, 29.50},
        {"M36", 36.0, 4.00, 32.00}, {"M39", 39.0, 4.00, 35.00}, {"M42", 42.0, 4.50, 37.50},
        {"M45", 45.0, 4.50, 40.50}, {"M48", 48.0, 5.00, 43.00}, {"M52", 52.0, 5.00, 47.00},
        {"M56", 56.0, 5.50, 50.50}, {"M60", 60.0, 5.50, 54.50}, {"M64", 64.0, 6.00, 58.00},
        {"M68", 68.0, 6.00, 62.00},
    },
    ...
    /* UNF */
    {
        ...
        {"1 1/8", 28.575, 2.117, 26.50}, {"1 1/4", 31.750, 2.117, 29.50},
        {"1 3/8", 34.925, 2.117, 32.75}, {"1 1/2", 38.100, 2.117, 36.00},
    },
    /* UNEF */
    {
...
const char *Hole::ThreadSize_ISOmetric_Enums[] = {
    "M1",  "M1.1", "M1.2", "M1.4", "M1.6", "M1.8", "M2",  "M2.2", "M2.5", "M3",  "M3.5",
    "M4",  "M4.5", "M5",   "M6",   "M7",   "M8",   "M9",  "M10",  "M11",  "M12", "M14",
    "M16", "M18",  "M20",  "M22",  "M24",  "M27",  "M30", "M33",  "M36",  "M39", "M42",
    "M45", "M48",  "M52",  "M56",  "M60",  "M64",  "M68", nullptr};
const char *Hole::ThreadClass_ISOmetric_Enums[] = {"4G", "4H", "5G", "5H", "6G",   "6H",
                                                   "7G", "7H", "8G", "8H", nullptr};
...
const char *Hole::ThreadSize_ISOmetricfine_Enums[] = {
    "M1x0.2",    "M1.1x0.2",  "M1.2x0.2", "M1.4x0.2",  "M1.6x0.2", "M1.8x0.2", "M2x0.25",
    "M2.2x0.25", "M2.5x0.35", "M3x0.35",  "M3.5x0.35", "M4x0.5",   "M4.5x0.5", "M5x0.5",
    "M5.5x0.5",  "M6x0.75",   "M7x0.75",  "M8x0.75",   "M8x1.0",   "M9x0.75",  "M9x1.0",
    "M10x0.75",  "M10x1.0",   "M10x1.25", "M11x0.75",  "M11x1.0",  "M12x1.0",  "M12x1.25",
    "M12x1.5",   "M14x1.0",   "M14x1.25", "M14x1.5",   "M15x1.0",  "M15x1.5",  "M16x1.0",
    "M16x1.5",   "M17x1.0",   "M17x1.5",  "M18x1.0",   "M18x1.5",  "M18x2.0",  "M20x1.0",
    "M20x1.5",   "M20x2.0",   "M22x1.0",  "M22x1.5",   "M22x2.0",  "M24x1.0",  "M24x1.5",
    "M24x2.0",   "M25x1.0",   "M25x1.5",  "M25x2.0",   "M27x1.0",  "M27x1.5",  "M27x2.0",
    "M28x1.0",   "M28x1.5",   "M28x2.0",  "M30x1.0",   "M30x1.5",  "M30x2.0",  "M30x3.0",
    "M32x1.5",   "M32x2.0",   "M33x1.5",  "M33x2.0",   "M33x3.0",  "M35x1.5",  "M35x2.0",
    "M36x1.5",   "M36x2.0",   "M36x3.0",  "M39x1.5",   "M39x2.0",  "M39x3.0",  "M40x1.5",
    "M40x2.0",   "M40x3.0",   "M42x1.5",  "M42x2.0",   "M42x3.0",  "M42x4.0",  "M45x1.5",
    "M45x2.0",   "M45x3.0",   "M45x4.0",  "M48x1.5",   "M48x2.0",  "M48x3.0",  "M48x4.0",
    "M50x1.5",   "M50x2.0",   "M50x3.0",  "M52x1.5",   "M52x2.0",  "M52x3.0",  "M52x4.0",
    "M55x1.5",   "M55x2.0",   "M55x3.0",  "M55x4.0",   "M56x1.5",  "M56x2.0",  "M56x3.0",
    "M56x4.0",   "M58x1.5",   "M58x2.0",  "M58x3.0",   "M58x4.0",  "M60x1.5",  "M60x2.0",
    "M60x3.0",   "M60x4.0",   "M62x1.5",  "M62x2.0",   "M62x3.0",  "M62x4.0",  "M64x1.5",
    "M64x2.0",   "M64x3.0",   "M64x4.0",  "M65x1.5",   "M65x2.0",  "M65x3.0",  "M65x4.0",
    "M68x1.5",   "M68x2.0",   "M68x3.0",  "M68x4.0",   "M70x1.5",  "M70x2.0",  "M70x3.0",
    "M70x4.0",   "M70x6.0",   "M72x1.5",  "M72x2.0",   "M72x3.0",  "M72x4.0",  "M72x6.0",
    "M75x1.5",   "M75x2.0",   "M75x3.0",  "M75x4.0",   "M75x6.0",  "M76x1.5",  "M76x2.0",
    "M76x3.0",   "M76x4.0",   "M76x6.0",  "M80x1.5",   "M80x2.0",  "M80x3.0",  "M80x4.0",
    "M80x6.0",   "M85x2.0",   "M85x3.0",  "M85x4.0",   "M85x6.0",  "M90x2.0",  "M90x3.0",
    "M90x4.0",   "M90x6.0",   "M95x2.0",  "M95x3.0",   "M95x4.0",  "M95x6.0",  "M100x2.0",
    "M100x3.0",  "M100x4.0",  "M100x6.0", nullptr};
const char *Hole::ThreadClass_ISOmetricfine_Enums[] = {"4G", "4H", "5G", "5H", "6G",   "6H",
                                                       "7G", "7H", "8G", "8H", nullptr};
...
const char *Hole::ThreadSize_UNF_Enums[] = {
    "#0",  "#1",  "#2",    "#3",    "#4",    "#5",    "#6",   "#8",  "#10",
    "#12", "1/4", "5/16",  "3/8",   "7/16",  "1/2",   "9/16", "5/8", "3/4",
    "7/8", "1",   "1 1/8", "1 1/4", "1 3/8", "1 1/2", nullptr};
...
const char *Hole::ThreadSize_UNEF_Enums[] = {
    "#12",   "1/4",    "5/16",  "3/8",    "7/16",  "1/2",     "9/16",  "5/8",   "11/16",
    "3/4",   "13/16",  "7/8",   "15/16",  "1",     "1 1/16",  "1 1/8", "1 1/4", "1 5/16",
    "1 3/8", "1 7/16", "1 1/2", "1 9/16", "1 5/8", "1 11/16", nullptr};
...
const App::PropertyAngle::Constraints Hole::floatAngle = {
    ...
    180.0 - Base::toDegrees<double>(Precision::Angular()), 1.0};
// OCC can only create holes with a min diameter of 10 times the Precision::Confusion()
const App::PropertyQuantityConstraint::Constraints diameterRange = {10 * Precision::Confusion(),
                                                                    FLT_MAX, 1.0};
...
Hole::Hole()
{
    ...
    ADD_PROPERTY_TYPE(HoleCutCountersinkAngle, (90.0), "Hole", App::Prop_None,
                      "Head cut countersink angle");
    ...
    ADD_PROPERTY_TYPE(
        DrillForDepth, ((long)0), "Hole", App::Prop_None,
    ...
    ADD_PROPERTY_TYPE(ThreadDepth, (23.5), "Hole", App::Prop_None,
                      "Thread Length"); // default is assuming an M1

    ADD_PROPERTY_TYPE(UseCustomThreadClearance, (false), "Hole", App::Prop_None,
                      "Use custom thread clearance");

    ADD_PROPERTY_TYPE(CustomThreadClearance, (0.0), "Hole", App::Prop_None,
...
void Hole::updateHoleCutParams()
{
    ...
    if (threadTypeStr == "ISOMetricProfile" || threadTypeStr == "ISOMetricFineProfile") {
        ...
        if (holeCutTypeStr == "Counterbore") {
            ...
            if (HoleCutDepth.getValue() == 0.0) HoleCutDepth.setValue(dimen.depth);
            ...
            if (HoleCutDiameter.getValue() == 0.0 || HoleCutDiameter.getValue() <= diameterVal) {
                ...
                if (dimen.diameter != 0.0) { HoleCutDiameter.setValue(dimen.diameter); }
                else {
                    HoleCutDiameter.setValue(Diameter.getValue() + 0.1);
                }
        ...
        if (holeCutTypeStr == "Counterbore") {
            ...
            if (HoleCutDepth.getValue() == 0.0) HoleCutDepth.setValue(diameterVal * 0.9);
            HoleCutDiameter.setReadOnly(false);
            HoleCutDepth.setReadOnly(false);
        }
        else if (holeCutTypeStr == "Countersink") {
            if (HoleCutDiameter.getValue() == 0.0 || HoleCutDiameter.getValue() <= diameterVal) {
                ...
                if (threadTypeStr != "None") HoleCutCountersinkAngle.setValue(82.0);
                else
                    HoleCutCountersinkAngle.setValue(90.0);
            }
            if (HoleCutCountersinkAngle.getValue() == 0.0) {
...
double Hole::getThreadClassClearance() const
{
    ...
    if (ThreadClass.getValueAsString()[1] == 'G') {
        for (unsigned int i = 0; i < ThreadClass_ISOmetric_data_size; i++) {
            ...
            if (pitch <= p) { return ThreadClass_ISOmetric_data[i][1]; }
        }
    }
...
double Hole::getThreadRunout(int mode) const
{
    ...
    switch (mode) {
        case 1: sf = 1.0; break;
        case 2: sf = 0.625; break;
        case 3: sf = 1.6; break;
        default: throw Base::ValueError("Unsupported argument");
    }
    for (unsigned int i = 0; i < ThreadRunout_size; i++) {
        double p = ThreadRunout[i][0];
        if (pitch <= p) { return sf * ThreadRunout[i][1]; }
    }
...
double Hole::getThreadPitch() const
{
    ...
    if (threadType < 0) { throw Base::IndexError("Thread type out of range"); }
    if (threadSize < 0) { throw Base::IndexError("Thread size out of range"); }
...
void Hole::updateThreadDepthParam()
{
    ...
    if (HoleDepth == "Dimension") {
        if (ThreadMethod == "Hole Depth") { ThreadDepth.setValue(Depth.getValue()); }
        else if (ThreadMethod == "Dimension") {
            // the thread cannot be longer than the hole depth
            if (ThreadDepth.getValue() > Depth.getValue()) ThreadDepth.setValue(Depth.getValue());
            else
        ...
        if (ThreadMethod != "Dimension") { ThreadDepth.setValue(getThroughAllLength()); }
        else {
            // the thread cannot be longer than the hole depth
...
std::optional<double> Hole::determineDiameter() const
{
    ...
    if (threadType < 0) {
        ...
        if (isRestoring()) return std::nullopt;
        throw Base::IndexError("Thread type out of range");
    }
    if (threadSize < 0) {
        // When restoring the feature it might be in an inconsistent state.
    ...
    if (threadType == 0) return std::nullopt;

    if (Threaded.getValue()) {

        if (ModelThread.getValue()) {
            if (UseCustomThreadClearance.getValue()) clearance = CustomThreadClearance.getValue();
            else
        ...
        std::string threadTypeStr = ThreadType.getValueAsString();
        if (threadTypeStr == "ISOMetricProfile" || threadTypeStr == "UNC" || threadTypeStr == "UNF"
            || threadTypeStr == "UNEF") {
        ...
        if (threadTypeStr == "ISOMetricProfile" || threadTypeStr == "ISOMetricFineProfile") {
            ...
            switch (ThreadFit.getValue()) {
                case 0: /* standard fit */
                    ...
                    if (!found) { diameter = diameter * 1.10; }
                    break;
                case 1: /* close fit */
                    // read diameter out of matrix
                    for (int i = 0; i < MatrixRowSizeMetric; i++) {
                    ...
                    if (!found) { diameter = diameter * 1.06; }
                    break;
                case 2: /* wide fit */
                    // read diameter out of matrix
                    for (int i = 0; i < MatrixRowSizeMetric; i++) {
                    ...
                    // if nothing was found, we must calculate
                    if (!found) { diameter = diameter * 1.16; }
                    break;
                default: throw Base::IndexError("Thread fit out of range");
            }
        }
            ...
            switch (ThreadFit.getValue()) {
                case 0: /* normal fit */
                    ...
                    if (!found) { diameter = diameter * 1.08; }
                    break;
                case 1: /* close fit */
                    // read diameter out of matrix
                    for (int i = 0; i < MatrixRowSizeUTS; i++) {
                    ...
                    // if nothing was found, we must calculate
                    if (!found) { diameter = diameter * 1.04; }
                    break;
                case 2: /* loose fit */
                    // read diameter out of matrix
                    for (int i = 0; i < MatrixRowSizeUTS; i++) {
                    ...
                    // if nothing was found, we must calculate
                    if (!found) { diameter = diameter * 1.12; }
                    break;
                default: throw Base::IndexError("Thread fit out of range");
            }
        }
            ...
            switch (ThreadFit.getValue()) {
                case 0: /* normal fit */
                    // we must calculate
                    if (!found) { diameter = diameter * 1.1; }
                    break;
                case 1: /* close fit */
                    if (!found) { diameter = diameter * 1.05; }
                    break;
                case 2: /* loose fit */
                    if (!found) { diameter = diameter * 1.15; }
                    break;
                default: throw Base::IndexError("Thread fit out of range");
            }
        }
...
{
    if (auto opt = determineDiameter()) Diameter.setValue(opt.value());
}
...
void Hole::onChanged(const App::Property *prop)
{
    if (prop == &ThreadType) {
        ...
        if (ThreadType.isValid()) type = ThreadType.getValueAsString();
        if (HoleCutType.isValid()) holeCutTypeStr = HoleCutType.getValueAsString();
        ...
        if (type != "None") updateDiameterParam();
    }
        ...
        if (Threaded.getValue()) {
            ...
            ThreadClass.setReadOnly(true);
            ThreadDirection.setReadOnly(true);
            if (type == "None") ThreadFit.setReadOnly(true);
            else
        ...
        if (Tapered.getValue()) TaperedAngle.setReadOnly(false);
        else
            TaperedAngle.setReadOnly(true);
    }
    else if (prop == &ThreadSize) {
        updateDiameterParam();
        if (!isRestoring()) updateThreadDepthParam();
        ...
        if (!isRestoring()) {
            ...
            if (Depth.getValue() > getThroughAllLength()) Depth.setValue(getThroughAllLength());
        }
...
/**
  ...
  */
static void computeIntersection(gp_Pnt pa1, gp_Pnt pa2, gp_Pnt pb1, gp_Pnt pb2, double &x,
                                double &y)
{
...
short Hole::mustExecute() const
{
    if (ThreadType.isTouched() || Threaded.isTouched() || ThreadSize.isTouched()
        ...
        || ThreadDepthType.isTouched() || ThreadDepth.isTouched())
        return 1;
...
static gp_Pnt toPnt(gp_Vec dir) { return gp_Pnt(dir.X(), dir.Y(), dir.Z()); }
...
App::DocumentObjectExecReturn *Hole::execute()
{
    ...
    try {
        ...
        if (Reversed.getValue()) SketchVector *= -1.0;
        ...
        if (method == "Dimension") length = Depth.getValue();
        ...
        bool isCountersink =
            (holeCutType == "Countersink" || holeCutType == "Countersink socket screw (deprecated)"
             || isDynamicCountersink(threadType, holeCutType));
        bool isCounterbore =
            (holeCutType == "Counterbore" || holeCutType == "Cheesehead (deprecated)"
        ...
        if (isCountersink) {
            ...
            computeIntersection(
                gp_Pnt(holeCutRadius, 0, 0),
                gp_Pnt(holeCutRadius - sin(countersinkAngle), -cos(countersinkAngle), 0),
                gp_Pnt(radius, 0, 0), gp_Pnt(radiusBottom, -length, 0), xPosCounter, zPosCounter);
            ...
            if (holeCutDepth <= 0.0)
                return new App::DocumentObjectExecReturn(
                    "Hole error: Hole cut depth must be greater than zero");
            ...
            computeIntersection(gp_Pnt(0, -holeCutDepth, 0),
                                gp_Pnt(holeCutRadius, -holeCutDepth, 0), gp_Pnt(radius, 0, 0),
        ...
        if (drillPoint == "Flat") {
            ...
            if (isDrillForDepth) {
                computeIntersection(gp_Pnt(0, -length, 0),
                                    ...
                                    gp_Pnt(radius, 0, 0), gp_Pnt(radiusBottom, -length, 0),
                                    xPosDrill, zPosDrill);
                          ...
                          TopoDS_Shape &helixShape) const
{
    auto getRotationAxis = [](const gp_Dir &dir1, const gp_Dir &dir2, gp_Dir &dir3, double &angle) {
        if (dir1.IsEqual(dir2, Precision::Angular())) return false;

        angle = acos(dir1 * dir2);
        if (dir1.IsOpposite(dir2, Precision::Angular())) {
            // Create a vector that is not parallel to dir1
            gp_XYZ xyz(dir1.XYZ());
            if (fabs(xyz.X()) <= fabs(xyz.Y()) && fabs(xyz.X()) <= fabs(xyz.Z())) xyz.SetX(1.0);
                                ...
                                const TopoDS_Shape &protohole) const
{
    ...
    for (int i = 1; i <= edgeMap.Extent(); i++) {
        ...
        // Circle?
        if (c->DynamicType() != STANDARD_TYPE(Geom_Circle)) continue;
...
TopoDS_Shape Hole::makeThread(const gp_Vec &xDir, const gp_Vec &zDir, double length)
{
    ...
    if (threadDepthMethod != "Dimension") {
        ...
        if (depthMethod == "Dimension") {
            ...
            if (threadDepth > (holeDepth - P / 2)) helixLength = holeDepth + P / 8;
        }
    }
    ...
    mkPS.Add(threadWire);
    if (!mkPS.IsReady()) throw Base::CADKernelError("Error: Thread could not be built");
    ...
    if (!mkSolid.IsDone()) throw Base::CADKernelError("Error: Result is not a solid");
...
Hole::CutDimensionSet::CutDimensionSet(const std::string &nme,
                                       std::vector<CounterBoreDimension> &&d, CutType cut,
                                       ThreadType thread, double a)
    : bore_data {std::move(d)}, cut_type {cut}, thread_type {thread}, name {nme}, angle {a}
{}

Hole::CutDimensionSet::CutDimensionSet(const std::string &nme,
                                       std::vector<CounterSinkDimension> &&d, CutType cut,
                                       ThreadType thread, double a)
...
const Hole::CounterBoreDimension &Hole::CutDimensionSet::get_bore(const std::string &t) const
{
    ...
    if (i == bore_data.end()) return CounterBoreDimension::nothing;
    else
        return *i;
}
...
const Hole::CounterSinkDimension &Hole::CutDimensionSet::get_sink(const std::string &t) const
{
    ...
    if (i == sink_data.end()) return CounterSinkDimension::nothing;
    else
        return *i;
}
...
void from_json(const nlohmann::json &j, Hole::CutDimensionSet &t)
{
    ...
    if (thread_type_string == "metric") t.thread_type = Hole::CutDimensionSet::Metric;
...
{
    std::vector<std::string> dirs {::App::Application::getResourceDir()
                                       + "Mod/PartDesign/Resources/Hole",
                                   ::App::Application::getUserAppDataDir() + "PartDesign/Hole"};

    std::clog << "Looking for thread definitions in: ";
    for (auto &i : dirs) std::clog << i << " ";
    std::clog << "\n";
    for (auto &dir : dirs) {
