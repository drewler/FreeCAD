...
protected:
    ...
    static void getUpToFace(TopoDS_Face &upToFace, const TopoDS_Shape &support,
    ...
    static bool checkWireInsideFace(const TopoDS_Wire &wire, const TopoDS_Face &face,
                                    const gp_Dir &dir);
    ...
    void getAxis(const App::DocumentObject *pcReferenceAxis,
                 ...
                 Base::Vector3d &dir, ForbiddenAxis checkAxis) const;
