...
std::string GeometryPy::representation() const { return "<Geometry object>"; }
...
// constructor method
int GeometryPy::PyInit(PyObject * /*args*/, PyObject * /*kwd*/) { return 0; }
    ...
    try {
        ...
        for (std::size_t i = 0; i < ext.size(); ++i) {
            ...
            std::shared_ptr<GeometryExtension> p =
                std::const_pointer_cast<GeometryExtension>(ext[i].lock());
...
PyObject *GeometryPy::getCustomAttributes(const char * /*attr*/) const { return nullptr; }

int GeometryPy::setCustomAttributes(const char * /*attr*/, PyObject * /*obj*/) { return 0; }
