...
std::string CylinderPy::representation() const { return "<Cylinder object>"; }
...
int CylinderPy::PyInit(PyObject *args, PyObject *kwds)
{
    ...
    if (PyArg_ParseTupleAndKeywords(args, kwds, "O!d", keywords_cd, &(CylinderPy::Type), &pCyl,
                                    &dist)) {
        CylinderPy *pcCylinder = static_cast<CylinderPy *>(pCyl);
        Handle(Geom_CylindricalSurface) cylinder =
            Handle(Geom_CylindricalSurface)::DownCast(pcCylinder->getGeomCylinderPtr()->handle());
        ...
        Handle(Geom_CylindricalSurface) cyl =
            Handle(Geom_CylindricalSurface)::DownCast(getGeomCylinderPtr()->handle());
    ...
    if (PyArg_ParseTupleAndKeywords(args, kwds, "O!", keywords_c, &(CylinderPy::Type), &pCyl)) {
        CylinderPy *pcCylinder = static_cast<CylinderPy *>(pCyl);
        Handle(Geom_CylindricalSurface) cyl1 =
            Handle(Geom_CylindricalSurface)::DownCast(pcCylinder->getGeomCylinderPtr()->handle());
        Handle(Geom_CylindricalSurface) cyl2 =
            Handle(Geom_CylindricalSurface)::DownCast(this->getGeomCylinderPtr()->handle());
    ...
    if (PyArg_ParseTupleAndKeywords(args, kwds, "O!O!O!", keywords_ppp, &(Base::VectorPy::Type),
        ...
        GC_MakeCylindricalSurface mc(gp_Pnt(v1.x, v1.y, v1.z), gp_Pnt(v2.x, v2.y, v2.z),
...
PyObject *CylinderPy::getCustomAttributes(const char * /*attr*/) const { return nullptr; }

int CylinderPy::setCustomAttributes(const char * /*attr*/, PyObject * /*obj*/) { return 0; }
