...
PyObject *BRepOffsetAPI_MakePipeShellPy::PyMake(struct _typeobject *, PyObject *args,
                                                PyObject *) // Python wrapper
{
    // create a new instance of BRepOffsetAPI_MakePipeShellPy and the Twin object
    PyObject *obj;
    if (!PyArg_ParseTuple(args, "O!", &(TopoShapePy::Type), &obj)) return nullptr;
...
// constructor method
int BRepOffsetAPI_MakePipeShellPy::PyInit(PyObject * /*args*/, PyObject * /*kwd*/) { return 0; }
...
{
    PyObject *obj;
    if (!PyArg_ParseTuple(args, "O!", &PyBool_Type, &obj)) return nullptr;
...
{
    PyObject *dir;
    if (!PyArg_ParseTuple(args, "O!", &Base::VectorPy::Type, &dir)) return nullptr;
...
{
    PyObject *shape;
    if (!PyArg_ParseTuple(args, "O!", &Part::TopoShapePy::Type, &shape)) return nullptr;
...
PyObject *BRepOffsetAPI_MakePipeShellPy::setAuxiliarySpine(PyObject *args)
{
    ...
    if (!PyArg_ParseTuple(args, "O!O!O!", &Part::TopoShapePy::Type, &spine, &PyBool_Type, &curv,
                          &PyLong_Type, &keep))
        return nullptr;
    ...
    try {
        ...
        switch (PyLong_AsLong(keep)) {
            case 1: typeOfCantact = BRepFill_Contact; break;
            case 2: typeOfCantact = BRepFill_ContactOnBorder; break;
            default: typeOfCantact = BRepFill_NoContact; break;
        }
        this->getBRepOffsetAPI_MakePipeShellPtr()->SetMode(TopoDS::Wire(s), Base::asBoolean(curv),
                                                           typeOfCantact);
        Py_Return;
    }
    catch (Standard_Failure &e) {
...
PyObject *BRepOffsetAPI_MakePipeShellPy::add(PyObject *args, PyObject *kwds)
{
    ...
    if (PyArg_ParseTupleAndKeywords(args, kwds, "O!|O!O!", keywords_pro, &Part::TopoShapePy::Type,
                                    &prof, &PyBool_Type, &curv, &PyBool_Type, &keep)) {
        try {
            const TopoDS_Shape &s =
                static_cast<Part::TopoShapePy *>(prof)->getTopoShapePtr()->getShape();
            this->getBRepOffsetAPI_MakePipeShellPtr()->Add(s, Base::asBoolean(curv),
                                                           Base::asBoolean(keep));
            Py_Return;
        }
        catch (Standard_Failure &e) {
    ...
    if (PyArg_ParseTupleAndKeywords(args, kwds, "O!O!|O!O!", keywords_loc, &Part::TopoShapePy::Type,
                                    &prof, &Part::TopoShapeVertexPy::Type, &loc, &PyBool_Type,
                                    &curv, &PyBool_Type, &keep)) {
        try {
            const TopoDS_Shape &s =
                static_cast<Part::TopoShapePy *>(prof)->getTopoShapePtr()->getShape();
            const TopoDS_Vertex &v = TopoDS::Vertex(
                static_cast<Part::TopoShapePy *>(loc)->getTopoShapePtr()->getShape());
            this->getBRepOffsetAPI_MakePipeShellPtr()->Add(s, v, Base::asBoolean(curv),
                                                           Base::asBoolean(keep));
            Py_Return;
        }
        catch (Standard_Failure &e) {
...
{
    PyObject *prof;
    if (!PyArg_ParseTuple(args, "O!", &Part::TopoShapePy::Type, &prof)) return nullptr;
...
PyObject *BRepOffsetAPI_MakePipeShellPy::setTolerance(PyObject *args)
{
    ...
    if (!PyArg_ParseTuple(args, "ddd", &tol3d, &boundTol, &tolAngular)) return nullptr;
...
{
    int nbseg;
    if (!PyArg_ParseTuple(args, "i", &nbseg)) return nullptr;
...
{
    int nbsec;
    if (!PyArg_ParseTuple(args, "i", &nbsec)) return nullptr;
...
PyObject *BRepOffsetAPI_MakePipeShellPy::getCustomAttributes(const char *) const { return nullptr; }

int BRepOffsetAPI_MakePipeShellPy::setCustomAttributes(const char *, PyObject *) { return 0; }
