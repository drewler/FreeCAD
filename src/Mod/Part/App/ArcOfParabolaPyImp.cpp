...
void ArcOfParabolaPy::setFocal(Py::Float arg) { getGeomArcOfParabolaPtr()->setFocal((double)arg); }
...
PyObject *ArcOfParabolaPy::getCustomAttributes(const char *) const { return nullptr; }

int ArcOfParabolaPy::setCustomAttributes(const char *, PyObject *) { return 0; }
