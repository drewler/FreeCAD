...
std::string ParabolaPy::representation() const { return "<Parabola object>"; }
...
{
    PyObject *p1, *p2, *p3;
    if (!PyArg_ParseTuple(args, "O!O!O!", &Base::VectorPy::Type, &p1, &Base::VectorPy::Type, &p2,
...
PyObject *ParabolaPy::getCustomAttributes(const char * /*attr*/) const { return nullptr; }
