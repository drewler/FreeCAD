...
int CirclePy::PyInit(PyObject *args, PyObject *kwds)
{
    ...
    if (PyArg_ParseTupleAndKeywords(args, kwds, "O!d", keywords_cd, &(CirclePy::Type), &pCirc,
                                    &dist)) {
    ...
    PyErr_Clear();
    if (PyArg_ParseTupleAndKeywords(args, kwds, "O!O!d", keywords_cnr, &(Base::VectorPy::Type),
                                    &pV1, &(Base::VectorPy::Type), &pV2, &dist)) {
    ...
    if (PyArg_ParseTupleAndKeywords(args, kwds, "O!O!O!", keywords_ppp, &(Base::VectorPy::Type),
        ...
        GC_MakeCircle mc(gp_Pnt(v1.x, v1.y, v1.z), gp_Pnt(v2.x, v2.y, v2.z),
...
PyObject *CirclePy::getCustomAttributes(const char *) const { return nullptr; }

int CirclePy::setCustomAttributes(const char *, PyObject *) { return 0; }
