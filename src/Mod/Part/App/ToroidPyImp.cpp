...
std::string ToroidPy::representation() const { return "<Toroid object>"; }
...
int ToroidPy::PyInit(PyObject *args, PyObject * /*kwd*/)
{
    if (PyArg_ParseTuple(args, "")) {
        Handle(Geom_ToroidalSurface) torus =
            Handle(Geom_ToroidalSurface)::DownCast(getGeomToroidPtr()->handle());
...
PyObject *ToroidPy::getCustomAttributes(const char * /*attr*/) const { return nullptr; }

int ToroidPy::setCustomAttributes(const char * /*attr*/, PyObject * /*obj*/) { return 0; }
