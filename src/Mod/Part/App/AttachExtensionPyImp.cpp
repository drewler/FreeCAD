...
Py::Object AttachExtensionPy::getAttacher() const
{
    ...
    try {
        return Py::Object(
            new Attacher::AttachEnginePy(this->getAttachExtensionPtr()->attacher().copy()), true);
    }
    catch (Standard_Failure &e) {
...
PyObject *AttachExtensionPy::getCustomAttributes(const char * /*attr*/) const { return nullptr; }

int AttachExtensionPy::setCustomAttributes(const char * /*attr*/, PyObject * /*obj*/) { return 0; }
