...
template<> struct vec_traits<gp_Pnt> {
...
template<> struct vec_traits<gp_Vec> {
...
template<> struct vec_traits<gp_Dir> {
...
template<> struct vec_traits<gp_XYZ> {
...
PartExport void closestPointsOnLines(const gp_Lin &lin1, const gp_Lin &lin2, gp_Pnt &p1,
                                     gp_Pnt &p2);
PartExport bool intersect(const gp_Pln &pln1, const gp_Pln &pln2, gp_Lin &lin);
PartExport bool tangentialArc(const gp_Pnt &p0, const gp_Vec &v0, const gp_Pnt &p1, gp_Pnt &c,
                              gp_Dir &a);
...
public:
    Handle(Geom_Surface)
        makeSurface(const TColStd_ListOfTransient &theBoundaries, const Standard_Real theTol,
                    const Standard_Integer theNbPnts, const Standard_Integer theNbIter,
     ...
     */
    static bool getTriangulation(const TopoDS_Face &face, std::vector<gp_Pnt> &points,
     ...
     * \return true if a triangulation exists or false otherwise
     */
    static bool getPolygonOnTriangulation(const TopoDS_Edge &edge, const TopoDS_Face &face,
     ...
     * \param normals
     */
    static void getPointNormals(const std::vector<gp_Pnt> &points,
     ...
     * \param vertexnormals
     */
    static void getPointNormals(const std::vector<gp_Pnt> &points, const TopoDS_Face &face,
                                std::vector<gp_Vec> &vertexnormals);
    /*!
     * \brief getPointNormals
     ...
     * \param vertexnormals
     */
    static void getPointNormals(const TopoDS_Face &face, Handle(Poly_Triangulation) aPoly,
     ...
     * \param normals
     */
    static void applyTransformationOnNormals(const TopLoc_Location &loc,
                                             std::vector<gp_Vec> &normals);
    /*!
     ...
     * \param done
     */
    static void getNormal(const Handle(Geom_Surface) & surf, double u, double v,
     ...
     * \param done
     */
    static void getNormal(const TopoDS_Face &face, double u, double v, const Standard_Real tol,
