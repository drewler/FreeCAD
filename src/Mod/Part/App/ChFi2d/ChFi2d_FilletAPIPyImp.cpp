...
int ChFi2d_FilletAPIPy::PyInit(PyObject *args, PyObject * /*kwd*/)
{
    ...
    PyObject *edge1;
    PyObject *edge2;
    if (PyArg_ParseTuple(args, "O!O!O!", &TopoShapeEdgePy::Type, &edge1, &TopoShapeEdgePy::Type,
                         &edge2, &PlanePy::Type, &plane)) {
...
std::string ChFi2d_FilletAPIPy::representation() const { return std::string("<FilletAPI object>"); }
...
{
    double radius;
    if (!PyArg_ParseTuple(args, "d", &radius)) return nullptr;
...
{
    PyObject *pnt;
    if (!PyArg_ParseTuple(args, "O!", &Base::VectorPy::Type, &pnt)) return nullptr;
...
PyObject *ChFi2d_FilletAPIPy::result(PyObject *args)
{
    PyObject *pnt;
    int solution = -1;
    if (!PyArg_ParseTuple(args, "O!|i", &Base::VectorPy::Type, &pnt, &solution)) return nullptr;
...
PyObject *ChFi2d_FilletAPIPy::getCustomAttributes(const char * /*attr*/) const { return nullptr; }

int ChFi2d_FilletAPIPy::setCustomAttributes(const char * /*attr*/, PyObject * /*obj*/) { return 0; }
