...
PyObject *ChFi2d_ChamferAPIPy::PyMake(struct _typeobject *, PyObject *,
...
int ChFi2d_ChamferAPIPy::PyInit(PyObject *args, PyObject * /*kwd*/)
{
    ...
    PyObject *edge1;
    PyObject *edge2;
    if (PyArg_ParseTuple(args, "O!O!", &TopoShapeEdgePy::Type, &edge1, &TopoShapeEdgePy::Type,
                         &edge2)) {
...
PyObject *ChFi2d_ChamferAPIPy::result(PyObject *args)
{
    ...
    if (!PyArg_ParseTuple(args, "dd", &length1, &length2)) return nullptr;
...
PyObject *ChFi2d_ChamferAPIPy::getCustomAttributes(const char * /*attr*/) const { return nullptr; }
