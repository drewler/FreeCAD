...
PyObject *SurfaceOfRevolutionPy::PyMake(struct _typeobject *, PyObject *,
...
int SurfaceOfRevolutionPy::PyInit(PyObject *args, PyObject * /*kwd*/)
{
    ...
    PyObject *pPnt;
    PyObject *pDir;
    if (!PyArg_ParseTuple(args, "O!O!O!", &(GeometryPy::Type), &pGeom, &(Base::VectorPy::Type),
                          &pPnt, &(Base::VectorPy::Type), &pDir))
        return -1;
    ...
    try {
        ...
        Handle(Geom_SurfaceOfRevolution) curve2 = new Geom_SurfaceOfRevolution(
            curve, gp_Ax1(gp_Pnt(pnt.x, pnt.y, pnt.z), gp_Dir(dir.x, dir.y, dir.z)));
