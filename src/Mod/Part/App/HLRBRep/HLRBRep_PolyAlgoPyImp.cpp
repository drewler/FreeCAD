...
int HLRBRep_PolyAlgoPy::PyInit(PyObject *args, PyObject * /*kwds*/)
{
    ...
    if (!PyArg_ParseTuple(args, "|O!", &Part::TopoShapePy::Type, &shape)) return -1;
...
PyObject *HLRBRep_PolyAlgoPy::setProjector(PyObject *args, PyObject *kwds)
{
    ...
    if (PyArg_ParseTupleAndKeywords(args, kwds, "|O!O!O!d", kwlist, &Base::VectorPy::Type, &ps,
        ...
        if (boost::math::isnan(focus)) getHLRBRep_PolyAlgoPtr()->Projector(HLRAlgo_Projector(ax2));
        else
...
PyObject *HLRBRep_PolyAlgoPy::getCustomAttributes(const char * /*attr*/) const { return nullptr; }

int HLRBRep_PolyAlgoPy::setCustomAttributes(const char * /*attr*/, PyObject * /*obj*/) { return 0; }
