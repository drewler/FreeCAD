...
std::string EllipsePy::representation() const { return "<Ellipse object>"; }
...
int EllipsePy::PyInit(PyObject *args, PyObject *kwds)
{
    ...
    if (PyArg_ParseTupleAndKeywords(args, kwds, "", keywords_n)) {
        Handle(Geom_Ellipse) ellipse =
            Handle(Geom_Ellipse)::DownCast(getGeomEllipsePtr()->handle());
    ...
    if (PyArg_ParseTupleAndKeywords(args, kwds, "O!", keywords_e, &(EllipsePy::Type), &pElips)) {
        ...
        Handle(Geom_Ellipse) Elips1 =
            Handle(Geom_Ellipse)::DownCast(pEllipse->getGeomEllipsePtr()->handle());
        Handle(Geom_Ellipse) Elips2 =
            Handle(Geom_Ellipse)::DownCast(this->getGeomEllipsePtr()->handle());
    ...
    if (PyArg_ParseTupleAndKeywords(args, kwds, "O!O!O!", keywords_ssc, &(Base::VectorPy::Type),
        ...
        GC_MakeEllipse me(gp_Pnt(v1.x, v1.y, v1.z), gp_Pnt(v2.x, v2.y, v2.z),
...
PyObject *EllipsePy::getCustomAttributes(const char * /*attr*/) const { return nullptr; }

int EllipsePy::setCustomAttributes(const char * /*attr*/, PyObject * /*obj*/) { return 0; }
