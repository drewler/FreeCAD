...
std::string ShapeFix_ShellPy::representation() const { return "<ShapeFix_Shell object>"; }
...
int ShapeFix_ShellPy::PyInit(PyObject *args, PyObject * /*kwds*/)
{
    ...
    if (!PyArg_ParseTuple(args, "|O!", &TopoShapeShellPy::Type, &shell)) return -1;
...
{
    PyObject *shell;
    if (!PyArg_ParseTuple(args, "O!", &TopoShapeShellPy::Type, &shell)) return nullptr;
...
PyObject *ShapeFix_ShellPy::fixFaceOrientation(PyObject *args)
{
    ...
    if (!PyArg_ParseTuple(args, "O!|O!O!", &TopoShapeShellPy::Type, &shell, &PyBool_Type,
                          &multiConex, &PyBool_Type, &nonManifold))
        return nullptr;
...
PyObject *ShapeFix_ShellPy::setNonManifoldFlag(PyObject *args)
{
    ...
    if (!PyArg_ParseTuple(args, "O!", &PyBool_Type, &nonManifold)) return nullptr;
...
PyObject *ShapeFix_ShellPy::getCustomAttributes(const char * /*attr*/) const { return nullptr; }

int ShapeFix_ShellPy::setCustomAttributes(const char * /*attr*/, PyObject * /*obj*/) { return 0; }
