...
std::string ShapeFix_EdgePy::representation() const { return "<ShapeFix_Edge object>"; }
...
PyObject *ShapeFix_EdgePy::fixRemovePCurve(PyObject *args)
{
    PyObject *edge;
    PyObject *face;
    if (PyArg_ParseTuple(args, "O!O!", &TopoShapeEdgePy::Type, &edge, &TopoShapeFacePy::Type,
                         &face)) {
    ...
    PyErr_Clear();
    PyObject *plm;
    if (PyArg_ParseTuple(args, "O!O!O!", &TopoShapeEdgePy::Type, &edge, &GeometrySurfacePy::Type,
                         &face, &Base::PlacementPy::Type, &plm)) {
        TopoDS_Shape e = static_cast<TopoShapePy *>(edge)->getTopoShapePtr()->getShape();
...
{
    PyObject *edge;
    if (!PyArg_ParseTuple(args, "O!", &TopoShapeEdgePy::Type, &edge)) return nullptr;
...
PyObject *ShapeFix_EdgePy::fixAddPCurve(PyObject *args)
{
    ...
    PyObject *seam;
    double prec = 0.0;
    if (PyArg_ParseTuple(args, "O!O!O!|d", &TopoShapeEdgePy::Type, &edge, &TopoShapeFacePy::Type,
                         &face, &PyBool_Type, &seam, &prec)) {
        TopoDS_Shape e = static_cast<TopoShapePy *>(edge)->getTopoShapePtr()->getShape();
        TopoDS_Shape f = static_cast<TopoShapePy *>(face)->getTopoShapePtr()->getShape();

        bool ok = getShapeFix_EdgePtr()->FixAddPCurve(TopoDS::Edge(e), TopoDS::Face(f),
                                                      Base::asBoolean(seam), prec);
        return Py::new_reference_to(Py::Boolean(ok));
    }
    ...
    if (PyArg_ParseTuple(args, "O!O!O!O!|d", &TopoShapeEdgePy::Type, &edge,
                         &GeometrySurfacePy::Type, &face, &Base::PlacementPy::Type, &plm,
...
PyObject *ShapeFix_EdgePy::fixSameParameter(PyObject *args)
{
    ...
    PyErr_Clear();
    PyObject *face;
    if (PyArg_ParseTuple(args, "O!O!|d", &TopoShapeEdgePy::Type, &edge, &TopoShapeFacePy::Type,
                         &face, &tolerance)) {
        TopoDS_Shape e = static_cast<TopoShapePy *>(edge)->getTopoShapePtr()->getShape();
        TopoDS_Shape f = static_cast<TopoShapePy *>(face)->getTopoShapePtr()->getShape();
...
PyObject *ShapeFix_EdgePy::getCustomAttributes(const char * /*attr*/) const { return nullptr; }

int ShapeFix_EdgePy::setCustomAttributes(const char * /*attr*/, PyObject * /*obj*/) { return 0; }
