...
std::string ShapeFix_FacePy::representation() const { return "<ShapeFix_Face object>"; }
...
int ShapeFix_FacePy::PyInit(PyObject *args, PyObject * /*kwds*/)
{
    ...
    if (PyArg_ParseTuple(args, "O!d|O!", &GeometrySurfacePy::Type, &face, &prec, &PyBool_Type,
                         &fwd)) {
        setHandle(new ShapeFix_Face());
        if (face) {
...
PyObject *ShapeFix_FacePy::fixSmallAreaWire(PyObject *args)
{
    ...
    if (!PyArg_ParseTuple(args, "O!", &PyBool_Type, &removeSmall)) return nullptr;
...
PyObject *ShapeFix_FacePy::getCustomAttributes(const char * /*attr*/) const { return nullptr; }

int ShapeFix_FacePy::setCustomAttributes(const char * /*attr*/, PyObject * /*obj*/) { return 0; }
