...
std::string ShapeFix_SolidPy::representation() const { return "<ShapeFix_Solid object>"; }
...
int ShapeFix_SolidPy::PyInit(PyObject *args, PyObject * /*kwds*/)
{
    ...
    if (!PyArg_ParseTuple(args, "|O!", &TopoShapeSolidPy::Type, &solid)) return -1;
...
{
    PyObject *solid;
    if (!PyArg_ParseTuple(args, "O!", &TopoShapeSolidPy::Type, &solid)) return nullptr;
...
PyObject *ShapeFix_SolidPy::getCustomAttributes(const char * /*attr*/) const { return nullptr; }

int ShapeFix_SolidPy::setCustomAttributes(const char * /*attr*/, PyObject * /*obj*/) { return 0; }
