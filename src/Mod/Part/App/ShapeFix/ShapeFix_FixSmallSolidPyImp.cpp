...
PyObject *ShapeFix_FixSmallSolidPy::PyMake(struct _typeobject *, PyObject *,
...
{
    double value = -1.0;
    if (!PyArg_ParseTuple(args, "|d", &value)) return nullptr;
...
PyObject *ShapeFix_FixSmallSolidPy::remove(PyObject *args)
{
    ...
    TopoShape sh = getShapeFix_FixSmallSolidPtr()->Remove(
        static_cast<TopoShapePy *>(shape)->getTopoShapePtr()->getShape(), context);
