...
std::string ShapeFix_SplitToolPy::representation() const { return "<ShapeFix_SplitTool object>"; }

PyObject *ShapeFix_SplitToolPy::PyMake(struct _typeobject *, PyObject *,
...
PyObject *ShapeFix_SplitToolPy::splitEdge(PyObject *args)
{
    ...
    do {
        ...
        if (PyArg_ParseTuple(args, "O!dO!O!dd", &TopoShapeEdgePy::Type, &edge, &param1,
                             &TopoShapeVertexPy::Type, &vert, &TopoShapeFacePy::Type, &face, &tol3d,
                             &tol2d)) {
            ...
            ok = getShapeFix_SplitToolPtr()->SplitEdge(TopoDS::Edge(e), param1, TopoDS::Vertex(v),
                                                       TopoDS::Face(f), e1, e2, tol3d, tol2d);
            break;
        }

        PyErr_Clear();
        if (PyArg_ParseTuple(args, "O!ddO!O!dd", &TopoShapeEdgePy::Type, &edge, &param1, &param2,
                             &TopoShapeVertexPy::Type, &vert, &TopoShapeFacePy::Type, &face, &tol3d,
                             &tol2d)) {
            TopoDS_Shape e = static_cast<TopoShapePy *>(edge)->getTopoShapePtr()->getShape();
            TopoDS_Shape v = static_cast<TopoShapePy *>(vert)->getTopoShapePtr()->getShape();
            ...
            ok = getShapeFix_SplitToolPtr()->SplitEdge(TopoDS::Edge(e), param1, param2,
                                                       TopoDS::Vertex(v), TopoDS::Face(f), e1, e2,
                                                       tol3d, tol2d);
            break;
        }
...
PyObject *ShapeFix_SplitToolPy::getCustomAttributes(const char * /*attr*/) const { return nullptr; }
