...
std::string OffsetSurfacePy::representation() const { return "<OffsetSurface object>"; }
...
int OffsetSurfacePy::PyInit(PyObject *args, PyObject * /*kwd*/)
{
    PyObject *pGeom;
    double offset;
    if (!PyArg_ParseTuple(args, "O!d", &(GeometryPy::Type), &pGeom, &offset)) return -1;
...
PyObject *OffsetSurfacePy::getCustomAttributes(const char * /*attr*/) const { return nullptr; }
