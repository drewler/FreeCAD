...
std::string BezierCurve2dPy::representation() const { return "<BezierCurve2d object>"; }
...
// constructor method
int BezierCurve2dPy::PyInit(PyObject * /*args*/, PyObject * /*kwd*/) { return 0; }

PyObject *BezierCurve2dPy::isRational(PyObject *args)
{
    if (!PyArg_ParseTuple(args, "")) return nullptr;
    Handle(Geom2d_BezierCurve) curve =
        Handle(Geom2d_BezierCurve)::DownCast(getGeometry2dPtr()->handle());
...
PyObject *BezierCurve2dPy::getCustomAttributes(const char * /*attr*/) const { return nullptr; }
