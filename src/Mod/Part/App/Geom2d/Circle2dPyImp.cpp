...
std::string Circle2dPy::representation() const { return "<Circle2d object>"; }
...
int Circle2dPy::PyInit(PyObject *args, PyObject *kwds)
{
    ...
    if (PyArg_ParseTupleAndKeywords(args, kwds, "O!d", keywords_cd, &(Circle2dPy::Type), &pCirc,
                                    &dist)) {
    ...
    if (PyArg_ParseTupleAndKeywords(args, kwds, "O!d", keywords_cnr,
                                    Base::Vector2dPy::type_object(), &pV1, &dist)) {
    ...
    if (PyArg_ParseTupleAndKeywords(
            args, kwds, "O!O!O!", keywords_ppp, Base::Vector2dPy::type_object(), &pV1,
...
PyObject *Circle2dPy::getCircleCenter(PyObject *args)
{
    ...
    if (!PyArg_ParseTuple(args, "O!O!O!", Base::Vector2dPy::type_object(), &p1,
                          Base::Vector2dPy::type_object(), &p2, Base::Vector2dPy::type_object(),
                          &p3))
        return nullptr;
...
PyObject *Circle2dPy::getCustomAttributes(const char *) const { return nullptr; }

int Circle2dPy::setCustomAttributes(const char *, PyObject *) { return 0; }
