...
std::string Ellipse2dPy::representation() const { return "<Ellipse2d object>"; }
...
int Ellipse2dPy::PyInit(PyObject *args, PyObject *kwds)
{
    ...
    if (PyArg_ParseTupleAndKeywords(args, kwds, "", keywords_n)) {
        Handle(Geom2d_Ellipse) ellipse =
            Handle(Geom2d_Ellipse)::DownCast(getGeom2dEllipsePtr()->handle());
    ...
    if (PyArg_ParseTupleAndKeywords(args, kwds, "O!", keywords_e, &(Ellipse2dPy::Type), &pElips)) {
        ...
        Handle(Geom2d_Ellipse) Elips1 =
            Handle(Geom2d_Ellipse)::DownCast(pEllipse->getGeom2dEllipsePtr()->handle());
        Handle(Geom2d_Ellipse) Elips2 =
            Handle(Geom2d_Ellipse)::DownCast(this->getGeom2dEllipsePtr()->handle());
    ...
    if (PyArg_ParseTupleAndKeywords(
            args, kwds, "O!O!O!", keywords_ssc, Base::Vector2dPy::type_object(), &pV1,
            Base::Vector2dPy::type_object(), &pV2, Base::Vector2dPy::type_object(), &pV3)) {
    ...
    if (PyArg_ParseTupleAndKeywords(args, kwds, "O!dd", keywords_cmm,
                                    Base::Vector2dPy::type_object(), &pV, &major, &minor)) {
...
PyObject *Ellipse2dPy::getCustomAttributes(const char * /*attr*/) const { return nullptr; }

int Ellipse2dPy::setCustomAttributes(const char * /*attr*/, PyObject * /*obj*/) { return 0; }
