...
std::string Hyperbola2dPy::representation() const { return "<Hyperbola2d object>"; }
...
PyObject *Hyperbola2dPy::getCustomAttributes(const char * /*attr*/) const { return nullptr; }
