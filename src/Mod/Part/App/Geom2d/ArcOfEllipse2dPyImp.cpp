...
std::string ArcOfEllipse2dPy::representation() const { return "<Arc of ellipse2d object>"; }
...
int ArcOfEllipse2dPy::PyInit(PyObject *args, PyObject * /*kwds*/)
{
    ...
    if (PyArg_ParseTuple(args, "O!dd|O!", &(Part::Ellipse2dPy::Type), &o, &u1, &u2, &PyBool_Type,
                         &sense)) {
        try {
...
PyObject *ArcOfEllipse2dPy::getCustomAttributes(const char *) const { return nullptr; }

int ArcOfEllipse2dPy::setCustomAttributes(const char *, PyObject *) { return 0; }
