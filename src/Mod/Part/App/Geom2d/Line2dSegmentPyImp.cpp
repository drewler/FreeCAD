...
std::string Line2dSegmentPy::representation() const { return "<Line2dSegment object>"; }
...
PyObject *Line2dSegmentPy::getCustomAttributes(const char * /*attr*/) const { return nullptr; }
