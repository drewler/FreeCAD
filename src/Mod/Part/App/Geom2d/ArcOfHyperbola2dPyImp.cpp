...
std::string ArcOfHyperbola2dPy::representation(void) const { return "<ArcOfHyperbola2d object>"; }
...
int ArcOfHyperbola2dPy::PyInit(PyObject *args, PyObject * /*kwds*/)
{
    ...
    if (PyArg_ParseTuple(args, "O!dd|O!", &(Part::Hyperbola2dPy::Type), &o, &u1, &u2, &PyBool_Type,
                         &sense)) {
        try {
...
PyObject *ArcOfHyperbola2dPy::getCustomAttributes(const char *) const { return nullptr; }
