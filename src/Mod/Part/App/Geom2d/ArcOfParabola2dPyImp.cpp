...
std::string ArcOfParabola2dPy::representation() const { return "<ArcOfParabola2d object>"; }
...
int ArcOfParabola2dPy::PyInit(PyObject *args, PyObject * /*kwds*/)
{
    ...
    if (PyArg_ParseTuple(args, "O!dd|O!", &(Part::Parabola2dPy::Type), &o, &u1, &u2, &PyBool_Type,
                         &sense)) {
        try {
...
PyObject *ArcOfParabola2dPy::getCustomAttributes(const char *) const { return nullptr; }
