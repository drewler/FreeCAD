...
std::string Conic2dPy::representation() const { return "<Conic2d object>"; }
...
// constructor method
int Conic2dPy::PyInit(PyObject * /*args*/, PyObject * /*kwds*/) { return 0; }
...
PyObject *Conic2dPy::getCustomAttributes(const char *) const { return nullptr; }
