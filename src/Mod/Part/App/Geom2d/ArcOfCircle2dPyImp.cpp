...
std::string ArcOfCircle2dPy::representation() const { return "<Arc of circle2d object>"; }
...
int ArcOfCircle2dPy::PyInit(PyObject *args, PyObject * /*kwds*/)
{
    ...
    if (PyArg_ParseTuple(args, "O!dd|O!", &(Part::Circle2dPy::Type), &o, &u1, &u2, &PyBool_Type,
                         &sense)) {
        try {
    ...
    if (PyArg_ParseTuple(args, "O!O!O!", Base::Vector2dPy::type_object(), &pV1,
                         Base::Vector2dPy::type_object(), &pV2, Base::Vector2dPy::type_object(),
                         &pV3)) {
...
PyObject *ArcOfCircle2dPy::getCustomAttributes(const char *) const { return nullptr; }
