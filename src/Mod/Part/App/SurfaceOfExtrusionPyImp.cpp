...
PyObject *SurfaceOfExtrusionPy::PyMake(struct _typeobject *, PyObject *,
...
int SurfaceOfExtrusionPy::PyInit(PyObject *args, PyObject * /*kwd*/)
{
    PyObject *pGeom;
    PyObject *pDir;
    if (!PyArg_ParseTuple(args, "O!O!", &(GeometryPy::Type), &pGeom, &(Base::VectorPy::Type),
                          &pDir))
        return -1;
...
{
    Handle(Geom_SurfaceOfLinearExtrusion) curve =
        Handle(Geom_SurfaceOfLinearExtrusion)::DownCast(getGeometryPtr()->handle());
...
PyObject *SurfaceOfExtrusionPy::getCustomAttributes(const char * /*attr*/) const { return nullptr; }
