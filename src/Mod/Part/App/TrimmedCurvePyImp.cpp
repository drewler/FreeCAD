...
std::string TrimmedCurvePy::representation() const { return "<Curve object>"; }
...
// constructor method
int TrimmedCurvePy::PyInit(PyObject * /*args*/, PyObject * /*kwd*/) { return 0; }
...
PyObject *TrimmedCurvePy::getCustomAttributes(const char * /*attr*/) const { return nullptr; }
