...
std::string HyperbolaPy::representation() const { return "<Hyperbola object>"; }
...
int HyperbolaPy::PyInit(PyObject *args, PyObject *kwds)
{
    ...
    if (PyArg_ParseTupleAndKeywords(args, kwds, "", keywords_n)) {
        Handle(Geom_Hyperbola) hyperbola =
            Handle(Geom_Hyperbola)::DownCast(getGeomHyperbolaPtr()->handle());
    ...
    if (PyArg_ParseTupleAndKeywords(args, kwds, "O!", keywords_e, &(HyperbolaPy::Type), &pHypr)) {
        ...
        Handle(Geom_Hyperbola) Hypr1 =
            Handle(Geom_Hyperbola)::DownCast(pHyperbola->getGeomHyperbolaPtr()->handle());
        Handle(Geom_Hyperbola) Hypr2 =
            Handle(Geom_Hyperbola)::DownCast(this->getGeomHyperbolaPtr()->handle());
    ...
    if (PyArg_ParseTupleAndKeywords(args, kwds, "O!O!O!", keywords_ssc, &(Base::VectorPy::Type),
                                    &pV1, &(Base::VectorPy::Type), &pV2, &(Base::VectorPy::Type),
                                    &pV3)) {
        Base::Vector3d v1 = static_cast<Base::VectorPy *>(pV1)->value();
        Base::Vector3d v2 = static_cast<Base::VectorPy *>(pV2)->value();
        Base::Vector3d v3 = static_cast<Base::VectorPy *>(pV3)->value();
        GC_MakeHyperbola me(gp_Pnt(v1.x, v1.y, v1.z), gp_Pnt(v2.x, v2.y, v2.z),
    ...
    PyObject *pV;
    double major, minor;
    if (PyArg_ParseTupleAndKeywords(args, kwds, "O!dd", keywords_cmm, &(Base::VectorPy::Type), &pV,
                                    &major, &minor)) {
...
PyObject *HyperbolaPy::getCustomAttributes(const char * /*attr*/) const { return nullptr; }

int HyperbolaPy::setCustomAttributes(const char * /*attr*/, PyObject * /*obj*/) { return 0; }
