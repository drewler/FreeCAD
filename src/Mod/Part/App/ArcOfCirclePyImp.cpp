...
void ArcOfCirclePy::setRadius(Py::Float arg) { getGeomArcOfCirclePtr()->setRadius((double)arg); }
...
PyObject *ArcOfCirclePy::getCustomAttributes(const char *) const { return nullptr; }

int ArcOfCirclePy::setCustomAttributes(const char *, PyObject *) { return 0; }
