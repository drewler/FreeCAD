...
public:
    ...
    short mustExecute() const override;
    //@}
    const char *getViewProviderName() const override { return "PartGui::ViewProviderEllipsoid"; }
};
...
public:
    ...
    short mustExecute() const override;
    /// returns the type name of the ViewProvider
    const char *getViewProviderName() const override { return "PartGui::ViewProviderPrism"; }
    //@}
private:
...
public:
    ...
    short mustExecute() const override;
    /// returns the type name of the ViewProvider
    const char *getViewProviderName() const override { return "PartGui::ViewProviderWedge"; }
    //@}
