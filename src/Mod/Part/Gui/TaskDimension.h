...
/*!find shape from selection strings
   ...
   */
bool getShapeFromStrings(TopoDS_Shape &shapeOut, const std::string &doc, const std::string &object,
                         const std::string &sub, Base::Matrix4D *mat = nullptr);
...
void goDimensionAngularNoTask(const VectorAdapter &vector1Adapter,
