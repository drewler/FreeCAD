...
TextSet getUIStrings(Base::Type attacherType, eMapMode mmode)
{
    if (attacherType.isDerivedFrom(AttachEngine3D::getClassTypeId())) {
        ...
        switch (mmode) {
            ...
            case mmFlatFace:
                return TwoStrings(
                    ...
                    qApp->translate("Attacher3D", "X' Y' plane is aligned to coincide planar face.",
                                    "Attachment3D mode tooltip"));
            case mmTangentPlane:
                return TwoStrings(
                    qApp->translate("Attacher3D", "XY tangent to surface",
            ...
            case mmRevolutionSection:
                return TwoStrings(
                    qApp->translate("Attacher3D", "Revolution Section",
                                    "Attachment3D mode caption"),
                    qApp->translate("Attacher3D",
            ...
            case mmThreePointsPlane:
                return TwoStrings(qApp->translate("Attacher3D", "XY plane by 3 points",
                                                  "Attachment3D mode caption"),
                                  qApp->translate("Attacher3D",
                                                  "Align XY plane to pass through three vertices.",
                                                  "Attachment3D mode tooltip"));
            case mmThreePointsNormal:
                return TwoStrings(qApp->translate("Attacher3D", "XZ plane by 3 points",
                                                  "Attachment3D mode caption"),
                                  qApp->translate("Attacher3D",
        ...
        switch (mmode) {
            ...
            case mmTranslate:
                return TwoStrings(qApp->translate("Attacher2D", "Translate origin",
            ...
            case mmFlatFace:
                return TwoStrings(
                    ...
                    qApp->translate("Attacher2D", "Plane is aligned to coincide planar face.",
                                    "AttachmentPlane mode tooltip"));
            case mmTangentPlane:
                return TwoStrings(qApp->translate("Attacher2D", "Tangent to surface",
                                                  "AttachmentPlane mode caption"),
                                  qApp->translate("Attacher2D",
            ...
            case mmRevolutionSection:
                return TwoStrings(
                    qApp->translate("Attacher2D", "Revolution Section",
                                    "AttachmentPlane mode caption"),
                    qApp->translate(
                        "Attacher2D",
                        ...
                        "AttachmentPlane mode tooltip"));
            case mmThreePointsPlane:
                return TwoStrings(qApp->translate("Attacher2D", "Plane by 3 points",
                                                  "AttachmentPlane mode caption"),
                                  qApp->translate("Attacher2D",
            ...
            case mmThreePointsNormal:
                return TwoStrings(
                    qApp->translate("Attacher2D", "Normal to 3 points",
                                    "AttachmentPlane mode caption"),
                    qApp->translate("Attacher2D",
        ...
        switch (mmode) {
            ...
            case mm1AxisZ:
                return TwoStrings(
                    ...
                    qApp->translate(
                        ...
                        "AttachmentLine mode tooltip"));
            case mm1AxisCurv:
                return TwoStrings(qApp->translate("Attacher1D", "Axis of curvature",
            ...
            case mm1Asymptote1:
                return TwoStrings(
                    ...
                    qApp->translate("Attacher1D", "Asymptote of a hyperbola.",
                                    "AttachmentLine mode tooltip"));
            case mm1Asymptote2:
                return TwoStrings(
                    qApp->translate("Attacher1D", "Asymptote2", "AttachmentLine mode caption"),
                    qApp->translate("Attacher1D", "Second asymptote of hyperbola.",
                                    "AttachmentLine mode tooltip"));
            case mm1Tangent:
                return TwoStrings(
            ...
            case mm1TangentU:
                return TwoStrings(
                    qApp->translate("Attacher1D", "Tangent to surface (U)",
                                    "AttachmentLine mode caption"),
                    qApp->translate(
                        "Attacher1D",
            ...
            case mm1TangentV:
                return TwoStrings(
                    qApp->translate("Attacher1D", "Tangent to surface (V)",
                                    "AttachmentLine mode caption"),
                    qApp->translate(
                        "Attacher1D",
                        "Tangent to surface, along U parameter. Vertex link defines where.",
                        "AttachmentLine mode tooltip"));
            case mm1TwoPoints:
                return TwoStrings(qApp->translate("Attacher1D", "Through two points",
                                                  "AttachmentLine mode caption"),
                                  qApp->translate("Attacher1D",
            ...
            case mm1Intersection:
                return TwoStrings(
                    ...
                    qApp->translate("Attacher1D", "Not implemented.",
                                    "AttachmentLine mode tooltip"));
            case mm1Proximity:
                return TwoStrings(
            ...
            case mm1AxisInertia1:
                return TwoStrings(qApp->translate("Attacher1D", "1st principal axis",
                                                  "AttachmentLine mode caption"),
                                  qApp->translate("Attacher1D",
                                                  "Line follows first principal axis of inertia.",
                                                  "AttachmentLine mode tooltip"));
            case mm1AxisInertia2:
                return TwoStrings(qApp->translate("Attacher1D", "2nd principal axis",
                                                  "AttachmentLine mode caption"),
                                  qApp->translate("Attacher1D",
                                                  "Line follows second principal axis of inertia.",
                                                  "AttachmentLine mode tooltip"));
            case mm1AxisInertia3:
                return TwoStrings(qApp->translate("Attacher1D", "3rd principal axis",
                                                  "AttachmentLine mode caption"),
                                  qApp->translate("Attacher1D",
            ...
            case mm1FaceNormal:
                return TwoStrings(
                    qApp->translate("Attacher1D", "Normal to surface",
                                    "AttachmentLine mode caption"),
                    qApp->translate("Attacher1D",
        ...
        switch (mmode) {
            ...
            case mm0Origin:
                return TwoStrings(
                    qApp->translate("Attacher0D", "Object's origin",
            ...
            case mm0Focus1:
                return TwoStrings(
                    ...
                    qApp->translate("Attacher0D", "Focus of ellipse, parabola, hyperbola.",
                                    "AttachmentPoint mode tooltip"));
            case mm0Focus2:
                return TwoStrings(
                    qApp->translate("Attacher0D", "Focus2", "AttachmentPoint mode caption"),
                    qApp->translate("Attacher0D", "Second focus of ellipse and hyperbola.",
                                    "AttachmentPoint mode tooltip"));
            case mm0OnEdge:
                return TwoStrings(
            ...
            case mm0CenterOfCurvature:
                return TwoStrings(qApp->translate("Attacher0D", "Center of curvature",
                                                  "AttachmentPoint mode caption"),
                                  qApp->translate("Attacher0D",
            ...
            case mm0Intersection:
                return TwoStrings(
                    ...
                    qApp->translate("Attacher0D", "Not implemented",
                                    "AttachmentPoint mode tooltip"));
            case mm0Vertex:
                return TwoStrings(
                    qApp->translate("Attacher0D", "Vertex", "AttachmentPoint mode caption"),
                    qApp->translate("Attacher0D", "Put Datum point coincident with another vertex.",
                                    "AttachmentPoint mode tooltip"));
            case mm0ProximityPoint1:
                return TwoStrings(
                    qApp->translate("Attacher0D", "Proximity point 1",
                                    "AttachmentPoint mode caption"),
                    qApp->translate("Attacher0D",
            ...
            case mm0ProximityPoint2:
                return TwoStrings(
                    qApp->translate("Attacher0D", "Proximity point 2",
                                    "AttachmentPoint mode caption"),
                    qApp->translate("Attacher0D",
...
QString getShapeTypeText(eRefType type)
{
    ...
    if (type >= 0 && type < rtDummy_numberOfShapeTypes) {
        if (eRefTypeStrings[int(type)].txt) {
            return qApp->translate("Attacher", eRefTypeStrings[int(type)].txt,
...
QStringList getRefListForMode(AttachEngine &attacher, eMapMode mmode)
{
    ...
    for (refTypeString &rts : list) {
        QStringList buf;
        for (eRefType rt : rts) { buf.append(getShapeTypeText(rt)); }
...
PyObject *AttacherGuiPy::sGetModeStrings(PyObject * /*self*/, PyObject *args)
{
    int modeIndex = 0;
    char *attacherType;
    if (!PyArg_ParseTuple(args, "si", &attacherType, &modeIndex)) return nullptr;
...
{
    int refTypeIndex = 0;
    if (!PyArg_ParseTuple(args, "i", &refTypeIndex)) return nullptr;
...
PyMethodDef AttacherGuiPy::Methods[] = {
    {"getModeStrings", (PyCFunction)AttacherGuiPy::sGetModeStrings, METH_VARARGS,
     ...
     "description."},
    {"getRefTypeUserFriendlyName", (PyCFunction)AttacherGuiPy::sGetRefTypeUserFriendlyName,
     METH_VARARGS,
