...
CmdMeshPartMesher::CmdMeshPartMesher() : Command("MeshPart_Mesher")
{
    sAppModule = "MeshPart";
...
CmdMeshPartTrimByPlane::CmdMeshPartTrimByPlane() : Command("MeshPart_TrimByPlane")
{
    sAppModule = "Mesh";
    sGroup = QT_TR_NOOP("Mesh");
...
void CmdMeshPartTrimByPlane::activated(int)
{
    ...
    if (inner == click) { role = Gui::SelectionRole::Inner; }
    else if (outer == click) {
...
CmdMeshPartSection::CmdMeshPartSection() : Command("MeshPart_SectionByPlane")
{
    sAppModule = "MeshPart";
    sGroup = QT_TR_NOOP("Mesh");
...
void CmdMeshPartSection::activated(int)
{
    ...
    if (plane.empty()) {
        QMessageBox::warning(
            Gui::getMainWindow(), qApp->translate("MeshPart_Section", "Select plane"),
...
CmdMeshPartCrossSections::CmdMeshPartCrossSections() : Command("MeshPart_CrossSections")
{
    sAppModule = "MeshPart";
...
CmdMeshPartCurveOnMesh::CmdMeshPartCurveOnMesh() : Command("MeshPart_CurveOnMesh")
{
    sAppModule = "MeshPart";
    sGroup = QT_TR_NOOP("Mesh");
...
bool CmdMeshPartCurveOnMesh::isActive()
{
    ...
    if (doc && doc->countObjectsOfType(Mesh::Feature::getClassTypeId()) > 0) return true;
