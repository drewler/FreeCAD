...
class DimensionBase(DraftAnnotation):
    ...
    def set_properties(self, obj):
        ...
        if "Normal" not in properties:
            ...
            obj.addProperty("App::PropertyVector", "Normal", "Dimension", _tip)
        ...
        if "Support" not in properties:
            _tip = QT_TRANSLATE_NOOP(
                "App::Property", "The object measured by this dimension " "object"
            )
            obj.addProperty("App::PropertyLink", "Support", "Dimension", _tip)
            obj.Support = None
        ...
        if "LinkedGeometry" not in properties:
            ...
            obj.addProperty(
                "App::PropertyLinkSubList", "LinkedGeometry", "Dimension", _tip
            )
            obj.LinkedGeometry = []
        ...
        if "Dimline" not in properties:
            ...
            obj.addProperty("App::PropertyVectorDistance", "Dimline", "Dimension", _tip)
...
class LinearDimension(DimensionBase):
    ...
    def set_properties(self, obj):
        ...
        if "Start" not in properties:
            ...
            obj.addProperty(
                "App::PropertyVectorDistance", "Start", "Linear/radial dimension", _tip
            )
        ...
        if "End" not in properties:
            ...
            obj.addProperty(
                "App::PropertyVectorDistance", "End", "Linear/radial dimension", _tip
            )
        ...
        if "Direction" not in properties:
            ...
            obj.addProperty(
                "App::PropertyVector", "Direction", "Linear/radial dimension", _tip
            )
        ...
        if "Distance" not in properties:
            ...
            obj.addProperty(
                "App::PropertyLength", "Distance", "Linear/radial dimension", _tip
            )
            obj.Distance = 0
        ...
        if "Diameter" not in properties:
            ...
            obj.addProperty("App::PropertyBool", "Diameter", "Radial dimension", _tip)
            obj.Diameter = False
        ...
        if obj.LinkedGeometry:
            if len(obj.LinkedGeometry) == 1:
                ...
                if len(sub_list) == 1:
                    ...
                    (obj.Start, obj.End) = measure_one_obj_vertices(
                        linked_obj, sub_list
                    )
...
class AngularDimension(DimensionBase):
    ...
    def set_properties(self, obj):
        ...
        if "FirstAngle" not in properties:
            ...
            obj.addProperty(
                "App::PropertyAngle", "FirstAngle", "Angular dimension", _tip
            )
            obj.FirstAngle = 0
        ...
        if "LastAngle" not in properties:
            ...
            obj.addProperty(
                "App::PropertyAngle", "LastAngle", "Angular dimension", _tip
            )
            obj.LastAngle = 90
        ...
        if "Center" not in properties:
            ...
            obj.addProperty(
                "App::PropertyVectorDistance", "Center", "Angular dimension", _tip
            )
        ...
        if "Angle" not in properties:
            ...
            obj.addProperty("App::PropertyAngle", "Angle", "Angular dimension", _tip)
            obj.Angle = 0
