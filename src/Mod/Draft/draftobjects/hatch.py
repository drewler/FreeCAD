    ...
    def setProperties(self, obj):
        ...
        if not "Base" in pl:
            obj.addProperty(
                ...
                "Hatch",
                QT_TRANSLATE_NOOP(
                    "App::Property", "The base object used by this object"
                ),
            )
        if not "File" in pl:
            obj.addProperty(
        ...
        if not "Pattern" in pl:
            obj.addProperty(
                ...
                "Hatch",
                QT_TRANSLATE_NOOP(
                    "App::Property", "The pattern name used by this object"
                ),
            )
        if not "Scale" in pl:
            obj.addProperty(
                ...
                "Hatch",
                QT_TRANSLATE_NOOP(
                    "App::Property", "The pattern scale used by this object"
                ),
            )
        if not "Rotation" in pl:
            obj.addProperty(
                ...
                "Hatch",
                QT_TRANSLATE_NOOP(
                    "App::Property", "The pattern rotation used by this object"
                ),
            )
