...
class DraftLink(DraftObject):
    ...
    def linkSetup(self, obj):
        ...
        if not hasattr(obj, "AlwaysSyncPlacement"):
            ...
            obj.addProperty("App::PropertyBool", "AlwaysSyncPlacement", "Draft", _tip)
        ...
        if hasattr(obj, "ShowElement"):
            ...
            _tip = QT_TRANSLATE_NOOP(
                "App::Property", "Show the individual array elements"
            )
    ...
    def migrate_attributes(self, obj):
        ...
        if hasattr(self, "useLink"):
            ...
            _wrn(
                "v0.19, {}, 'useLink' will be migrated "
    ...
    def buildShape(self, obj, pl, pls):
        ...
        if self.use_link:
            if not getattr(obj, "ExpandArray", False) or obj.Count != len(pls):
                ...
                obj.setPropertyStatus("PlacementList", "Immutable")
                obj.Count = len(pls)
            if getattr(obj, "ExpandArray", False) and getattr(
                obj, "AlwaysSyncPlacement", False
            ):
