...
def sync_snap_toolbar_button(button, status):
    ...
    if button == "Draft_Snap_Lock_Button":
        snap_toolbar.actions()[0].setChecked(
            status
        )  # Snap lock must be the first button
...
class Draft_Snap_Lock(Draft_Snap_Base):
    ...
    def __init__(self):
        super(Draft_Snap_Lock, self).__init__(
            name=translate("draft", "Main toggle snap")
        )
    ...
    def GetResources(self):
        ...
        return {
            ...
            "MenuText": QT_TRANSLATE_NOOP(
                "Draft_Snap_Lock", "Main snapping toggle On/Off"
            ),
            "ToolTip": QT_TRANSLATE_NOOP(
                "Draft_Snap_Lock", "Activates or deactivates all snap methods at once."
            ),
        }
...
class Draft_Snap_Midpoint(Draft_Snap_Base):
    ...
    def __init__(self):
        super(Draft_Snap_Midpoint, self).__init__(
            name=translate("draft", "Midpoint snap")
        )
...
class Draft_Snap_Perpendicular(Draft_Snap_Base):
    ...
    def __init__(self):
        super(Draft_Snap_Perpendicular, self).__init__(
            name=translate("draft", "Perpendicular snap")
        )
...
class Draft_Snap_Intersection(Draft_Snap_Base):
    ...
    def __init__(self):
        super(Draft_Snap_Intersection, self).__init__(
            name=translate("draft", "Intersection snap")
        )
...
class Draft_Snap_Parallel(Draft_Snap_Base):
    ...
    def __init__(self):
        super(Draft_Snap_Parallel, self).__init__(
            name=translate("draft", "Parallel snap")
        )
...
class Draft_Snap_Endpoint(Draft_Snap_Base):
    ...
    def __init__(self):
        super(Draft_Snap_Endpoint, self).__init__(
            name=translate("draft", "Endpoint snap")
        )
...
class Draft_Snap_Angle(Draft_Snap_Base):
    ...
    def __init__(self):
        super(Draft_Snap_Angle, self).__init__(
            name=translate("draft", "Angle snap (30 and 45 degrees)")
        )
    ...
    def GetResources(self):
        ...
        return {
            ...
            "ToolTip": QT_TRANSLATE_NOOP(
                "Draft_Snap_Angle",
                "Set snapping to points in a circular arc located at multiples of 30 and 45 degree angles.",
            ),
        }
...
class Draft_Snap_Center(Draft_Snap_Base):
    ...
    def __init__(self):
        super(Draft_Snap_Center, self).__init__(
            name=translate("draft", "Arc center snap")
        )
...
class Draft_Snap_Extension(Draft_Snap_Base):
    ...
    def __init__(self):
        super(Draft_Snap_Extension, self).__init__(
            name=translate("draft", "Edge extension snap")
        )
...
class Draft_Snap_Ortho(Draft_Snap_Base):
    ...
    def __init__(self):
        super(Draft_Snap_Ortho, self).__init__(
            name=translate("draft", "Orthogonal snap")
        )
    ...
    def GetResources(self):
        ...
        return {
            ...
            "ToolTip": QT_TRANSLATE_NOOP(
                "Draft_Snap_Ortho",
                "Set snapping to a direction that is a multiple of 45 degrees from a point.",
            ),
        }
...
class Draft_Snap_Special(Draft_Snap_Base):
    ...
    def __init__(self):
        super(Draft_Snap_Special, self).__init__(
            name=translate("draft", "Special point snap")
        )
...
class Draft_Snap_Dimensions(Draft_Snap_Base):
    ...
    def __init__(self):
        super(Draft_Snap_Dimensions, self).__init__(
            name=translate("draft", "Dimension display")
        )
    ...
    def GetResources(self):
        ...
        return {
            "Pixmap": "Snap_Dimensions",
            "MenuText": QT_TRANSLATE_NOOP("Draft_Snap_Dimensions", "Show dimensions"),
            "ToolTip": QT_TRANSLATE_NOOP(
                "Draft_Snap_Dimensions",
                "Show temporary linear dimensions when editing an object and using other snapping methods.",
            ),
        }
    ...
    def Activated(self):
        ...
        if hasattr(Gui, "Snapper"):
            ...
            sync_snap_statusbar_button(
                "Draft_Snap_Dimensions" + "_Statusbutton", status
            )
...
class Draft_Snap_WorkingPlane(Draft_Snap_Base):
    ...
    def __init__(self):
        super(Draft_Snap_WorkingPlane, self).__init__(
            name=translate("draft", "Working plane snap")
        )
