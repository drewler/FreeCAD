...
class BezCurve(gui_lines.Line):
    ...
    def GetResources(self):
        ...
        return {
            ...
            "ToolTip": QT_TRANSLATE_NOOP(
                "Draft_BezCurve",
                "Creates an N-degree Bézier curve. The more points you pick, the higher the degree.\nCTRL to snap, SHIFT to constrain.",
            ),
        }
    ...
    def drawUpdate(self, point):
        ...
        if len(self.node) == 1:
            ...
            self.obj.Shape = self.updateShape(self.node)
            _msg(translate("draft", "Pick next point, " "or finish (A) or close (O)"))
    ...
    def finish(self, closed=False, cont=False):
        ...
        if len(self.node) > 1:
            ...
            try:
                ...
                self.commit(translate("draft", "Create BezCurve"), _cmd_list)
            except Exception:
...
class CubicBezCurve(gui_lines.Line):
    ...
    def GetResources(self):
        ...
        return {
            ...
            "ToolTip": QT_TRANSLATE_NOOP(
                "Draft_CubicBezCurve",
                "Creates a Bézier curve made of 2nd degree (quadratic) and 3rd degree (cubic) segments. Click and drag to define each segment.\nAfter the curve is created you can go back to edit each control point and set the properties of each knot.\nCTRL to snap, SHIFT to constrain.",
            ),
        }
    ...
    def Activated(self):
        ...
        """
        super(CubicBezCurve, self).Activated(
            name="CubicBezCurve", icon="Draft_CubicBezCurve"
        )
        if self.doc:
            self.bezcurvetrack = trackers.bezcurveTracker()
    ...
    def drawUpdate(self, point):
        ...
        if len(self.node) == 1:
            ...
            _msg(
                translate(
                    "draft",
                    "Click and drag to define next knot, " "or finish (A) or close (O)",
                )
            )
...
class BezierGroup:
    ...
    def GetResources(self):
        ...
        return {
            ...
            "ToolTip": QT_TRANSLATE_NOOP(
                "Draft_BezierTools", "Create various types of Bézier curves."
            ),
        }
