    ...
    def proceed(self):
        ...
        if len(sel) != 2:
            _err(
                translate(
                    "draft",
                    "Please select exactly two objects, the base object and the point object, before calling this command.",
                )
            )
        else:
    ...
    def GetResources(self):
        ...
        return {
            ...
            "ToolTip": QT_TRANSLATE_NOOP(
                ...
                "Like the PointArray tool, but creates a 'Point link array' instead.\nA 'Point link array' is more efficient when handling many copies.",
            ),
        }
