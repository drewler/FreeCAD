...
Workbench::Workbench()
{
    ...
    tree->setObjectName(QString::fromLatin1(QT_TRANSLATE_NOOP("QDockWidget", "Tree view (MVC)")));
...
Gui::MenuItem *Workbench::setupMenuBar() const
{
    ...
    *threads << "Sandbox_PythonLockThread"
             << "Sandbox_NolockPython"
             << "Sandbox_PyQtThread"
             << "Sandbox_PythonThread"
             << "Sandbox_PythonMainThread";
    test->setCommand("Threads");
    *test << "Sandbox_Thread"
          << "Sandbox_TestThread"
          << "Sandbox_SaveThread"
          << "Sandbox_WorkerThread"
          << "Sandbox_SeqThread"
          << "Sandbox_BlockThread"
          << "Sandbox_NoThread" << threads << "Separator"
          << "Sandbox_Dialog"
          << "Sandbox_FileDialog";
...
Gui::ToolBarItem *Workbench::setupCommandBars() const { return 0; }
...
void SoWidgetShape::initClass() { SO_NODE_INIT_CLASS(SoWidgetShape, SoShape, "Shape"); }

SoWidgetShape::SoWidgetShape() { SO_NODE_CONSTRUCTOR(SoWidgetShape); }
...
#endif
    glRasterPos2d(10, 10);
    glDrawPixels(this->image.width(), this->image.height(), GL_RGBA, GL_UNSIGNED_BYTE,
                 this->image.bits());
}
...
void SoWidgetShape::getQuad(SoState *state, SbVec3f &v0, SbVec3f &v1, SbVec3f &v2, SbVec3f &v3)
{
