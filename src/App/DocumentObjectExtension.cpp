...
short int DocumentObjectExtension::extensionMustExecute() { return 0; }
...
bool DocumentObjectExtension::extensionGetSubObject(DocumentObject *&, const char *, PyObject **,
...
bool DocumentObjectExtension::extensionGetLinkedObject(DocumentObject *&, bool, Base::Matrix4D *,
                                                       bool, int) const
{
    return false;
}
