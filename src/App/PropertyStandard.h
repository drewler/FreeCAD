...
public:
    ...
    struct Constraints {
        ...
        Constraints() : LowerBound(0), UpperBound(0), StepSize(0), candelete(false) {}
        Constraints(long l, long u, long s)
            : LowerBound(l), UpperBound(u), StepSize(s), candelete(false)
        {}
        ~Constraints() = default;
        void setDeletable(bool on) { candelete = on; }
        bool isDeletable() const { return candelete; }
...
public:
    ...
    const std::string &getStrValue() const { return _cValue; }
...
public:
    ...
    const char *getEditorName() const override { return "Gui::PropertyEditor::PropertyFontItem"; }
...
public:
    ...
    std::shared_ptr<Base::Persistence> getObject() const { return _pObject; }
