...
public:
    ...
    const char *getViewProviderName() const override { return "Gui::ViewProviderAnnotation"; }
};
...
public:
    ...
    /// returns the type name of the ViewProvider
    const char *getViewProviderName() const override { return "Gui::ViewProviderAnnotationLabel"; }
};
