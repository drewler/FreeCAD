...
public:
    void updateElementReference(App::DocumentObject *feature, bool reverse = false,
    ...
    void getPathsToDocumentObject(DocumentObject *,
...
// Note: use std::map instead of unordered_map to keep the binding order stable
    ...
    void buildGraph(const ExpressionMap &exprs,
                    boost::unordered_map<int, App::ObjectIdentifier> &revNodes, DiGraph &g,
