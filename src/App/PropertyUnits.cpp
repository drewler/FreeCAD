...
Base::Quantity PropertyQuantity::getQuantityValue() const { return Quantity(_dValue, _Unit); }
...
PyObject *PropertyQuantity::getPyObject() { return new QuantityPy(new Quantity(_dValue, _Unit)); }
...
void PropertyQuantity::setPyObject(PyObject *value)
{
    ...
    if (PyObject_TypeCheck(value, &(UnitPy::Type))) {
        ...
        if (unit != _Unit) throw Base::UnitsMismatchError("Not matching Unit!");
...
void PropertyQuantity::setPathValue(const ObjectIdentifier & /*path*/, const boost::any &value)
{
    ...
    aboutToSetValue();
    if (!q.getUnit().isEmpty()) _Unit = q.getUnit();
    _dValue = q.getValue();
    setValue(q.getValue());
}
...
PropertyAcceleration::PropertyAcceleration() { setUnit(Base::Unit::Acceleration); }
...
PropertyDistance::PropertyDistance() { setUnit(Base::Unit::Length); }
...
PropertyElectricPotential::PropertyElectricPotential() { setUnit(Base::Unit::ElectricPotential); }
...
PropertyFrequency::PropertyFrequency() { setUnit(Base::Unit::Frequency); }
...
PropertyForce::PropertyForce() { setUnit(Base::Unit::Force); }
...
PropertyPressure::PropertyPressure() { setUnit(Base::Unit::Pressure); }
...
PropertySpeed::PropertySpeed() { setUnit(Base::Unit::Velocity); }
...
PropertyStiffness::PropertyStiffness() { setUnit(Base::Unit::Stiffness); }
