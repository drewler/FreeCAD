...
PYCXX_STANDARD_EXCEPTION(StopIteration, Exception)
    ...
    && ((defined(Py_LIMITED_API) && Py_LIMITED_API + 0 >= 0x03050000 && PY_MAJOR_VERSION == 3      \
         && PY_MINOR_VERSION >= 5)                                                                 \
        || (!defined(Py_LIMITED_API) && PY_MAJOR_VERSION == 3 && PY_MINOR_VERSION >= 5))
...
#if (defined(Py_LIMITED_API) && Py_LIMITED_API + 0 >= 0x03060000 && PY_MAJOR_VERSION == 3          \
     && PY_MINOR_VERSION >= 6)                                                                     \
    || (!defined(Py_LIMITED_API) && PY_MAJOR_VERSION == 3 && PY_MINOR_VERSION >= 4)
