...
public:
    enum VolumeType
    {
        ...
        POLYHEDA,
        NB_VOLUME_TYPES
    }; // to keep synchronised with GetSize()!
    ...
    bool IsLinked(const SMDS_MeshNode *theNode1, const SMDS_MeshNode *theNode2,
    ...
    bool IsLinked(const int theNode1Index, const int theNode2Index,
