...
struct StdMeshers_ShapeShapeBiDirectionMap {
    ...
    {
        if (_assocType == UNDEF) _assocType = type;
    }
};
...
/*!
   ...
   */
bool FindSubShapeAssociation(const TopoDS_Shape &theShape1, SMESH_Mesh *theMesh1,
                             const TopoDS_Shape &theShape2, SMESH_Mesh *theMesh2,
...
/*!
   ...
   */
int FindFaceAssociation(const TopoDS_Face &face1, TopoDS_Vertex VV1[2], const TopoDS_Face &face2,
                        TopoDS_Vertex VV2[2], std::list<TopoDS_Edge> &edges1,
                        std::list<TopoDS_Edge> &edges2, const bool isClosenessAssoc = false);
...
/*!
   ...
   */
TopoDS_Face GetNextFace(const TAncestorMap &edgeToFaces, const TopoDS_Edge &edge,
...
/*!
   ...
   */
std::pair<int, TopoDS_Edge> GetPropagationEdge(SMESH_Mesh *aMesh, const TopoDS_Edge &anEdge,
...
/*!
   ...
   */
bool FindMatchingNodesOnFaces(const TopoDS_Face &face1, SMESH_Mesh *mesh1, const TopoDS_Face &face2,
                              SMESH_Mesh *mesh2, const TShapeShapeMap &assocMap,
...
/*!
   ...
   */
TopoDS_Edge GetBoundaryEdge(const TopoDS_Shape &edgeContainer, const SMESH_Mesh &mesh,
