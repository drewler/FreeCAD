...
#define INFOS(msg)                                                                                 \
    {                                                                                              \
        MESS_BEGIN("- Trace ") << msg << MESS_END                                                  \
    }
#define PYSCRIPT(msg)                                                                              \
    {                                                                                              \
        MESS_INIT("---PYSCRIPT--- ") << msg << MESS_END                                            \
    }
#define INTERRUPTION(msg)                                                                          \
    {                                                                                              \
        MESS_BEGIN("- INTERRUPTION: ") << msg << MESS_ABORT                                        \
    }
#ifdef WNT
...
#define INFOS_COMPILATION                                                                          \
    {                                                                                              \
        MESS_BEGIN("COMPILED with ")                                                               \
            << COMPILER << ", " << __DATE__ << " at " << __TIME__ << MESS_END                      \
    }
...
#define SCRUTE(var)                                                                                \
    {                                                                                              \
        MESS_BEGIN("- Trace ") << #var << "=" << var << MESS_END                                   \
    }

#define REPERE ("------- ")
#define BEGIN_OF(msg)                                                                              \
    {                                                                                              \
        MESS_BEGIN(REPERE) << "Begin of: " << msg << MESS_END                                      \
    }
#define END_OF(msg)                                                                                \
    {                                                                                              \
        MESS_BEGIN(REPERE) << "Normal end of: " << msg << MESS_END                                 \
    }
...
#define MESSAGE(msg)                                                                               \
    {                                                                                              \
        MESS_BEGIN("MSG:") << msg << MESS_END                                                      \
    }
#define SCRUTE(var)                                                                                \
    {                                                                                              \
        MESS_BEGIN("SCRUTE:") << #var << " = " << var << MESS_END                                  \
    }
#define REPERE ("-------")
#define BEGIN_OF(msg)                                                                              \
    {                                                                                              \
        MESS_BEGIN("MSG BEGIN:") << msg << MESS_END                                                \
    }
#define END_OF(msg)                                                                                \
    {                                                                                              \
        MESS_BEGIN("MSG END:") << msg << MESS_END                                                  \
    }
