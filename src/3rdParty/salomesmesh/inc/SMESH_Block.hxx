...
public:
    ...
    bool LoadBlockShapes(const TopoDS_Shell &theShell, const TopoDS_Vertex &theVertex000,
    ...
    bool LoadMeshBlock(const SMDS_MeshVolume *theVolume, const int theNode000Index,
    ...
    bool LoadFace(const TopoDS_Face &theFace, const int theFaceID,
    ...
    static bool Insert(const TopoDS_Shape &theShape, const int theShapeID,
                       TopTools_IndexedMapOfOrientedShape &theShapeIDMap);
    ...
    static bool FindBlockShapes(const TopoDS_Shell &theShell, const TopoDS_Vertex &theVertex000,
                                const TopoDS_Vertex &theVertex001,
                                TopTools_IndexedMapOfOrientedShape &theShapeIDMap);
    // add sub-shapes of theBlock to theShapeIDMap so that they get
    // IDs according to enum TShapeID
...
public:
    ...
    bool VertexPoint(const int theVertexID, gp_XYZ &thePoint) const
    {
        ...
        thePoint = myPnt[theVertexID - ID_FirstV];
        return true;
    }
    ...
    bool EdgePoint(const int theEdgeID, const gp_XYZ &theParams, gp_XYZ &thePoint) const
    {
        ...
        thePoint = myEdge[theEdgeID - ID_FirstE].Point(theParams);
        return true;
    }
    ...
    {
        if (!IsEdgeID(theEdgeID)) return false;
        theU = myEdge[theEdgeID - ID_FirstE].GetU(theParams);
        return true;
    }
    ...
    bool FacePoint(const int theFaceID, const gp_XYZ &theParams, gp_XYZ &thePoint) const
    {
        ...
        thePoint = myFace[theFaceID - ID_FirstF].Point(theParams);
        return true;
    }
    ...
    {
        if (!IsFaceID(theFaceID)) return false;
        theUV = myFace[theFaceID - ID_FirstF].GetUV(theParams);
        return true;
    }
    ...
    static bool ShellPoint(const gp_XYZ &theParams, const std::vector<gp_XYZ> &thePointOnShape,
                           gp_XYZ &thePoint);
...
public:
    ...
    bool ComputeParameters(const gp_Pnt &thePoint, gp_XYZ &theParams,
...
public:
    ...
    static int GetOrderedEdges(const TopoDS_Face &theFace, std::list<TopoDS_Edge> &theEdges,
...
protected:
   ...
   */
    ...
    public:
        ...
        bool IsUVInQuad(const gp_XY &uv, const gp_XYZ &param0, const gp_XYZ &param1,
    ...
    bool findUVByHalfDivision(const gp_Pnt &thePoint, const gp_XY &theUV, const TFace &tface,
                              gp_XYZ &theParams);
    bool findUVAround(const gp_Pnt &thePoint, const gp_XY &theUV, const TFace &tface,
