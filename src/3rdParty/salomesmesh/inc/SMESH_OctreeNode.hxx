...
public:
    ...
    bool NodesAround(const gp_XYZ &point, std::map<double, const SMDS_MeshNode *> &dist2Nodes,
                     double precision);

    // Return a list of Nodes close to a point
    void NodesAround(const gp_XYZ &point, std::vector<const SMDS_MeshNode *> &nodes,
                     double precision);
    ...
    void FindCoincidentNodes(TIDSortedNodeSet *nodes, const double theTolerance,
...
protected:
    ...
    void FindCoincidentNodes(const SMDS_MeshNode *Node, TIDSortedNodeSet *SetOfNodes,
                             std::list<const SMDS_MeshNode *> *Result, const double precision);
