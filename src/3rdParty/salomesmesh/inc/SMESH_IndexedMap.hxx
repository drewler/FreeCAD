...
class SMESH_IndexedMap: public NCollection_BaseCollection<TheKeyType>, public NCollection_BaseMap
{
...
private:
    ...
    public:
        ...
        IndexedMapNode(const TheKeyType &theKey1, const Standard_Integer theKey2,
                       NCollection_ListNode *theNext1, NCollection_ListNode *theNext2)
        ...
        //! Key1
        TheKeyType &Key1(void) { return this->ChangeValue(); }
        //! Key2
        const Standard_Integer &Key2(void) { return myKey2; }
        //! Next2
        IndexedMapNode *&Next2(void) { return myNext2; }
...
public:
    ...
    class Iterator: public NCollection_BaseCollection<TheKeyType>::Iterator
    {
    public:
        //! Empty constructor
        ...
        Iterator(const SMESH_IndexedMap &theMap)
            : myMap(const_cast<SMESH_IndexedMap<TheKeyType> *>(
                &theMap) /*(SMESH_IndexedMap *) &theMap*/),
              myIndex(1)
        {}
        //! Query if the end of collection is reached by iterator
        virtual Standard_Boolean More(void) const { return (myIndex <= myMap->Extent()); }
        //! Make a step along the collection
        virtual void Next(void) { myIndex++; }
        //! Value access
        virtual const TheKeyType &Value(void) const
        {
#if !defined No_Exception && !defined No_Standard_NoSuchObject
            if (!More()) Standard_NoSuchObject::Raise("SMESH_IndexedMap::Iterator::Value");
#endif
...
public:
    ...
    virtual void Assign(const NCollection_BaseCollection<TheKeyType> &theOther)
    {
        ...
        for (; anIter.More(); anIter.Next()) Add(anIter.Value());
    }
    ...
    SMESH_IndexedMap &operator=(const SMESH_IndexedMap &theOther)
    {
        ...
        for (i = 1; i <= iLength; i++) {
            ...
            IndexedMapNode *pNode =
                new (this->myAllocator) IndexedMapNode(aKey1, i, myData1[iK1], myData2[iK2]);
            myData1[iK1] = pNode;
            myData2[iK2] = pNode;
            Increment();
        }
    ...
    void ReSize(const Standard_Integer N)
    {
        ...
        if (BeginResize(N, newBuck, (NCollection_ListNode **&)ppNewData1,
                        (NCollection_ListNode **&)ppNewData2, this->myAllocator)) {
            if (myData1) {
                IndexedMapNode *p, *q;
            ...
            EndResize(N, newBuck, (NCollection_ListNode **&)ppNewData1,
                      (NCollection_ListNode **&)ppNewData2, this->myAllocator);
        }
    }
    ...
    Standard_Integer Add(const TheKeyType &theKey1)
    {
        ...
        while (pNode) {
            if (IsEqual(pNode->Key1(), theKey1)) return pNode->Key2();
            pNode = (IndexedMapNode *)pNode->Next();
        }
        Increment();
        Standard_Integer iK2 = HashCode(Extent(), NbBuckets());
        pNode =
            new (this->myAllocator) IndexedMapNode(theKey1, Extent(), myData1[iK1], myData2[iK2]);
        myData1[iK1] = pNode;
        myData2[iK2] = pNode;
        return Extent();
    }
    ...
    Standard_Boolean Contains(const TheKeyType &theKey1) const
    {
        ...
        while (pNode1) {
            if (IsEqual(pNode1->Key1(), theKey1)) return Standard_True;
    ...
    void Substitute(const Standard_Integer theIndex, const TheKeyType &theKey1)
    {
        ...
        if (q == p) myData1[iK] = (IndexedMapNode *)p->Next();
        else {
            while (q->Next() != p) q = (IndexedMapNode *)q->Next();
            q->Next() = p->Next();
        }
    ...
    {
#if !defined No_Exception && !defined No_Standard_OutOfRange
        if (Extent() == 0) Standard_OutOfRange::Raise("SMESH_IndexedMap::RemoveLast");
#endif
        IndexedMapNode *p, *q;
        ...
        q = NULL;
        while (p) {
            if (p->Key2() == Extent()) break;
            q = p;
            p = (IndexedMapNode *)p->Next2();
        }
        if (q == NULL) myData2[iK2] = (IndexedMapNode *)p->Next2();
        else
            q->Next2() = p->Next2();
        ...
        if (q == p) myData1[iK1] = (IndexedMapNode *)p->Next();
        else {
            while (q->Next() != p) q = (IndexedMapNode *)q->Next();
            q->Next() = p->Next();
        }
...
#endif
        IndexedMapNode *pNode2 = (IndexedMapNode *)myData2[HashCode(theKey2, NbBuckets())];
        while (pNode2) {
            if (pNode2->Key2() == theKey2) return pNode2->Key1();
    ...
    //! operator ()
    const TheKeyType &operator()(const Standard_Integer theKey2) const { return FindKey(theKey2); }

    //! FindIndex
    Standard_Integer FindIndex(const TheKeyType &theKey1) const
    {
        if (IsEmpty()) return 0;
        IndexedMapNode *pNode1 = (IndexedMapNode *)myData1[HashCode(theKey1, NbBuckets())];
        while (pNode1) {
            if (IsEqual(pNode1->Key1(), theKey1)) return pNode1->Key2();
            pNode1 = (IndexedMapNode *)pNode1->Next();
        }
        return 0;
    }
    ...
    void Clear(const Handle(NCollection_BaseAllocator) & theAllocator)
    {
        Clear();
        this->myAllocator =
            (!theAllocator.IsNull() ? theAllocator
                                    : NCollection_BaseAllocator::CommonBaseAllocator());
    }

    //! Destructor
    ~SMESH_IndexedMap(void) { Clear(); }

    //! Size
    virtual Standard_Integer Size(void) const { return Extent(); }
