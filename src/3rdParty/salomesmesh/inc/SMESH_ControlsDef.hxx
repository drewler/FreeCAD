...
public:
    ...
    template<class InputIterator> TSequenceOfXYZ(InputIterator theBegin, InputIterator theEnd);
...
public:
    ...
    void GetHistogram(int nbIntervals, std::vector<int> &nbEvents, std::vector<double> &funValues,
                      const std::vector<int> &elements, const double *minmax = 0,
...
private:
    bool process();
    bool findConnected(const TDataMapFacePtrInt &theAllFacePtrInt, SMDS_MeshFace *theStartFace,
                       TMapOfLink &theNonManifold, TColStd_MapOfInteger &theResFaces);
    bool isInPlane(const SMDS_MeshFace *theFace1, const SMDS_MeshFace *theFace2);
    void expandBoundary(TMapOfLink &theMapOfBoundary, TVectorOfLink &theSeqOfBoundary,
                        TDataMapOfLinkFacePtr &theDMapLinkFacePtr, TMapOfLink &theNonManifold,
...
public:
    ...
    virtual bool Contains(const SMESHDS_Mesh *theMeshDS, const TopoDS_Shape &theShape,
...
public:
    ...
    static void GetElementsId(const SMDS_Mesh *theMesh, PredicatePtr thePredicate,
