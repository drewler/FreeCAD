...
MEDWRAPPER_EXPORT
TKey2Gauss GetKey2Gauss(const PWrapper &theWrapper, TErr *theErr = NULL,
...
PProfileInfo GetProfileInfo(const PWrapper &theWrapper, const std::string &theProfileName,
                            TErr *theErr = NULL, EModeProfil theMode = eCOMPACT);
...
MEDWRAPPER_EXPORT
TMKey2Profile GetMKey2Profile(const PWrapper &theWrapper, TErr *theErr = NULL,
