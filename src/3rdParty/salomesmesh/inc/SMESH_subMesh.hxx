...
protected:
   ...
   */
    void notifyListenersOnEvent(const int event, const event_type eventType,
...
protected:
   ...
   */
    TopoDS_Shape getCollection(SMESH_Gen *theGen, SMESH_Algo *theAlgo, bool &theSubComputed,
                               bool &theSubFailed, std::vector<SMESH_subMesh *> &theSubs);
    /*!
   * \brief Update compute_state by _computeError
    * \retval bool - false if there are errors
   */
    bool checkComputeError(SMESH_Algo *theAlgo, const bool theComputeOK,
