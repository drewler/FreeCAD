...
int SMDS_VolumeOfFaces::NbFaces() const { return myNbFaces; }
    ...
    switch (type) {
        ...
        default:
            return SMDS_ElemIteratorPtr(new SMDS_IteratorOfElements(
                this, type,
                SMDS_ElemIteratorPtr(new SMDS_VolumeOfFaces_MyIterator(myFaces, myNbFaces))));
    }
}

SMDS_VolumeOfFaces::SMDS_VolumeOfFaces(const SMDS_MeshFace *face1, const SMDS_MeshFace *face2,
                                       const SMDS_MeshFace *face3, const SMDS_MeshFace *face4)
{
...
SMDS_VolumeOfFaces::SMDS_VolumeOfFaces(const SMDS_MeshFace *face1, const SMDS_MeshFace *face2,
                                       const SMDS_MeshFace *face3, const SMDS_MeshFace *face4,
                                       const SMDS_MeshFace *face5, const SMDS_MeshFace *face6)
{
    //MESSAGE("****************************************************** SMDS_VolumeOfFaces");
    myNbFaces = 6;
    myFaces[0] = face1;
