...
doublereal diptdr_(doublereal *pt, doublereal *p1dr, doublereal *p2dr)
{
    ...
    ret_val = (d__1 = a * pt[1] + b * pt[2] + c__, abs(d__1)) / sqrt(a * a + b * b);
    return ret_val;
} /* diptdr_ */

/* Subroutine */ int qutr2d_(doublereal *p1, doublereal *p2, doublereal *p3, doublereal *qualite)
{
    /* System generated locals */
    ...
    if (a * b * c__ != 0.) {
        ...
        /* Computing MAX */
        d__2 = max(a, b);
        *qualite = sqrt((d__1 = (p - a) / p * (p - b) * (p - c__), abs(d__1))) * 3.4641016151377544f
            / max(d__2, c__);
    }
    else {
        *qualite = 0.;
...
doublereal surtd2_(doublereal *p1, doublereal *p2, doublereal *p3)
{
    ...
    /* Function Body */
    ret_val = ((p2[1] - p1[1]) * (p3[2] - p1[2]) - (p2[2] - p1[2]) * (p3[1] - p1[1])) * .5;
    return ret_val;
} /* surtd2_ */
...
/* Subroutine */ int insoar_(integer *mxsomm, integer *mosoar, integer *mxsoar, integer *n1soar,
                             integer *nosoar)
{
    /* System generated locals */
...
/* Subroutine */ int fasoar_(integer *ns1, integer *ns2, integer *nt1, integer *nt2,
                             integer *nolign, integer *mosoar, integer *mxsoar, integer *n1soar,
                             integer *nosoar, integer *noarst, integer *noar, integer *ierr)
{
    /* System generated locals */
    ...
    extern /* Subroutine */ int hasoar_(integer *, integer *, integer *, integer *, integer *,
                                        integer *);
    ...
    *ierr = 0;
    ...
    if (*noar == 0) {
        ...
        *noar = -(*noar);
        ...
        if (nosoar[*noar * nosoar_dim1 + 4] > 0 && nosoar[*noar * nosoar_dim1 + 5] > 0) {
            if ((nosoar[*noar * nosoar_dim1 + 4] != *nt1 && nosoar[*noar * nosoar_dim1 + 4] != *nt2)
                || (nosoar[*noar * nosoar_dim1 + 5] != *nt1
                    && nosoar[*noar * nosoar_dim1 + 5] != *nt2)) {
        ...
        if (nosoar[*noar * nosoar_dim1 + 4] <= 0) {
            ...
            if (nosoar[*noar * nosoar_dim1 + 5] > 0 && *nt1 > 0
                && nosoar[*noar * nosoar_dim1 + 5] != *nt1) {
                /*               arete appartenant a plus de 2 triangles => erreur */
        ...
        if (*nt2 > 0) {
            ...
            if (nosoar[*noar * nosoar_dim1 + 5] > 0 && nosoar[*noar * nosoar_dim1 + 5] != *nt2) {
                /*               arete appartenant a plus de 2 triangles => erreur */
...
/* Subroutine */ int fq1inv_(real *x, real *y, real *s, real *xc, real *yc, integer *ierr)
{
    /* System generated locals */
    real r__1, r__2;
    ...
    if (a != 0.) {
        ...
        for (i__ = 1; i__ <= 2; ++i__) {
            ...
            *yc = (w * t[i__ - 1] - y0) / u;
            ...
            /* Computing MAX */
            r__1 = 0.f, r__2 = -(*xc), r__1 = max(r__1, r__2), r__2 = *xc - 1.f,
            r__1 = max(r__1, r__2), r__2 = -(*yc), r__1 = max(r__1, r__2), r__2 = *yc - 1.f;
...
/* Subroutine */ int ptdatr_(doublereal *point, doublereal *pxyd, integer *nosotr, integer *nsigne)
{
    /* System generated locals */
    doublereal d__1, d__2;
    ...
    if (d__ > 0.) {
        ...
        if (cb1 >= 0. && cb1 <= 1. && cb2 >= 0. && cb2 <= 1. && cb3 >= 0. && cb3 <= 1.) {
        ...
        *nsigne = 0;
        for (i__ = 1; i__ <= 3; ++i__) {
            ...
            x1 = pxyd[n1 * 3 + 1];
            y1 = pxyd[n1 * 3 + 2];
            d__ = (pxyd[n2 * 3 + 1] - x1) * (point[2] - y1)
                - (pxyd[n2 * 3 + 2] - y1) * (point[1] - x1);
            dd = (pxyd[n2 * 3 + 1] - x1) * (pxyd[n3 * 3 + 2] - y1)
                - (pxyd[n2 * 3 + 2] - y1) * (pxyd[n3 * 3 + 1] - x1);
            /* Computing 2nd power */
            d__1 = pxyd[n2 * 3 + 1] - x1;
            /* Computing 2nd power */
            d__2 = pxyd[n2 * 3 + 2] - y1;
...
integer notrpt_(doublereal *p, doublereal *pxyd, integer *notrde, integer *letree)
{
    /* System generated locals */
    integer ret_val;
...
/* Subroutine */ int teajpt_(integer *ns, integer *nbsomm, integer *mxsomm, doublereal *pxyd,
                             integer *letree, integer *ntrp, integer *ierr)
{
    static integer i__;
    extern /* Subroutine */ int te4ste_(integer *, integer *, doublereal *, integer *, integer *,
                                        integer *);
...
/* Subroutine */ int n1trva_(integer *nt, integer *lar, integer *letree, integer *notrva,
                             integer *lhpile)
{
...
/* Subroutine */ int cenced_(doublereal *xy1, doublereal *xy2, doublereal *xy3, doublereal *cetria,
                             integer *ierr)
{
    /* Format strings */
...
/* Subroutine */ int teajte_(integer *mxsomm, integer *nbsomm, doublereal *pxyd, doublereal *comxmi,
                             doublereal *aretmx, integer *mxtree, integer *letree, integer *ierr)
{
    /* System generated locals */
    integer i__1;
    doublereal d__1, d__2;
    ...
    static real arete;
    extern /* Subroutine */ int teajpt_(integer *, integer *, integer *, doublereal *, integer *,
                                        integer *, integer *);
...
/* Subroutine */ int tetaid_(integer *nutysu, doublereal *dx, doublereal *dy, doublereal *longai,
                             integer *ierr)
{
    /* Format strings */
...
/* Subroutine */ int tehote_(integer *nutysu, integer *nbarpi, integer *mxsomm, integer *nbsomm,
                             doublereal *pxyd, doublereal *comxmi, doublereal *aretmx,
                             integer *letree, integer *mxqueu, integer *laqueu, integer *ierr)
{
    /* System generated locals */
    integer i__1;
...
#define nuste (equiv_2)
    ...
    extern /* Subroutine */ int te4ste_(integer *, integer *, doublereal *, integer *, integer *,
                                        integer *),
        n1trva_(integer *, integer *, integer *, integer *, integer *);
    extern integer nosui3_(integer *);
    extern /* Subroutine */ int tetaid_(integer *, doublereal *, doublereal *, doublereal *,
                                        integer *);
    ...
    *ierr = 0;
    ...
    if (*nutysu > 0) {
        ...
        for (i__ = 1; i__ <= i__1; ++i__) {
            /*           calcul de pxyzd(3,i) */
            tetaid_(nutysu, &pxyd[i__ * 3 + 1], &pxyd[i__ * 3 + 2], &pxyd[i__ * 3 + 3], ierr);
            if (*ierr != 0) { goto L9999; }
            /* L1: */
        }
    }
    else {
        ...
        L2:
            ...
            *ns3 = letree[nte * 9 + 8];
            ...
            d__1 = max(d__1, d__2), d__2 = d__7 * d__7 + d__8 * d__8;
            d2 = max(d__1, d__2);
            /* Computing 2nd power */
            d__1 = pxyd[i__ * 3 + 3];
            if (d2 > d__1 * d__1) {
    ...
    L15:
        if (letree[nte * 9] > 0) {
            ...
            for (i__ = 3; i__ >= 0; --i__) {
                ...
                ++lhqueu;
                ++lequeu;
                if (lequeu > *mxqueu) { lequeu -= *mxqueu; }
        ...
        *ns3 = letree[nte * 9 + 8];
        ...
        if ((xrmin <= dmin__ && dmin__ <= xrmax) || (xrmin <= dmax__ && dmax__ <= xrmax)) {
            ...
            if ((yrmin <= dmin__ && dmin__ <= yrmax) || (yrmin <= dmax__ && dmax__ <= yrmax)) {
                ...
                for (i__ = 1; i__ <= 3; ++i__) {
                    ...
                    if (noteva <= 0) { goto L30; }
                    /*                 il existe un te voisin */
                    if (niveau > 0) { goto L30; }
                    /*                 nte a un te voisin plus petit ou egal */
                    if (letree[noteva * 9] <= 0) { goto L30; }
                    ...
                    if (*nutysu > 0) {
                        ...
                        for (j = nbsom0 + 1; j <= i__1; ++j) {
                            /*                       mise a jour de taille_ideale des nouveaux sommets de te */
                            tetaid_(nutysu, &pxyd[j * 3 + 1], &pxyd[j * 3 + 2], &pxyd[j * 3 + 3],
                                    ierr);
                            if (*ierr != 0) { goto L9999; }
                            /* L32: */
                        }
...
/* Subroutine */ int tetrte_(doublereal *comxmi, doublereal *aretmx, integer *nbarpi,
                             integer *mxsomm, doublereal *pxyd, integer *mxqueu, integer *laqueu,
                             integer *letree, integer *mosoar, integer *mxsoar, integer *n1soar,
                             integer *nosoar, integer *moartr, integer *mxartr, integer *n1artr,
                             integer *noartr, integer *noarst, integer *ierr)
{
    /* System generated locals */
    ...
    extern /* Subroutine */ int f0trte_(integer *, doublereal *, integer *, integer *, integer *,
                                        integer *, integer *, integer *, integer *, integer *,
                                        integer *, integer *, integer *, integer *),
        f1trte_(integer *, doublereal *, integer *, integer *, integer *, integer *, integer *,
                integer *, integer *, integer *, integer *, integer *, integer *, integer *,
                integer *);
    extern integer nopre3_(integer *);
    extern /* Subroutine */ int f2trte_(integer *, doublereal *, integer *, integer *, integer *,
                                        integer *, integer *, integer *, integer *, integer *,
                                        integer *, integer *, integer *, integer *, integer *),
        f3trte_(integer *, doublereal *, integer *, integer *, integer *, integer *, integer *,
                integer *, integer *, integer *, integer *, integer *, integer *, integer *,
                integer *),
        n1trva_(integer *, integer *, integer *, integer *, integer *);
...
L10:
    if (lhqueu >= 0) {
        ...
        if ((xrmin <= dmin__ && dmin__ <= xrmax) || (xrmin <= dmax__ && dmax__ <= xrmax)) {
                ...
                for (i__ = 1; i__ <= 3; ++i__) {
                    ...
                    if (noteva > 0) {
                        ...
                        if (letree[noteva * 9] > 0) {
                            ...
                            milieu[i__ - 1] = letree[nopre3_(&i__) + 5 + nsot * 9];
                            ++nbmili;
                        }
                    }
            ...
            /*              ---------------------------------- */
            L50:
                f0trte_(&letree[nte * 9], &pxyd[4], mosoar, mxsoar, n1soar, &nosoar[nosoar_offset],
                        moartr, mxartr, n1artr, &noartr[noartr_offset], &noarst[1], &nbtr, nutr,
                        ierr);
                if (*ierr != 0) { return 0; }
                goto L10;
            ...
            /*              ----------------------------------- */
            L100:
                f1trte_(&letree[nte * 9], &pxyd[4], milieu, mosoar, mxsoar, n1soar,
                        &nosoar[nosoar_offset], moartr, mxartr, n1artr, &noartr[noartr_offset],
                        &noarst[1], &nbtr, nutr, ierr);
                if (*ierr != 0) { return 0; }
                goto L10;
            ...
            /*              ----------------------------------- */
            L200:
                f2trte_(&letree[nte * 9], &pxyd[4], milieu, mosoar, mxsoar, n1soar,
                        &nosoar[nosoar_offset], moartr, mxartr, n1artr, &noartr[noartr_offset],
                        &noarst[1], &nbtr, nutr, ierr);
                if (*ierr != 0) { return 0; }
                goto L10;
            ...
            /*              ------------------------------------- */
            L300:
                f3trte_(&letree[nte * 9], &pxyd[4], milieu, mosoar, mxsoar, n1soar,
                        &nosoar[nosoar_offset], moartr, mxartr, n1artr, &noartr[noartr_offset],
                        &noarst[1], &nbtr, nutr, ierr);
                if (*ierr != 0) { return 0; }
                goto L10;
...
/* Subroutine */ int aisoar_(integer *mosoar, integer *mxsoar, integer *nosoar, integer *na1)
{
    /* System generated locals */
    integer nosoar_dim1, nosoar_offset, i__1;
    ...
    for (*na1 = 1; *na1 <= i__1; ++(*na1)) {
        if (nosoar[*na1 * nosoar_dim1 + 1] > 0 && nosoar[*na1 * nosoar_dim1 + 3] <= 0) { goto L15; }
        /* L10: */
    }
...
L15:
    ...
    for (na = *na1 + 1; na <= i__1; ++na) {
        if (nosoar[na * nosoar_dim1 + 1] > 0 && nosoar[na * nosoar_dim1 + 3] <= 0) {
...
/* Subroutine */ int tedela_(doublereal *pxyd, integer *noarst, integer *mosoar, integer *mxsoar,
                             integer *n1soar, integer *nosoar, integer *n1ardv, integer *moartr,
                             integer *mxartr, integer *n1artr, integer *noartr, integer *modifs)
{
    /* System generated locals */
    integer nosoar_dim1, nosoar_offset, noartr_dim1, noartr_offset, i__1;
    doublereal d__1, d__2;
    ...
    extern /* Subroutine */ int te2t2t_(integer *, integer *, integer *, integer *, integer *,
                                        integer *, integer *, integer *),
        mt4sqa_(integer *, integer *, integer *, integer *, integer *, integer *, integer *,
                integer *, integer *),
        cenced_(doublereal *, doublereal *, doublereal *, doublereal *, integer *);
...
L20:
    if (na0 > 0) {
        ...
        if (nosoar[na * nosoar_dim1 + 1] == 0) { goto L20; }

        /*        si arete frontaliere pas d'echange possible */
        if (nosoar[na * nosoar_dim1 + 3] > 0) { goto L20; }

        /*        existe-t-il 2 triangles ayant cette arete commune? */
        if (nosoar[na * nosoar_dim1 + 4] <= 0 || nosoar[na * nosoar_dim1 + 5] <= 0) { goto L20; }
        ...
        mt4sqa_(&na, moartr, &noartr[noartr_offset], mosoar, &nosoar[nosoar_offset], &ns1, &ns2,
                &ns3, &ns4);
        if (ns4 == 0) { goto L20; }
        ...
        s123 = surtd2_(&pxyd[ns1 * 3 + 1], &pxyd[ns2 * 3 + 1], &pxyd[ns3 * 3 + 1]);
        s142 = surtd2_(&pxyd[ns1 * 3 + 1], &pxyd[ns4 * 3 + 1], &pxyd[ns2 * 3 + 1]);
        s12 = abs(s123) + abs(s142);
        if (s12 <= a12 * .001f) { goto L20; }

        /*        calcul des surfaces des triangles 143 et 234 de cette arete */
        s143 = surtd2_(&pxyd[ns1 * 3 + 1], &pxyd[ns4 * 3 + 1], &pxyd[ns3 * 3 + 1]);
        s234 = surtd2_(&pxyd[ns2 * 3 + 1], &pxyd[ns3 * 3 + 1], &pxyd[ns4 * 3 + 1]);
        s34 = abs(s234) + abs(s143);

        if ((d__1 = s34 - s12, abs(d__1)) > s34 * 1e-15) { goto L20; }
        ...
        ierr = -1;
        cenced_(&pxyd[ns1 * 3 + 1], &pxyd[ns2 * 3 + 1], &pxyd[ns3 * 3 + 1], cetria, &ierr);
        if (ierr > 0) {
        ...
        if (d__1 * d__1 + d__2 * d__2 < cetria[2]) {
            ...
            te2t2t_(&na, mosoar, n1soar, &nosoar[nosoar_offset], &noarst[1], moartr,
                    &noartr[noartr_offset], &na34);
            if (na34 == 0) { goto L20; }
            r0 = cetria[2];
            ...
            for (j = 4; j <= 5; ++j) {
                ...
                for (i__ = 1; i__ <= 3; ++i__) {
                    ...
                    if (n != na34) {
                        if (nosoar[n * nosoar_dim1 + 3] == 0 && nosoar[n * nosoar_dim1 + 6] == -1) {
...
/* Subroutine */ int terefr_(integer *nbarpi, doublereal *pxyd, integer *mosoar, integer *mxsoar,
                             integer *n1soar, integer *nosoar, integer *moartr, integer *mxartr,
                             integer *n1artr, integer *noartr, integer *noarst, integer *mxarcf,
                             integer *n1arcf, integer *noarcf, integer *larmin, integer *notrcf,
                             integer *nbarpe, integer *ierr)
{
    /* System generated locals */
    integer nosoar_dim1, nosoar_offset, noartr_dim1, noartr_offset, i__1;
    ...
    extern /* Subroutine */ int tefoar_(integer *, integer *, doublereal *, integer *, integer *,
                                        integer *, integer *, integer *, integer *, integer *,
                                        integer *, integer *, integer *, integer *, integer *,
                                        integer *, integer *, integer *);
    ...
    *nbarpe = 0;
    ...
    for (narete = 1; narete <= i__1; ++narete) {
        ...
        if (nosoar[narete * nosoar_dim1 + 3] > 0) {
            ...
            if (nosoar[narete * nosoar_dim1 + 4] <= 0 || nosoar[narete * nosoar_dim1 + 5] <= 0) {
                ...
                tefoar_(&narete, nbarpi, &pxyd[4], mosoar, mxsoar, n1soar, &nosoar[nosoar_offset],
                        moartr, mxartr, n1artr, &noartr[noartr_offset], &noarst[1], mxarcf, n1arcf,
...
/* Subroutine */ int tesuex_(integer *nblftr, integer *nulftr, integer *ndtri0, integer *nbsomm,
                             doublereal *pxyd, integer *nslign, integer *mosoar, integer *mxsoar,
                             integer *nosoar, integer *moartr, integer *mxartr, integer *n1artr,
                             integer *noartr, integer *noarst, integer *nbtria, integer *letrsu,
                             integer *ierr)
{
    /* System generated locals */
    integer nosoar_dim1, nosoar_offset, noartr_dim1, noartr_offset, i__1, i__2;
    ...
    if (noar1 != 0) {
        ...
        for (i__ = 4; i__ <= 5; ++i__) {
            ...
            if (nt > 0) {
                ...
                if (letrsu[nt] != 0 && (i__1 = letrsu[nt], abs(i__1)) != ligne) { goto L60; }
                ...
                for (j = 1; j <= 3; ++j) {
                    ...
                    if (nosoar[na * nosoar_dim1 + 6] != -2) { goto L50; }
                    ...
                    if (nl > 0) {
                        ...
                        if (nt == (i__1 = nosoar[na * nosoar_dim1 + 4], abs(i__1))) { nt2 = 5; }
                        else {
                            nt2 = 4;
                        }
                        nt2 = (i__1 = nosoar[nt2 + na * nosoar_dim1], abs(i__1));
                        if (nt2 > 0) {
...
L80:
    ...
    for (nt2 = 1; nt2 <= i__1; ++nt2) {
        if ((i__2 = letrsu[nt2], abs(i__2)) == nl) { goto L92; }
        /* L90: */
    }
    ...
    for (nt = 1; nt <= i__1; ++nt) {
        ...
        if (letrsu[nt] <= 0) {
            ...
            for (i__ = 1; i__ <= 3; ++i__) {
                ...
                if (nslign[ns1] < 0) { nslign[ns1] = 0; }
                if (nslign[ns2] < 0) { nslign[ns2] = 0; }
                /* L190: */
            }
        }
    ...
    for (noar = 1; noar <= i__1; ++noar) {
        ...
        if (nosoar[noar * nosoar_dim1 + 1] > 0) {
            ...
            if (nt > 0) {
                ...
                if (letrsu[nt] <= 0) { nosoar[noar * nosoar_dim1 + 5] = 0; }
            }
            ...
            if (nt > 0) {
                if (letrsu[nt] <= 0) {
                    ...
                    if (nosoar[noar * nosoar_dim1 + 5] > 0) {
                        nosoar[noar * nosoar_dim1 + 4] = nosoar[noar * nosoar_dim1 + 5];
...
L9990:
    i__1 = *nblftr;
    for (nl = 1; nl <= i__1; ++nl) {
        if (nulftr[nl] < 0) { nulftr[nl] = -nulftr[nl]; }
        /* L9991: */
    }
    return 0;
} /* tesuex_ */

/* Subroutine */ int trp1st_(integer *ns, integer *noarst, integer *mosoar, integer *nosoar,
                             integer *moartr, integer *mxartr, integer *noartr, integer *mxpile,
                             integer *lhpile, integer *lapile)
{
    /* Format strings */
    ...
    extern /* Subroutine */ int nusotr_(integer *, integer *, integer *, integer *, integer *,
                                        integer *);
    ...
    *lhpile = 0;
    ...
    if (noartr[nt0 * noartr_dim1 + 1] == 0) { goto L100; }

    /*     le numero des 3 sommets du triangle nt0 dans le sens direct */
    nusotr_(&nt0, mosoar, &nosoar[nosoar_offset], moartr, &noartr[noartr_offset], nosotr);

    /*     reperage du sommet ns dans le triangle nt0 */
    for (nar = 1; nar <= 3; ++nar) {
        if (nosotr[nar - 1] == *ns) { goto L10; }
        /* L5: */
    }
...
L10:
    *lhpile = 1;
    ...
    if (nosoar[noar * nosoar_dim1 + 4] == nt0) { nt1 = nosoar[noar * nosoar_dim1 + 5]; }
    ...
    if (nt1 > 0) {
        ...
        if (noartr[nt1 * noartr_dim1 + 1] == 0) { goto L30; }
    ...
    L15:
        nusotr_(&nt1, mosoar, &nosoar[nosoar_offset], moartr, &noartr[noartr_offset], nosotr);

        /*        reperage du sommet ns dans nt1 */
        for (nar = 1; nar <= 3; ++nar) {
            if (nosotr[nar - 1] == *ns) { goto L25; }
            /* L20: */
        }
    ...
    L25:
        ...
        if (nosoar[noar * nosoar_dim1 + 4] == nt1) { nt1 = nosoar[noar * nosoar_dim1 + 5]; }
...
L30:
    *lhpile = 1;
    ...
    nusotr_(&nta, mosoar, &nosoar[nosoar_offset], moartr, &noartr[noartr_offset], nosotr);
    for (nar = 1; nar <= 3; ++nar) {
        if (nosotr[nar - 1] == *ns) { goto L33; }
        /* L32: */
    }
    goto L100;
...
L33:
    ...
    if (nosoar[noar * nosoar_dim1 + 4] == nta) { nt1 = nosoar[noar * nosoar_dim1 + 5]; }
...
/*     ========================================================== */
L40:
    if (noartr[nt1 * noartr_dim1 + 1] == 0) { goto L70; }
...
/* Subroutine */ int nusotr_(integer *nt, integer *mosoar, integer *nosoar, integer *moartr,
                             integer *noartr, integer *nosotr)
{
    /* System generated locals */
    integer nosoar_dim1, nosoar_offset, noartr_dim1, noartr_offset, i__1;
...
/* Subroutine */ int tesusp_(doublereal *quamal, integer *nbarpi, doublereal *pxyd, integer *noarst,
                             integer *mosoar, integer *mxsoar, integer *n1soar, integer *nosoar,
                             integer *moartr, integer *mxartr, integer *n1artr, integer *noartr,
                             integer *mxarcf, integer *n1arcf, integer *noarcf, integer *larmin,
                             integer *notrcf, integer *liarcf, integer *ierr)
{
    /* System generated locals */
    integer nosoar_dim1, nosoar_offset, noartr_dim1, noartr_offset, i__1, i__2;
    doublereal d__1, d__2;
...
#define ns3 (equiv_2 + 2)
    ...
    extern /* Subroutine */ int te1stm_(integer *, integer *, doublereal *, integer *, integer *,
                                        integer *, integer *, integer *, integer *, integer *,
                                        integer *, integer *, integer *, integer *, integer *,
                                        integer *, integer *, integer *, integer *),
        qutr2d_(doublereal *, doublereal *, doublereal *, doublereal *),
        trp1st_(integer *, integer *, integer *, integer *, integer *, integer *, integer *,
                integer *, integer *, integer *);
...
#define nosotr (equiv_2)
    ...
    *ierr = 0;
    ...
    L15:
        ...
        trp1st_(&ns, &noarst[1], mosoar, &nosoar[nosoar_offset], moartr, mxartr,
                &noartr[noartr_offset], mxarcf, &nbtrcf, &notrcf[1]);
        if (nbtrcf == 0) { goto L100; }
        if (nbtrcf < 0) {
        ...
        for (i__ = 1; i__ <= i__2; ++i__) {
            ...
            nt = notrcf[i__];
            nusotr_(&nt, mosoar, &nosoar[nosoar_offset], moartr, &noartr[noartr_offset], nosotr);
            /*           nosotr(1:3) est en equivalence avec ns1, ns2, ns3 */
            /*           la qualite du triangle ns1 ns2 ns3 */
            qutr2d_(&pxyd[*ns1 * 3 + 1], &pxyd[*ns2 * 3 + 1], &pxyd[*ns3 * 3 + 1], &qualit);
            if (qualit < quamin) {
                quamin = qualit;
                ntqmin = nt;
            }
        ...
        if (quamin < quaopt) {
            ...
            nusotr_(&ntqmin, mosoar, &nosoar[nosoar_offset], moartr, &noartr[noartr_offset],
                    nosotr);
            nste = 0;
            d0 = 1e28f;
            for (j = 1; j <= 3; ++j) {
            ...
            if (nste > 0) {
                ...
                /*              ========================================== */
                te1stm_(&nste, nbarpi, &pxyd[4], &noarst[1], mosoar, mxsoar, n1soar,
                        &nosoar[nosoar_offset], moartr, mxartr, n1artr, &noartr[noartr_offset],
                        mxarcf, n1arcf, &noarcf[4], &larmin[1], &notrcf[1], &liarcf[1], ierr);
                if (*ierr == 0) {
...
/* Subroutine */ int teamqa_(integer *nutysu, doublereal *airemx, integer *noarst, integer *mosoar,
                             integer *mxsoar, integer *n1soar, integer *nosoar, integer *moartr,
                             integer *mxartr, integer *n1artr, integer *noartr, integer *mxtrcf,
                             integer *notrcf, integer *nostbo, integer *n1arcf, integer *noarcf,
                             integer *larmin, integer *nbarpi, integer *nbsomm, integer *mxsomm,
                             doublereal *pxyd, integer *nslign, integer *ierr)
{
    /* System generated locals */
    integer noartr_dim1, noartr_offset, nosoar_dim1, nosoar_offset, i__1, i__2, i__3, i__4, i__5;
    doublereal d__1, d__2;
    ...
    extern doublereal surtd2_(doublereal *, doublereal *, doublereal *);
    extern /* Subroutine */ int trp1st_(integer *, integer *, integer *, integer *, integer *,
                                        integer *, integer *, integer *, integer *, integer *),
        tedela_(doublereal *, integer *, integer *, integer *, integer *, integer *, integer *,
                integer *, integer *, integer *, integer *, integer *),
        tr3str_(integer *, integer *, integer *, integer *, integer *, integer *, integer *,
                integer *, integer *, integer *, integer *, integer *, integer *),
        tetaid_(integer *, doublereal *, doublereal *, doublereal *, integer *);
    ...
    for (iter = 1; iter <= i__1; ++iter) {
        ...
        for (ns = nbs1; i__3 < 0 ? ns >= i__2 : ns <= i__2; ns += i__3) {
            ...
            if (nslign[ns] != 0) { goto L1000; }

            /*           existe-t-il une arete de sommet ns ? */
            noar = noarst[ns];
            if (noar <= 0) { goto L1000; }
            if (nosoar[noar * nosoar_dim1 + 1] <= 0) { goto L1000; }
            ...
            trp1st_(&ns, &noarst[1], mosoar, &nosoar[nosoar_offset], moartr, mxartr,
                    &noartr[noartr_offset], mxtrcf, &nbtrcf, &notrcf[1]);
            if (nbtrcf <= 0) { goto L1000; }
        ...
        L19:
            ...
            for (i__ = 1; i__ <= i__4; ++i__) {
                ...
                nusotr_(&nt, mosoar, &nosoar[nosoar_offset], moartr, &noartr[noartr_offset],
                        nosotr);
                d__ = surtd2_(&pxyd[nosotr[0] * 3 + 1], &pxyd[nosotr[1] * 3 + 1],
                              &pxyd[nosotr[2] * 3 + 1]);
                if (d__ > airetm) {
                    airetm = d__;
                    imax = i__;
                ...
                for (na = 1; na <= 3; ++na) {
                    ...
                    if (nosoar[noar * nosoar_dim1 + 1] != ns
                        && nosoar[noar * nosoar_dim1 + 2] != ns) {
                        goto L25;
                    }
                    /* L20: */
                }
            ...
            if (airetm > *airemx || dmax__ > dns * 1.34) {
                ...
                ++(*nbsomm);
                for (i__ = 1; i__ <= 3; ++i__) {
                    pxyd[i__ + *nbsomm * 3] = (pxyd[i__ + nosotr[0] * 3] + pxyd[i__ + nosotr[1] * 3]
                                               + pxyd[i__ + nosotr[2] * 3])
                        / 3.;
                    /* L160: */
                }
                if (*nutysu > 0) {
                    /*                 la fonction taille_ideale(x,y,z) existe */
                    tetaid_(nutysu, &pxyd[*nbsomm * 3 + 1], &pxyd[*nbsomm * 3 + 2],
                            &pxyd[*nbsomm * 3 + 3], &ier);
                }
                ...
                tr3str_(nbsomm, &nt, mosoar, mxsoar, n1soar, &nosoar[nosoar_offset], moartr, mxartr,
                        n1artr, &noartr[noartr_offset], &noarst[1], nosotr, ierr);
                if (*ierr != 0) { goto L9999; }
        ...
        L200:
            ...
            if (*nutysu > 0) {
                /*              la fonction taille_ideale(x,y,z) existe */
                tetaid_(nutysu, &pxyd[ns * 3 + 1], &pxyd[ns * 3 + 2], &pxyd[ns * 3 + 3], &ier);
            }
            ...
            L206:
                s0 += (d__1 = surtd2_(xyzns, &pxyd[ns2 * 3 + 1], &pxyd[ns3 * 3 + 1]), abs(d__1));
                s1 += (d__1 = surtd2_(&pxyd[ns * 3 + 1], &pxyd[ns2 * 3 + 1], &pxyd[ns3 * 3 + 1]),
                       abs(d__1));
                /* L210: */
            }
        ...
        /*           les aretes chainees de la boule sont rendues delaunay */
        L900:
            tedela_(&pxyd[4], &noarst[1], mosoar, mxsoar, n1soar, &nosoar[nosoar_offset], &noar0,
                    moartr, mxartr, n1artr, &noartr[noartr_offset], &modifs);
...
/* Subroutine */ int teamqt_(integer *nutysu, doublereal *aretmx, doublereal *airemx,
                             integer *noarst, integer *mosoar, integer *mxsoar, integer *n1soar,
                             integer *nosoar, integer *moartr, integer *mxartr, integer *n1artr,
                             integer *noartr, integer *mxarcf, integer *notrcf, integer *nostbo,
                             integer *n1arcf, integer *noarcf, integer *larmin, integer *nbarpi,
                             integer *nbsomm, integer *mxsomm, doublereal *pxyd, integer *nslign,
                             integer *ierr)
{
    /* System generated locals */
    ...
    /* Local variables */
    extern /* Subroutine */ int qualitetrte_(doublereal *, integer *, integer *, integer *,
                                             integer *, integer *, integer *, integer *,
                                             doublereal *, doublereal *),
        teamqa_(integer *, doublereal *, integer *, integer *, integer *, integer *, integer *,
                integer *, integer *, integer *, integer *, integer *, integer *, integer *,
                integer *, integer *, integer *, integer *, integer *, integer *, doublereal *,
                integer *, integer *);
    static integer nbtria;
    static doublereal quamin, quamoy;
    extern /* Subroutine */ int tesuqm_(doublereal *, integer *, doublereal *, integer *, integer *,
                                        integer *, integer *, integer *, integer *, integer *,
                                        integer *, integer *, integer *, integer *, integer *,
                                        integer *, integer *, integer *, doublereal *),
        tesusp_(doublereal *, integer *, doublereal *, integer *, integer *, integer *, integer *,
                integer *, integer *, integer *, integer *, integer *, integer *, integer *,
                integer *, integer *, integer *, integer *, integer *);
    ...
    *ierr = 0;
    ...
    /*     inferieure a quamal */
    /*     ====================================================== */
    tesuqm_(&c_b357, nbarpi, &pxyd[4], &noarst[1], mosoar, mxsoar, n1soar, &nosoar[nosoar_offset],
            moartr, mxartr, n1artr, &noartr[noartr_offset], mxarcf, n1arcf, &noarcf[4], &larmin[1],
            &notrcf[1], &nostbo[1], &quamin);
    qualitetrte_(&pxyd[4], mosoar, mxsoar, &nosoar[nosoar_offset], moartr, mxartr,
                 &noartr[noartr_offset], &nbtria, &quamoy, &quamin);
    ...
    if (quamin <= .1) {
        tesusp_(&c_b357, nbarpi, &pxyd[4], &noarst[1], mosoar, mxsoar, n1soar,
                &nosoar[nosoar_offset], moartr, mxartr, n1artr, &noartr[noartr_offset], mxarcf,
                n1arcf, &noarcf[4], &larmin[1], &notrcf[1], &nostbo[1], ierr);
        if (*ierr != 0) { goto L9999; }
    }
    ...
    /*     ================================================================ */
    teamqa_(nutysu, airemx, &noarst[1], mosoar, mxsoar, n1soar, &nosoar[nosoar_offset], moartr,
            mxartr, n1artr, &noartr[noartr_offset], mxarcf, &notrcf[1], &nostbo[1], n1arcf,
            &noarcf[4], &larmin[1], nbarpi, nbsomm, mxsomm, &pxyd[4], &nslign[1], ierr);
    qualitetrte_(&pxyd[4], mosoar, mxsoar, &nosoar[nosoar_offset], moartr, mxartr,
                 &noartr[noartr_offset], &nbtria, &quamoy, &quamin);
    if (*ierr != 0) { goto L9999; }
...
/* Subroutine */ int trfrcf_(integer *nscent, integer *mosoar, integer *nosoar, integer *moartr,
                             integer *noartr, integer *nbtrcf, integer *notrcf, integer *nbarfr)
{
    /* System generated locals */
    integer noartr_dim1, noartr_offset, nosoar_dim1, nosoar_offset, i__1, i__2;
...
/* Subroutine */ int int2ar_(doublereal *p1, doublereal *p2, doublereal *p3, doublereal *p4,
                             logical *oui)
{
    /* System generated locals */
    doublereal d__1, d__2;
    ...
    x = (p1[1] * x43 * y21 - p3[1] * x21 * y43 - (p1[2] - p3[2]) * x21 * x43) / d__;
    y = -(p1[2] * y43 * x21 - p3[2] * y21 * x43 - (p1[1] - p3[1]) * y21 * y43) / d__;
...
/* Subroutine */ int trchtd_(doublereal *pxyd, integer *nar00, integer *nar0, integer *noarcf,
                             integer *namin0, integer *namin, integer *larmin)
{
    /* System generated locals */
    integer i__1, i__2;
    doublereal d__1, d__2;
    ...
    extern /* Subroutine */ int int2ar_(doublereal *, doublereal *, doublereal *, doublereal *,
                                        logical *),
        qutr2d_(doublereal *, doublereal *, doublereal *, doublereal *),
        cenced_(doublereal *, doublereal *, doublereal *, doublereal *, integer *);
    extern doublereal surtd2_(doublereal *, doublereal *, doublereal *);
...
L10:
    ...
    L15:
        if (nar1 != nar3 && noarcf[nar1 * 3 + 2] != nar3) {
            ...
            np1 = noarcf[nar1 * 3 + 1];
            np2 = noarcf[nar2 * 3 + 1];
            int2ar_(&pxyd[ns2 * 3 + 1], &pxyd[ns3 * 3 + 1], &pxyd[np1 * 3 + 1], &pxyd[np2 * 3 + 1],
                    &oui);
            if (oui) { goto L10; }
    ...
    L18:
        if (nar1 != *nar0 && noarcf[nar1 * 3 + 2] != *nar0) {
            ...
            np1 = noarcf[nar1 * 3 + 1];
            np2 = noarcf[nar2 * 3 + 1];
            int2ar_(&pxyd[ns1 * 3 + 1], &pxyd[ns3 * 3 + 1], &pxyd[np1 * 3 + 1], &pxyd[np2 * 3 + 1],
                    &oui);
            if (oui) { goto L10; }
            /*           les 2 aretes ne s'intersectent pas entre leurs sommets */
            nar1 = nar2;
        ...
        dd = surtd2_(&pxyd[ns1 * 3 + 1], &pxyd[ns2 * 3 + 1], &pxyd[ns3 * 3 + 1]);
        if (dd <= 0.) {
            ...
            qutr2d_(&pxyd[ns1 * 3 + 1], &pxyd[ns2 * 3 + 1], &pxyd[ns3 * 3 + 1], &q);
        }
    ...
    if (nbmin > 1) {
        ...
        for (i__ = 1; i__ <= i__1; ++i__) {
            ...
            /*           et son rayon */
            ier = -1;
            cenced_(&pxyd[ns1 * 3 + 1], &pxyd[ns2 * 3 + 1], &pxyd[ns3 * 3 + 1], centre, &ier);
            if (ier != 0) {
...
/* Subroutine */ int trcf0a_(integer *nbcf, integer *na01, integer *na1, integer *na2, integer *na3,
                             ...
                             integer *n1arcf, integer *noarcf, integer *nt)
{
    ...
    extern /* Subroutine */ int trcf3a_(integer *, integer *, integer *, integer *, integer *,
                                        integer *, integer *, integer *, integer *, integer *,
                                        integer *, integer *);
    static integer noar2s, noar3s;
    extern /* Subroutine */ int fasoar_(integer *, integer *, integer *, integer *, integer *,
                                        integer *, integer *, integer *, integer *, integer *,
                                        integer *, integer *);
    ...
    if (*nbcf + 2 > *mxarcf) { goto L9100; }

    /*     creation des 3 aretes du triangle dans le tableau nosoar */
    /*     ======================================================== */
    /*     la formation de l'arete sommet1-sommet2 dans le tableau nosoar */
    fasoar_(&noarcf[*na1 * 3 + 1], &noarcf[*na2 * 3 + 1], &c_n1, &c_n1, &c__0, mosoar, mxsoar,
            n1soar, &nosoar[nosoar_offset], &noarst[1], noar1, &ierr);
    if (ierr != 0) { goto L9900; }

    /*     la formation de l'arete sommet2-sommet3 dans le tableau nosoar */
    fasoar_(&noarcf[*na2 * 3 + 1], &noarcf[*na3 * 3 + 1], &c_n1, &c_n1, &c__0, mosoar, mxsoar,
            n1soar, &nosoar[nosoar_offset], &noarst[1], noar2, &ierr);
    if (ierr != 0) { goto L9900; }

    /*     la formation de l'arete sommet3-sommet1 dans le tableau nosoar */
    fasoar_(&noarcf[*na3 * 3 + 1], &noarcf[*na1 * 3 + 1], &c_n1, &c_n1, &c__0, mosoar, mxsoar,
            n1soar, &nosoar[nosoar_offset], &noarst[1], noar3, &ierr);
    if (ierr != 0) { goto L9900; }

    /*     ajout dans noartr de ce triangle nt */
    /*     =================================== */
    trcf3a_(&noarcf[*na1 * 3 + 1], &noarcf[*na2 * 3 + 1], &noarcf[*na3 * 3 + 1], noar1, noar2,
            noar3, mosoar, &nosoar[nosoar_offset], moartr, n1artr, &noartr[noartr_offset], nt);
    if (*nt <= 0) { return 0; }
...
/* Subroutine */ int trcf1a_(integer *nbcf, integer *na01, integer *na1, integer *na2,
                             integer *noar1, integer *noar3, integer *mosoar, integer *mxsoar,
                             integer *n1soar, integer *nosoar, integer *moartr, integer *n1artr,
                             integer *noartr, integer *noarst, integer *mxarcf, integer *n1arcf,
                             integer *noarcf, integer *nt)
{
    /* System generated locals */
    integer nosoar_dim1, nosoar_offset, noartr_dim1, noartr_offset;
    ...
    extern /* Subroutine */ int trcf3a_(integer *, integer *, integer *, integer *, integer *,
                                        integer *, integer *, integer *, integer *, integer *,
                                        integer *, integer *),
        fasoar_(integer *, integer *, integer *, integer *, integer *, integer *, integer *,
                integer *, integer *, integer *, integer *, integer *);
    ...
    /*     =============================================================== */
    trcf3a_(&noarcf[*na1 * 3 + 1], &noarcf[*na2 * 3 + 1], &noarcf[na3 * 3 + 1], noar1,
            &noarcf[*na2 * 3 + 3], noar3, mosoar, &nosoar[nosoar_offset], moartr, n1artr,
...
/* Subroutine */ int trcf2a_(integer *nbcf, integer *na1, integer *noar3, integer *mosoar,
                             integer *mxsoar, integer *n1soar, integer *nosoar, integer *moartr,
                             integer *n1artr, integer *noartr, integer *noarst, integer *n1arcf,
                             integer *noarcf, integer *nt)
{
    /* System generated locals */
    integer nosoar_dim1, nosoar_offset, noartr_dim1, noartr_offset;
    ...
    trcf3a_(&noarcf[*na1 * 3 + 1], &noarcf[na2 * 3 + 1], &noarcf[na3 * 3 + 1],
            &noarcf[*na1 * 3 + 3], &noarcf[na2 * 3 + 3], noar3, mosoar, &nosoar[nosoar_offset],
            moartr, n1artr, &noartr[noartr_offset], nt);
    if (*nt <= 0) { return 0; }
...
/* Subroutine */ int trcf3a_(integer *ns1, integer *ns2, integer *ns3, integer *noar1,
                             integer *noar2, integer *noar3, integer *mosoar, integer *nosoar,
                             integer *moartr, integer *n1artr, integer *noartr, integer *nt)
{
    /* System generated locals */
    integer nosoar_dim1, nosoar_offset, noartr_dim1, noartr_offset;
    ...
    *n1artr = noartr[*n1artr * noartr_dim1 + 2];
    ...
    if (*ns1 == nosoar[*noar1 * nosoar_dim1 + 1]) { n = 1; }
    else {
        n = -1;
    }
    ...
    if (nosoar[*noar1 * nosoar_dim1 + 4] <= 0) { n = 4; }
    else {
        n = 5;
    }
    ...
    /*     ====================== */
    /*     orientation des 3 aretes du triangle pour qu'il soit direct */
    if (*ns2 == nosoar[*noar2 * nosoar_dim1 + 1]) { n = 1; }
    else {
        n = -1;
    }
    ...
    /*     le numero du triangle nt pour l'arete */
    if (nosoar[*noar2 * nosoar_dim1 + 4] <= 0) { n = 4; }
    else {
        n = 5;
    }
    ...
    /*     ====================== */
    /*     orientation des 3 aretes du triangle pour qu'il soit direct */
    if (*ns3 == nosoar[*noar3 * nosoar_dim1 + 1]) { n = 1; }
    else {
        n = -1;
    }
    ...
    /*     le numero du triangle nt pour l'arete */
    if (nosoar[*noar3 * nosoar_dim1 + 4] <= 0) { n = 4; }
    else {
        n = 5;
    }
...
/* Subroutine */ int trcf3s_(integer *nbcf, integer *na01, integer *na1, integer *na02,
                             integer *na2, integer *na03, integer *na3, integer *mosoar,
                             integer *mxsoar, integer *n1soar, integer *nosoar, integer *moartr,
                             integer *n1artr, integer *noartr, integer *noarst, integer *mxarcf,
                             integer *n1arcf, integer *noarcf, integer *nt)
{
    ...
    extern /* Subroutine */ int trcf0a_(integer *, integer *, integer *, integer *, integer *,
                                        integer *, integer *, integer *, integer *, integer *,
                                        integer *, integer *, integer *, integer *, integer *,
                                        integer *, integer *, integer *, integer *, integer *),
        trcf1a_(integer *, integer *, integer *, integer *, integer *, integer *, integer *,
                integer *, integer *, integer *, integer *, integer *, integer *, integer *,
                integer *, integer *, integer *, integer *),
        trcf2a_(integer *, integer *, integer *, integer *, integer *, integer *, integer *,
                integer *, integer *, integer *, integer *, integer *, integer *, integer *),
        trcf3a_(integer *, integer *, integer *, integer *, integer *, integer *, integer *,
                integer *, integer *, integer *, integer *, integer *);
    ...
    if (nbascf == 3) {
        ...
        trcf3a_(&noarcf[*na1 * 3 + 1], &noarcf[*na2 * 3 + 1], &noarcf[*na3 * 3 + 1],
                &noarcf[*na1 * 3 + 3], &noarcf[*na2 * 3 + 3], &noarcf[*na3 * 3 + 3], mosoar,
        ...
        trcf2a_(nbcf, &naa1, &naor3, mosoar, mxsoar, n1soar, &nosoar[nosoar_offset], moartr, n1artr,
                &noartr[noartr_offset], &noarst[1], n1arcf, &noarcf[4], nt);
    }
    else if (nbascf == 1) {
        ...
        trcf1a_(nbcf, &naa01, &naa1, &naa2, &naor1, &naor3, mosoar, mxsoar, n1soar,
                &nosoar[nosoar_offset], moartr, n1artr, &noartr[noartr_offset], &noarst[1], mxarcf,
                n1arcf, &noarcf[4], nt);
    }
    else {
        ...
        trcf0a_(nbcf, na01, na1, na2, na3, &naa1, &naa2, &naa01, mosoar, mxsoar, n1soar,
                &nosoar[nosoar_offset], moartr, n1artr, &noartr[noartr_offset], &noarst[1], mxarcf,
                n1arcf, &noarcf[4], nt);
    }
    return 0;
...
/* Subroutine */ int tridcf_(integer *nbcf0, integer *nbstpe, integer *nostpe, doublereal *pxyd,
                             integer *noarst, integer *mosoar, integer *mxsoar, integer *n1soar,
                             integer *nosoar, integer *moartr, integer *n1artr, integer *noartr,
                             integer *mxarcf, integer *n1arcf, integer *noarcf, integer *larmin,
                             integer *nbtrcf, integer *notrcf, integer *ierr)
{
    /* System generated locals */
    integer noartr_dim1, noartr_offset, nosoar_dim1, nosoar_offset, i__1, i__2;
    ...
    static integer i__, k;
    static doublereal s;
    static integer nt, na0, na1, na2, na3, ns1, ns2, ns3, nt0, nt1, nt2, na01, na02, na12, na03,
        ncf, ntp0, nbcf;
    static doublereal dmin__;
    ...
    extern /* Subroutine */ int trcf3a_(integer *, integer *, integer *, integer *, integer *,
                                        integer *, integer *, integer *, integer *, integer *,
                                        integer *, integer *),
        trcf3s_(integer *, integer *, integer *, integer *, integer *, integer *, integer *,
                integer *, integer *, integer *, integer *, integer *, integer *, integer *,
                integer *, integer *, integer *, integer *, integer *);
    extern doublereal surtd2_(doublereal *, doublereal *, doublereal *);
    extern /* Subroutine */ int fasoar_(integer *, integer *, integer *, integer *, integer *,
    ...
    extern /* Subroutine */ int trchtd_(doublereal *, integer *, integer *, integer *, integer *,
                                        integer *, integer *);
...
L1:
    ...
    L2:
        ...
        for (i__ = 1; i__ <= i__2; ++i__) {
            ...
            d__ = surtd2_(&pxyd[ns1 * 3 + 1], &pxyd[ns2 * 3 + 1], &pxyd[ns3 * 3 + 1]);
            if (d__ > 0.) {
                /*              distance de ce sommet ns3 a l'arete na1 */
                d__ = diptdr_(&pxyd[ns3 * 3 + 1], &pxyd[ns1 * 3 + 1], &pxyd[ns2 * 3 + 1]);
                if (d__ < dmin__) {
                    dmin__ = d__;
                    imin = i__;
                }
        ...
        if (imin > 0) {
            ...
            fasoar_(&ns2, &ns3, &c_n1, &c_n1, &c__0, mosoar, mxsoar, n1soar, &nosoar[nosoar_offset],
                    &noarst[1], &noar2, ierr);
            if (*ierr != 0) { goto L9900; }
            /*           la formation de l'arete ns3-ns1 dans le tableau nosoar */
            fasoar_(&ns3, &ns1, &c_n1, &c_n1, &c__0, mosoar, mxsoar, n1soar, &nosoar[nosoar_offset],
                    &noarst[1], &noar3, ierr);
            if (*ierr != 0) { goto L9900; }

            /*           ajout dans noartr du triangle de sommets ns1 ns2 ns3 */
            /*           et d'aretes na1, noar2, noar3 dans nosoar */
            trcf3a_(&ns1, &ns2, &ns3, &noar1, &noar2, &noar3, mosoar, &nosoar[nosoar_offset],
                    moartr, n1artr, &noartr[noartr_offset], &nt);
            s = surtd2_(&pxyd[ns1 * 3 + 1], &pxyd[ns2 * 3 + 1], &pxyd[ns3 * 3 + 1]);
            if (s <= 0.) {
...
L10:
    if (nbcf > 0) {
        ...
        /*        ------------------------------------------------------ */
        trcf3s_(&nbcf, &na01, &na1, &na02, &na2, &na03, &na3, mosoar, mxsoar, n1soar,
                &nosoar[nosoar_offset], moartr, n1artr, &noartr[noartr_offset], &noarst[1], mxarcf,
                n1arcf, &noarcf[4], &nt);
        if (nt <= 0) {
        ...
        nusotr_(&nt, mosoar, &nosoar[nosoar_offset], moartr, &noartr[noartr_offset], nosotr);
        s = surtd2_(&pxyd[nosotr[0] * 3 + 1], &pxyd[nosotr[1] * 3 + 1], &pxyd[nosotr[2] * 3 + 1]);
        if (s <= 0.) {
    ...
    for (ntp0 = 1; ntp0 <= i__1; ++ntp0) {
        ...
        for (i__ = 1; i__ <= 3; ++i__) {
            ...
            if (nt1 <= 0) {
                ...
                //}
                //e_wsle();
                nusotr_(&nt0, mosoar, &nosoar[nosoar_offset], moartr, &noartr[noartr_offset],
                        nosotr);
                ...
                //}
                //e_wsle();
                nusotr_(&nt1, mosoar, &nosoar[nosoar_offset], moartr, &noartr[noartr_offset],
                        nosotr);
                ...
                //}
                //e_wsle();
                nusotr_(&nt2, mosoar, &nosoar[nosoar_offset], moartr, &noartr[noartr_offset],
                        nosotr);
...
/* Subroutine */ int te1stm_(integer *nsasup, integer *nbarpi, doublereal *pxyd, integer *noarst,
                             integer *mosoar, integer *mxsoar, integer *n1soar, integer *nosoar,
                             integer *moartr, integer *mxartr, integer *n1artr, integer *noartr,
                             integer *mxarcf, integer *n1arcf, integer *noarcf, integer *larmin,
                             integer *notrcf, integer *liarcf, integer *ierr)
{
    ...
    extern /* Subroutine */ int tridcf_(integer *, integer *, integer *, doublereal *, integer *,
                                        integer *, integer *, integer *, integer *, integer *,
                                        integer *, integer *, integer *, integer *, integer *,
                                        integer *, integer *, integer *, integer *);
    static integer nbtrcf;
    extern /* Subroutine */ int focftr_(integer *, integer *, integer *, doublereal *, integer *,
                                        integer *, integer *, integer *, integer *, integer *,
                                        integer *, integer *, integer *, integer *, integer *,
                                        integer *, integer *, integer *);
    static integer modifs;
    extern /* Subroutine */ int trfrcf_(integer *, integer *, integer *, integer *, integer *,
                                        integer *, integer *, integer *);
    ...
    *ierr = 0;
    ...
    trp1st_(nsasup, &noarst[1], mosoar, &nosoar[nosoar_offset], moartr, mxartr,
            &noartr[noartr_offset], mxarcf, &nbtrcf, &notrcf[1]);
    ...
    trfrcf_(nsasup, mosoar, &nosoar[nosoar_offset], moartr, &noartr[noartr_offset], &nbtrcf,
            &notrcf[1], &nbarfr);
    if (nbarfr >= nbtrcf) {
    ...
    focftr_(&nbtrcf, &notrcf[1], nbarpi, &pxyd[4], &noarst[1], mosoar, mxsoar, n1soar,
            &nosoar[nosoar_offset], moartr, n1artr, &noartr[noartr_offset], &nbarcf, n1arcf,
            &noarcf[4], &nbstpe, nostpe, ierr);
    if (*ierr != 0) {
    ...
    /*     ============================================================ */
    nbcf = 1;
    tridcf_(&nbcf, &nbstpe, nostpe, &pxyd[4], &noarst[1], mosoar, mxsoar, n1soar,
            &nosoar[nosoar_offset], moartr, n1artr, &noartr[noartr_offset], mxarcf, n1arcf,
            &noarcf[4], &larmin[1], &nbtrcf, &notrcf[1], ierr);
    if (*ierr != 0) { return 0; }
    ...
    tedela_(&pxyd[4], &noarst[1], mosoar, mxsoar, n1soar, &nosoar[nosoar_offset], &liarcf[1],
            moartr, mxartr, n1artr, &noartr[noartr_offset], &modifs);
    return 0;
} /* te1stm_ */

/* Subroutine */ int tr3str_(integer *np, integer *nt, integer *mosoar, integer *mxsoar,
                             integer *n1soar, integer *nosoar, integer *moartr, integer *mxartr,
                             integer *n1artr, integer *noartr, integer *noarst, integer *nutr,
                             integer *ierr)
{
    /* System generated locals */
    integer nosoar_dim1, nosoar_offset, noartr_dim1, noartr_offset;
...
/* Subroutine */ int mt4sqa_(integer *na, integer *moartr, integer *noartr, integer *mosoar,
                             integer *nosoar, integer *ns1, integer *ns2, integer *ns3,
                             integer *ns4)
{
    /* System generated locals */
    integer noartr_dim1, noartr_offset, nosoar_dim1, nosoar_offset, i__1;
    ...
    for (i__ = 1; i__ <= 3; ++i__) {
        if ((i__1 = noartr[i__ + nt * noartr_dim1], abs(i__1)) == *na) { goto L8; }
        /* L5: */
    }
...
L8:
    ...
    *ns3 = nosoar[naa * nosoar_dim1 + 1];
    if (*ns3 == *ns1 || *ns3 == *ns2) { *ns3 = nosoar[naa * nosoar_dim1 + 2]; }
    ...
    if (naa == *na) { naa = (i__1 = noartr[nt * noartr_dim1 + 2], abs(i__1)); }
    *ns4 = nosoar[naa * nosoar_dim1 + 1];
    if (*ns4 == *ns1 || *ns4 == *ns2) { *ns4 = nosoar[naa * nosoar_dim1 + 2]; }
    return 0;
} /* mt4sqa_ */

/* Subroutine */ int te2t2t_(integer *noaret, integer *mosoar, integer *n1soar, integer *nosoar,
                             integer *noarst, integer *moartr, integer *noartr, integer *noar34)
{
    /* System generated locals */
    integer nosoar_dim1, nosoar_offset, noartr_dim1, noartr_offset, i__1;
    ...
    /* Local variables */
    static integer n1, n2, n3, ns1, ns2, ns3, ns4, nt1, nt2, na31, na23, na14, na42, ierr;
    extern /* Subroutine */ int mt4sqa_(integer *, integer *, integer *, integer *, integer *,
                                        integer *, integer *, integer *, integer *),
        fasoar_(integer *, integer *, integer *, integer *, integer *, integer *, integer *,
                integer *, integer *, integer *, integer *, integer *),
        sasoar_(integer *, integer *, integer *, integer *, integer *, integer *);
    ...
    /* Function Body */
    *noar34 = 0;
    if (nosoar[*noaret * nosoar_dim1 + 3] > 0) { return 0; }

    /*     les 4 sommets des 2 triangles ayant l'arete noaret en commun */
    mt4sqa_(noaret, moartr, &noartr[noartr_offset], mosoar, &nosoar[nosoar_offset], &ns1, &ns2,
            &ns3, &ns4);
    ...
    for (n1 = 1; n1 <= 3; ++n1) {
        if ((i__1 = noartr[n1 + nt1 * noartr_dim1], abs(i__1)) == *noaret) { goto L15; }
        /* L10: */
    }
...
L15:
    ...
    for (n1 = 1; n1 <= 3; ++n1) {
        if ((i__1 = noartr[n1 + nt2 * noartr_dim1], abs(i__1)) == *noaret) { goto L25; }
        /* L20: */
    }
    /*     impossible d'arriver ici sans bogue! */
...
L25:
    ...
    ierr = -1;
    fasoar_(&ns3, &ns4, &nt1, &nt2, &c__0, mosoar, &mxsoar, n1soar, &nosoar[nosoar_offset],
            &noarst[1], noar34, &ierr);
    if (ierr > 0) {
    ...
    sasoar_(noaret, mosoar, &mxsoar, n1soar, &nosoar[nosoar_offset], &noarst[1]);

    /*     nt1 = triangle 143 */
    noartr[nt1 * noartr_dim1 + 1] = na14;
    /*     sens de stockage de l'arete ns3-ns4 dans nosoar? */
    if (nosoar[*noar34 * nosoar_dim1 + 1] == ns3) { n1 = -1; }
    else {
        n1 = 1;
    }
    ...
    na23 = abs(na23);
    if (nosoar[na23 * nosoar_dim1 + 4] == nt1) { n1 = 4; }
    else {
        n1 = 5;
    }
    ...
    na14 = abs(na14);
    if (nosoar[na14 * nosoar_dim1 + 4] == nt2) { n1 = 4; }
    else {
        n1 = 5;
    }
...
/* Subroutine */ int f0trte_(integer *letree, doublereal *pxyd, integer *mosoar, integer *mxsoar,
                             integer *n1soar, integer *nosoar, integer *moartr, integer *mxartr,
                             integer *n1artr, integer *noartr, integer *noarst, integer *nbtr,
                             integer *nutr, integer *ierr)
{
    ...
    extern /* Subroutine */ int trpite_(integer *, doublereal *, integer *, integer *, integer *,
                                        integer *, integer *, integer *, integer *, integer *,
                                        integer *, integer *, integer *, integer *);
    ...
    *n1artr = noartr[*n1artr * noartr_dim1 + 2];
    ...
    for (i__ = 1; i__ <= 3; ++i__) {
        ...
        fasoar_(&letree[i__ + 5], &letree[i1 + 5], &nt, &c_n1, &c__0, mosoar, mxsoar, n1soar,
                &nosoar[nosoar_offset], &noarst[1], &nuarco[i__ - 1], ierr);
        if (*ierr != 0) { return 0; }
        /* L10: */
    }
    ...
    for (i__ = 1; i__ <= 3; ++i__) {
        ...
        if (letree[i__ + 5] == nosoar[nuarco[i__ - 1] * nosoar_dim1 + 1]) { lesign = 1; }
        else {
            lesign = -1;
        }
    ...
    *nbtr = 1;
    nutr[1] = nt;
    trpite_(letree, &pxyd[4], mosoar, mxsoar, n1soar, &nosoar[nosoar_offset], moartr, mxartr,
            n1artr, &noartr[noartr_offset], &noarst[1], nbtr, &nutr[1], ierr);
    return 0;
} /* f0trte_ */

/* Subroutine */ int f1trte_(integer *letree, doublereal *pxyd, integer *milieu, integer *mosoar,
                             integer *mxsoar, integer *n1soar, integer *nosoar, integer *moartr,
                             integer *mxartr, integer *n1artr, integer *noartr, integer *noarst,
                             integer *nbtr, integer *nutr, integer *ierr)
{
    /* System generated locals */
    integer nosoar_dim1, nosoar_offset, noartr_dim1, noartr_offset;
...
L9:
    ...
    for (i__ = 1; i__ <= 2; ++i__) {
        ...
        fasoar_(&nosotr[i__ - 1], &nosotr[i1 - 1], &nutr[i__], &c_n1, &c__0, mosoar, mxsoar, n1soar,
                &nosoar[nosoar_offset], &noarst[1], &nuarco[i__ - 1], ierr);
        if (*ierr != 0) { return 0; }
        /* L10: */
    }
    ...
    fasoar_(&nosotr[2], &nm, &nutr[2], &c_n1, &c__0, mosoar, mxsoar, n1soar, &nosoar[nosoar_offset],
            &noarst[1], &nuarco[2], ierr);
    if (*ierr != 0) { return 0; }

    /*     ajout eventuel de l'arete milieu s1 dans nosoar */
    fasoar_(nosotr, &nm, &nutr[1], &c_n1, &c__0, mosoar, mxsoar, n1soar, &nosoar[nosoar_offset],
            &noarst[1], &nuarco[3], ierr);
    if (*ierr != 0) { return 0; }

    /*     ajout eventuel de l'arete milieu s2 dans nosoar */
    fasoar_(&nosotr[1], &nm, &nutr[1], &nutr[2], &c__0, mosoar, mxsoar, n1soar,
    ...
    for (i__ = 1; i__ <= 2; ++i__) {
        ...
        if (nosotr[i__ - 1] == nosoar[nuarco[i__ - 1] * nosoar_dim1 + 1]) { lesign = 1; }
        else {
            lesign = -1;
        }
        /*        l'arete ns1-ns2 dans nosoar est celle du cote du te */
    ...
    if (nm == nosoar[nuarco[4] * nosoar_dim1 + 1]) { lesign = -1; }
    else {
        lesign = 1;
    }
    ...
    /*     l'arete s1 milieu */
    if (nm == nosoar[nuarco[3] * nosoar_dim1 + 1]) { lesign = 1; }
    else {
        lesign = -1;
    }
    ...
    /*     l'arete s3 milieu */
    if (nm == nosoar[nuarco[2] * nosoar_dim1 + 1]) { lesign = -1; }
    else {
        lesign = 1;
    }
...
/* Subroutine */ int f2trte_(integer *letree, doublereal *pxyd, integer *milieu, integer *mosoar,
                             integer *mxsoar, integer *n1soar, integer *nosoar, integer *moartr,
                             integer *mxartr, integer *n1artr, integer *noartr, integer *noarst,
                             integer *nbtr, integer *nutr, integer *ierr)
{
...
L9:
    ...
    /*     ajout eventuel de l'arete s1 s2 dans nosoar */
    fasoar_(nosotr, &nosotr[1], &nutr[1], &c_n1, &c__0, mosoar, mxsoar, n1soar,
            &nosoar[nosoar_offset], &noarst[1], nuarco, ierr);
    if (*ierr != 0) { return 0; }
    ...
    fasoar_(nosotr, &nm2, &nutr[1], &nutr[2], &c__0, mosoar, mxsoar, n1soar, &nosoar[nosoar_offset],
            &noarst[1], &nuarco[2], ierr);
    if (*ierr != 0) { return 0; }

    /*     ajout eventuel de l'arete nm2 nm3 dans nosoar */
    fasoar_(&nm3, &nm2, &nutr[2], &nutr[3], &c__0, mosoar, mxsoar, n1soar, &nosoar[nosoar_offset],
            &noarst[1], &nuarco[3], ierr);
    if (*ierr != 0) { return 0; }

    /*     ajout eventuel de l'arete s1 nm3 dans nosoar */
    fasoar_(nosotr, &nm3, &nutr[2], &c_n1, &c__0, mosoar, mxsoar, n1soar, &nosoar[nosoar_offset],
            &noarst[1], &nuarco[4], ierr);
    if (*ierr != 0) { return 0; }
    ...
    if (nm2 == nosoar[nuarco[2] * nosoar_dim1 + 1]) { lesign = 1; }
    else {
        lesign = -1;
    }
    ...
    if (nm2 == nosoar[nuarco[3] * nosoar_dim1 + 1]) { lesign = 1; }
    else {
        lesign = -1;
    }
    noartr[nutr[2] * noartr_dim1 + 2] = lesign * nuarco[3];
    noartr[nutr[3] * noartr_dim1 + 1] = -lesign * nuarco[3];
    if (nm3 == nosoar[nuarco[4] * nosoar_dim1 + 1]) { lesign = 1; }
    else {
        lesign = -1;
    }
    noartr[nutr[2] * noartr_dim1 + 3] = lesign * nuarco[4];
    ...
    if (nm2 == nosoar[nuarco[5] * nosoar_dim1 + 1]) { lesign = 1; }
    else {
        lesign = -1;
    }
    noartr[nutr[3] * noartr_dim1 + 2] = lesign * nuarco[5];
    if (nm3 == nosoar[nuarco[6] * nosoar_dim1 + 1]) { lesign = -1; }
    else {
        lesign = 1;
    }
...
/* Subroutine */ int f3trte_(integer *letree, doublereal *pxyd, integer *milieu, integer *mosoar,
                             integer *mxsoar, integer *n1soar, integer *nosoar, integer *moartr,
                             integer *mxartr, integer *n1artr, integer *noartr, integer *noarst,
                             integer *nbtr, integer *nutr, integer *ierr)
{
    ...
    *nbtr = 4;
    ...
    for (i__ = 1; i__ <= 3; ++i__) {
        ...
        fasoar_(&letree[i__ + 5], &milieu[i__], &nutr[i__], &c_n1, &c__0, mosoar, mxsoar, n1soar,
                &nosoar[nosoar_offset], &noarst[1], &nuarco[i3 - 3], ierr);
        if (*ierr != 0) { return 0; }

        /*        ajout eventuel de l'arete mi mi-1 dans nosoar */
        fasoar_(&milieu[i__], &milieu[i0], &nutr[i__], &nutr[4], &c__0, mosoar, mxsoar, n1soar,
                &nosoar[nosoar_offset], &noarst[1], &nuarco[i3 - 2], ierr);
        if (*ierr != 0) { return 0; }

        /*        ajout eventuel de l'arete m i-1  si dans nosoar */
        fasoar_(&milieu[i0], &letree[i__ + 5], &nutr[i__], &c_n1, &c__0, mosoar, mxsoar, n1soar,
                &nosoar[nosoar_offset], &noarst[1], &nuarco[i3 - 1], ierr);
        if (*ierr != 0) { return 0; }
    ...
    for (i__ = 1; i__ <= 3; ++i__) {
        ...
        if (letree[i__ + 5] == nosoar[nuarco[i3 - 3] * nosoar_dim1 + 1]) { lesign = 1; }
        else {
            lesign = -1;
        }
        noartr[nutr[i__] * noartr_dim1 + 1] = lesign * nuarco[i3 - 3];

        if (milieu[i__] == nosoar[nuarco[i3 - 2] * nosoar_dim1 + 1]) { lesign = 1; }
        else {
            lesign = -1;
        }
        noartr[nutr[i__] * noartr_dim1 + 2] = lesign * nuarco[i3 - 2];

        if (milieu[i0] == nosoar[nuarco[i3 - 1] * nosoar_dim1 + 1]) { lesign = 1; }
        else {
            lesign = -1;
        }
    ...
    for (i__ = 1; i__ <= 3; ++i__) {
        i3 += 3;
        if (milieu[i__] == nosoar[nuarco[i3 - 1] * nosoar_dim1 + 1]) { lesign = -1; }
        else {
            lesign = 1;
        }
...
/* Subroutine */ int hasoar_(integer *mosoar, integer *mxsoar, integer *n1soar, integer *nosoar,
                             integer *nu2sar, integer *noar)
{
    /* System generated locals */
    integer nosoar_dim1, nosoar_offset;
...
/* Subroutine */ int mt3str_(integer *nt, integer *moartr, integer *noartr, integer *mosoar,
                             integer *nosoar, integer *ns1, integer *ns2, integer *ns3)
{
    /* System generated locals */
    integer noartr_dim1, noartr_offset, nosoar_dim1, nosoar_offset;
...
/* Subroutine */ int trpite_(integer *letree, doublereal *pxyd, integer *mosoar, integer *mxsoar,
                             integer *n1soar, integer *nosoar, integer *moartr, integer *mxartr,
                             integer *n1artr, integer *noartr, integer *noarst, integer *nbtr,
                             integer *nutr, integer *ierr)
{
    ...
    extern /* Subroutine */ int tr3str_(integer *, integer *, integer *, integer *, integer *,
                                        integer *, integer *, integer *, integer *, integer *,
                                        integer *, integer *, integer *);
    static integer nsigne;
    extern /* Subroutine */ int ptdatr_(doublereal *, doublereal *, integer *, integer *);
    static integer nosotr[3];
    extern /* Subroutine */ int nusotr_(integer *, integer *, integer *, integer *, integer *,
                                        integer *);
    ...
    for (k = 0; k <= 3; ++k) {
        ...
        for (n = 1; n <= i__1; ++n) {
            ...
            if (nsigne > 0) {
                ...
                tr3str_(&np, &nt, mosoar, mxsoar, n1soar, &nosoar[nosoar_offset], moartr, mxartr,
                        n1artr, &noartr[noartr_offset], &noarst[1], &nutr[*nbtr + 1], ierr);
                if (*ierr != 0) { return 0; }
...
/* Subroutine */ int sasoar_(integer *noar, integer *mosoar, integer *mxsoar, integer *n1soar,
                             integer *nosoar, integer *noarst)
{
    /* System generated locals */
    integer nosoar_dim1, nosoar_offset, i__1;
    ...
    for (k = 1; k <= 2; ++k) {
        if (noarst[ns[k - 1]] == *noar) {
            ...
            if (nosoar[ns[k - 1] * nosoar_dim1 + 1] == ns[k - 1]
                && nosoar[ns[k - 1] * nosoar_dim1 + 2] > 0
                && nosoar[ns[k - 1] * nosoar_dim1 + 4] > 0) {
                ...
                i__1 = *mxsoar;
                for (i__ = 1; i__ <= i__1; ++i__) {
                    if (nosoar[i__ * nosoar_dim1 + 1] > 0 && nosoar[i__ * nosoar_dim1 + 4] > 0) {
                        /*                    arete non vide */
    ...
    L10:
        ...
        if (*noar != nosoar[*noar * nosoar_dim1 + 1]) {
            ...
            nosoar[*mosoar + noar0 * nosoar_dim1] = nosoar[*mosoar + *noar * nosoar_dim1];
...
/* Subroutine */ int caetoi_(integer *noar, integer *mosoar, integer *mxsoar, integer *n1soar,
                             integer *nosoar, integer *noarst, integer *n1aeoc, integer *nbtrar)
{
    /* System generated locals */
    integer nosoar_dim1, nosoar_offset;
    ...
    extern /* Subroutine */ int sasoar_(integer *, integer *, integer *, integer *, integer *,
                                        integer *);
    ...
    L10:
        ...
        sasoar_(noar, mosoar, mxsoar, n1soar, &nosoar[nosoar_offset], &noarst[1]);
...
/* Subroutine */ int focftr_(integer *nbtrcf, integer *notrcf, integer *nbarpi, doublereal *pxyd,
                             integer *noarst, integer *mosoar, integer *mxsoar, integer *n1soar,
                             integer *nosoar, integer *moartr, integer *n1artr, integer *noartr,
                             integer *nbarcf, integer *n1arcf, integer *noarcf, integer *nbstpe,
                             integer *nostpe, integer *ierr)
{
    /* System generated locals */
    integer nosoar_dim1, nosoar_offset, noartr_dim1, noartr_offset, i__1, i__2;
    ...
    /* Local variables */
    static integer i__, j, k, n, kk, nt, na0, na1, ns0, ns1, ns2, nt0, noar, nbst, n1ae00, n1aeoc;
    extern /* Subroutine */ int caetoi_(integer *, integer *, integer *, integer *, integer *,
                                        integer *, integer *, integer *);
    ...
    *ierr = 0;
    ...
    for (i__ = 1; i__ <= i__1; ++i__) {
        ...
        for (k = 1; k <= 3; ++k) {
            i__2 = nbst;
            for (j = 1; j <= i__2; ++j) {
                if (nosotr[k - 1] == nostpe[j]) { goto L3; }
                /* L2: */
            }
            /*           ajout du sommet */
            ++nbst;
        ...
        for (j = 1; j <= 3; ++j) {
            ...
            caetoi_(&noar, mosoar, mxsoar, n1soar, &nosoar[nosoar_offset], &noarst[1], &n1aeoc,
                    &nbtrar);
            if (nbtrar <= 0) {
...
L12:
    ...
    if (nt <= 0) { nt = nosoar[na1 * nosoar_dim1 + 5]; }
...
L20:
    ...
    L25:
        if (na1 > 0) {
            ...
            if (n1aeoc == na1) { n1aeoc = nosoar[na1 * nosoar_dim1 + 6]; }
            else {
...
/* Subroutine */ int int1sd_(integer *ns1, integer *ns2, integer *ns3, integer *ns4,
                             doublereal *pxyd, integer *linter, doublereal *x0, doublereal *y0)
{
    /* System generated locals */
    doublereal d__1, d__2;

    /* Local variables */
    static doublereal d__, x, y, x1, y1, d21, d43, p21, p43, x21, y21, x43, y43;
    ...
    /*     les 2 coordonnees du point d'intersection */
    x = (x1 * x43 * y21 - pxyd[*ns3 * 3 + 1] * x21 * y43 - (y1 - pxyd[*ns3 * 3 + 2]) * x21 * x43)
        / d__;
    y = (-y1 * y43 * x21 + pxyd[*ns3 * 3 + 2] * y21 * x43 + (x1 - pxyd[*ns3 * 3 + 1]) * y21 * y43)
        / d__;
    ...
    p43 = ((x - pxyd[*ns3 * 3 + 1]) * x43 + (y - pxyd[*ns3 * 3 + 2]) * y43) / d43;
...
/* Subroutine */ int tefoar_(integer *narete, integer *nbarpi, doublereal *pxyd, integer *mosoar,
                             integer *mxsoar, integer *n1soar, integer *nosoar, integer *moartr,
                             integer *mxartr, integer *n1artr, integer *noartr, integer *noarst,
                             integer *mxarcf, integer *n1arcf, integer *noarcf, integer *larmin,
                             integer *notrcf, integer *ierr)
{
    /* System generated locals */
    integer noartr_dim1, noartr_offset, nosoar_dim1, nosoar_offset, i__1;
    doublereal d__1, d__2;
    ...
    static integer na, ns[2], nt, na0, na1, na2, ns1, ns2, nt0, ns3, ns4, nt1, na00, na01, nbt, nsp;
#define nacf (equiv_1)
    static integer nbcf;
    static doublereal dmin__;
...
#define nacf2 (equiv_1 + 1)
    ...
    extern /* Subroutine */ int int1sd_(integer *, integer *, integer *, integer *, doublereal *,
...
L26:
    ...
    if (linter <= 0) {
        ...
        if (nosoar[na01 * nosoar_dim1 + 4] == nt0) { nt0 = nosoar[na01 * nosoar_dim1 + 5]; }
        else {
            nt0 = nosoar[na01 * nosoar_dim1 + 4];
        }
        if (nt0 > 0) { goto L20; }
...
L30:
    ...
    for (j = 1; j <= 3; ++j) {
        if (nosotr[j - 1] == ns2) { goto L70; }
        /* L32: */
    }

    /*     recherche de l'arete noar, na1 dans nt1 qui est l'arete na0 de nt0 */
    for (na1 = 1; na1 <= 3; ++na1) {
        if ((i__1 = noartr[na1 + nt1 * noartr_dim1], abs(i__1)) == noar) { goto L35; }
        /* L34: */
    }
...
L35:
    ...
    for (i1 = 1; i1 <= 2; ++i1) {
        ...
        if (linter > 0) {
            ...
            trp1st_(&nsp, &noarst[1], mosoar, &nosoar[nosoar_offset], moartr, mxartr,
                    &noartr[noartr_offset], &c__32, &nbt, lapitr);
            if (nbt <= 0) {
...
/* Subroutine */ int te4ste_(integer *nbsomm, integer *mxsomm, doublereal *pxyd, integer *ntrp,
                             integer *letree, integer *ierr)
{
    ...
    extern integer nopre3_(integer *);
    extern /* Subroutine */ int n1trva_(integer *, integer *, integer *, integer *, integer *);
    extern integer nosui3_(integer *);
...
/* Subroutine */ int tesuqm_(doublereal *quamal, integer *nbarpi, doublereal *pxyd, integer *noarst,
                             integer *mosoar, integer *mxsoar, integer *n1soar, integer *nosoar,
                             integer *moartr, integer *mxartr, integer *n1artr, integer *noartr,
                             integer *mxarcf, integer *n1arcf, integer *noarcf, integer *larmin,
                             integer *notrcf, integer *liarcf, doublereal *quamin)
{
    /* System generated locals */
    integer nosoar_dim1, nosoar_offset, noartr_dim1, noartr_offset, i__1, i__2;
    doublereal d__1, d__2;
    ...
    extern /* Subroutine */ int te2t2t_(integer *, integer *, integer *, integer *, integer *,
        ...
        mt4sqa_(integer *, integer *, integer *, integer *, integer *, integer *, integer *,
                integer *, integer *),
        te1stm_(integer *, integer *, doublereal *, integer *, integer *, integer *, integer *,
                integer *, integer *, integer *, integer *, integer *, integer *, integer *,
                integer *, integer *, integer *, integer *, integer *),
        qutr2d_(doublereal *, doublereal *, doublereal *, doublereal *);
    extern doublereal surtd2_(doublereal *, doublereal *, doublereal *);
    ...
    *quamin = 2.f;
    ...
    i__1 = *mxartr;
    for (nt = 1; nt <= i__1; ++nt) {
        if (noartr[nt * noartr_dim1 + 1] == 0) { goto L10; }
        /*        le numero des 3 sommets du triangle nt */
        nusotr_(&nt, mosoar, &nosoar[nosoar_offset], moartr, &noartr[noartr_offset], nosotr);
        /*        la qualite du triangle ns1 ns2 ns3 */
        qutr2d_(&pxyd[nosotr[0] * 3 + 1], &pxyd[nosotr[1] * 3 + 1], &pxyd[nosotr[2] * 3 + 1],
                &qualit);
        if (qualit < *quamal) {
            if (nbtrqm >= 1024) { goto L10; }
            ++nbtrqm;
            notrqm[nbtrqm - 1] = nt;
    ...
    *quamin = qutrqm[0];
    ...
    for (n = 1; n <= i__1; ++n) {
        ...
        if (noartr[ntqmin * noartr_dim1 + 1] == 0) { goto L100; }
        ...
        /*        le numero des 3 sommets du triangle ntqmin */
        nusotr_(&ntqmin, mosoar, &nosoar[nosoar_offset], moartr, &noartr[noartr_offset], nosotr);
        ...
        if (nbt == 1) {
            ...
            /*           l'arete appartient a deux triangles actifs */
            /*           le numero des 4 sommets du quadrangle des 2 triangles */
            mt4sqa_(&noar, moartr, &noartr[noartr_offset], mosoar, &nosoar[nosoar_offset], &ns1,
                    &ns2, &ns3, &ns4);
            if (ns4 == 0) { goto L100; }
            ...
            if ((d__1 = s34 - s12, abs(d__1)) > s34 * 1e-14) { goto L100; }

            /*           quadrangle convexe */
            /*           echange de la diagonale 12 par 34 des 2 triangles */
            /*           ------------------------------------------------- */
            te2t2t_(&noar, mosoar, n1soar, &nosoar[nosoar_offset], &noarst[1], moartr,
                    &noartr[noartr_offset], &noar34);
        ...
        L40:
            if (ns3 > *nbarpi) {
                ...
                te1stm_(&ns3, nbarpi, &pxyd[4], &noarst[1], mosoar, mxsoar, n1soar,
                        &nosoar[nosoar_offset], moartr, mxartr, n1artr, &noartr[noartr_offset],
                        mxarcf, n1arcf, &noarcf[4], &larmin[1], &notrcf[1], &liarcf[1], &ierr);
