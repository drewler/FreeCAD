...
{
    if (dim() != 1) EXCEPTION(logic_error, "dim() != 1");
    if (myWeights.capacity() == myWeights.size()) EXCEPTION(logic_error, "Extra gauss point");
    myCoords.push_back(x);
    myWeights.push_back(weight);
}
void TGaussDef::add(const double x, const double y, const double weight)
{
    if (dim() != 2) EXCEPTION(logic_error, "dim() != 2");
    if (myWeights.capacity() == myWeights.size()) EXCEPTION(logic_error, "Extra gauss point");
    myCoords.push_back(x);
...
{
    if (dim() != 3) EXCEPTION(logic_error, "dim() != 3");
    if (myWeights.capacity() == myWeights.size()) EXCEPTION(logic_error, "Extra gauss point");
    myCoords.push_back(x);
    myCoords.push_back(y);
...
void TGaussDef::setRefCoords(const TShapeFun &aShapeFun)
{
    ...
    myRefCoords.assign(aShapeFun.myRefCoord.begin(), aShapeFun.myRefCoord.end());
}
    ...
    switch (geom) {
        ...
        case eSEG3:
            ...
            switch (nbGauss) {
                ...
                default: EXCEPTION(logic_error, "Invalid nb of gauss points for SEG" << nbGauss);
            }
            break;
        ...
        case eTRIA6:
            if (variant == 1) {
                ...
                switch (nbGauss) {
                    ...
                    default:
                        EXCEPTION(logic_error,
                                  "Invalid nb of gauss points for TRIA, variant 1: " << nbGauss);
                }
            }
            else if (variant == 2) {
                ...
                switch (nbGauss) {
                    ...
                    default:
                        EXCEPTION(logic_error,
                                  "Invalid nb of gauss points for TRIA, variant 2: " << nbGauss);
                }
            }
            else if (variant == 3) {
                if (geom == eTRIA3) setRefCoords(TTria3b());
                ...
                switch (nbGauss) {
                    ...
                    default:
                        EXCEPTION(logic_error,
                                  "Invalid nb of gauss points for TRIA, variant 3: " << nbGauss);
                }
            }
            break;
        ...
        case eQUAD8:
            if (variant == 1) {
                ...
                switch (nbGauss) {
                    ...
                    default:
                        EXCEPTION(logic_error,
                                  "Invalid nb of gauss points for QUAD, variant 1: " << nbGauss);
                }
            }
            else if (variant == 2) {
                ...
                switch (nbGauss) {
                    ...
                    default:
                        EXCEPTION(logic_error,
                                  "Invalid nb of gauss points for QUAD, variant 3: " << nbGauss);
                }
            }
            break;
        ...
        case eTETRA10:
            ...
            switch (nbGauss) {
                ...
                case 15: { // FPG15
                    const double a = 0.25;
                    const double b1 = (7 + sqrt(15.)) / 34., c1 = (13 + 3 * sqrt(15.)) / 34.,
                                 d = (5 - sqrt(15.)) / 20.;
                    const double b2 = (7 - sqrt(15.)) / 34., c2 = (13 - 3 * sqrt(15.)) / 34.,
                                 e = (5 + sqrt(15.)) / 20.;
        ...
        case ePYRA13:
            ...
            switch (nbGauss) {
                ...
                default: EXCEPTION(logic_error, "Invalid nb of gauss points for PYRA: " << nbGauss);
            }
            break;
        case ePENTA6:
        case ePENTA15:
        ...
        default: EXCEPTION(logic_error, "unexpected EGeometrieElement: " << geom);
    }
