...
void SMESH::throwSalomeEx(const char *txt) { throw SALOME_Exception(txt); }

void SMESH::doNothing(const char *txt) { MESSAGE(txt << " " << __FILE__ << ": " << __LINE__); }
// ------------------------------------------------------------------
                                                ...
                                                SMESH_ComputeErrorPtr er2)
{
    ...
    if (er1->myName == er2->myName || hasInfo1 != hasInfo2) return hasInfo1 < hasInfo2 ? er2 : er1;
