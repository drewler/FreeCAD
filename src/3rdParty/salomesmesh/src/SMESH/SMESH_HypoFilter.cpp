                                                      ...
                                                      const TopoDS_Shape &aShape) const
{
    ...
    if (SMESH_MesherHelper::IsSubShape(aShape, /*mainShape=*/_shape)) return true;
    ...
    if (_preferableShapes.Contains(aShape)) return true; // issue 21559, Mesh_6
...
SMESH_HypoFilter::SMESH_HypoFilter() : myNbPredicates(0) {}
...
SMESH_HypoPredicate *SMESH_HypoFilter::IsAuxiliary() { return new IsAuxiliaryPredicate(); }
...
bool SMESH_HypoFilter::IsOk(const SMESH_Hypothesis *aHyp, const TopoDS_Shape &aShape) const
{
