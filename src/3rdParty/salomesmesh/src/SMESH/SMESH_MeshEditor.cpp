...
namespace
{
template<class ELEM_SET> SMDS_ElemIteratorPtr elemSetIterator(const ELEM_SET &elements)
{
    typedef SMDS_SetIterator<SMDS_pElement, typename ELEM_SET::const_iterator> TSetIterator;
...
SMESH_MeshEditor::SMESH_MeshEditor(SMESH_Mesh *theMesh) : myMesh(theMesh) // theMesh may be NULL
{}
...
SMDS_MeshElement *SMESH_MeshEditor::AddElement(const vector<const SMDS_MeshNode *> &node,
    ...
    switch (features.myType) {
            ...
            if (!features.myIsPoly) {
                if (nbnode == 3) {
                    if (ID >= 1) e = mesh->AddFaceWithID(node[0], node[1], node[2], ID);
                        ...
                        e = mesh->AddFace(node[0], node[1], node[2]);
                }
                else if (nbnode == 4) {
                    if (ID >= 1) e = mesh->AddFaceWithID(node[0], node[1], node[2], node[3], ID);
                    else
                        e = mesh->AddFace(node[0], node[1], node[2], node[3]);
                }
                else if (nbnode == 6) {
                    if (ID >= 1)
                        e = mesh->AddFaceWithID(node[0], node[1], node[2], node[3], node[4],
                                                node[5], ID);
                    else
                        e = mesh->AddFace(node[0], node[1], node[2], node[3], node[4], node[5]);
                }
                else if (nbnode == 7) {
                    if (ID >= 1)
                        e = mesh->AddFaceWithID(node[0], node[1], node[2], node[3], node[4],
                    ...
                    if (ID >= 1)
                        e = mesh->AddFaceWithID(node[0], node[1], node[2], node[3], node[4],
                                                node[5], node[6], node[7], node[8], ID);
                    else
                        e = mesh->AddFace(node[0], node[1], node[2], node[3], node[4], node[5],
            ...
            if (!features.myIsPoly) {
                if (nbnode == 4) {
                    if (ID >= 1) e = mesh->AddVolumeWithID(node[0], node[1], node[2], node[3], ID);
                        ...
                        e = mesh->AddVolume(node[0], node[1], node[2], node[3]);
                }
                else if (nbnode == 5) {
                    if (ID >= 1)
                        e = mesh->AddVolumeWithID(node[0], node[1], node[2], node[3], node[4], ID);
                    else
                        e = mesh->AddVolume(node[0], node[1], node[2], node[3], node[4]);
                }
                else if (nbnode == 6) {
                    if (ID >= 1)
                        e = mesh->AddVolumeWithID(node[0], node[1], node[2], node[3], node[4],
                                                  node[5], ID);
                    else
                        e = mesh->AddVolume(node[0], node[1], node[2], node[3], node[4], node[5]);
                }
                else if (nbnode == 8) {
                    if (ID >= 1)
                        e = mesh->AddVolumeWithID(node[0], node[1], node[2], node[3], node[4],
                    ...
                    if (ID >= 1)
                        e = mesh->AddVolumeWithID(node[0], node[1], node[2], node[3], node[4],
                                                  node[5], node[6], node[7], node[8], node[9], ID);
                    else
                        e = mesh->AddVolume(node[0], node[1], node[2], node[3], node[4], node[5],
                    ...
                    if (ID >= 1)
                        e = mesh->AddVolumeWithID(
                            node[0], node[1], node[2], node[3], node[4], node[5], node[6], node[7],
                            node[8], node[9], node[10], node[11], node[12], node[13], node[14], ID);
                    else
                        e = mesh->AddVolume(node[0], node[1], node[2], node[3], node[4], node[5],
                                            node[6], node[7], node[8], node[9], node[10], node[11],
                    ...
                    if (ID >= 1)
                        e = mesh->AddVolumeWithID(
                            ...
                            node[15], node[16], node[17], node[18], node[19], ID);
                    else
                        e = mesh->AddVolume(node[0], node[1], node[2], node[3], node[4], node[5],
                                            node[6], node[7], node[8], node[9], node[10], node[11],
                    ...
                    if (ID >= 1)
                        e = mesh->AddVolumeWithID(
                            node[0], node[1], node[2], node[3], node[4], node[5], node[6], node[7],
                            node[8], node[9], node[10], node[11], node[12], node[13], node[14],
                            node[15], node[16], node[17], node[18], node[19], node[20], node[21],
                            node[22], node[23], node[24], node[25], node[26], ID);
                    else
                        e = mesh->AddVolume(node[0], node[1], node[2], node[3], node[4], node[5],
                                            node[6], node[7], node[8], node[9], node[10], node[11],
                                            node[12], node[13], node[14], node[15], node[16],
                                            node[17], node[18], node[19], node[20], node[21],
                                            node[22], node[23], node[24], node[25], node[26]);
                }
            }
            else if (!features.myIsQuad) {
                if (ID >= 1)
                    e = mesh->AddPolyhedralVolumeWithID(node, features.myPolyhedQuantities, ID);
                else
                    e = mesh->AddPolyhedralVolume(node, features.myPolyhedQuantities);
            }
            else {
        ...
        case SMDSAbs_Edge:
            if (nbnode == 2) {
                if (ID >= 1) e = mesh->AddEdgeWithID(node[0], node[1], ID);
                    ...
                    e = mesh->AddEdge(node[0], node[1]);
            }
            else if (nbnode == 3) {
                if (ID >= 1) e = mesh->AddEdgeWithID(node[0], node[1], node[2], ID);
                else
                    e = mesh->AddEdge(node[0], node[1], node[2]);
            }
            break;
        ...
        case SMDSAbs_Node:
            if (ID >= 1) e = mesh->AddNodeWithID(node[0]->X(), node[0]->Y(), node[0]->Z(), ID);
                ...
                e = mesh->AddNode(node[0]->X(), node[0]->Y(), node[0]->Z());
            break;

        case SMDSAbs_Ball:
            if (ID >= 1) e = mesh->AddBallWithID(node[0], features.myBallDiameter, ID);
            else
                e = mesh->AddBall(node[0], features.myBallDiameter);
            break;
                                               ...
                                               const ElemFeatures &features)
{
    ...
    while (id != nodeIDs.end()) {
        if (const SMDS_MeshNode *node = GetMeshDS()->FindNode(*id++)) nodes.push_back(node);
        else
            return 0;
    }
...
int SMESH_MeshEditor::Remove(const list<int> &theIDs, const bool isNodes)
{
    myLastCreatedElems.Clear();
    myLastCreatedNodes.Clear();
    ...
    for (; it != theIDs.end(); it++) {
        ...
        if (isNodes) elem = aMesh->FindNode(*it);
        else
        ...
        // Do remove
        if (isNodes) aMesh->RemoveNode(static_cast<const SMDS_MeshNode *>(elem));
        else
                                                  ...
                                                  TIDSortedElemSet &all0DElems)
{
    ...
    if (elements.empty()) {
        ...
        while (elemIt->more()) allNodes.push_back(elemIt->next());
    ...
    while (elemIt->more()) {
        ...
        while (nodeIt->more()) {
            ...
            if (it0D->more()) all0DElems.insert(it0D->next());
            else {
...
int SMESH_MeshEditor::FindShape(const SMDS_MeshElement *theElem)
{
    ...
    SMESHDS_Mesh *aMesh = GetMeshDS();
    if (aMesh->ShapeToMesh().IsNull()) return 0;

    int aShapeID = theElem->getshapeId();
    if (aShapeID < 1) return 0;

    if (SMESHDS_SubMesh *sm = aMesh->MeshElements(aShapeID))
        if (sm->Contains(theElem)) return aShapeID;
    ...
    if (theElem->GetType() != SMDSAbs_Node) {
        ...
        while (nodeIt->more()) {
            ...
            if ((aShapeID = node->getshapeId()) > 0) {
                if (SMESHDS_SubMesh *sm = aMesh->MeshElements(aShapeID)) {
                    if (sm->Contains(theElem)) return aShapeID;
                    if (aShape.IsNull()) aShape = aMesh->IndexToShape(aShapeID);
                }
            }
        }
    }
    ...
    if (!aShape.IsNull()) {
        ...
        for (; ancIt.More(); ancIt.Next()) {
            ...
            if (sm && sm->Contains(theElem)) return aMesh->ShapeToIndex(ancIt.Value());
        }
    }
    else {
        SMESHDS_SubMeshIteratorPtr smIt = GetMeshDS()->SubMeshes();
        while (const SMESHDS_SubMesh *sm = smIt->next())
            if (sm->Contains(theElem)) return sm->GetID();
    }
...
bool SMESH_MeshEditor::IsMedium(const SMDS_MeshNode *node, const SMDSAbs_ElementType typeToCheck)
{
    bool isMedium = false;
...
static bool getNodesFromTwoTria(const SMDS_MeshElement *theTria1, const SMDS_MeshElement *theTria2,
                                ...
                                vector<const SMDS_MeshNode *> &N2)
{
    ...
    if (sames[0] > -1) {
        ...
        if (sames[1] > -1) { shiftNodesQuadTria(N1); }
    }
    i = sames[0] + sames[1] + sames[2];
    for (; i < 2; i++) { shiftNodesQuadTria(N2); }
                                   ...
                                   const SMDS_MeshElement *theTria2)
{
    ...
    if (!theTria1 || !theTria2) return false;
    ...
    if ((theTria1->GetEntityType() == SMDSEntity_Triangle)
        ...
        while (it->more()) {
            ...
            i++;
            if (i == 3) {
                if (it->more()) return false; // theTria1 is not a triangle
                it = theTria2->nodesIterator();
            }
            if (i == 6 && it->more()) return false; // theTria2 is not a triangle
        }
        ...
        if (aNodes[i1] == aNodes[i2]) return false;
    ...
    vector<const SMDS_MeshNode *> N1;
    vector<const SMDS_MeshNode *> N2;
    if (!getNodesFromTwoTria(theTria1, theTria2, N1, N2)) return false;
    ...
    for (int is2nd = 0; is2nd < 2; ++is2nd) {
        ...
        if (nodes.size() < 7) continue;
        helper.SetSubShape(tria->getshapeId());
        const TopoDS_Face &F = TopoDS::Face(helper.GetSubShape());
        gp_Pnt xyz;
        if (F.IsNull()) {
            xyz = (SMESH_TNodeXYZ(nodes[3]) + SMESH_TNodeXYZ(nodes[4]) + SMESH_TNodeXYZ(nodes[5]))
                / 3.;
        }
        else {
            bool checkUV;
            gp_XY uv = (helper.GetNodeUV(F, nodes[3], nodes[2], &checkUV)
                        ...
                        + helper.GetNodeUV(F, nodes[5], nodes[1], &checkUV))
                / 3.;
            TopLoc_Location loc;
...
static bool findTriangles(const SMDS_MeshNode *theNode1, const SMDS_MeshNode *theNode2,
                          const SMDS_MeshElement *&theTria1, const SMDS_MeshElement *&theTria2)
{
    ...
    while (it->more()) {
        const SMDS_MeshElement *elem = it->next();
        if (elem->NbCornerNodes() == 3) emap.insert(elem);
    }
    it = theNode2->GetInverseElementIterator(SMDSAbs_Face);
    while (it->more()) {
        const SMDS_MeshElement *elem = it->next();
        if (emap.count(elem)) {
            if (!theTria1) { theTria1 = elem; }
            else {
                theTria2 = elem;
                // theTria1 must be element with minimum ID
                if (theTria2->GetID() < theTria1->GetID()) std::swap(theTria2, theTria1);
                return true;
            }
        }
    }
...
bool SMESH_MeshEditor::InverseDiag(const SMDS_MeshNode *theNode1, const SMDS_MeshNode *theNode2)
{
    myLastCreatedElems.Clear();
    myLastCreatedNodes.Clear();
    ...
    if (!findTriangles(theNode1, theNode2, tr1, tr2)) return false;
    ...
    if ((tr1->GetEntityType() == SMDSEntity_Triangle)
        ...
        for (i = 0, it = tr1->nodesIterator(); it->more(); i++) {
            ...
            if (aNodes1[i] == theNode1) iA1 = i; // node A in tr1
        ...
        for (i = 0, it = tr2->nodesIterator(); it->more(); i++) {
            ...
            if (aNodes2[i] == theNode2) iB2 = i; // node B in tr2
            else if (aNodes2[i] != theNode1)
                i2 = i; // node 2
        }

        // nodes 1 and 2 should not be the same
        if (aNodes1[i1] == aNodes2[i2]) return false;
...
bool getQuadrangleNodes(const SMDS_MeshNode *theQuadNodes[], const SMDS_MeshNode *theNode1,
                        const SMDS_MeshNode *theNode2, const SMDS_MeshElement *tr1,
                        const SMDS_MeshElement *tr2)
{
    if (tr1->NbNodes() != tr2->NbNodes()) return false;
    ...
    while (i < 3) {
        ...
        bool isDiag = (n == theNode1 || n == theNode2);
        if (isDiag) {
            if (iFirstDiag < 0) iFirstDiag = iNode;
...
bool SMESH_MeshEditor::DeleteDiag(const SMDS_MeshNode *theNode1, const SMDS_MeshNode *theNode2)
{
    myLastCreatedElems.Clear();
    myLastCreatedNodes.Clear();
    ...
    if ((tr1->GetEntityType() == SMDSEntity_Triangle)
        ...
        if (!getQuadrangleNodes(aNodes, theNode1, theNode2, tr1, tr2)) return false;
        ...
        if (aShapeId) { aMesh->SetMeshElementOnShape(newElem, aShapeId); }
    ...
    // check case of quadratic faces
    if (tr1->GetEntityType() != SMDSEntity_Quad_Triangle) return false;
    if (tr2->GetEntityType() != SMDSEntity_Quad_Triangle) return false;
    ...
    vector<const SMDS_MeshNode *> N1;
    vector<const SMDS_MeshNode *> N2;
    if (!getNodesFromTwoTria(tr1, tr2, N1, N2)) return false;
    // now we receive following N1 and N2 (using numeration as above image)
    // tria1 : (1 2 4 5 9 7)  and  tria2 : (3 4 2 8 9 6)
    // i.e. first nodes from both arrays determ new diagonal
    ...
    const SMDS_MeshElement *newElem = 0;
    newElem = aMesh->AddFace(aNodes[0], aNodes[1], aNodes[2], aNodes[3], aNodes[4], aNodes[5],
                             aNodes[6], aNodes[7]);
    myLastCreatedElems.Append(newElem);
    AddToSameGroups(newElem, tr1, aMesh);
    int aShapeId = tr1->getshapeId();
...
bool SMESH_MeshEditor::Reorient(const SMDS_MeshElement *theElem)
{
    ...
    if (type < SMDSAbs_Edge || type > SMDSAbs_Volume) return false;

    const SMDSAbs_EntityType geomType = theElem->GetEntityType();
    if (geomType == SMDSEntity_Polyhedra) // polyhedron
    {
        const SMDS_VtkVolume *aPolyedre = dynamic_cast<const SMDS_VtkVolume *>(theElem);
        if (!aPolyedre) {
...
int SMESH_MeshEditor::Reorient2D(TIDSortedElemSet &theFaces, const gp_Dir &theDirection,
                                 const SMDS_MeshElement *theFace)
{
    ...
    if (theFaces.empty()) {
        ...
        while (fIt->more()) theFaces.insert(theFaces.end(), fIt->next());
    }

    // orient theFace according to theDirection
    gp_XYZ normal;
    SMESH_MeshAlgos::FaceNormal(theFace, normal, /*normalized=*/false);
    if (normal * theDirection.XYZ() < 0) nbReori += Reorient(theFace);
    ...
    while (!startFaces.empty()) {
        ...
        if (!visitedFaces.insert(theFace).second) continue;
        ...
        for (int i = 0; i < nbNodes; ++i) // loop on links of theFace
        {
            ...
            if (!linkIt_isNew.second) {
                ...
                while ((otherFace = SMESH_MeshAlgos::FindFaceInSet(
                            link.first, link.second, theFaces, avoidSet, &nodeInd1, &nodeInd2)))
...
int SMESH_MeshEditor::Reorient2DBy3D(TIDSortedElemSet &theFaces, TIDSortedElemSet &theVolumes,
                                     const bool theOutsideNormal)
{
    ...
    while (faceIt->more()) // loop on given faces
    {
        ...
        while (vIt->more()) {
            ...
            if (!checkedVolumes.insert(volume).second) continue;
            if (!theVolumes.empty() && !theVolumes.count(volume)) continue;
            ...
            if (isOutside != theOutsideNormal) nbReori += Reorient(face);
        }
    } // loop on given faces
                         ...
                         SMESH::Controls::NumericalFunctorPtr &theCrit)
{
    ...
    if (!theElem || !theCrit->GetPoints(theElem, P)) return 1e100;
                                 ...
                                 SMESH::Controls::NumericalFunctorPtr theCrit)
{
    ...
    for (itElem = theElems.begin(); itElem != theElems.end(); itElem++) {
        ...
        if (elem->NbCornerNodes() != 4) continue;
        ...
        else // split quadratic quadrangle
        {
            ...
            if (aNodes.size() == 9) {
                ...
                if (aBadRate1 <= aBadRate2) helper.AddTLinkNode(aNodes[0], aNodes[2], aNodes[8]);
                else
        ...
        if (aShapeId) aMesh->SetMeshElementOnShape(newElem1, aShapeId);
...
void SMESH_MeshEditor::QuadTo4Tri(TIDSortedElemSet &theElems)
{
    ...
    if (theElems.empty()) faceIt = GetMeshDS()->elementsIterator(SMDSAbs_Face);
        ...
        faceIt = elemSetIterator(theElems);
    ...
    while (faceIt->more()) {
        ...
        if (!quad || quad->NbCornerNodes() != 4) continue;
        ...
        if (quad->getshapeId() < 1) {
            ...
            if (!helper.GetSubShape().IsNull() && helper.GetSubShape().ShapeType() == TopAbs_FACE) {
        ...
        if (nodes.size() == 9) { nCentral = nodes.back(); }
        else {
            size_t iN = 0;
            if (F.IsNull()) {
                for (; iN < nodes.size(); ++iN) xyz[iN] = SMESH_TNodeXYZ(nodes[iN]);

                for (; iN < 8; ++iN) // mid-side points of a linear qudrangle
                    xyz[iN] = 0.5 * (xyz[iN - 4] + xyz[(iN - 3) % 4]);

                xyz[8] = helper.calcTFI(0.5, 0.5, xyz[0], xyz[1], xyz[2], xyz[3], xyz[4], xyz[5],
                                        xyz[6], xyz[7]);
            }
            else {
                ...
                uv[8] = helper.calcTFI(0.5, 0.5, uv[0], uv[1], uv[2], uv[3], uv[4], uv[5], uv[6],
                                       uv[7]);
            ...
            nCentral =
                helper.AddNode(xyz[8].X(), xyz[8].Y(), xyz[8].Z(), /*id=*/0, uv[8].X(), uv[8].Y());
        ...
        if (helper.GetIsQuadratic()) helper.AddTLinks(static_cast<const SMDS_MeshFace *>(quad));

        for (int i = 0; i < 4; ++i) {
            SMDS_MeshElement *tria = helper.AddFace(nodes[i], nodes[(i + 1) % 4], nCentral);
                                ...
                                SMESH::Controls::NumericalFunctorPtr theCrit)
{
    ...
    if (!theCrit.get()) return -1;

    if (!theQuad || theQuad->GetType() != SMDSAbs_Face) return -1;

    if (theQuad->NbNodes() == 4 || (theQuad->NbNodes() == 8 && theQuad->IsQuadratic())) {
        ...
        int i = 0;
        //while (itN->more())
        while (i < 4) { aNodes[i++] = static_cast<const SMDS_MeshNode *>(itN->next()); }
        // compare two sets of possible triangles
        double aBadRate1, aBadRate2; // to what extent a set is bad
        SMDS_FaceOfNodes tr1(aNodes[0], aNodes[1], aNodes[2]);
        SMDS_FaceOfNodes tr2(aNodes[2], aNodes[3], aNodes[0]);
...
const int theHexTo5_1[5 * 4 + 1] = {0, 1, 2, 5, 0, 4, 5, 7, 0, 2, 3, 7, 2, 5, 6, 7, 0, 5, 2, 7, -1};
const int theHexTo5_2[5 * 4 + 1] = {1, 2, 3, 6, 1, 4, 5, 6, 0, 1, 3, 4, 3, 4, 6, 7, 1, 3, 4, 6, -1};
const int *theHexTo5[2] = {theHexTo5_1, theHexTo5_2};

const int theHexTo6_1[6 * 4 + 1] = {1, 5, 6, 0, 0, 1, 2, 6, 0, 4, 5, 6, 0,
                                    4, 6, 7, 0, 2, 3, 6, 0, 3, 7, 6, -1};
const int theHexTo6_2[6 * 4 + 1] = {2, 6, 7, 1, 1, 2, 3, 7, 1, 5, 6, 7, 1,
                                    5, 7, 4, 1, 3, 0, 7, 1, 0, 4, 7, -1};
const int theHexTo6_3[6 * 4 + 1] = {3, 7, 4, 2, 2, 3, 0, 4, 2, 6, 7, 4, 2,
                                    6, 4, 5, 2, 0, 1, 4, 2, 1, 5, 4, -1};
const int theHexTo6_4[6 * 4 + 1] = {0, 4, 5, 3, 3, 0, 1, 5, 3, 7, 4, 5, 3,
                                    7, 5, 6, 3, 1, 2, 5, 3, 2, 6, 5, -1};
const int *theHexTo6[4] = {theHexTo6_1, theHexTo6_2, theHexTo6_3, theHexTo6_4};

const int thePyraTo2_1[2 * 4 + 1] = {0, 1, 2, 4, 0, 2, 3, 4, -1};
const int thePyraTo2_2[2 * 4 + 1] = {1, 2, 3, 4, 1, 3, 0, 4, -1};
const int *thePyraTo2[2] = {thePyraTo2_1, thePyraTo2_2};

const int thePentaTo3_1[3 * 4 + 1] = {0, 1, 2, 3, 1, 3, 4, 2, 2, 3, 4, 5, -1};
const int thePentaTo3_2[3 * 4 + 1] = {1, 2, 0, 4, 2, 4, 5, 0, 0, 4, 5, 3, -1};
const int thePentaTo3_3[3 * 4 + 1] = {2, 0, 1, 5, 0, 5, 3, 1, 1, 5, 3, 4, -1};
const int thePentaTo3_4[3 * 4 + 1] = {0, 1, 2, 3, 1, 3, 4, 5, 2, 3, 1, 5, -1};
const int thePentaTo3_5[3 * 4 + 1] = {1, 2, 0, 4, 2, 4, 5, 3, 0, 4, 2, 3, -1};
const int thePentaTo3_6[3 * 4 + 1] = {2, 0, 1, 5, 0, 5, 3, 4, 1, 5, 0, 4, -1};
...
const int theHexTo2Prisms_BT_1[6 * 2 + 1] = {0, 1, 3, 4, 5, 7, 1, 2, 3, 5, 6, 7, -1};
const int theHexTo2Prisms_BT_2[6 * 2 + 1] = {0, 1, 2, 4, 5, 6, 0, 2, 3, 4, 6, 7, -1};
const int *theHexTo2Prisms_BT[2] = {theHexTo2Prisms_BT_1, theHexTo2Prisms_BT_2};

const int theHexTo2Prisms_LR_1[6 * 2 + 1] = {1, 0, 4, 2, 3, 7, 1, 4, 5, 2, 7, 6, -1};
const int theHexTo2Prisms_LR_2[6 * 2 + 1] = {1, 0, 4, 2, 3, 7, 1, 4, 5, 2, 7, 6, -1};
const int *theHexTo2Prisms_LR[2] = {theHexTo2Prisms_LR_1, theHexTo2Prisms_LR_2};

const int theHexTo2Prisms_FB_1[6 * 2 + 1] = {0, 3, 4, 1, 2, 5, 3, 7, 4, 2, 6, 5, -1};
const int theHexTo2Prisms_FB_2[6 * 2 + 1] = {0, 3, 7, 1, 2, 7, 0, 7, 4, 1, 6, 5, -1};
...
struct TSplitMethod {
    ...
    ~TSplitMethod()
    {
        if (_ownConn) delete[] _connectivity;
        _connectivity = 0;
    }
    bool hasFacet(const TTriangleFacet &facet) const
    {
        if (_nbCorners == 4) {
            ...
            for (; tetConn[0] >= 0; tetConn += 4)
                if ((facet.contains(tetConn[0]) + facet.contains(tetConn[1])
                     + facet.contains(tetConn[2]) + facet.contains(tetConn[3]))
                    == 3)
                    return true;
        }
        else // prism, _nbCorners == 6
        {
            ...
            for (; prismConn[0] >= 0; prismConn += 6) {
                if ((facet.contains(prismConn[0]) && facet.contains(prismConn[1])
                     && facet.contains(prismConn[2]))
                    || (facet.contains(prismConn[3]) && facet.contains(prismConn[4])
...
TSplitMethod getTetraSplitMethod(SMDS_VolumeTool &vol, const int theMethodFlags)
{
    ...
    for (int iF = 0; iF < vol.NbFaces(); ++iF) {
        ...
        if (nbNodes == 4) {
            ...
            else if (t123.hasAdjacentVol(vol.Element()))
                triaSplits.push_back(t123);
        }
        else {
            int iCom = 0; // common node of triangle faces to split into
            for (int iVar = 0; iVar < nbNodes; ++iVar, ++iCom) {
                TTriangleFacet t012(nInd[iQ * (iCom)], nInd[iQ * ((iCom + 1) % nbNodes)],
                                    nInd[iQ * ((iCom + 2) % nbNodes)]);
                TTriangleFacet t023(nInd[iQ * (iCom)], nInd[iQ * ((iCom + 2) % nbNodes)],
        ...
        if (!triaSplits.empty()) hasAdjacentSplits = true;
    }
    ...
    if (!vol.Element()->IsPoly() && !is24TetMode) {
        ...
        switch (vol.Element()->GetEntityType()) {
            ...
            case SMDSEntity_Quad_Pyramid:
                connVariants = thePyraTo2;
                nbTet = 2;
                break;
            case SMDSEntity_Penta:
            case SMDSEntity_Quad_Penta:
                connVariants = thePentaTo3;
                nbTet = 3;
                nbVariants = 6;
                break;
            default: nbVariants = 0;
        }
        for (int variant = 0; variant < nbVariants && method._nbSplits == 0; ++variant) {
            ...
            if (hasAdjacentSplits && method._nbSplits > 0) {
                ...
                if (!facetCreated) method = TSplitMethod(0); // incompatible method
            }
        }
    }
    if (method._nbSplits < 1) {
        ...
        for (int iF = 0; iF < vol.NbFaces(); ++iF) {
            ...
            if (iCommon >= nbNodes) iCommon = 0; // something wrong
...
TSplitMethod getPrismSplitMethod(SMDS_VolumeTool &vol, const int methodFlags,
                                 const int facetToSplit)
{
    ...
    for (int is2nd = 0; is2nd < 2; ++is2nd) {
        ...
        TTriangleFacet t123(nInd[1 * iQ], nInd[2 * iQ], nInd[3 * iQ]);
        TTriangleFacet *t;
        if (t012.hasAdjacentVol(vol.Element(), SMDSGeom_PENTA)) t = &t012;
        ...
        for (int variant = 0; variant < nbVariants; ++variant) {
            ...
            if (method.hasFacet(*t)) return method;
        }
    }
    ...
    for (int variant = 0; variant < nbVariants; ++variant)
        for (int is2nd = 0; is2nd < 2; ++is2nd) {
            ...
            SMDS_FaceOfNodes tria(nodes[t->_n1], nodes[t->_n2], nodes[t->_n3]);
                                    ...
                                    const SMDSAbs_GeometryType geom) const
{
    ...
    while (volIt1->more()) {
        ...
        if (v->GetGeomType() != geom) continue;
        ...
        if (ind2 < 0 || lastCornerInd < ind2) continue;
        const int ind3 = v->GetNodeIndex(n3);
        if (ind3 < 0 || lastCornerInd < ind3) continue;
        return true;
    }
    return false;
}
...
struct TVolumeFaceKey: pair<pair<int, int>, pair<int, int>> {
    TVolumeFaceKey(SMDS_VolumeTool &vol, int iF)
    {
        ...
        for (int i = 0; i < nbNodes; i += iQ) sortedNodes.insert(fNodes[i]);
...
void SMESH_MeshEditor::SplitVolumes(const TFacetOfElem &theElems, const int theMethodFlags)
{
    ...
    for (; elem2facet != theElems.end(); ++elem2facet) {
        ...
        if (elem->GetType() != SMDSAbs_Volume) continue;
        const SMDSAbs_EntityType geomType = elem->GetEntityType();
        if (geomType == SMDSEntity_Tetra || geomType == SMDSEntity_Quad_Tetra) continue;

        if (!volTool.Set(elem, /*ignoreCentralNodes=*/false)) continue; // strange...

        TSplitMethod splitMethod =
            (facetToSplit < 0 ? getTetraSplitMethod(volTool, theMethodFlags)
        ...
        if (!splitMethod._faceBaryNode.empty()) {
            ...
            for (; iF_n != splitMethod._faceBaryNode.end(); ++iF_n) {
                map<TVolumeFaceKey, const SMDS_MeshNode *>::iterator f_n =
                    volFace2BaryNode
                        .insert(make_pair(TVolumeFaceKey(volTool, iF_n->first), iF_n->second))
                        .first;
                if (!f_n->second) {
        ...
        if (splitMethod._nbCorners == 4) // tetra
            for (int i = 0; i < splitMethod._nbSplits; ++i, volConn += splitMethod._nbCorners)
                newElems.Append(splitVols[i] =
                                    helper.AddVolume(nodes[volConn[0]], nodes[volConn[1]],
                                                     nodes[volConn[2]], nodes[volConn[3]]));
        else // prisms
            for (int i = 0; i < splitMethod._nbSplits; ++i, volConn += splitMethod._nbCorners)
                newElems.Append(splitVols[i] = helper.AddVolume(
                                    nodes[volConn[0]], nodes[volConn[1]], nodes[volConn[2]],
                                    nodes[volConn[3]], nodes[volConn[4]], nodes[volConn[5]]));
        ...
        for (int iF = 0; iF < volTool.NbFaces(); ++iF) {
            ...
            vector<const SMDS_MeshNode *> fNodes(
                volTool.GetFaceNodes(iF), volTool.GetFaceNodes(iF) + volTool.NbFaceNodes(iF));
                ...
                if (iF_n != splitMethod._faceBaryNode.end()) {
                    ...
                    if (fSubMesh) // update position of the bary node on geometry
                    {
                        ...
                        if (!s.IsNull() && s.ShapeType() == TopAbs_FACE) {
                            ...
                            double distXYZ[4];
                            if (!fHelper.CheckNodeUV(TopoDS::Face(s), baryNode, uv, /*tol=*/1e-7,
                                                     /*force=*/true, distXYZ)
                                && uv.X() < 1e100) {
                    ...
                    if (facet == facets.end()) break;
                    for (; facet != facets.end(); ++facet) {
                        if (!volTool.IsFaceExternal(iF)) swap(facet->_n2, facet->_n3);
                        triangles.push_back(helper.AddFace(
                            volNodes[facet->_n1], volNodes[facet->_n2], volNodes[facet->_n3]));
                    }
                }
                for (int i = 0; i < triangles.size(); ++i) {
                    if (!triangles[i]) continue;
                    if (fSubMesh) fSubMesh->AddElement(triangles[i]);
        ...
        if (geomType == SMDSEntity_TriQuad_Hexa) {
            ...
            for (int i = 20; i < volTool.NbNodes(); ++i)
                if (volNodes[i]->NbInverseElements() == 0) GetMeshDS()->RemoveNode(volNodes[i]);
        }
...
void SMESH_MeshEditor::GetHexaFacetsToSplit(TIDSortedElemSet &theHexas,
                                            const gp_Ax1 &theFacetNormal, TFacetOfElem &theFacets)
{
#define THIS_METHOD "SMESH_MeshEditor::GetHexaFacetsToSplit(): "
    ...
    const SMDS_MeshElement *startHex;
    {
        ...
        SMDS_ElemIteratorPtr elemIt = SMDS_ElemIteratorPtr(new TElemSetIter(
            theHexas.begin(), theHexas.end(), SMDS_MeshElement::GeomFilter(SMDSGeom_HEXA)));
        ...
        if (!startHex) throw SALOME_Exception(THIS_METHOD "startHex not found");
    }
    ...
    if (facetID < 0) throw SALOME_Exception(THIS_METHOD "facet of startHex not found");
    ...
    while (startHex) {
        ...
        for (int is2nd = 0; is2nd < 2; ++is2nd) {
            ...
            {
                vTool.Set(curHex);
                if (vTool.IsFreeFace(curFacet, &curHex)) { curHex = 0; }
                else {
            ...
            while (curHex) {
                ...
                if (vTool.IsFreeFace(oppFacet, &curHex)) { curHex = 0; }
                else {
                    // get a new curFacet
        ...
        while (!startHex && fIt != facetsToCheck.end()) {
            ...
            vTool.Set(hex);
            if (vTool.IsFreeFace(lateralFacet, &curHex) || curHex->GetGeomType() != SMDSGeom_HEXA)
                continue;
            if (!allHex && !theHexas.count(curHex)) continue;
...
void selectNodes(const vector<const SMDS_MeshNode *> &srcNodes,
                 vector<const SMDS_MeshNode *> *tgtNodesVec, const int *interlace,
                 const int nbElems, const int nbNodes, SMESHDS_Mesh *mesh = 0,
                 ...
                 SMDSAbs_ElementType type = SMDSAbs_All)
{
    for (int iE = 0; iE < nbElems; ++iE) {
        ...
        for (int iN = 0; iN < nbNodes; ++iN) elemNodes[iN] = srcNodes[select[iN]];
    }
        ...
        for (elemIt = elemQueue.begin(); elemIt != elemQueue.end(); ++elemIt) {
            ...
            switch (elem->GetEntityType()) {
                case SMDSEntity_TriQuad_Hexa: // HEX27
                {
                    ...
                    static int vInd[8][8] = {
                        {0, 8, 20, 11, 16, 21, 26, 24},  {1, 9, 20, 8, 17, 22, 26, 21},
                        {2, 10, 20, 9, 18, 23, 26, 22},  {3, 11, 20, 10, 19, 24, 26, 23},
                        {16, 21, 26, 24, 4, 12, 25, 15}, {17, 22, 26, 21, 5, 13, 25, 12},
                        {18, 23, 26, 22, 6, 14, 25, 13}, {19, 24, 26, 23, 7, 15, 25, 14}};
                    selectNodes(elemNodes, &splitNodes[0], &vInd[0][0], nbElems, nbNodes);

                    // add boundary faces to elemQueue
                    static int fInd[6][9] = {
                        {0, 1, 2, 3, 8, 9, 10, 11, 20},   {4, 5, 6, 7, 12, 13, 14, 15, 25},
                        {0, 1, 5, 4, 8, 17, 12, 16, 21},  {1, 2, 6, 5, 9, 18, 13, 17, 22},
                        {2, 3, 7, 6, 10, 19, 14, 18, 23}, {3, 0, 4, 7, 11, 16, 15, 19, 24}};
                    selectNodes(elemNodes, &subNodes[0], &fInd[0][0], 6, 9, mesh, &elemQueue,
                                SMDSAbs_Face);
                    ...
                    selectNodes(elemNodes, &subNodes[0], &eInd[0][0], 12, 3, mesh, &elemQueue,
                                SMDSAbs_Edge);
                    break;
                }
                case SMDSEntity_BiQuad_Triangle: // TRIA7
                {
                    ...
                    selectNodes(elemNodes, &subNodes[0], &eInd[0][0], 3, 3, mesh, &elemQueue,
                                SMDSAbs_Edge);
                    break;
                }
                case SMDSEntity_BiQuad_Quadrangle: // QUAD9
                {
                    ...
                    selectNodes(elemNodes, &subNodes[0], &eInd[0][0], 4, 3, mesh, &elemQueue,
                                SMDSAbs_Edge);
                    break;
                }
                case SMDSEntity_Quad_Edge: {
                    if (elemIt == elemQueue.begin()) continue; // an elem is in theElems
                    elemNodes.assign(elem->begin_nodes(), elem->end_nodes());
                    nbElems = 2;
                    nbNodes = 2;
                    elemType = &segType;
            ...
            if (subMesh)
                for (size_t i = 0; i < splitElems.size(); ++i) subMesh->AddElement(splitElems[i]);
        }
    }
}
...
void SMESH_MeshEditor::AddToSameGroups(const SMDS_MeshElement *elemToAdd,
                                       const SMDS_MeshElement *elemInGroups, SMESHDS_Mesh *aMesh)
{
    ...
    if (!groups.empty()) {
        ...
        for (; grIt != groups.end(); grIt++) {
            ...
            if (group && group->Contains(elemInGroups)) group->SMDSGroup().Add(elemToAdd);
        }
    }
}
...
//=======================================================================
void SMESH_MeshEditor::RemoveElemFromGroups(const SMDS_MeshElement *removeelem, SMESHDS_Mesh *aMesh)
{
    const set<SMESHDS_GroupBase *> &groups = aMesh->GetGroups();
    if (!groups.empty()) {
        set<SMESHDS_GroupBase *>::const_iterator GrIt = groups.begin();
...
void SMESH_MeshEditor::ReplaceElemInGroups(const SMDS_MeshElement *elemToRm,
                                           const SMDS_MeshElement *elemToAdd, SMESHDS_Mesh *aMesh)
{
    const set<SMESHDS_GroupBase *> &groups = aMesh->GetGroups();
    if (!groups.empty()) {
        set<SMESHDS_GroupBase *>::const_iterator grIt = groups.begin();
    ...
    if (!groups.empty()) {
        ...
        for (; grIt != groups.end(); grIt++) {
            ...
            if (group && group->SMDSGroup().Remove(elemToRm))
                for (int i = 0; i < elemToAdd.size(); ++i) group->SMDSGroup().Add(elemToAdd[i]);
        }
    }
}
...
bool SMESH_MeshEditor::QuadToTri(TIDSortedElemSet &theElems, const bool the13Diag)
{
    myLastCreatedElems.Clear();
    myLastCreatedNodes.Clear();
    ...
    for (itElem = theElems.begin(); itElem != theElems.end(); itElem++) {
        ...
        if (elem->NbNodes() == 4) {
            ...
            int i = 0;
            while (itN->more()) aNodes[i++] = static_cast<const SMDS_MeshNode *>(itN->next());
        ...
        if (elem->NbNodes() == 8 && elem->IsQuadratic()) {
            ...
            if (aShapeId != helper.GetSubShapeID()) {
                surface.Nullify();
                TopoDS_Shape shape;
                if (aShapeId > 0) shape = aMesh->IndexToShape(aShapeId);
                if (!shape.IsNull() && shape.ShapeType() == TopAbs_FACE) {
                    TopoDS_Face face = TopoDS::Face(shape);
                    surface = BRep_Tool::Surface(face);
                    if (!surface.IsNull()) helper.SetSubShape(shape);
                }
            }
            ...
            gp_XYZ p(0, 0, 0);
            if (surface.IsNull()) {
                for (i = 0; i < 4; i++) p += gp_XYZ(aNodes[i]->X(), aNodes[i]->Y(), aNodes[i]->Z());
                p /= 4;
            }
            else {
                TopoDS_Face geomFace = TopoDS::Face(helper.GetSubShape());
                gp_XY uv(0, 0);
                for (i = 0; i < 4; i++) uv += helper.GetNodeUV(geomFace, aNodes[i], inFaceNode);
                uv /= 4.;
            ...
            if (the13Diag) {
                newElem1 =
                    aMesh->AddFace(aNodes[2], aNodes[3], aNodes[0], aNodes[6], aNodes[7], newN);
                newElem2 =
                    aMesh->AddFace(aNodes[2], aNodes[0], aNodes[1], newN, aNodes[4], aNodes[5]);
            }
            else {
                newElem1 =
                    aMesh->AddFace(aNodes[3], aNodes[0], aNodes[1], aNodes[7], aNodes[4], newN);
                newElem2 =
                    aMesh->AddFace(aNodes[3], aNodes[1], aNodes[2], newN, aNodes[5], aNodes[6]);
            }
            myLastCreatedElems.Append(newElem1);
            myLastCreatedElems.Append(newElem2);
            // put a new triangle on the same shape and add to the same groups
...
double getAngle(const SMDS_MeshElement *tr1, const SMDS_MeshElement *tr2, const SMDS_MeshNode *n1,
                const SMDS_MeshNode *n2)
{
    ...
    if (!SMESH::Controls::NumericalFunctor::GetPoints(tr1, P1)
        ...
        return angle;
    gp_Vec N1, N2;
    if (!tr1->IsQuadratic()) N1 = gp_Vec(P1(2) - P1(1)) ^ gp_Vec(P1(3) - P1(1));
    else
        N1 = gp_Vec(P1(3) - P1(1)) ^ gp_Vec(P1(5) - P1(1));
    if (N1.SquareMagnitude() <= gp::Resolution()) return angle;
    if (!tr2->IsQuadratic()) N2 = gp_Vec(P2(2) - P2(1)) ^ gp_Vec(P2(3) - P2(1));
    else
        N2 = gp_Vec(P2(3) - P2(1)) ^ gp_Vec(P2(5) - P2(1));
    if (N2.SquareMagnitude() <= gp::Resolution()) return angle;
        ...
        while (it->more()) {
            ...
            if (n == n1 || n == n2) {
                if (iDiag < 0) iDiag = i;
                    ...
                    if (i - iDiag == 1) nFirst[t] = (n == n1 ? n2 : n1);
                    else
                        nFirst[t] = n;
                    break;
                }
    ...
    if (nFirst[0] == nFirst[1]) N2.Reverse();
...
{
public:
    LinkID_Gen(const SMESHDS_Mesh *theMesh) : myMesh(theMesh), myMaxID(theMesh->MaxNodeID() + 1) {}
    ...
    bool GetNodes(const long theLinkID, const SMDS_MeshNode *&theNode1,
                                 ...
                                 const double theMaxAngle)
{
    ...
    for (itLE = mapLi_listEl.begin(); itLE != mapLi_listEl.end(); itLE++) {
        ...
        if (nbElems < 2) {
            ...
            if (mapEl_setLi[elem].empty()) mapEl_setLi.erase(elem);
        }
    }
        ...
        while (startElem || !startLinks.empty()) {
            while (!startElem && !startLinks.empty()) {
                ...
                if (itLE != mapLi_listEl.end()) {
                    ...
                    for (; itE != listElem.end(); itE++)
                        if (mapEl_setLi.find((*itE)) != mapEl_setLi.end()) startElem = (*itE);
            ...
            if (startElem) {
                ...
                for (itLi = setLi.begin(); itLi != setLi.end(); itLi++) {
                    ...
                    itLE = mapLi_listEl.find(link);
                    if (itLE == mapLi_listEl.end()) continue;

                    const SMDS_MeshElement *elem = (*itLE).second.front();
                    if (elem == tr1) elem = (*itLE).second.back();
                    mapLi_listEl.erase(itLE);
                    if (mapEl_setLi.find(elem) == mapEl_setLi.end()) continue;
                    if (tr2) {
                        tr3 = elem;
                        link13 = &link;
                    }
                    ...
                    for (it = links.begin(); it != links.end(); it++) {
                        ...
                        if (link2 != link) startLinks.push_back(link2);
                    }
                }
                ...
                if (tr2) {
                    ...
                    if (tr2 && getQuadrangleNodes(n12, linkNode1, linkNode2, tr1, tr2)) Ok12 = true;
                }
                if (tr3) {
                    linkNode1 = link13->first;
                    linkNode2 = link13->second;
                    if (tr3 && getQuadrangleNodes(n13, linkNode1, linkNode2, tr1, tr3)) Ok13 = true;
                }
                ...
                if (Ok12 && Ok13) {
                    ...
                    if (aBadRate13 < aBadRate12) Ok12 = false;
                    else
                        Ok13 = false;
                }
                ...
                if (Ok12) {
                    ...
                    if (tr1->NbNodes() == 3) {
                        ...
                        if (N1.size() == 7 || N2.size() == 7) // biquadratic
                            newElem =
                                aMesh->AddFace(aNodes[0], aNodes[1], aNodes[2], aNodes[3],
                        ...
                        aMesh->RemoveElement(tr2);
                        // remove middle node (9)
                        if (N1[4]->NbInverseElements() == 0) aMesh->RemoveNode(N1[4]);
...
void SMESH_MeshEditor::GetLinkedNodes(const SMDS_MeshNode *theNode, TIDSortedElemSet &linkedNodes,
                                      SMDSAbs_ElementType type)
{
    SMDS_ElemIteratorPtr elemIt = theNode->GetInverseElementIterator(type);
    while (elemIt->more()) {
        const SMDS_MeshElement *elem = elemIt->next();
        if (elem->GetType() == SMDSAbs_0DElement) continue;
        ...
        if (elem->GetType() == SMDSAbs_Volume) {
            ...
            while (nodeIt->more()) {
                const SMDS_MeshNode *n = cast2Node(nodeIt->next());
                if (theNode != n && vol.IsLinked(theNode, n)) linkedNodes.insert(n);
            }
        }
        else {
...
void laplacianSmooth(const SMDS_MeshNode *theNode, const Handle(Geom_Surface) & theSurface,
...
void centroidalSmooth(const SMDS_MeshNode *theNode, const Handle(Geom_Surface) & theSurface,
                      map<const SMDS_MeshNode *, gp_XY *> &theUVMap)
{
...
void SMESH_MeshEditor::Smooth(TIDSortedElemSet &theElems, set<const SMDS_MeshNode *> &theFixedNodes,
                              const SmoothMethod theSmoothMethod, const int theNbIterations,
                              double theTgtAspectRatio, const bool the2D)
{
    myLastCreatedElems.Clear();
    myLastCreatedNodes.Clear();
    ...
    if (theTgtAspectRatio < 1.0) theTgtAspectRatio = 1.0;
    ...
    if (the2D)
        for (itElem = theElems.begin(); itElem != theElems.end(); itElem++) {
            ...
            if (fId && faceIdSet.find(fId) == faceIdSet.end() && aMesh->MeshElements(fId)) {
                TopoDS_Shape F = aMesh->IndexToShape(fId);
                if (!F.IsNull() && F.ShapeType() == TopAbs_FACE) faceIdSet.insert(fId);
            }
        }
    ...
    for (; fId != faceIdSet.rend(); ++fId) {
        ...
        if (*fId) {
            ...
            if (isUPeriodic) surface->UPeriod();
            isVPeriodic = surface->IsVPeriodic();
            if (isVPeriodic) surface->VPeriod();
        ...
        while (itElem != theElems.end()) {
            ...
            if (!isQuadratic) isQuadratic = elem->IsQuadratic();
            ...
            while (nn++ < nbn) {
                ...
                if (posType != SMDS_TOP_EDGE && posType != SMDS_TOP_VERTEX
                    ...
                    if (all) setMovableNodes.insert(node);
                    else
                        checkBoundaryNodes = true;
                }
                if (posType == SMDS_TOP_3DSPACE) checkBoundaryNodes = true;
            }
            ...
            while (nn++ < nbn) {
                node = static_cast<const SMDS_MeshNode *>(itN->next());
                if (node->GetPosition()->GetDim() == 2) nodeInFace = node;
                if (uvMap.find(node) == uvMap.end()) uvCheckNodes.push_back(node);
            ...
            for (; n != uvCheckNodes.end(); ++n) {
                ...
                if (project) { // compute new UV
                    ...
                    if (!getClosestUV(projector, pNode, newUV)) {
                        ...
                        if (isUPeriodic) newUV.SetX(ElCLib::InPeriod(newUV.X(), u1, u2));
                        if (isVPeriodic) newUV.SetY(ElCLib::InPeriod(newUV.Y(), v1, v2));
                        // check new UV
                        // if ( posType != SMDS_TOP_3DSPACE )
        ...
        if (!faceSubMesh || nbElemOnFace != faceSubMesh->NbElements()) checkBoundaryNodes = true;
        ...
        if (!surface.IsNull()) {
            ...
            for (; eExp.More(); eExp.Next()) {
                ...
                // assure uv1 < uv2
                if (uv1.Coord(iPar) > uv2.Coord(iPar)) std::swap(uv1, uv2);
                ...
                while (nSeamIt->more()) {
                    ...
                    if (!isQuadratic || !IsMedium(node)) seamNodes.push_back(node);
                }
                ...
                for (; vExp.More(); vExp.Next()) {
                    ...
                    if (sm) {
                        nSeamIt = sm->GetNodes();
                        while (nSeamIt->more()) seamNodes.push_back(nSeamIt->next());
                    }
                }
                ...
                for (; noSeIt != seamNodes.end(); ++noSeIt) {
                    ...
                    while (eIt->more()) {
                        ...
                        while (nn++ < nbn) {
                            const SMDS_MeshNode *n =
                                static_cast<const SMDS_MeshNode *>(nIt->next());
                            if (n == nSeam || setMovableNodes.find(n) == setMovableNodes.end())
                                continue;
                            ...
                            if (Abs(uv1.Coord(iPar) - x) > Abs(uv2.Coord(iPar) - x)) {
        ...
        for (it = 0; it < theNbIterations; it++) {
            ...
            for (; nodeToMove != setMovableNodes.end(); nodeToMove++) {
                ...
                if (aDispl > maxDisplacement) maxDisplacement = aDispl;
            }
            ...
            for (; elemIt != elemsOnFace.end(); ++elemIt) {
                ...
                if (aQualityFunc.GetPoints(elem, aPoints)) {
                    ...
                    if (aValue > maxRatio) maxRatio = aValue;
                }
            }
            ...
            if (it + 1 == theNbIterations) { MESSAGE("-- Iteration limit exceeded --"); }
        } // smoothing iterations

        MESSAGE(" Face id: " << *fId << " Nb iterstions: " << it << " Displacement: "
                             << maxDisplacement << " Aspect Ratio " << maxRatio);
            ...
            for (; elemIt != elemsOnFace.end(); ++elemIt) {
                ...
                if (QF->IsQuadratic()) {
                    ...
                    for (size_t i = 1; i < nodes.size(); i += 2) // i points to a medium node
                    {
                        if (!surface.IsNull()) {
                            gp_XY uv1 =
                                helper.GetNodeUV(face, nodes[i - 1], nodes[i + 1], &checkUV);
                            gp_XY uv2 =
                                helper.GetNodeUV(face, nodes[i + 1], nodes[i - 1], &checkUV);
                            ...
                            xyz =
                                0.5 * (SMESH_TNodeXYZ(nodes[i - 1]) + SMESH_TNodeXYZ(nodes[i + 1]));
                        }
...
bool isReverse(const SMDS_MeshElement *face, const vector<const SMDS_MeshNode *> &prevNodes,
               const vector<const SMDS_MeshNode *> &nextNodes, const int iNotSame)
{
...
{
    if (!theElemSets[0].empty() && (*theElemSets[0].begin())->GetType() == SMDSAbs_Node) {
        std::swap(theElemSets[0], theElemSets[1]);
    }
    else if (!theElemSets[1].empty() && (*theElemSets[1].begin())->GetType() != SMDSAbs_Node) {
        std::swap(theElemSets[0], theElemSets[1]);
    }
}
} // namespace
...
void SMESH_MeshEditor::sweepElement(const SMDS_MeshElement *elem,
                                    ...
                                    list<const SMDS_MeshElement *> &newElems, const int nbSteps,
                                    SMESH_SequenceOfElemPtr &srcElements)
{
    ...
    for (iNode = 0; iNode < nbNodes; iNode++) {
        ...
        if (prevNod[iNode] != nextNod[iNode]) nbDouble += !isSingleNode[iNode];

        if (iNode < nbCorners) { // check corners only
            if (prevNod[iNode] == nextNod[iNode]) sames[nbSame++] = iNode;
            else
                iNotSameNode = iNode;
        }
    }
    ...
    if (elem->GetType() == SMDSAbs_Face && !isReverse(elem, prevNod, nextNod, iNotSameNode)) {
        ...
        if ((e = SMESH_MeshAlgos::FindFaceInSet(nextNod[0], prevNod[0], dummy, dummy, &i1, &i2))
            ...
            || (e = SMESH_MeshAlgos::FindFaceInSet(prevNod[0], prevNod[1], dummy, dummy, &i1,
                                                   &i2))) {
    ...
    for (int iStep = 0; iStep < nbSteps; iStep++) {
        ...
        /*if(!elem->IsPoly())*/ {
            switch (baseType) {
                ...
                case SMDSEntity_Node: { // sweep NODE
                    if (nbSame == 0) {
                        if (isSingleNode[0]) aNewElem = aMesh->AddEdge(prevNod[0], nextNod[0]);
                        else
                ...
                case SMDSEntity_Edge: { // sweep EDGE
                    ...
                    else // ---> polygon
                    {
                        ...
                        switch (poly_nodes.size()) {
                            case 3:
                                aNewElem =
                                    aMesh->AddFace(poly_nodes[0], poly_nodes[1], poly_nodes[2]);
                                break;
                            case 4:
                                aNewElem = aMesh->AddFace(poly_nodes[0], poly_nodes[1],
                                                          poly_nodes[2], poly_nodes[3]);
                                break;
                            default: aNewElem = aMesh->AddPolygonalFace(poly_nodes);
                        }
                    }
                    break;
                }
                case SMDSEntity_Triangle: // TRIANGLE --->
                {
                    ...
                    if (nbSame == 0) // ---> pentahedron
                        aNewElem = aMesh->AddVolume(prevNod[0], prevNod[1], prevNod[2], nextNod[0],
                                                    nextNod[1], nextNod[2]);
                ...
                case SMDSEntity_Quad_Edge: // sweep quadratic EDGE --->
                {
                    ...
                    if (nbDouble + nbSame == 2) {
                        ...
                        if (nbSame == 0) { // ---> bi-quadratic quadrangle
                            aNewElem = aMesh->AddFace(prevNod[0], prevNod[1], nextNod[1],
                                                      nextNod[0], prevNod[2], midlNod[1],
                                                      nextNod[2], midlNod[0], midlNod[2]);
                        }
                    }
                    else
                        return;
                ...
                case SMDSEntity_BiQuad_Triangle: /* ??? */ {
                    ...
                    if (nbSame == 0) {
                        ...
                        aNewElem = aMesh->AddVolume(prevNod[0], prevNod[1], prevNod[2], nextNod[0],
                                                    nextNod[1], nextNod[2], prevNod[3], prevNod[4],
                                                    prevNod[5], nextNod[3], nextNod[4], nextNod[5],
                        ...
                        int i1a = i1 + 3;
                        int i01 = i0 + 3;
                        aNewElem = aMesh->AddVolume(
                            prevNod[i1], prevNod[i0], nextNod[i0], nextNod[i1], prevNod[apex],
                            prevNod[i01], midlNod[i0], nextNod[i01], midlNod[i1], prevNod[i1a],
                            prevNod[i0a], nextNod[i0a], nextNod[i1a]);
                    }
                    else if (nbSame == 2) {
                        ...
                        int n31 = n3 + 3;
                        aNewElem = aMesh->AddVolume(
                            prevNod[n1], prevNod[n2], prevNod[n3], nextNod[n1], prevNod[n12],
                            prevNod[n23], prevNod[n31], midlNod[n1], nextNod[n12], nextNod[n31]);
                    }
                    break;
                }
                case SMDSEntity_Quad_Quadrangle: { // sweep Quadratic QUADRANGLE --->
                    if (nbSame == 0) {
                        ...
                        int n25 = n5 + 4;
                        aNewElem = aMesh->AddVolume(
                            prevNod[n1], prevNod[n2], nextNod[n2], prevNod[n4], prevNod[n5],
                            nextNod[n5], prevNod[n12], midlNod[n2], nextNod[n12], prevNod[n45],
                            midlNod[n5], nextNod[n45], prevNod[n14], prevNod[n25], nextNod[n25]);
                    }
                    break;
                }
                ...
                case SMDSEntity_Polygon: { // sweep POLYGON
                    ...
                    if (nbNodes == 6 && nbSame == 0 && nbDouble == 0) {
                        // --->  hexagonal prism
                        aNewElem = aMesh->AddVolume(prevNod[0], prevNod[1], prevNod[2], prevNod[3],
                                                    prevNod[4], prevNod[5], nextNod[0], nextNod[1],
                                                    nextNod[2], nextNod[3], nextNod[4], nextNod[5]);
                    }
                    break;
                }
                case SMDSEntity_Ball: return;
        ...
        if (!aNewElem && elem->GetType() == SMDSAbs_Face) // try to create a polyherdal prism
        {
            ...
            // bottom of prism
            for (int inode = 0; inode < nbNodes; inode++) polyedre_nodes.push_back(prevNod[inode]);
            ...
            for (int iface = 0; iface < nbNodes; iface += 1 + iQuad) {
                ...
                if (nbFaceNodes > 2) quantities.push_back(nbFaceNodes);
        ...
        // set new prev nodes
        for (iNode = 0; iNode < nbNodes; iNode++) prevNod[iNode] = nextNod[iNode];
...
void SMESH_MeshEditor::makeWalls(TNodeOfNodeListMap &mapNewNodes, TTElemOfElemListMap &newElemsMap,
                                 TElemOfVecOfNnlmiMap &elemNewNodesMap, TIDSortedElemSet &elemSet,
                                 const int nbSteps, SMESH_SequenceOfElemPtr &srcElements)
{
    ...
    for (; nList != mapNewNodes.end(); nList++) {
        const SMDS_MeshNode *node = static_cast<const SMDS_MeshNode *>(nList->first);
        if (newElemsMap.count(node)) continue; // node was extruded into edge
        ...
        while (eIt->more() && nbInitElems < 2) {
            ...
            if (type == SMDSAbs_Volume || type < highType || !elemSet.count(e)) continue;
            if (type > highType) {
                nbInitElems = 0;
                highType = type;
            }
    ...
    for (; itElem != newElemsMap.end(); itElem++, itElemNodes++) {
        ...
        if (elem->GetType() == SMDSAbs_Edge) {
            ...
            if (!isQuadratic) {
                ...
                if (!aMesh->FindEdge(vecNewNodes[0]->second.back(), vecNewNodes[1]->second.back(),
        ...
        if (hasFreeLinks) {
            ...
            for (volNb = 0; volNb < nbVolumesByStep; volNb++) {
                ...
                for (iF = 0; iF < nbF; iF++) {
                    if (vTool.IsFreeFace(iF) && vTool.GetFaceNodes(iF, faceNodeSet)
                        && initNodeSet != faceNodeSet) // except an initial face
                    {
                        if (nbSteps == 1 && faceNodeSet == topNodeSet) continue;
                        if (faceNodeSet == initNodeSetNoCenter) continue;
                        freeInd.push_back(iF);
                        // find source edge of a free face iF
                        vector<const SMDS_MeshNode *>
                            commonNodes; // shared by the initial and free faces
                        ...
                        if (std::distance(commonNodes.begin(), lastCommom) == 3)
                            srcEdges.push_back(
                                aMesh->FindEdge(commonNodes[0], commonNodes[1], commonNodes[2]));
                        else
                            srcEdges.push_back(aMesh->FindEdge(commonNodes[0], commonNodes[1]));
#ifdef _DEBUG_
                        if (!srcEdges.back()) {
                            cout << "SMESH_MeshEditor::makeWalls(), no source edge found for a "
                                    "free face #"
                ...
                for (int iStep = 0; iStep < nbSteps; iStep++) {
                    ...
                    for (; ind != freeInd.end(); ++ind, ++srcEdge) // loop on free faces
                    {
                        ...
                        if (nbn == 3) ///// triangle
                        {
                            ...
                            if (!f
                                || nodes[1]
                                    != f->GetNodeWrap(f->GetNodeIndex(nodes[0]) + nextShift)) {
                                const SMDS_MeshNode *newOrder[3] = {nodes[1 - nextShift], nodes[1],
                                                                    nodes[1 + nextShift]};
                                if (f) aMesh->ChangeElementNodes(f, &newOrder[0], nbn);
                                else
                                    myLastCreatedElems.Append(
                                        aMesh->AddFace(newOrder[0], newOrder[1], newOrder[2]));
                            }
                        }
                        else if (nbn == 4) ///// quadrangle
                        {
                            ...
                            if (!f
                                ...
                                if (f) aMesh->ChangeElementNodes(f, &newOrder[0], nbn);
                                    ...
                                    myLastCreatedElems.Append(aMesh->AddFace(
                                        newOrder[0], newOrder[1], newOrder[2], newOrder[3]));
                            }
                        }
                        else if (nbn == 6 && isQuadratic) /////// quadratic triangle
                        {
                            f = aMesh->FindFace(nodes[0], nodes[2], nodes[4], nodes[1], nodes[3],
                                                nodes[5]);
                            if (!f
                                || nodes[2]
                                    != f->GetNodeWrap(f->GetNodeIndex(nodes[0]) + 2 * nextShift)) {
                                const SMDS_MeshNode *newOrder[6] = {
                                    nodes[2 - 2 * nextShift], nodes[2], nodes[2 + 2 * nextShift],
                                    nodes[3 - 2 * nextShift], nodes[3], nodes[3 + 2 * nextShift]};
                                if (f) aMesh->ChangeElementNodes(f, &newOrder[0], nbn);
                                else
                                    myLastCreatedElems.Append(
                                        aMesh->AddFace(newOrder[0], newOrder[1], newOrder[2],
                                                       newOrder[3], newOrder[4], newOrder[5]));
                            }
                        }
                        else if (nbn == 8 && isQuadratic) /////// quadratic quadrangle
                        {
                            f = aMesh->FindFace(nodes[0], nodes[2], nodes[4], nodes[6], nodes[1],
                                                nodes[3], nodes[5], nodes[7]);
                            if (!f
                                || nodes[2]
                                    != f->GetNodeWrap(f->GetNodeIndex(nodes[0]) + 2 * nextShift)) {
                                const SMDS_MeshNode *newOrder[8] = {
                                    nodes[0], nodes[4 - 2 * nextShift],
                                    nodes[4], nodes[4 + 2 * nextShift],
                                    nodes[1], nodes[5 - 2 * nextShift],
                                    nodes[5], nodes[5 + 2 * nextShift]};
                                if (f) aMesh->ChangeElementNodes(f, &newOrder[0], nbn);
                                else
                                    myLastCreatedElems.Append(aMesh->AddFace(
                                        newOrder[0], newOrder[1], newOrder[2], newOrder[3],
                                        newOrder[4], newOrder[5], newOrder[6], newOrder[7]));
                            }
                        }
                        else if (nbn == 9 && isQuadratic) /////// bi-quadratic quadrangle
                        {
                            f = aMesh->FindElement(
                                vector<const SMDS_MeshNode *>(nodes, nodes + nbn), SMDSAbs_Face,
                                /*noMedium=*/false);
                            if (!f
                                || nodes[2]
                                    != f->GetNodeWrap(f->GetNodeIndex(nodes[0]) + 2 * nextShift)) {
                                const SMDS_MeshNode *newOrder[9] = {
                                    nodes[0], nodes[4 - 2 * nextShift],
                                    nodes[4], nodes[4 + 2 * nextShift],
                                    nodes[1], nodes[5 - 2 * nextShift],
                                    nodes[5], nodes[5 + 2 * nextShift],
                                ...
                                if (f) aMesh->ChangeElementNodes(f, &newOrder[0], nbn);
                                    ...
                                    myLastCreatedElems.Append(
                                        aMesh->AddFace(newOrder[0], newOrder[1], newOrder[2],
                                                       newOrder[3], newOrder[4], newOrder[5],
                                                       newOrder[6], newOrder[7], newOrder[8]));
                            }
                        }
                        else //////// polygon
                        {
                            ...
                            if (!f
                                ...
                                if (f) aMesh->ChangeElementNodes(f, &polygon_nodes[0], nbn);
                                else
                                    AddElement(polygon_nodes,
                                               polyFace.SetQuad((*v)->IsQuadratic()));
                            }
                        }
        ...
        if (iF >= 0) {
            ...
            if (!hasFreeLinks || !aMesh->FindElement(nodeVec, SMDSAbs_Face, /*noMedium=*/false)) {
                ...
                while (srcElements.Length() < myLastCreatedElems.Length()) srcElements.Append(elem);
            }
        }
...
SMESH_MeshEditor::RotationSweep(TIDSortedElemSet theElemSets[2], const gp_Ax1 &theAxis,
                                const double theAngle, const int theNbSteps, const double theTol,
                                const bool theMakeGroups, const bool theMakeWalls)
{
    myLastCreatedElems.Clear();
    myLastCreatedNodes.Clear();
    ...
    const bool isQuadraticMesh =
        bool(myMesh->NbEdges(ORDER_QUADRATIC) + myMesh->NbFaces(ORDER_QUADRATIC)
    ...
    for (int is2ndSet = 0; is2ndSet < 2; ++is2ndSet) {
        ...
        for (itElem = theElems.begin(); itElem != theElems.end(); itElem++) {
            const SMDS_MeshElement *elem = *itElem;
            if (!elem || elem->GetType() == SMDSAbs_Volume) continue;
                ...
                if (listNewNodes.empty()) {
                    ...
                    if (isQuadraticMesh) {
                        ...
                        while (it->more() && !needMediumNodes) {
                            ...
                            needMediumNodes =
                                (invElem->IsQuadratic() && !invElem->IsMediumNode(node));
                            if (!needMediumNodes
                                && invElem->GetEntityType() == SMDSEntity_BiQuad_Quadrangle)
    ...
    if (theMakeGroups) newGroupIDs = generateGroups(srcNodes, srcElems, "rotated");
...
SMESH_MeshEditor::ExtrusParam::ExtrusParam(const gp_Vec &theStep, const int theNbSteps,
                                           const int theFlags, const double theTolerance)
    : myDir(theStep), myFlags(theFlags), myTolerance(theTolerance), myElemsToUse(NULL)
{
    mySteps = new TColStd_HSequenceOfReal;
    const double stepSize = theStep.Magnitude();
    for (int i = 1; i <= theNbSteps; i++) mySteps->Append(stepSize);

    if ((theFlags & EXTRUSION_FLAG_SEW) && (theTolerance > 0)) {
...
SMESH_MeshEditor::ExtrusParam::ExtrusParam(const gp_Dir &theDir,
                                           ...
                                           const int theFlags, const double theTolerance)
    : myDir(theDir), mySteps(theSteps), myFlags(theFlags), myTolerance(theTolerance),
      myElemsToUse(NULL)
{
    if ((theFlags & EXTRUSION_FLAG_SEW) && (theTolerance > 0)) {
        myMakeNodesFun = &SMESH_MeshEditor::ExtrusParam::makeNodesByDirAndSew;
...
SMESH_MeshEditor::ExtrusParam::ExtrusParam(const double theStepSize, const int theNbSteps,
                                           const int theFlags, const int theDim)
    : myDir(1, 0, 0), mySteps(new TColStd_HSequenceOfReal), myFlags(theFlags), myTolerance(0),
      myElemsToUse(NULL)
{
    for (int i = 0; i < theNbSteps; i++) mySteps->Append(theStepSize);

    if (theDim == 1) { myMakeNodesFun = &SMESH_MeshEditor::ExtrusParam::makeNodesByNormal1D; }
    else {
...
int SMESH_MeshEditor::ExtrusParam::makeNodesByDir(SMESHDS_Mesh *mesh, const SMDS_MeshNode *srcNode,
                                                        ...
                                                        const bool makeMediumNodes)
{
    ...
    for (beginStepIter(makeMediumNodes); moreSteps(); ++nbNodes) // loop on steps
    {
        ...
        if (!node) node = mesh->AddNode(P1.X(), P1.Y(), P1.Z());
                                                       ...
                                                       const bool makeMediumNodes)
{
    ...
    while (faceIt->more()) {
        const SMDS_MeshElement *face = faceIt->next();
        if (myElemsToUse && !myElemsToUse->count(face)) continue;
    ...
    if (normSize < std::numeric_limits<double>::min()) return 0;
    ...
    for (beginStepIter(makeMediumNodes); moreSteps(); ++nbNodes) // loop on steps
    {
        ...
        if (norms.size() > 1) {
            for (size_t iF = 0; iF < norms.size(); ++iF) // loop on faces
            {
                ...
                if (dot < std::numeric_limits<double>::min()) dot = stepSize * 1e-3;
...
SMESH_MeshEditor::PGroupIDs
SMESH_MeshEditor::ExtrusionSweep(TIDSortedElemSet theElems[2], const gp_Vec &theStep,
                                 const int theNbSteps, TTElemOfElemListMap &newElemsMap,
                                 const int theFlags, const double theTolerance)
{
...
SMESH_MeshEditor::PGroupIDs SMESH_MeshEditor::ExtrusionSweep(TIDSortedElemSet theElemSets[2],
                                                             ...
                                                             TTElemOfElemListMap &newElemsMap)
{
    ...
    PGroupIDs newGroupIDs;
    if (theParams.ToMakeGroups()) newGroupIDs = generateGroups(srcNodes, srcElems, "extruded");
...
//purpose  :
//=======================================================================
SMESH_MeshEditor::Extrusion_Error SMESH_MeshEditor::ExtrusionAlongTrack(
    TIDSortedElemSet theElements[2], SMESH_subMesh *theTrack, const SMDS_MeshNode *theN1,
    const bool theHasAngles, list<double> &theAngles, const bool theLinearVariation,
    const bool theHasRefPoint, const gp_Pnt &theRefPoint, const bool theMakeGroups)
{
    ...
    // nothing to do
    if (!aNbE) return EXTR_NO_ELEMENTS;
    ...
    if (!pSubMeshDS)
        return ExtrusionAlongTrack(theElements, theTrack->GetFather(), theN1, theHasAngles,
                                   theAngles, theLinearVariation, theHasRefPoint, theRefPoint,
                                   theMakeGroups);
    ...
    while (aItE->more()) {
        ...
        if (aTypeE != SMDSAbs_Edge) return EXTR_PATH_NOT_EDGE;
    }
    ...
    if (aS.ShapeType() == TopAbs_EDGE) {
        ...
        if (SMESH_Algo::isDegenerated(aTrackEdge)) return EXTR_BAD_PATH_SHAPE;
        ...
        if (!(aN1 == theN1 || aN2 == theN1)) return EXTR_BAD_STARTING_NODE;
        ...
        for (; itPP != firstList.end(); itPP++) { fullList.push_back(*itPP); }
        ...
        for (; itLLPP != LLPPs.end(); itLLPP++) {
            ...
            gp_Dir Dnew(
                gp_Vec((D1.X() + D2.X()) / 2, (D1.Y() + D2.Y()) / 2, (D1.Z() + D2.Z()) / 2));
            PP1.SetTangent(Dnew);
...
//=======================================================================
SMESH_MeshEditor::Extrusion_Error SMESH_MeshEditor::ExtrusionAlongTrack(
    TIDSortedElemSet theElements[2], SMESH_Mesh *theTrack, const SMDS_MeshNode *theN1,
    const bool theHasAngles, list<double> &theAngles, const bool theLinearVariation,
    const bool theHasRefPoint, const gp_Pnt &theRefPoint, const bool theMakeGroups)
{
    myLastCreatedElems.Clear();
    ...
    if (!theTrack->HasShapeToMesh()) {
        ...
        //check start node
        if (!theTrack->GetMeshDS()->Contains(theN1)) { return EXTR_BAD_STARTING_NODE; }

        conn = nbEdgeConnectivity(theN1);
        if (conn != 1) return EXTR_PATH_NOT_EDGE;
        ...
        if (totalNbEdges == 1) {
            ...
            while (nIt->more()) {
                ...
                if (conn > 2) { return EXTR_PATH_NOT_EDGE; }
                    ...
                    if (currentElem == prevElem) currentElem = aItE->next();
                    nIt = currentElem->nodesIterator();
        ...
        if (nbEdges != totalNbEdges) return EXTR_PATH_NOT_EDGE;
        ...
        for (; itLLPP != LLPPs.end(); itLLPP++) {
            ...
            fullList.push_back(PP1);
            itPP++;
            for (; itPP != currList.end(); itPP++) { fullList.push_back(*itPP); }
            PP1 = fullList.back();
            fullList.pop_back();
        }
        fullList.push_back(PP1);
...
SMESH_MeshEditor::MakeEdgePathPoints(std::list<double> &aPrms, const TopoDS_Edge &aTrackEdge,
                                     bool FirstIsStart, list<SMESH_MeshEditor_PathPoint> &LPP)
{
    ...
    aPrms.sort();
    if (FirstIsStart) {
        if (aT1 > aT2) { aPrms.reverse(); }
    }
    else {
        if (aT2 > aT1) { aPrms.reverse(); }
    }
    // 3. Path Points
    ...
    for (; aItD != aPrms.end(); ++aItD) {
        ...
        if (aL2 < aTolVec2) return EXTR_CANT_GET_TANGENT;
...
//purpose  : auxilary for ExtrusionAlongTrack
//=======================================================================
SMESH_MeshEditor::Extrusion_Error SMESH_MeshEditor::MakeExtrElements(
    TIDSortedElemSet theElemSets[2], list<SMESH_MeshEditor_PathPoint> &fullList,
    const bool theHasAngles, list<double> &theAngles, const bool theLinearVariation,
    const bool theHasRefPoint, const gp_Pnt &theRefPoint, const bool theMakeGroups)
{
    ...
    for (; itPP != fullList.end(); itPP++) {
        aPPs.push_back(*itPP);
        if (theHasAngles && itAngles != theAngles.end()) aPPs.back().SetAngle(*itAngles++);
    }
        ...
        for (int is2ndSet = 0; is2ndSet < 2; ++is2ndSet) {
            ...
            for (; itElem != theElements.end(); itElem++) {
                ...
                while (itN->more()) {
                    ...
                    if (newNodes.insert(node).second) aGC += SMESH_TNodeXYZ(node);
                }
            }
        }
        aGC /= newNodes.size();
    ...
    for (int is2ndSet = 0; is2ndSet < 2; ++is2ndSet) {
        ...
        for (itElem = theElements.begin(); itElem != theElements.end(); itElem++) {
            ...
            while (itN->more()) {
                ...
                const SMDS_MeshNode *node = cast2Node(itN->next());
                TNodeOfNodeListMap::iterator nIt =
                    mapNewNodes.insert(make_pair(node, emptyList)).first;
                list<const SMDS_MeshNode *> &listNewNodes = nIt->second;
                if (listNewNodes.empty()) {
                    // make new nodes
                    ...
                    for (int j = 1; j < aNbTP; ++j) {
                        ...
                        if (elem->IsQuadratic() && !elem->IsMediumNode(node)) {
                            ...
                            const SMDS_MeshNode *newNode =
                                aMesh->AddNode(midP.X(), midP.Y(), midP.Z());
                            myLastCreatedNodes.Append(newNode);
                            srcNodes.Append(node);
                            listNewNodes.push_back(newNode);
                        }
                    ...
                    if (listNewNodes.size() == aNbTP - 1) {
                        ...
                        listNewNodes.clear();
                        for (i = 0; i < 2 * (aNbTP - 1); i++) { listNewNodes.push_back(aNodes[i]); }
                    }
                }
    ...
    if (theMakeGroups) generateGroups(srcNodes, srcElems, "extruded");
...
//purpose  : auxilary for ExtrusionAlongTrack
//=======================================================================
void SMESH_MeshEditor::LinearAngleVariation(const int nbSteps, list<double> &Angles)
{
    ...
    if (nbSteps > nbAngles) {
        ...
        for (int iSt = 0; iSt < nbSteps; ++iSt) {
            ...
            if (angPrevFloor == angCurFloor) angle = rAn2St * theAngles[int(angCurFloor)];
            else {
                ...
                if (iC < nbAngles) angle += (angCur - angCurFloor) * theAngles[iC];

                iP = int(angPrevCeil);
                while (iC-- > iP) angle += theAngles[iC];
            }
            res.push_back(angle);
            angPrev = angCur;
        }
        Angles.clear();
        it = res.begin();
        for (; it != res.end(); it++) Angles.push_back(*it);
    }
}
...
SMESH_MeshEditor::PGroupIDs SMESH_MeshEditor::Transform(TIDSortedElemSet &theElems,
                                                        const gp_Trsf &theTrsf, const bool theCopy,
                                                        ...
                                                        SMESH_Mesh *theTargetMesh)
{
    ...
    if (theElems.empty()) // transform the whole mesh
    {
        ...
        while (nIt->more()) {
            ...
            if (node->NbInverseElements() == 0) orphanNode.insert(node);
        }
    }
    ...
    if (!theCopy && !needReverse && !theTargetMesh) return PGroupIDs();
    ...
    for (itElem = theElems.begin(); itElem != theElems.end(); itElem++) {
        ...
        if (geomType == SMDSGeom_POLYHEDRA) // ------------------ polyhedral volume
        {
            ...
            if (!allTransformed) continue; // not all nodes transformed
        }
        else // ----------------------- the rest element types
        {
            while (iForw.size() < nbNodes) iForw.push_back(iForw.size());
            const vector<int> &iRev =
                SMDS_MeshCell::reverseSmdsOrder(elem->GetEntityType(), nbNodes);
            ...
            while (itN->more()) {
                ...
                TNodeNodeMap::iterator nodeMapIt = nodeMap.find(node);
                if (nodeMapIt == nodeMap.end()) break; // not all nodes transformed
                nodes[i[iNode++]] = (*nodeMapIt).second;
            }
            if (iNode != nbNodes) continue; // not all nodes transformed
        }
        ...
        if (editor) {
            ...
            if (nbNodes > 2) aMesh->ChangeElementNodes(elem, &nodes[0], nbNodes);
        }

    } // loop on elements

    if (editor && editor != this) myLastCreatedElems = editor->myLastCreatedElems;

    PGroupIDs newGroupIDs;

    if ((theMakeGroups && theCopy) || (theMakeGroups && theTargetMesh))
...
SMESH_MeshEditor::PGroupIDs SMESH_MeshEditor::generateGroups(
    const SMESH_SequenceOfElemPtr &nodeGens, const SMESH_SequenceOfElemPtr &elemGens,
    const std::string &postfix, SMESH_Mesh *targetMesh, const bool topPresent)
{
    ...
    for (int isNodes = 0; isNodes < 2; ++isNodes) {
        ...
        for (int iElem = 1; iElem <= elems.Length(); ++iElem) {
            ...
            if (const SMDS_MeshElement *resElem = elems(iElem))
                if (resElem != sourceElem) resultElems.push_back(resElem);
            while (iElem < gens.Length() && gens(iElem + 1) == sourceElem)
                if (const SMDS_MeshElement *resElem = elems(++iElem))
                    if (resElem != sourceElem) resultElems.push_back(resElem);
            ...
            for (gOldNew = groupsOldNew.begin(); gOldNew != gLast; ++gOldNew) {
                ...
                if (oldGroup->Contains(sourceElem)) // sourceElem is in oldGroup
                {
                    ...
                    vector<const SMDS_MeshElement *>::iterator resLast = resultElems.end(),
                                                               resElemIt;
                    for (resElemIt = resultElems.begin(); resElemIt != resLast; ++resElemIt)
                        if (*resElemIt) newGroup.Add(*resElemIt);
    ...
    for (size_t i = 0; i < orderedOldNewGroups.size(); ++i) {
        ...
        for (int is2nd = 0; is2nd < 2; ++is2nd) {
            ...
            if (newGroupDS->IsEmpty()) { mesh->GetMeshDS()->RemoveGroup(newGroupDS); }
            else {
                // set group type
                ...
                // make a name
                const bool isTop =
                    (topPresent && newGroupDS->GetType() == oldGroupDS->GetType() && is2nd);

                string name = oldGroupDS->GetStoreName();
                { // remove trailing whitespaces (issue 22599)
                    size_t size = name.size();
                    while (size > 1 && isspace(name[size - 1])) --size;
                    if (size != name.size()) {
                        name.resize(size);
                ...
                if (!targetMesh) {
                    ...
                    while (!groupNames.insert(name).second) // name exists
                        name = SMESH_Comment(oldGroupDS->GetStoreName())
                            << "_" << suffix << "_" << nb++;
                }
                else if (isTop) {
                    name += "_top";
                ...
                if (isTop) topGrouIds.push_back(newGroupDS->GetID());
                else
...
void SMESH_MeshEditor::FindCoincidentNodes(TIDSortedNodeSet &theNodes, const double theTolerance,
                                           ...
                                           bool theSeparateCornersAndMedium)
{
    ...
    if (myMesh->NbEdges(ORDER_QUADRATIC) + myMesh->NbFaces(ORDER_QUADRATIC)
            + myMesh->NbVolumes(ORDER_QUADRATIC)
        == 0)
    ...
    if (theNodes.empty()) // get all nodes in the mesh
    {
        ...
        if (theSeparateCornersAndMedium)
            ...
            while (nIt->more()) theNodes.insert(theNodes.end(), nIt->next());
    }
                                   ...
                                   vector<int> &quantities) const
{
        ...
        for (iSimple = 0; iSimple < nbSimple && !foundLoop; iSimple++) {
            ...
            if (!loopSet.insert(n).second) {
                ...
                if (loopLen > 2) {
                    ...
                    for (; iC < curLast; iC++) { poly_nodes.push_back(simpleNodes[iC]); }
                }
    ...
    if (iSimple > 2) {
        ...
        for (int i = 0; i < iSimple; i++) poly_nodes.push_back(simpleNodes[i]);
    }
...
void SMESH_MeshEditor::MergeNodes(TListOfListOfNodes &theGroupsOfNodes)
{
    ...
    for (; eIt != elems.end(); eIt++) {
        ...
        while (itN->more()) {
            ...
            if (isUnique) uniqueNodes[iUnique++] = n;
            else
                iRepl[nbRepl++] = iCur;
            iCur++;
        }
        ...
        if (nbNodes != nbUniqueNodes) // some nodes stick
        {
            if (elem->IsPoly()) // Polygons and Polyhedral volumes
            {
                if (elem->GetType() == SMDSAbs_Face) // Polygon
                {
                    ...
                    if (isQuad) {
                        ...
                        SMDS_MeshCell::applyInterlace // interlace medium and corner nodes
                            (SMDS_MeshCell::interlacedSmdsOrder(SMDSEntity_Quad_Polygon, nbNodes),
                             curNodes);
#else
                        ...
                        for (int iface = 0; iface < nbNew; iface++) {
                            ...
                            if (isQuad) // check if a result elem is a valid quadratic polygon
                            {
                                ...
                                throw SALOME_Exception(
                                    "Quadratic polygon not supported with VTK <6.2");
#endif
                            }
                ...
                {
                    if (nbUniqueNodes < 4) { rmElemIds.push_back(elem->GetID()); }
                    else {
                        ...
                        if (aPolyedre) {
                            ...
                            for (int iface = 1; iface <= nbFaces; iface++) {
                                ...
                                for (int inode = 1; inode <= nbFaceNodes; inode++) {
                                    const SMDS_MeshNode *faceNode =
                                        aPolyedre->GetFaceNode(iface, inode);
            ...
            switch (nbNodes) {
                ...
                case 6: ///////////////////////////////////// PENTAHEDRON
                    if (nbUniqueNodes == 4) {
                        // ---------------------------------> tetrahedron
                        if (nbRepl == 3 && iRepl[0] > 2 && iRepl[1] > 2 && iRepl[2] > 2) {
                            // all top nodes stick: reverse a bottom
                            uniqueNodes[0] = curNodes[1];
                            uniqueNodes[1] = curNodes[0];
                        }
                        else if (nbRepl == 3 && iRepl[0] < 3 && iRepl[1] < 3 && iRepl[2] < 3) {
                        ...
                        else if (nbRepl == 4 && iRepl[2] - iRepl[0] == 3
                                 && iRepl[3] - iRepl[1] == 3) {
                        ...
                        if (nbRepl == 2 && iRepl[1] - iRepl[0] == 3) {
                            ...
                            SMDS_MeshElement *newElem =
                                aMesh->AddVolume(curNodes[3], curNodes[4], curNodes[5],
                ...
                case 8: {
                    if (elem->IsQuadratic()) { // Quadratic quadrangle
                        ...
                        //   0    7    3
                        isOk = false;
                        if (nbRepl == 2) { MESSAGE("nbRepl=2: " << iRepl[0] << " " << iRepl[1]); }
                        if (nbRepl == 3) {
                        ...
                        if (nbRepl == 4) {
                            MESSAGE("nbRepl=4: " << iRepl[0] << " " << iRepl[1] << " " << iRepl[2]
                                                 << " " << iRepl[3]);
                        }
                        if (nbRepl == 5) {
                            MESSAGE("nbRepl=5: " << iRepl[0] << " " << iRepl[1] << " " << iRepl[2]
                                                 << " " << iRepl[3] << " " << iRepl[4]);
                        }
                        break;
                    }
                    ...
                    if (nbUniqueNodes == 4 && nbRepl == 4) {
                        ...
                        for (int iFace = 0; iFace < 6; iFace++) {
                            const int *ind =
                                hexa.GetFaceNodesIndices(iFace); // indices of face nodes
                            if (curNodes[ind[0]] == curNodes[ind[1]]
                                ...
                                for (iCur = 0; iCur < 4 && nbStick < 2; iCur++) {
                                    if (curNodes[ind[iCur]] == curNodes[ind[iCur + 1]]) nbStick++;
                                }
                                if (nbStick == 1) {
                        ...
                        for (int iFace = 0; iFace < 6 && nbTria < 3; iFace++) {
                            ...
                            for (iCur = 0; iCur < 4; iCur++) faceNodes.insert(curNodes[ind[iCur]]);
                            if (faceNodes.size() == 3) iTria[nbTria++] = iFace;
                        }
                        ...
                        if (nbTria == 2 && iTria[0] == hexa.GetOppFaceIndex(iTria[1])) {
                            ...
                            if (!hexa.IsForward()) std::swap(indB[0], indB[2]);
                        ...
                        for (int iFace = 0; iFace < 6; iFace++) {
                            ...
                            if (curNodes[ind[0]] == curNodes[ind[1]]
                                ...
                                if (nbStick == 0) {
                                    ...
                                    // tetrahedron 2
                                    SMDS_MeshElement *newElem =
                                        aMesh->AddVolume(curNodes[ind[0]], curNodes[ind[3]],
                                                         curNodes[ind[2]], curNodes[indTop[0]]);
                                    myLastCreatedElems.Append(newElem);
                                    if (aShapeId) aMesh->SetMeshElementOnShape(newElem, aShapeId);
                                    isOk = true;
                                }
                        ...
                        for (iFace = 0; iFace < 6; iFace++) {
                            const int *ind =
                                hexa.GetFaceNodesIndices(iFace); // indices of face nodes
                            nodeSet.clear();
                            for (iCur = 0; iCur < 4; iCur++) nodeSet.insert(curNodes[ind[iCur]]);
                            nbUniqueNodes = nodeSet.size();
                            if (nbUniqueNodes == 3) iTriFace[nbTri++] = iFace;
                        ...
                        if (nbQuad == 2 && nbTri == 4
                            ...
                            // --------------------------------------------> 2 tetrahedrons
                            const int *ind1 =
                                hexa.GetFaceNodesIndices(iQuadFace[0]); // indices of quad1 nodes
                            ...
                            nbUniqueNodes = 4;
                            // tetrahedron 2
                            SMDS_MeshElement *newElem = aMesh->AddVolume(
                                curNodes[i1d], curNodes[i2], curNodes[i3d], curNodes[i2t]);
                            myLastCreatedElems.Append(newElem);
                            if (aShapeId) aMesh->SetMeshElementOnShape(newElem, aShapeId);
                            isOk = true;
                        }
        ...
        if (isOk) // the non-poly elem remains valid after sticking nodes
        {
            if (nbNodes != nbUniqueNodes
                ...
                if (sm && newElem) sm->AddElement(newElem);
                if (elem != newElem) ReplaceElemInGroups(elem, newElem, aMesh);
            }
        }
        else {
...
public:
    SortableElement(const SMDS_MeshElement *theElem)
    {
        myElem = theElem;
        SMDS_ElemIteratorPtr nodeIt = theElem->nodesIterator();
        while (nodeIt->more()) this->insert(nodeIt->next());
    }

    const SMDS_MeshElement *Get() const { return myElem; }
                                         ...
                                         TListOfListOfElementsID &theGroupsOfElementsID)
{
    ...
    if (theElements.empty()) { // get all elements in the mesh
        SMDS_ElemIteratorPtr eIt = GetMeshDS()->elementsIterator();
        while (eIt->more()) theElements.insert(theElements.end(), eIt->next());
    }
...
static const SMDS_MeshElement *findAdjacentFace(const SMDS_MeshNode *n1, const SMDS_MeshNode *n2,
                                                const SMDS_MeshElement *elem)
{
    TIDSortedElemSet elemSet, avoidSet;
    if (elem) avoidSet.insert(elem);
...
static const SMDS_MeshElement *findSegment(const SMDS_MeshNode *n1, const SMDS_MeshNode *n2)
{
    ...
    while (it->more()) {
        ...
        if (seg->GetNodeIndex(n2) >= 0) return seg;
    }
    return 0;
}
...
{
    if (!theFirstNode || !theSecondNode) return false;
    ...
    while (nStart != theLastNode) {
        if (nStart == theFirstNode) return !needTheLast;
        ...
        while (invElemIt->more()) {
            ...
            if (e == curElem || foundElems.insert(e).second) {
                ...
                if (e->IsQuadratic()) {
                    const SMDS_VtkFace *F = dynamic_cast<const SMDS_VtkFace *>(e);
                    if (!F) throw SALOME_Exception(LOCALIZED("not an SMDS_VtkFace"));
                    // use special nodes iterator
                    SMDS_ElemIteratorPtr anIter = F->interlacedNodesElemIterator();
                    while (anIter->more()) { nodes[iNode++] = cast2Node(anIter->next()); }
                }
                else {
                    SMDS_ElemIteratorPtr nIt = e->nodesIterator();
                    while (nIt->more())
        ...
        if (nbNewBorders == 0) {
            ...
            if (needTheLast) {
                for (curElemIt = curElemList.begin(), nStartIt = nStartList.begin();
                     curElemIt != curElemList.end(); curElemIt++, nStartIt++)
            ...
            if (contNodes[0].empty() && contNodes[1].empty()) return false;
...
SMESH_MeshEditor::Sew_Error SMESH_MeshEditor::SewFreeBorder(
    const SMDS_MeshNode *theBordFirstNode, const SMDS_MeshNode *theBordSecondNode,
    const SMDS_MeshNode *theBordLastNode, const SMDS_MeshNode *theSideFirstNode,
    const SMDS_MeshNode *theSideSecondNode, const SMDS_MeshNode *theSideThirdNode,
    const bool theSideIsFreeBorder, const bool toCreatePolygons, const bool toCreatePolyedrs)
{
    myLastCreatedElems.Clear();
    myLastCreatedNodes.Clear();
    ...
    // Free border 1
    // --------------
    if (!FindFreeBorder(theBordFirstNode, theBordSecondNode, theBordLastNode, nSide[0], eSide[0])) {
    ...
    if (theSideIsFreeBorder) {
        // Free border 2
        // --------------
        if (!FindFreeBorder(theSideFirstNode, theSideSecondNode, theSideThirdNode, nSide[1],
                            eSide[1])) {
            MESSAGE(" Free Border 2 not found ");
            aResult = (aResult != SEW_OK ? SEW_BOTH_BORDERS_NOT_FOUND : SEW_BORDER2_NOT_FOUND);
        }
    }
    if (aResult != SEW_OK) return aResult;
        ...
        do {
            ...
            while (invElemIt->more()) {
                ...
                if (isVolume) // --volume
                    ...
                    if (elem->IsQuadratic()) {
                        ...
                        while (anIter->more()) {
                            ...
                            if (nodes[iNode++] == prevSideNode) iPrevNode = iNode - 1;
                        }
                    }
                    else {
                ...
                for (iNode = 0; iNode < nbNodes; iNode++) {
                    ...
                    if (isVolume) {
                        if (!volume.IsLinked(n, prevSideNode)) continue;
                    }
                    else {
                    ...
                    if (!isJustChecked && foundSideLinkIDs.find(iLink) == foundSideLinkIDs.end()) {
            ...
            if (*nBordIt == theBordLastNode) searchByDir = false;
            else {
    ...
    if ((toMergeConformal) || (theSideIsFreeBorder && !theSideThirdNode)) {

        // all nodes are to be merged

        for (nIt[0] = nSide[0].begin(), nIt[1] = nSide[1].begin();
             nIt[0] != nSide[0].end() && nIt[1] != nSide[1].end(); nIt[0]++, nIt[1]++) {
        ...
        for (iBord = 0; iBord < 2; iBord++) { // loop on 2 borders
            ...
            for (iNode = 0; nIt != nodes.end(); nIt++, iNode++) { // loop on border nodes
                ...
                gp_XYZ segment(nCur->X() - nPrev->X(), nCur->Y() - nPrev->Y(),
                               nCur->Z() - nPrev->Z());
            ...
            for (iNode = 0; iNode < nbNodes[iBord]; iNode++) { param[iBord][iNode] /= bordLength; }
        }
        ...
        do {
            ...
            for (iBord = 0; iBord < 2; iBord++) { // loop on 2 borders
                ...
                if (i[iBord] > 0) prevParam = Max(prevParam, param[iBord][i[iBord] - 1]);
            }
            ...
            if (Abs(du) <= minSegLen * 0.2) {
                ...
                if (otherLink) {
                    ...
                    const SMDS_MeshNode *n12 = nodeList.front();
                    nodeList.pop_front();
                    const SMDS_MeshNode *n22 = nodeList.front();
                    nodeList.pop_front();
                ...
                if (notFound || otherLink) {
                    ...
                    insertMapIt =
                        insertMap.insert(make_pair(elem, list<const SMDS_MeshNode *>())).first;
            ...
            for (iBord = 0; iBord < 2; iBord++) { // loop on 2 borders
                if (next[iBord]) {
                    if (i[iBord] != 0 && eIt[iBord] != eSide[iBord].end()) eIt[iBord]++;
        ...
        for (insertMapIt = insertMap.begin(); insertMapIt != insertMap.end(); insertMapIt++) {
            const SMDS_MeshElement *elem = (*insertMapIt).first;
            list<const SMDS_MeshNode *> &nodeList = (*insertMapIt).second;
            const SMDS_MeshNode *n1 = nodeList.front();
            nodeList.pop_front();
            const SMDS_MeshNode *n2 = nodeList.front();
            nodeList.pop_front();
    ...
    for (; groupIt != nodeGroupsToMerge.end(); groupIt++) {
        ...
        while (segIt->more()) segments.insert(segIt->next());
    }

    // find coincident
    TListOfListOfElementsID equalGroups;
    if (!segments.empty()) FindEqualElements(segments, equalGroups);
    if (!equalGroups.empty()) {
        ...
        for (; seg != segments.end(); ++seg) myLastCreatedElems.Append(*seg);
    }
                                           ...
                                           const bool toCreatePoly)
{
    ...
    if (theElement->GetType() == SMDSAbs_Edge) {
        ...
        {
            vector<const SMDS_MeshNode *> nodes(theElement->begin_nodes(), theElement->end_nodes());
            int iOther = 0, nbN = nodes.size();
            for (; iOther < nbN; ++iOther)
                if (nodes[iOther] != theBetweenNode1 && nodes[iOther] != theBetweenNode2) break;
            if (iOther == 0) {
    ...
    while (nodeIt->more()) {
        ...
        if (n == theBetweenNode1) il1 = iNode;
    ...
    if (toCreatePoly || theFace->IsPoly()) {
        ...
        if (theFace->IsQuadratic()) {
            ...
            while (anIter->more() && !isFLN) {
                ...
                poly_nodes[iNode++] = n;
                if (n == nodes[il1]) { isFLN = true; }
            }
            // add nodes to insert
            list<const SMDS_MeshNode *>::iterator nIt = aNodesToInsert.begin();
            for (; nIt != aNodesToInsert.end(); nIt++) { poly_nodes[iNode++] = *nIt; }
            // add nodes of face starting from last node of link
            while (anIter->more()) { poly_nodes[iNode++] = cast2Node(anIter->next()); }
        }
        else {
        ...
        list<const SMDS_MeshNode *>::iterator nIt = aNodesToInsert.begin();
        for (iNode = 1; nIt != aNodesToInsert.end(); nIt++) { linkNodes[iNode++] = *nIt; }
        ...
        if (nbFaceNodes == 3) {
            ...
            for (int iQuad = 0; iQuad < nbSplits; iQuad++) {
                ...
                for (iSplit = 0; iSplit < nbSplits; iSplit++) {
                    if (iSplit == iQuad) {
                        SMDS_FaceOfNodes quad(linkNodes[i1++], linkNodes[i2++], nodes[i3],
                                              nodes[i4]);
                        aBadRate += getBadRate(&quad, aCrit);
                    }
                    else {
                        SMDS_FaceOfNodes tria(linkNodes[i1++], linkNodes[i2++],
        ...
        for (iSplit = 0; iSplit < nbSplits - 1; iSplit++) {
            ...
            if (iSplit == iBestQuad)
                newElems.push_back(
                    aMesh->AddFace(linkNodes[i1++], linkNodes[i2++], nodes[i3], nodes[i4]));
            else
                newElems.push_back(aMesh->AddFace(linkNodes[i1++], linkNodes[i2++],
        ...
        for (i = 0; i < nbshift; i++) {
            ...
            for (j = 0; j < nbFaceNodes - 1; j++) { nodes[j] = nodes[j + 1]; }
        ...
        list<const SMDS_MeshNode *>::iterator nIt = aNodesToInsert.begin();
        for (iNode = 1; nIt != aNodesToInsert.end(); nIt++) { aNodes[iNode++] = *nIt; }
        for (i = 1; i < nbn; i++)
                                     ...
                                     list<const SMDS_MeshNode *> &theNodesToInsert)
{
    ...
    while (invElemIt->more()) { // loop on inverse elements of theBetweenNode1
        ...
        if (!aVolume.IsLinked(theBetweenNode1, theBetweenNode2)) continue;
...
void volumeToPolyhedron(const SMDS_MeshElement *elem, vector<const SMDS_MeshNode *> &nodes,
...
int SMESH_MeshEditor::convertElemToQuadratic(SMESHDS_SubMesh *theSm, SMESH_MesherHelper &theHelper,
                                             const bool theForce3d)
{
    ...
    while (ElemItr->more()) {
        ...
        if (aType < SMDSAbs_Edge || aType > SMDSAbs_Volume) continue;
        ...
        if (elem->IsQuadratic()) {
            ...
            switch (aType) {
                case SMDSAbs_Volume:
                    theHelper.AddTLinks(static_cast<const SMDS_MeshVolume *>(elem));
                    break;
                case SMDSAbs_Face:
                    theHelper.AddTLinks(static_cast<const SMDS_MeshFace *>(elem));
                    break;
                case SMDSAbs_Edge:
                    theHelper.AddTLinks(static_cast<const SMDS_MeshEdge *>(elem));
                    break;
                default:;
            }
            ...
            case SMDSAbs_Face: {
                switch (nbNodes) {
                    case 3:
                        ...
                        break;
                    case 4:
                        NewElem = theHelper.AddFace(nodes[0], nodes[1], nodes[2], nodes[3], id,
                                                    theForce3d);
                        break;
                    default: NewElem = theHelper.AddPolygonalFace(nodes, id, theForce3d);
                }
                break;
            }
            case SMDSAbs_Volume: {
                switch (aGeomType) {
                    case SMDSEntity_Tetra:
                        NewElem = theHelper.AddVolume(nodes[0], nodes[1], nodes[2], nodes[3], id,
                                                      theForce3d);
                        break;
                    case SMDSEntity_Pyramid:
                    ...
                    case SMDSEntity_TriQuad_Hexa:
                        NewElem =
                            theHelper.AddVolume(nodes[0], nodes[1], nodes[2], nodes[3], nodes[4],
                                                nodes[5], nodes[6], nodes[7], id, theForce3d);
                        break;
                    case SMDSEntity_Hexagonal_Prism:
                    default:
                        NewElem =
                            theHelper.AddPolyhedralVolume(nodes, nbNodeInFaces, id, theForce3d);
                }
                break;
            }
            default: continue;
        ...
        if (NewElem && NewElem->getshapeId() < 1) theSm->AddElement(NewElem);
    }
    return nbElem;
}
//=======================================================================
...
void SMESH_MeshEditor::ConvertToQuadratic(const bool theForce3d, const bool theToBiQuad)
{
    ...
    if (nbCheckedElems < totalNbElems) // not all elements are in sub-meshes
    {
        ...
        while (aFaceItr->more()) {
            ...
            switch (type) {
                ...
                case SMDSEntity_BiQuad_Triangle:
                    ...
                    if (nodes.size() == 7
                        && nodes[6]->NbInverseElements() == 0) // rm a central node
                ...
                case SMDSEntity_BiQuad_Quadrangle:
                    NewFace =
                        aHelper.AddFace(nodes[0], nodes[1], nodes[2], nodes[3], id, theForce3d);
                    if (nodes.size() == 9
                        && nodes[8]->NbInverseElements() == 0) // rm a central node
                        GetMeshDS()->RemoveFreeNode(nodes[8], /*sm=*/0, /*fromGroups=*/true);
                    break;

                default:; NewFace = aHelper.AddPolygonalFace(nodes, id, theForce3d);
            }
        ...
        while (aVolumeItr->more()) {
            ...
            switch (type) {
                case SMDSEntity_Tetra:
                    NewVolume =
                        aHelper.AddVolume(nodes[0], nodes[1], nodes[2], nodes[3], id, theForce3d);
                    break;
                case SMDSEntity_Hexa:
                case SMDSEntity_Quad_Hexa:
                case SMDSEntity_TriQuad_Hexa:
                    NewVolume = aHelper.AddVolume(nodes[0], nodes[1], nodes[2], nodes[3], nodes[4],
                                                  nodes[5], nodes[6], nodes[7], id, theForce3d);
    ...
    if (!theForce3d) { // setenv NO_FixQuadraticElements to know if FixQuadraticElements() is guilty of bad conversion
...
void SMESH_MeshEditor::ConvertToQuadratic(const bool theForce3d, TIDSortedElemSet &theElements,
                                          const bool theToBiQuad)
{
    ...
    for (; nIt != allNodes.end(); ++nIt) {
        ...
        while (invIt->more()) {
            ...
            if (type >= elemType) continue; // same type or more complex linear element

            if (!checkedAdjacentElems[type].insert(e).second) continue; // e is already checked

            // check nodes
            bool allIn = true;
            SMDS_NodeIteratorPtr nodeIt = e->nodeIterator();
            while (nodeIt->more() && allIn) allIn = allNodes.count(nodeIt->next());
            if (allIn) theElements.insert(e);
        }
    }
    ...
    for (eIt = theElements.begin(); eIt != theElements.end(); ++eIt) {
        ...
        if (!smDS || !smDS->Contains(elem)) smDS = meshDS->MeshElements(elem->getshapeId());
        ...
        switch (nbNodes) {
            case 4: // cases for most frequently used element types go first (for optimization)
                if (type == SMDSAbs_Volume)
                    newElem =
                        helper.AddVolume(nodes[0], nodes[1], nodes[2], nodes[3], id, theForce3d);
                else
                    newElem =
                        helper.AddFace(nodes[0], nodes[1], nodes[2], nodes[3], id, theForce3d);
                break;
            case 8:
                newElem = helper.AddVolume(nodes[0], nodes[1], nodes[2], nodes[3], nodes[4],
                                           nodes[5], nodes[6], nodes[7], id, theForce3d);
                break;
            case 3: newElem = helper.AddFace(nodes[0], nodes[1], nodes[2], id, theForce3d); break;
            case 2: newElem = helper.AddEdge(nodes[0], nodes[1], id, theForce3d); break;
            case 5:
                newElem = helper.AddVolume(nodes[0], nodes[1], nodes[2], nodes[3], nodes[4], id,
                                           theForce3d);
                break;
            case 6:
                newElem = helper.AddVolume(nodes[0], nodes[1], nodes[2], nodes[3], nodes[4],
        ...
        if (newElem && smDS) smDS->AddElement(newElem);
...
int SMESH_MeshEditor::removeQuadElem(SMESHDS_SubMesh *theSm, SMDS_ElemIteratorPtr theItr,
...
bool SMESH_MeshEditor::ConvertFromQuadratic()
{
    ...
    int totalNbElems = GetMeshDS()->NbEdges() + GetMeshDS()->NbFaces() + GetMeshDS()->NbVolumes();
...
bool allMediumNodesIn(const SMDS_MeshElement *elem, TIDSortedNodeSet &nodeSet)
{
    for (int i = elem->NbCornerNodes(); i < elem->NbNodes(); ++i)
        if (!nodeSet.count(elem->GetNode(i))) return false;
    return true;
}
} // namespace
    ...
    for (; nIt != mediumNodes.end(); ++nIt) {
        ...
        while (invIt->more()) {
            ...
            if (e->IsQuadratic() && allMediumNodesIn(e, mediumNodes)) {
                ...
                if (!complexFound) moreElemsToConvert.insert(e);
            }
        }
    }
                                                              ...
                                                              const SMDS_MeshNode *theSecondNode2)
{
    ...
    if (theSide1.size() != theSide2.size()) return SEW_DIFF_NB_OF_ELEMENTS;
            ...
            while (fIt->more()) { // loop on faces sharing a node
                ...
                if (faceSet->find(f) == faceSet->end()) {
                    ...
                    while (nodeIt->more() && allInSet) { // loop on nodes of a face
                        const SMDS_MeshNode *n = static_cast<const SMDS_MeshNode *>(nodeIt->next());
                        if (nodeSet->find(n) == nodeSet->end()) allInSet = false;
                        else
                            faceNodeSet.insert(n);
                    }
                    if (allInSet) {
        ...
        if (!volSet->empty()) {
            ...
            for (vIt = volSet->begin(); vIt != volSet->end(); vIt++) {
                ...
                for (iFace = 0; iFace < vol.NbFaces(); iFace++) {
                    if (!vol.IsFreeFace(iFace)) continue;
                    ...
                    if (!aFreeFace) {
                        ...
                        if (aFreeFace) tempFaceList.push_back(aFreeFace);
                    }

                    if (aFreeFace) freeFaceList.push_back(aFreeFace);
    ...
    if (theFirstNode1 != theFirstNode2) nReplaceMap.insert(make_pair(theFirstNode1, theFirstNode2));
    ...
    for (; linkIt[0] != linkList[0].end(); linkIt[0]++, linkIt[1]++) {
        ...
        if (!linkIdSet.count(linkID)) continue;
        ...
        for (iSide = 0; iSide < 2; iSide++) { // loop on 2 sides
            ...
            face[iSide] = SMESH_MeshAlgos::FindFaceInSet(
                n1, n2, *faceSetPtr[iSide], avoidSet, &iLinkNode[iSide][0], &iLinkNode[iSide][1]);
            if (face[iSide]) {
                ...
                if (face[iSide]->IsQuadratic()) {
                    ...
                    while (nIter->more()) fnodes[iSide].push_back(cast2Node(nIter->next()));
                }
                else {
                    fnodes[iSide].assign(face[iSide]->begin_nodes(), face[iSide]->end_nodes());
                }
        ...
        if (faceSetPtr[0]->empty() || faceSetPtr[1]->empty()) break;
    ...
    if (aResult == SEW_OK
        ...
        MESSAGE((linkIt[0] != linkList[0].end())
                << " " << (faceSetPtr[0]->empty()) << " " << (faceSetPtr[1]->empty()));
        aResult = SEW_TOPO_DIFF_SETS_OF_ELEMENTS;
    }
    ...
    //    aTmpFacesMesh.RemoveElement( tmpFaceIt->next() );
    list<const SMDS_MeshElement *>::iterator tmpFaceIt = tempFaceList.begin();
    for (; tmpFaceIt != tempFaceList.end(); ++tmpFaceIt) aMesh->RemoveElement(*tmpFaceIt);
...
SMESH_MeshEditor::Sew_Error SMESH_MeshEditor::FindMatchingNodes(
    set<const SMDS_MeshElement *> &theSide1, set<const SMDS_MeshElement *> &theSide2,
    ...
    TNodeNodeMap &nReplaceMap)
{
    ...
    for (; linkIt[0] != linkList[0].end(); linkIt[0]++, linkIt[1]++) {
        NLink link[] = {*linkIt[0], *linkIt[1]};
        if (linkSet.find(link[0]) == linkSet.end()) continue;
        ...
        if (face[0] && face[1]) {
            ...
            MESSAGE(" Link 1: " << link[0].first->GetID() << " " << link[0].second->GetID()
                                ...
                                << " " << link[1].second->GetID() << " F 2: " << face[1]
                                << " | Bind: ");
#endif
            int nbN = nbNodes[0];
            {
            ...
            for (int i = 0; i < nbN; i++) {
                ...
                else // new in set == encountered for the first time: add
                {
                    ...
                    MESSAGE("Add link 1: " << n1->GetID() << " " << n2->GetID() << " "
                                           << " | link 2: " << nReplaceMap[n1]->GetID() << " "
                                           << nReplaceMap[n2]->GetID() << " ");
#endif
                    linkList[0].push_back(NLink(n1, n2));
                    linkList[1].push_back(NLink(nReplaceMap[n1], nReplaceMap[n2]));
                }
...
void SMESH_MeshEditor::DoubleElements(const TIDSortedElemSet &theElements)
{
    ...
    if (theElements.empty()) {
        if (mesh->NbNodes() == 0) return;
        // get most complex type
        SMDSAbs_ElementType types[SMDSAbs_NbElementTypes] = {SMDSAbs_Volume, SMDSAbs_Face,
                                                             SMDSAbs_Edge,   SMDSAbs_0DElement,
                                                             SMDSAbs_Ball,   SMDSAbs_Node};
        ...
        while (elemIt->more()) allElems.push_back(elemIt->next());
                                   ...
                                   const TIDSortedElemSet &theAffectedElems)
{
    ...
    if (theElems.size() == 0) return false;

    SMESHDS_Mesh *aMeshDS = GetMeshDS();
    if (!aMeshDS) return false;
...
bool SMESH_MeshEditor::doubleNodes(SMESHDS_Mesh *theMeshDS, const TIDSortedElemSet &theElems,
                                   const TIDSortedElemSet &theNodesNot,
                                   TNodeNodeMap &theNodeNodeMap, const bool theIsDoubleElem)
{
    MESSAGE("doubleNodes");
    ...
    for (; elemItr != theElems.end(); ++elemItr) {
        ...
        while (anIter->more()) {
            ...
            if (n2n != theNodeNodeMap.end()) { aNewNode = n2n->second; }
        ...
        if (theIsDoubleElem) AddElement(newNodes, elemType.Init(anElem, /*basicOnly=*/false));
        else
                                   ...
                                   const std::list<int> &theListOfModifiedElems)
{
    ...
    if (theListOfNodes.size() == 0) return false;
    ...
    for (anElemIter = theListOfModifiedElems.begin(); anElemIter != theListOfModifiedElems.end();
         ++anElemIter) {
    ...
    std::map<SMDS_MeshElement *, vector<const SMDS_MeshNode *>>::iterator anElemToNodesIter =
        anElemToNodes.begin();
...
bool isInside(const SMDS_MeshElement *theElem, Classifier &theClassifier, const double theTol)
{
    gp_XYZ centerXYZ(0, 0, 0);
    SMDS_ElemIteratorPtr aNodeItr = theElem->nodesIterator();
    while (aNodeItr->more()) centerXYZ += SMESH_TNodeXYZ(cast2Node(aNodeItr->next()));
...
struct _FaceClassifier {
    ...
    {
        _extremum.Initialize(_surface, _surface.FirstUParameter(), _surface.LastUParameter(),
    ...
    TopAbs_State State() const { return _state; }
};
} // namespace
                                                  ...
                                                  TIDSortedElemSet &theAffectedElems)
{
    if (theShape.IsNull()) {
        ...
        for (ielem = 1; elemItr != theElems.end(); ++elemItr) {
            ...
            if (!anElem || (anElem->GetType() != SMDSAbs_Face)) continue;
            gp_XYZ normal;
            SMESH_MeshAlgos::FaceNormal(anElem, normal, /*normalized=*/true);
            MESSAGE("element " << ielem++ << " normal " << normal.X() << " " << normal.Y() << " "
                               << normal.Z());
            ...
            for (; nodit != nodesElem.end(); nodit++) {
                ...
                if (!aNode || theNodesNot.find(aNode) != theNodesNot.end()) continue;
                ...
                while (backElemItr->more()) {
                    ...
                    if (alreadyCheckedElems.find(curElem) != alreadyCheckedElems.end()) continue;
                    if (theElems.find(curElem) != theElems.end()) continue;
                    ...
                    gp_XYZ p;
                    p.SetCoord(x / nb - aNode->X(), y / nb - aNode->Y(), z / nb - aNode->Z());
            ...
            while (nodeItr->more()) {
                ...
                while (backElemItr->more()) {
                    ...
                    if (curElem && theElems.find(curElem) == theElems.end()
                        && (bsc3d.get() ? isInside(curElem, *bsc3d, aTol)
 ...
 */
double SMESH_MeshEditor::OrientedAngle(const gp_Pnt &p0, const gp_Pnt &p1, const gp_Pnt &g1,
                                       const gp_Pnt &g2)
{
...
bool SMESH_MeshEditor::DoubleNodesOnGroupBoundaries(const std::vector<TIDSortedElemSet> &theElems,
                                                    bool createJointElems, bool onAllBoundaries)
{
    MESSAGE("----------------------------------------------");
    ...
    std::map<DownIdType, std::map<int, int>, DownIdCompare>
        faceDomains;            // face --> (id domain --> id volume)
    std::map<int, int> celldom; // cell vtkId --> domain
    std::map<DownIdType, std::map<int, int>, DownIdCompare>
        cellDomains;                               // oldNode --> (id domain --> id cell)
    ...
    for (int idom = 0; idom < nbDomains - 1; idom++) {
        ...
        for (; elemItr != domain.end(); ++elemItr) {
            ...
            for (int idombis = idombisdeb; idombis < theElems.size();
                 idombis++) // check if the element belongs to a domain further in the list
            {
    ...
    for (int idom = 0; idom < nbDomains; idom++) {
        ...
        for (; elemItr != domain.end(); ++elemItr) {
            ...
            for (int n = 0; n < nbNeighbors; n++) {
                ...
                {
                    bool ok = false;
                    for (int idombis = 0; idombis < theElems.size() && !ok;
                         idombis++) // check if the neighbor belongs to another domain of the list
                    {
                        // MESSAGE("Domain " << idombis);
                        const TIDSortedElemSet &domainbis = theElems[idombis];
                        if (domainbis.count(elem))
                            ok = true; // neighbor is in a correct domain : face is kept
                    }
                    if (ok || onAllBoundaries) // the characteristics of the face is stored
                    {
                        DownIdType face(downIds[n], downTypes[n]);
                        if (!faceDomains[face].count(idom)) {
                            faceDomains[face][idom] =
                                vtkId; // volume associated to face in this domain
                            celldom[vtkId] = idom;
    ...
    for (int idomain = idom0; idomain < nbDomains; idomain++) {
        ...
        const TIDSortedElemSet &domain =
            (idomain == iRestDom) ? theRestDomElems : theElems[idomain];
        itface = faceDomains.begin();
        for (; itface != faceDomains.end(); ++itface) {
            const std::map<int, int> &domvol = itface->second;
            if (!domvol.count(idomain)) continue;
            ...
            for (; itn != oldNodes.end(); ++itn) {
                ...
                for (int i = 0; i < l.ncells; i++) {
                    ...
                    const SMDS_MeshElement *anElem =
                        GetMeshDS()->FindElement(GetMeshDS()->fromVtkToSmds(vtkId));
                    if (!domain.count(anElem)) continue;
    ...
    std::map<std::vector<int>, std::vector<int>>
        edgesMultiDomains;                        // nodes of edge --> ordered domains
    std::map<int, std::vector<int>> mutipleNodes; // nodes multi domains with domain order
    std::map<int, std::vector<int>>
        mutipleNodesToFace; // nodes multi domains with domain order to transform in Face (junction between 3 or more 2D domains)
                ...
                for (; itdom != domvol.end(); ++itdom) {
                    ...
                    if (!nodeDomains[oldId].count(idom)) // --- node to clone
                    {
                        if (nodeDomains[oldId].size() >= 2) // a multiple node
                        {
                            ...
                            if (mutipleNodes.count(oldId)) orderedDoms = mutipleNodes[oldId];
                            else {
    ...
    for (int idomain = idom0; idomain < nbDomains; idomain++) {
        ...
        for (; itface != faceDomains.end(); ++itface) {
            ...
            for (; itn != oldNodes.end(); ++itn) {
                int oldId = *itn;
                if (mutipleNodes.count(oldId)) nbMultipleNodes++;
            }
            if (nbMultipleNodes
                > 1) // check if an edge of the face is shared between 3 or more domains
            {
                ...
                if ((cellType == VTK_LINE)
                    || (cellType == VTK_QUADRATIC_EDGE)) // shared edge (between two faces)
                {
                    int nodes[3];
                ...
                else // shared face (between two volumes)
                {
                    ...
                    const unsigned char *edgeType =
                        grid->getDownArray(cellType)->getDownTypes(downId);
                    for (int ie = 0; ie < nbEdges; ie++) {
                        int nodes[3];
                        int nbNodes =
                            grid->getDownArray(edgeType[ie])->getNodes(downEdgeIds[ie], nodes);
                        if (mutipleNodes.count(nodes[0])
                            && mutipleNodes.count(nodes[nbNodes - 1])) {
                            vector<int> vn0 = mutipleNodes[nodes[0]];
                            vector<int> vn1 = mutipleNodes[nodes[nbNodes - 1]];
                            vector<int> doms;
                            for (int i0 = 0; i0 < vn0.size(); i0++)
                                for (int i1 = 0; i1 < vn1.size(); i1++)
                                    if (vn0[i0] == vn1[i1]) doms.push_back(vn0[i0]);
                            if (doms.size() > 2) {
                                ...
                                map<int, SMDS_VtkVolume *>
                                    domvol; // domain --> a volume with the edge
                                map<int, double>
                                    angleDom; // oriented angles between planes defined by edge and volume centers
                                int nbvol = grid->GetParentVolumes(vtkVolIds, downEdgeIds[ie],
                                                                   edgeType[ie]);
                                for (int id = 0; id < doms.size(); id++) {
                                    int idom = doms[id];
                                    const TIDSortedElemSet &domain =
                                        (idom == iRestDom) ? theRestDomElems : theElems[idom];
                                    for (int ivol = 0; ivol < nbvol; ivol++) {
                                        int smdsId = meshDS->fromVtkToSmds(vtkVolIds[ivol]);
                                        SMDS_MeshElement *elem =
                                            (SMDS_MeshElement *)meshDS->FindElement(smdsId);
                                        if (domain.count(elem)) {
                                            SMDS_VtkVolume *svol =
                                                dynamic_cast<SMDS_VtkVolume *>(elem);
                                            domvol[idom] = svol;
                                            ...
                                            if (id == 0) {
                                                gref.SetXYZ(
                                                    gp_XYZ(values[0], values[1], values[2]));
                                                angleDom[idom] = 0;
                                            }
                                            else {
                                                gp_Pnt g(values[0], values[1], values[2]);
                                                angleDom[idom] =
                                                    OrientedAngle(p0, p1, gref, g); // -pi<angle<+pi
                                ...
                                for (map<int, double>::iterator ia = angleDom.begin();
                                     ia != angleDom.end(); ++ia)
                                    sortedDom[ia->second] = ia->first;
                                vector<int> vnodes;
                                vector<int> vdom;
                                for (map<double, int>::iterator ib = sortedDom.begin();
                                     ib != sortedDom.end(); ++ib) {
                                ...
                                edgesMultiDomains[vnodes] =
                                    vdom; // nodes vector --> ordered domains
                            }
                        }
                    }
                }
    ...
    if (createJointElems) {
        ...
        mapOfJunctionGroups[joints2DName] =
            this->myMesh->AddGroup(SMDSAbs_Face, joints2DName.c_str(), idg);
        SMESHDS_Group *joints2DGrp =
            dynamic_cast<SMESHDS_Group *>(mapOfJunctionGroups[joints2DName]->GetGroupDS());
        string joints3DName = "joints3D";
        mapOfJunctionGroups[joints3DName] =
            this->myMesh->AddGroup(SMDSAbs_Volume, joints3DName.c_str(), idg);
        SMESHDS_Group *joints3DGrp =
            dynamic_cast<SMESHDS_Group *>(mapOfJunctionGroups[joints3DName]->GetGroupDS());
        ...
        for (; itface != faceDomains.end(); ++itface) {
            ...
            SMDS_MeshCell *vol = grid->extrudeVolumeFromFace(vtkVolId, dom1, dom2, oldNodes,
                                                             nodeDomains, nodeQuadDomains);
            stringstream grpname;
            grpname << "j_";
            if (dom1 < dom2) grpname << dom1 << "_" << dom2;
            else
                grpname << dom2 << "_" << dom1;
            string namegrp = grpname.str();
            if (!mapOfJunctionGroups.count(namegrp))
                mapOfJunctionGroups[namegrp] =
                    this->myMesh->AddGroup(vol->GetType(), namegrp.c_str(), idg);
            SMESHDS_Group *sgrp =
                dynamic_cast<SMESHDS_Group *>(mapOfJunctionGroups[namegrp]->GetGroupDS());
            if (sgrp) sgrp->Add(vol->GetID());
            if (vol->GetType() == SMDSAbs_Volume) joints3DGrp->Add(vol->GetID());
    ...
    if (createJointElems) {
        ...
        for (; itn != mutipleNodesToFace.end(); ++itn) {
            ...
            if (!mapOfJunctionGroups.count(namegrp))
                mapOfJunctionGroups[namegrp] =
                    this->myMesh->AddGroup(SMDSAbs_Face, namegrp.c_str(), idg);
            SMESHDS_Group *sgrp =
                dynamic_cast<SMESHDS_Group *>(mapOfJunctionGroups[namegrp]->GetGroupDS());
            if (sgrp) sgrp->Add(face->GetID());
        }
        ...
        for (; ite != edgesMultiDomains.end(); ++ite) {
            ...
            if (nodes.size() == 2) {
                ...
                if (!mapOfJunctionGroups.count(namegrp))
                    mapOfJunctionGroups[namegrp] =
                        this->myMesh->AddGroup(SMDSAbs_Volume, namegrp.c_str(), idg);
                SMESHDS_Group *sgrp =
                    dynamic_cast<SMESHDS_Group *>(mapOfJunctionGroups[namegrp]->GetGroupDS());
                if (sgrp) sgrp->Add(vol->GetID());
            }
    ...
    std::map<DownIdType, std::map<int, int>, DownIdCompare>
        faceOrEdgeDom;        // cellToModify --> (id domain --> id cell)
    ...
    for (int idomain = idom0; idomain < nbDomains; idomain++) {
        ...
        for (; itnod != nodeDomains.end(); ++itnod) {
            ...
            for (int i = 0; i < l.ncells; i++) {
                ...
                int vtkType = grid->GetCellType(vtkId);
                int downId = grid->CellIdToDownId(vtkId);
                if (downId < 0) continue; // new cells: not to be modified
                DownIdType aCell(downId, vtkType);
                int volParents[1000];
                ...
                for (int j = 0; j < nbvol; j++)
                    if (celldom.count(volParents[j]) && (celldom[volParents[j]] == idomain))
                        if (!feDom.count(vtkId)) {
                            ...
                            faceOrEdgeDom[aCell][idomain] =
                                vtkId; // affect face or edge to the first domain only
    ...
    std::map<DownIdType, std::map<int, int>, DownIdCompare> *maps[3] = {&faceDomains, &cellDomains,
                                                                        &faceOrEdgeDom};
    for (int m = 0; m < 3; m++) {
    ...
    meshDS
        ->CleanDownWardConnectivity(); // Mesh has been modified, downward connectivity is no more usable, free memory
    grid->BuildLinks();
    ...
    for (int idom = 0; idom < theElems.size(); idom++) {
        ...
        for (; elemItr != domain.end(); ++elemItr) {
            ...
            while (nodeIt->more()) {
                ...
                if (isMedium) ln2.push_back(node);
                else
                    ln0.push_back(node);
                ...
                if (isMedium) ln3.push_back(clone);
                else
                    ln1.push_back(clone);
            ...
            switch (aType) {
                case VTK_TRIANGLE:
                    ...
                    break;
                case VTK_QUAD:
                    vol = meshDS->AddVolume(ln0[3], ln0[2], ln0[1], ln0[0], ln1[3], ln1[2], ln1[1],
                                            ln1[0]);
                ...
                case VTK_QUADRATIC_TRIANGLE:
                    vol = meshDS->AddVolume(ln1[0], ln1[1], ln1[2], ln0[0], ln0[1], ln0[2], ln3[0],
                                            ln3[1], ln3[2], ln2[0], ln2[1], ln2[2], ln4[0], ln4[1],
                                            ln4[2]);
                ...
                case VTK_QUADRATIC_QUAD:
                    ...
                    vol = meshDS->AddVolume(ln1[0], ln1[1], ln1[2], ln1[3], ln0[0], ln0[1], ln0[2],
                                            ln0[3], ln3[0], ln3[1], ln3[2], ln3[3], ln2[0], ln2[1],
                                            ln2[2], ln2[3], ln4[0], ln4[1], ln4[2], ln4[3]);
 ...
 */
void SMESH_MeshEditor::CreateHoleSkin(double radius, const TopoDS_Shape &theShape,
                                      SMESH_NodeSearcher *theNodeSearcher, const char *groupName,
                                      ...
                                      std::vector<std::vector<int>> &listOfListOfNodes)
{
    ...
    if (groupDS) {
        if (groupDS->GetType() != SMDSAbs_Node) return;
        isNodeGroup = true; // a group of nodes exists and it is in this mesh
    }

    if (nodesCoords.size() > 0) isNodeCoords = true; // a list o nodes given by their coordinates
    ...
    if (gpnts.size() > 0) {
        ...
        if (startNode) nodeId = startNode->GetID();
        ...
        while (!setOfVolToCheck.empty()) {
            ...
            for (int i = 0; i < npts; i++) {
                ...
                if (mapOfNodeDistance2.count(pts[i])) {
                    ...
                    for (int j = 0; j < gpnts.size(); j++) {
                        ...
                        if (d2 < distance2) {
                            distance2 = d2;
                            if (distance2 < radius2) break;
                        }
                    }
                    mapOfNodeDistance2[pts[i]] = distance2;
                    MESSAGE("  point " << pts[i] << " distance2 " << distance2 << " coords "
            ...
            if (volInside) {
                ...
                MESSAGE("  volume inside,  vtkId " << vtkId << " smdsId "
                                                   << meshDS->fromVtkToSmds(vtkId));
                int neighborsVtkIds[NBMAXNEIGHBORS];
                int downIds[NBMAXNEIGHBORS];
                unsigned char downTypes[NBMAXNEIGHBORS];
                ...
                for (int n = 0; n < nbNeighbors; n++)
                    if (!setOfInsideVol.count(neighborsVtkIds[n])
                        || setOfOutsideVol.count(neighborsVtkIds[n]))
                        setOfVolToCheck.insert(neighborsVtkIds[n]);
            }
            else {
                setOfOutsideVol.insert(vtkId);
                MESSAGE("  volume outside, vtkId " << vtkId << " smdsId "
                                                   << meshDS->fromVtkToSmds(vtkId));
            }
    ...
    while (addedInside) {
        ...
        while (!setOfVolToCheck.empty()) {
            ...
            if (grid->GetCellType(vtkId) == VTK_HEXAHEDRON) {
                MESSAGE("volume to recheck,  vtkId " << vtkId << " smdsId "
                                                     << meshDS->fromVtkToSmds(vtkId));
                int countInside = 0;
                int neighborsVtkIds[NBMAXNEIGHBORS];
                int downIds[NBMAXNEIGHBORS];
                ...
                int nbNeighbors = grid->GetNeighbors(neighborsVtkIds, downIds, downTypes, vtkId);
                for (int n = 0; n < nbNeighbors; n++)
                    if (setOfInsideVol.count(neighborsVtkIds[n])) countInside++;
    ...
    std::map<DownIdType, int, DownIdCompare>
        boundaryFaces; // boundary faces inside the volume --> corresponding cell
    std::map<DownIdType, int, DownIdCompare>
        skinFaces; // faces on the skin of the global volume --> corresponding cell
    ...
    for (; it != setOfInsideVol.end(); ++it) {
        ...
        for (int n = 0; n < nbNeighbors; n++) {
            int neighborDim =
                SMDS_Downward::getCellDimension(grid->GetCellType(neighborsVtkIds[n]));
            if (neighborDim == 3) {
                if (!setOfInsideVol.count(
                        neighborsVtkIds[n])) // neighbor volume is not inside : face is boundary
                {
                    DownIdType face(downIds[n], downTypes[n]);
                ...
                if (vtkFaceId >= 0) {
                    ...
                    int nbEdges =
                        grid->getDownArray(downTypes[n])->getNumberOfDownCells(downIds[n]);
                    const int *dEdges = grid->getDownArray(downTypes[n])->getDownCells(downIds[n]);
                    const unsigned char *dTypes =
                        grid->getDownArray(downTypes[n])->getDownTypes(downIds[n]);
                    for (int i = 0; i < nbEdges; i++) {
                        int vtkEdgeId = grid->getDownArray(dTypes[i])->getVtkCellId(dEdges[i]);
                        if (vtkEdgeId >= 0) sgrpei->Add(meshDS->fromVtkToSmds(vtkEdgeId));
                    }
                }
            }
            else if (neighborDim == 2) // skin of the volume
            {
                ...
                int vtkFaceId = grid->getDownArray(downTypes[n])->getVtkCellId(downIds[n]);
                if (vtkFaceId >= 0) sgrps->Add(meshDS->fromVtkToSmds(vtkFaceId));
            }
        }
    }
    ...
    std::map<int, std::set<DownIdType, DownIdCompare>>
        shapeIdToEdges; // shapeId --> set of downward edges
    ...
    for (; itShape != shapeIdToVtkIdSet.end(); ++itShape) {
        ...
        for (; its != itShape->second.end(); ++its) {
            ...
            for (int n = 0; n < nbNeighbors; n++) {
                ...
                int smdsId = meshDS->fromVtkToSmds(neighborsVtkIds[n]);
                const SMDS_MeshElement *elem = meshDS->FindElement(smdsId);
                if (shapeIds.count(elem->getshapeId())
                    && !sgrps->Contains(
                        elem)) // edge : neighbor in the set of shape, not in the group
                {
                    ...
                    if (!shapeIdToEdges[shapeId].count(edge)) {
                        ...
                        int vtkNodeId[3];
                        int nbNodes =
                            grid->getDownArray(downTypes[n])->getNodes(downIds[n], vtkNodeId);
                        nodesEdges.push_back(vtkNodeId[0]);
                        nodesEdges.push_back(vtkNodeId[nbNodes - 1]);
                        MESSAGE("       --- nodes " << vtkNodeId[0] + 1 << " "
                                                    << vtkNodeId[nbNodes - 1] + 1);
                    }
                }
            }
        }
        ...
        if (nodesEdges.size() > 0) {
            order.push_back(nodesEdges[0]);
            MESSAGE("       --- back " << order.back() + 1); // SMDS id = VTK id + 1;
            nodesEdges[0] = -1;
            order.push_back(nodesEdges[1]);
            MESSAGE("       --- back " << order.back() + 1);
            ...
            while (found) {
                ...
                for (i = 0; i < nodesEdges.size(); i++)
                    if (nodesEdges[i] == nodeTofind) break;
                if (i == nodesEdges.size()) found = false; // no follower found on back
                else {
                    if (i % 2) // odd ==> use the previous one
                        if (nodesEdges[i - 1] < 0) found = false;
                        else {
                            order.push_back(nodesEdges[i - 1]);
                            MESSAGE("       --- back " << order.back() + 1);
                            nodesEdges[i - 1] = -1;
                        }
                ...
                if (i % 2) // odd ==> use the previous one
                    if (nodesEdges[i - 1] < 0) found = false;
                        ...
                        order.push_front(nodesEdges[i - 1]);
                        MESSAGE("       --- front " << order.front() + 1);
                        nodesEdges[i - 1] = -1;
                    }
                else // even ==> use the next one
                    if (nodesEdges[i + 1] < 0) found = false;
...
bool SMESH_MeshEditor::Make2DMeshFrom3D()
{
    ...
    while (vIt->more()) {
        ...
        for (int iface = 0, n = vTool.NbFaces(); iface < n; iface++) {
            if (!vTool.IsFreeFace(iface)) continue;
            nbFree++;
            vector<const SMDS_MeshNode *> nodes;
            int nbFaceNodes = vTool.NbFaceNodes(iface);
            const SMDS_MeshNode **faceNodes = vTool.GetFaceNodes(iface);
            int inode = 0;
            for (; inode < nbFaceNodes; inode += iQuad + 1) nodes.push_back(faceNodes[inode]);

            if (iQuad) // add medium nodes
            {
                for (inode = 1; inode < nbFaceNodes; inode += 2) nodes.push_back(faceNodes[inode]);
...
{
    if (const SMDS_MeshNode *n = mesh->FindNode(node->GetID())) return n;
...
int SMESH_MeshEditor::MakeBoundaryMesh(const TIDSortedElemSet &elements, Bnd_Dimension dimension,
                                       SMESH_Group *group /*=0*/, SMESH_Mesh *targetMesh /*=0*/,
                                       ...
                                       bool aroundElements /*= false*/)
{
    ...
    if (!targetMesh) toCopyElements = toCopyExistingBoundary = false;
    ...
    while (eIt->more()) {
        ...
        if (vTool.Set(elem, /*ignoreCentralNodes=*/true)) // elem is a volume --------------
        {
            ...
            if (missType == SMDSAbs_Face) vTool.SetExternalNormal();
            for (size_t i = 0; i < freeFacets.size(); ++i) {
                ...
                if (missType == SMDSAbs_Edge) // boundary edges
                {
                    ...
                    for (int i = 0; i < nbFaceNodes; i += 1 + iQuad) {
                        for (int j = 0; j < nodes.size(); ++j) nodes[j] = nn[i + j];
                ...
                else // boundary face
                {
                    ...
                    if (iCenter > 0) nodes.push_back(vTool.GetNodes()[iCenter]);

                    if (const SMDS_MeshElement *f =
                            aMesh->FindElement(nodes, SMDSAbs_Face, /*noMedium=*/false))
        ...
        if (targetMesh != myMesh)
            ...
            for (size_t i = 0; i < missingBndElems.size(); ++i) {
                ...
                if (aroundElements
                    && tgtEditor.GetMeshDS()->FindElement(tgtNodes, missType,
                                                          /*noMedium=*/false))
                    continue;
            ...
            for (int i = 0; i < missingBndElems.size(); ++i) {
                ...
                if (aroundElements
                    && tgtEditor.GetMeshDS()->FindElement(nodes, missType,
                                                          /*noMedium=*/false))
                    continue;
                SMDS_MeshElement *newElem =
...
void SMESH_MeshEditor::copyPosition(const SMDS_MeshNode *from, const SMDS_MeshNode *to)
{
    if (!from || !to) return;
    ...
    switch (pos->GetTypeOfPosition()) {
        ...
        case SMDS_TOP_FACE: {
            ...
            GetMeshDS()->SetNodeOnFace(to, from->getshapeId(), fPos->GetUParameter(),
                                       fPos->GetVParameter());
            break;
        }
        case SMDS_TOP_EDGE: {
