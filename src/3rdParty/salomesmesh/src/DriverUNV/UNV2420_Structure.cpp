...
//                    const TDataSet& theDataSet)
{
    ...
    if (part_name.empty()) out_stream << "SMESH_Mesh" << endl; // R2: Part Name
    else
    ...
    out_stream << "    1.0000000000000000E+0    0.0000000000000000E+0    0.0000000000000000E+0"
               << endl;
    out_stream << "    0.0000000000000000E+0    1.0000000000000000E+0    0.0000000000000000E+0"
               << endl;
    out_stream << "    0.0000000000000000E+0    0.0000000000000000E+0    1.0000000000000000E+0"
               << endl;
    out_stream << "    0.0000000000000000E+0    0.0000000000000000E+0    0.0000000000000000E+0"
               << endl;
