...
int main()
{
    ...
    i = 0;
    for (KDTREE_TYPE_2il::const_reverse_iterator iter = t.tree.rbegin(); iter != t.tree.rend();
         ++iter, ++i)
        ;
    ...
    std::cout << "Nearest to " << s << ": " << t.find_nearest(s) << std::endl;

    RECORD_2il::point_t s2 = {10, 10};
    std::cout << "Nearest to " << s2 << ": " << t.find_nearest(s2) << std::endl;
