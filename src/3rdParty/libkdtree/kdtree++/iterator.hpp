...
namespace KDTree
{
template<typename _Val, typename _Ref, typename _Ptr> class _Iterator;
...
protected:
    ...
    template<size_t const __K, typename _Val, typename _Acc, typename _Dist, typename _Cmp,
             typename _Alloc>
    friend class KDTree;
};

template<typename _Val, typename _Ref, typename _Ptr> class _Iterator: protected _Base_iterator
{
public:
