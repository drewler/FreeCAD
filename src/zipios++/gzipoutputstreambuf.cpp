...
GZIPOutputStreambuf::GZIPOutputStreambuf(streambuf *outbuf, bool del_outbuf)
    : DeflateOutputStreambuf(outbuf, true, del_outbuf), _open(false)
{}

void GZIPOutputStreambuf::setFilename(const string &filename) { _filename = filename; }

void GZIPOutputStreambuf::setComment(const string &comment) { _comment = comment; }

void GZIPOutputStreambuf::close() { finish(); }
...
GZIPOutputStreambuf::~GZIPOutputStreambuf() { finish(); }
...
int GZIPOutputStreambuf::sync() { return DeflateOutputStreambuf::sync(); }
