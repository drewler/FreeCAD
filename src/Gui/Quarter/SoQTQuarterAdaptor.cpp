...
SIM::Coin3D::Quarter::SoQTQuarterAdaptor::SoQTQuarterAdaptor(QtGLContext *context, QWidget *parent,
                                                             const QtGLWidget *sharewidget,
                                                             Qt::WindowFlags f)
...
SIM::Coin3D::Quarter::SoQTQuarterAdaptor::~SoQTQuarterAdaptor() { delete m_seeksensor; }
...
QWidget *SIM::Coin3D::Quarter::SoQTQuarterAdaptor::getGLWidget() { return viewport(); }
...
QWidget *SIM::Coin3D::Quarter::SoQTQuarterAdaptor::getGLWidget() const { return viewport(); }
...
void SIM::Coin3D::Quarter::SoQTQuarterAdaptor::convertOrtho2Perspective(
    const SoOrthographicCamera *in, SoPerspectiveCamera *out)
{
    if (!in || !out) {
...
void SIM::Coin3D::Quarter::SoQTQuarterAdaptor::convertPerspective2Ortho(
    const SoPerspectiveCamera *in, SoOrthographicCamera *out)
{
    out->aspectRatio.setValue(in->aspectRatio.getValue());
    out->focalDistance.setValue(in->focalDistance.getValue());
    out->orientation.setValue(in->orientation.getValue());
...
SbBool SIM::Coin3D::Quarter::SoQTQuarterAdaptor::isViewing() const { return m_viewingflag; }
...
void SIM::Coin3D::Quarter::SoQTQuarterAdaptor::interactiveCountInc()
{
    ...
    if (++m_interactionnesting == 1) { m_interactionStartCallback.invokeCallbacks(this); }
}
...
void SIM::Coin3D::Quarter::SoQTQuarterAdaptor::addStartCallback(
    SIM::Coin3D::Quarter::SoQTQuarterAdaptorCB *func, void *data)
{
    m_interactionStartCallback.addCallback((SoCallbackListCB *)func, data);
}

void SIM::Coin3D::Quarter::SoQTQuarterAdaptor::removeStartCallback(
    SIM::Coin3D::Quarter::SoQTQuarterAdaptorCB *func, void *data)
{
    m_interactionStartCallback.removeCallback((SoCallbackListCB *)func, data);
}

void SIM::Coin3D::Quarter::SoQTQuarterAdaptor::addFinishCallback(
    SIM::Coin3D::Quarter::SoQTQuarterAdaptorCB *func, void *data)
{
    m_interactionEndCallback.addCallback((SoCallbackListCB *)func, data);
}

void SIM::Coin3D::Quarter::SoQTQuarterAdaptor::removeFinishCallback(
    SIM::Coin3D::Quarter::SoQTQuarterAdaptorCB *func, void *data)
{
...
float SIM::Coin3D::Quarter::SoQTQuarterAdaptor::getSeekDistance() const { return m_seekdistance; }

float SIM::Coin3D::Quarter::SoQTQuarterAdaptor::getSeekTime() const { return m_seekperiod; }

SbBool SIM::Coin3D::Quarter::SoQTQuarterAdaptor::isSeekMode() const { return m_inseekmode; }
...
void SIM::Coin3D::Quarter::SoQTQuarterAdaptor::setPickRadius(float pickRadius)
{
    ...
    if (evm) {
        ...
        if (a) { a->setPickRadius(pickRadius); }
    }
}
...
void SIM::Coin3D::Quarter::SoQTQuarterAdaptor::seekToPoint(const SbVec3f &scenepos)
{
    ...
    getCameraCoordinateSystem(getSoRenderManager()->getCamera(), getSceneGraph(), cameramatrix,
                              camerainverse);
...
void SIM::Coin3D::Quarter::SoQTQuarterAdaptor::seeksensorCB(void *data, SoSensor *s)
{
    ...
    float t = float((currenttime - sensor->getBaseTime()).getValue()) / thisp->m_seekperiod;
    ...
    thisp->getSoRenderManager()->getCamera()->orientation =
        SbRotation::slerp(thisp->m_camerastartorient, thisp->m_cameraendorient, t);
...
void SIM::Coin3D::Quarter::SoQTQuarterAdaptor::saveHomePosition()
{
    ...
    if (m_storedcamera) { m_storedcamera->unref(); }
...
void SIM::Coin3D::Quarter::SoQTQuarterAdaptor::draw2DString(const char *str, SbVec2s glsize,
                                                            SbVec2f position)
{
    // Store GL state.
...
void SIM::Coin3D::Quarter::SoQTQuarterAdaptor::printString(const char *s)
{
    ...
    for (i = 0; i < n; i++) glBitmap(8, 12, 0.0, 2.0, 10.0, 0.0, fps2dfont[s[i] - 32]);
}
    ...
    if (type.isDerivedFrom(SoKeyboardEvent::getClassTypeId())) {
        ...
        if (keyevent->getState() == SoButtonEvent::DOWN) {
            switch (keyevent->getKey()) {
                ...
                case SoKeyboardEvent::UP_ARROW: moveCameraScreen(SbVec2f(0.0f, 0.1f)); return true;
