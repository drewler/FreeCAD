...
private:
    ...
    static void writeX3DChild(SoNode *node, std::map<SoNode *, std::string> &nodeMap, int &numDEF,
                              int spaces, std::ostream &out);
    static void writeX3DFields(SoNode *node, std::map<SoNode *, std::string> &nodeMap, bool isRoot,
