...
protected:
    ...
    void slotSkipRecompute(const App::Document &doc,
...
public:
    ...
    mutable boost::signals2::signal<void(const Gui::ViewProviderDocumentObject &,
                                         const Gui::HighlightMode &, bool,
                                         App::DocumentObject *parent, const char *subname)>
        signalHighlightObject;
    /// signal on changed Object, the 2nd argument is the highlite mode to use
    mutable boost::signals2::signal<void(const Gui::ViewProviderDocumentObject &,
                                         const Gui::TreeItemMode &, App::DocumentObject *parent,
                                         const char *subname)>
        signalExpandObject;
    ...
    void addRootObjectsToGroup(const std::vector<App::DocumentObject *> &,
    ...
    ViewProvider *getInEdit(ViewProviderDocumentObject **parentVp = nullptr,
                            std::string *subname = nullptr, int *mode = nullptr,
