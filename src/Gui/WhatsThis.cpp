...
StdCmdDescription::StdCmdDescription() : Command("Std_DescriptionMode")
{
    sGroup = "Help";
...
{
    Q_UNUSED(iMsg);
    if (!inDescriptionMode()) enterDescriptionMode();
    else
        leaveDescriptionMode();
}

bool StdCmdDescription::inDescriptionMode() { return _descrMode; }
