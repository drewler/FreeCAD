 ...
 */
DlgInputDialogImp::DlgInputDialogImp(const QString &labelTxt, QWidget *parent, bool modal,
                                     Type type)
    : QDialog(parent), ui(new Ui_DlgInputDialog)
{
    this->setModal(modal);
    ui->setupUi(this);
...
{
    if (!ui->lineEdit->text().isEmpty()) accept();
}
...
void DlgInputDialogImp::setType(DlgInputDialogImp::Type t)
{
    ...
    switch (inputtype) {
        case LineEdit: input = ui->lineEdit; break;
        case SpinBox: input = ui->spinBox; break;
        case UIntBox: input = ui->uIntSpinBox; break;
        case FloatSpinBox: input = ui->floatSpinBox; break;
        case ComboBox: input = ui->comboBox; break;
        default: break;
    }
...
DlgInputDialogImp::Type DlgInputDialogImp::type() const { return inputtype; }

QSpinBox *DlgInputDialogImp::getSpinBox() const { return ui->spinBox; }

Gui::UIntSpinBox *DlgInputDialogImp::getUIntBox() const { return ui->uIntSpinBox; }

QDoubleSpinBox *DlgInputDialogImp::getFloatSpinBox() const { return ui->floatSpinBox; }

QLineEdit *DlgInputDialogImp::getLineEdit() const { return ui->lineEdit; }

QComboBox *DlgInputDialogImp::getComboBox() const { return ui->comboBox; }
