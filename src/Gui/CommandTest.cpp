...
Std_TestQM::Std_TestQM() : Command("Std_TestQM")
{
...
void Std_TestQM::activated(int iMsg)
{
    Q_UNUSED(iMsg);
    QStringList files =
        QFileDialog::getOpenFileNames(getMainWindow(), QString::fromLatin1("Test translation"),
                                      QString(), QString::fromLatin1("Translation (*.qm)"));
    if (!files.empty()) {
        ...
        for (QStringList::Iterator it = files.begin(); it != files.end(); ++it) {
            ...
            if (translator->load(*it)) { qApp->installTranslator(translator); }
            else {
                delete translator;
            }
        }
...
Std_TestReloadQM::Std_TestReloadQM() : Command("Std_TestReloadQM")
{
    sGroup = "Standard-Test";
...
FCCmdTest1::FCCmdTest1() : Command("Std_Test1")
{
    sGroup = "Standard-Test";
    sMenuText = "Test1";
...
void FCCmdTest1::activated(int iMsg) { Q_UNUSED(iMsg); }
...
FCCmdTest2::FCCmdTest2() : Command("Std_Test2")
{
    sGroup = "Standard-Test";
    sMenuText = "Test2";
...
void FCCmdTest2::activated(int iMsg) { Q_UNUSED(iMsg); }

bool FCCmdTest2::isActive() { return (getDocument() != nullptr); }
...
FCCmdTest3::FCCmdTest3() : Command("Std_Test3")
{
    sGroup = "Standard-Test";
    sMenuText = "Test3";
...
bool FCCmdTest3::isActive() { return (getDocument() != nullptr); }
...
FCCmdTest4::FCCmdTest4() : Command("Std_Test4")
{
    sGroup = "Standard-Test";
    sMenuText = "Test4";
...
bool FCCmdTest4::isActive() { return (getDocument() != nullptr); }
...
FCCmdTest5::FCCmdTest5() : Command("Std_Test5")
{
    sGroup = "Standard-Test";
    sMenuText = "Test5";
...
bool FCCmdTest5::isActive() { return (getDocument() != nullptr); }
...
FCCmdTest6::FCCmdTest6() : Command("Std_Test6")
{
    sGroup = "Standard-Test";
    sMenuText = "Test6";
...
bool FCCmdTest6::isActive() { return (getDocument() != nullptr); }
...
CmdTestCmdFuncs::CmdTestCmdFuncs() : Command("Std_TestCmdFuncs")
{
    sGroup = "Standard-Test";
...
void CmdTestCmdFuncs::activated(int iMsg)
{
    ...
    Gui::cmdAppObject(obj,
                      std::ostringstream() << "Visibility ="
                                           << "False");
    Gui::cmdGuiObject(obj,
                      std::ostringstream() << "Visibility ="
                                           << "False");
...
bool CmdTestCmdFuncs::isActive() { return (getDocument() != nullptr); }
...
CmdTestProgress1::CmdTestProgress1() : Command("Std_TestProgress1")
{
    sGroup = "Standard-Test";
...
bool CmdTestProgress1::isActive() { return (!Base::Sequencer().isRunning()); }
...
CmdTestProgress2::CmdTestProgress2() : Command("Std_TestProgress2")
{
    sGroup = "Standard-Test";
...
bool CmdTestProgress2::isActive() { return (!Base::Sequencer().isRunning()); }
...
CmdTestProgress3::CmdTestProgress3() : Command("Std_TestProgress3")
{
    sGroup = "Standard-Test";
...
bool CmdTestProgress3::isActive() { return (!Base::Sequencer().isRunning()); }
...
CmdTestProgress4::CmdTestProgress4() : Command("Std_TestProgress4")
{
    sGroup = "Standard-Test";
...
bool CmdTestProgress4::isActive() { return (!Base::Sequencer().isRunning()); }
...
CmdTestProgress5::CmdTestProgress5() : Command("Std_TestProgress5")
{
    sGroup = "Standard-Test";
...
bool CmdTestProgress5::isActive() { return (!Base::Sequencer().isRunning()); }
...
CmdTestMDI1::CmdTestMDI1() : Command("Std_MDITest1")
{
    sGroup = "Standard-Test";
...
bool CmdTestMDI1::isActive() { return getMainWindow()->activeWindow(); }

DEF_STD_CMD_A(CmdTestMDI2)

CmdTestMDI2::CmdTestMDI2() : Command("Std_MDITest2")
{
    sGroup = "Standard-Test";
...
bool CmdTestMDI2::isActive() { return getMainWindow()->activeWindow(); }

DEF_STD_CMD_A(CmdTestMDI3)

CmdTestMDI3::CmdTestMDI3() : Command("Std_MDITest3")
{
    sGroup = "Standard-Test";
...
void CmdTestMDI3::activated(int iMsg)
{
    ...
    MDIView *mdi = getMainWindow()->activeWindow();
    getMainWindow()->removeWindow(mdi);
    mdi->setParent(nullptr,
                   Qt::Window | Qt::WindowTitleHint | Qt::WindowSystemMenuHint
                       | Qt::WindowMinMaxButtonsHint);
    mdi->show();
}

bool CmdTestMDI3::isActive() { return getMainWindow()->activeWindow(); }

DEF_STD_CMD(CmdTestConsoleOutput)

CmdTestConsoleOutput::CmdTestConsoleOutput() : Command("Std_TestConsoleOutput")
{
    sGroup = "Standard-Test";
...
public:
    void run() override
    {
        for (int i = 0; i < 10; i++) Base::Console().Log("Write a log to the console output.\n");
    }
};
