...
void SoShapeScale::initClass() { SO_KIT_INIT_CLASS(SoShapeScale, SoBaseKit, "BaseKit"); }
...
void SoAxisCrossKit::initClass() { SO_KIT_INIT_CLASS(SoAxisCrossKit, SoBaseKit, "BaseKit"); }
...
SbBool SoAxisCrossKit::affectsState() const { return false; }
...
void SoRegPoint::initClass() { SO_NODE_INIT_CLASS(SoRegPoint, SoShape, "Shape"); }
...
SoRegPoint::~SoRegPoint() { root->unref(); }
