...
const char *TinkerCADNavigationStyle::mouseButtons(ViewerMode mode)
{
    switch (mode) {
        ...
        case NavigationStyle::DRAGGING: return QT_TR_NOOP("Press right mouse button");
...
SbBool TinkerCADNavigationStyle::processSoEvent(const SoEvent *const ev)
{
        ...
        switch (button) {
            ...
            case SoMouseButtonEvent::BUTTON2:
                ...
                if (press) {
                    ...
                    if (tmp.getValue() < dci) { canOpenPopupMenu = true; }
                }
    ...
    switch (combo) {
        case 0:
            ...
            newmode = NavigationStyle::IDLE;
            break;
        case BUTTON1DOWN: newmode = NavigationStyle::SELECTION; break;
        case BUTTON2DOWN: newmode = NavigationStyle::DRAGGING; break;
