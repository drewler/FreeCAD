...
static double degreesToRadians(const double &degreesIn) { return degreesIn * (M_PI / 180.0); }
...
{
    auto incrementsBox = new Gui::TaskView::TaskBox(Gui::BitmapFactory().pixmap("button_valid"),
