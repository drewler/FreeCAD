...
VertexProperty::VertexProperty()
    : rectangle(new RectItem()), point(new QGraphicsEllipseItem()),
      visibleIcon(new QGraphicsPixmapItem()), stateIcon(new QGraphicsPixmapItem()),
      icon(new QGraphicsPixmapItem()), text(new QGraphicsTextItem()), row(0), column(0),
      topoSortIndex(0), lastVisibleState(VisibilityState::None),
      lastFeatureState(FeatureState::None), dagVisible(true)
{
    //set z values.
