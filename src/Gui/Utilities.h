...
template<> struct vec_traits<SbVec3f> {
...
template<> struct vec_traits<SbVec3d> {
...
template<> struct vec_traits<SbRotation> {
...
template<> struct vec_traits<SbColor> {
...
template<> struct vec_traits<App::Color> {
