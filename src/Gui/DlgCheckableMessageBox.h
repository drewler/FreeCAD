...
public:
    ...
    static QDialogButtonBox::StandardButton question(
        QWidget *parent, const QString &title, const QString &question, const QString &checkBoxText,
    ...
    static void showMessage(const QString &header, const QString &message, bool check = false,
    ...
    static void showMessage(const QString &header, const QString &message, const QString &prefPath,
                            const QString &paramEntry, bool entryDefault = false,
                            bool check = false,
                            const QString &checkText = QString::fromLatin1("Don't show me again"));
