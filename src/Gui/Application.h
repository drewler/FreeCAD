...
protected:
    ...
    const std::map<int, std::string> userEditModes {{0, QT_TRANSLATE_NOOP("EditMode", "Default")},
...
public:
    ...
    static PyObject *sAddWorkbenchHandler(PyObject *self,
                                          PyObject *args); // adds a new workbench handler to a list
    static PyObject *
