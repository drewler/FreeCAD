...
StdOrthographicCamera::StdOrthographicCamera() : Command("Std_OrthographicCamera")
{
...
bool StdOrthographicCamera::isActive()
{
    ...
    if (view) {
        ...
        if (mode != check) _pcAction->setChecked(mode);
        return true;
    }
...
StdPerspectiveCamera::StdPerspectiveCamera() : Command("Std_PerspectiveCamera")
{
    sGroup = "Standard-View";
...
StdCmdViewSaveCamera::StdCmdViewSaveCamera() : Command("Std_ViewSaveCamera")
{
    sGroup = "Standard-View";
...
void StdCmdViewSaveCamera::activated(int iMsg)
{
    ...
    if (view) { view->getViewer()->saveHomePosition(); }
}
...
StdCmdViewRestoreCamera::StdCmdViewRestoreCamera() : Command("Std_ViewRestoreCamera")
{
    sGroup = "Standard-View";
...
void StdCmdViewRestoreCamera::activated(int iMsg)
{
    ...
    auto view = qobject_cast<Gui::View3DInventor *>(Gui::getMainWindow()->activeWindow());
    if (view) { view->getViewer()->resetToHomePosition(); }
}
...
public:
    ...
    const char *className() const override { return "StdCmdFreezeViews"; }
...
StdCmdFreezeViews::StdCmdFreezeViews()
    : Command("Std_FreezeViews"), maxViews(50), savedViews(0), offset(0), saveView(nullptr),
      freezeView(nullptr), clearView(nullptr), separator(nullptr)
{
    sGroup = "Standard-View";
...
void StdCmdFreezeViews::onSaveViews()
{
    ...
    QString fn = FileDialog::getSaveFileName(
        getMainWindow(), QObject::tr("Save frozen views"), QString(),
    ...
    if (file.open(QFile::WriteOnly)) {
        ...
        for (QList<QAction *>::Iterator it = acts.begin() + offset; it != acts.end(); ++it) {
            ...
            if (!data.isEmpty()) {
                ...
                if (lines.size() > 1) { lines.pop_front(); }
...
void StdCmdFreezeViews::onRestoreViews()
{
    ...
    if (savedViews > 0) {
        int ret = QMessageBox::question(
            getMainWindow(), QObject::tr("Restore views"),
    ...
    QString fn = FileDialog::getOpenFileName(
        getMainWindow(), QObject::tr("Restore frozen views"), QString(),
        QString::fromLatin1("%1 (*.cam)").arg(QObject::tr("Frozen views")));
    if (fn.isEmpty()) return;
    QFile file(fn);
    ...
    if (scheme == 1) {
        ...
        if (numRestoredViews > 0) separator->setVisible(true);
...
StdCmdToggleClipPlane::StdCmdToggleClipPlane() : Command("Std_ToggleClipPlane")
{
    sGroup = "Standard-View";
...
void StdCmdToggleClipPlane::activated(int iMsg)
{
    ...
    if (!clipping) {
        auto view = qobject_cast<View3DInventor *>(getMainWindow()->activeWindow());
        if (view) { clipping = Gui::Dialog::Clipping::makeDockWidget(view); }
    }
}
...
StdCmdDrawStyle::StdCmdDrawStyle() : Command("Std_DrawStyle")
{
    sGroup = "Standard-View";
    ...
    this->getGuiApplication()->signalActivateView.connect(
        boost::bind(&StdCmdDrawStyle::updateIcon, this, bp::_1));
}
...
bool StdCmdDrawStyle::isActive() { return Gui::Application::Instance->activeDocument(); }
...
StdCmdToggleVisibility::StdCmdToggleVisibility() : Command("Std_ToggleVisibility")
{
    sGroup = "Standard-View";
...
bool StdCmdToggleVisibility::isActive() { return (Gui::Selection().size() != 0); }
...
StdCmdToggleSelectability::StdCmdToggleSelectability() : Command("Std_ToggleSelectability")
{
    sGroup = "Standard-View";
...
bool StdCmdToggleSelectability::isActive() { return (Gui::Selection().size() != 0); }
...
StdCmdShowSelection::StdCmdShowSelection() : Command("Std_ShowSelection")
{
    sGroup = "Standard-View";
...
bool StdCmdShowSelection::isActive() { return (Gui::Selection().size() != 0); }
...
StdCmdHideSelection::StdCmdHideSelection() : Command("Std_HideSelection")
{
    sGroup = "Standard-View";
...
bool StdCmdHideSelection::isActive() { return (Gui::Selection().size() != 0); }
...
StdCmdSelectVisibleObjects::StdCmdSelectVisibleObjects() : Command("Std_SelectVisibleObjects")
{
    sGroup = "Standard-View";
...
void StdCmdSelectVisibleObjects::activated(int iMsg)
{
    ...
    for (const auto &it : obj) {
        if (doc->isShow(it->getNameInDocument())) visible.push_back(it);
    }
...
bool StdCmdSelectVisibleObjects::isActive() { return App::GetApplication().getActiveDocument(); }
...
StdCmdToggleObjects::StdCmdToggleObjects() : Command("Std_ToggleObjects")
{
    sGroup = "Standard-View";
...
bool StdCmdToggleObjects::isActive() { return App::GetApplication().getActiveDocument(); }
...
StdCmdShowObjects::StdCmdShowObjects() : Command("Std_ShowObjects")
{
    sGroup = "Standard-View";
...
void StdCmdShowObjects::activated(int iMsg)
{
    ...
    for (const auto &it : obj) {
        doCommand(Gui, "Gui.getDocument(\"%s\").getObject(\"%s\").Visibility=True", app->getName(),
                  it->getNameInDocument());
    }
}

bool StdCmdShowObjects::isActive() { return App::GetApplication().getActiveDocument(); }
...
StdCmdHideObjects::StdCmdHideObjects() : Command("Std_HideObjects")
{
    sGroup = "Standard-View";
...
void StdCmdHideObjects::activated(int iMsg)
{
    ...
    for (const auto &it : obj) {
        doCommand(Gui, "Gui.getDocument(\"%s\").getObject(\"%s\").Visibility=False", app->getName(),
                  it->getNameInDocument());
    }
}

bool StdCmdHideObjects::isActive() { return App::GetApplication().getActiveDocument(); }
...
StdCmdViewHome::StdCmdViewHome() : Command("Std_ViewHome")
{
    sGroup = "Standard-View";
...
void StdCmdViewHome::activated(int iMsg)
{
    ...
    doCommand(Command::Gui, "Gui.activeDocument().activeView().viewDefaultOrientation('%s',0)",
              default_view.c_str());
...
StdCmdViewBottom::StdCmdViewBottom() : Command("Std_ViewBottom")
{
    sGroup = "Standard-View";
...
StdCmdViewFront::StdCmdViewFront() : Command("Std_ViewFront")
{
    sGroup = "Standard-View";
...
StdCmdViewLeft::StdCmdViewLeft() : Command("Std_ViewLeft")
{
    sGroup = "Standard-View";
...
StdCmdViewRear::StdCmdViewRear() : Command("Std_ViewRear")
{
    sGroup = "Standard-View";
...
StdCmdViewRight::StdCmdViewRight() : Command("Std_ViewRight")
{
    sGroup = "Standard-View";
...
StdCmdViewTop::StdCmdViewTop() : Command("Std_ViewTop")
{
    sGroup = "Standard-View";
...
StdCmdViewIsometric::StdCmdViewIsometric() : Command("Std_ViewIsometric")
{
    sGroup = "Standard-View";
...
StdCmdViewDimetric::StdCmdViewDimetric() : Command("Std_ViewDimetric")
{
    sGroup = "Standard-View";
...
StdCmdViewTrimetric::StdCmdViewTrimetric() : Command("Std_ViewTrimetric")
{
    sGroup = "Standard-View";
...
StdCmdViewRotateLeft::StdCmdViewRotateLeft() : Command("Std_ViewRotateLeft")
{
    sGroup = "Standard-View";
...
StdCmdViewRotateRight::StdCmdViewRotateRight() : Command("Std_ViewRotateRight")
{
    sGroup = "Standard-View";
...
StdCmdViewFitAll::StdCmdViewFitAll() : Command("Std_ViewFitAll")
{
    sGroup = "Standard-View";
...
StdCmdViewFitSelection::StdCmdViewFitSelection() : Command("Std_ViewFitSelection")
{
    sGroup = "Standard-View";
...
StdViewDock::StdViewDock() : Command("Std_ViewDock")
{
    sGroup = "Standard-View";
...
void StdViewDock::activated(int iMsg) { Q_UNUSED(iMsg); }
...
StdViewUndock::StdViewUndock() : Command("Std_ViewUndock")
{
    sGroup = "Standard-View";
...
void StdViewUndock::activated(int iMsg) { Q_UNUSED(iMsg); }
...
StdMainFullscreen::StdMainFullscreen() : Command("Std_MainFullscreen")
{
    sGroup = "Standard-View";
...
void StdMainFullscreen::activated(int iMsg)
{
    ...
    if (view) view->setCurrentViewMode(MDIView::Child);
...
StdViewFullscreen::StdViewFullscreen() : Command("Std_ViewFullscreen")
{
    sGroup = "Standard-View";
    sMenuText = QT_TR_NOOP("Fullscreen");
    sToolTipText =
...
void StdViewFullscreen::activated(int iMsg) { Q_UNUSED(iMsg); }
...
StdViewDockUndockFullscreen::StdViewDockUndockFullscreen() : Command("Std_ViewDockUndockFullscreen")
{
    sGroup = "Standard-View";
...
void StdViewDockUndockFullscreen::activated(int iMsg)
{
    ...
    if (doc) {
        ...
        if (iMsg == 0) { getMainWindow()->addWindow(clone); }
            ...
            if (view->currentViewMode() == MDIView::TopLevel) getMainWindow()->addWindow(clone);
            else
                clone->setCurrentViewMode(MDIView::TopLevel);
        }
        else if (iMsg == 2) {
            if (view->currentViewMode() == MDIView::FullScreen) getMainWindow()->addWindow(clone);
            else
...
StdViewScreenShot::StdViewScreenShot() : Command("Std_ViewScreenShot")
{
    sGroup = "Standard-View";
...
void StdViewScreenShot::activated(int iMsg)
{
    ...
    if (view) {
        ...
        for (QStringList::Iterator it = formats.begin(); it != formats.end(); ++it) {
            ...
            if (ext == *it) selFilter = filter.last();
        }
        ...
        if (!selFilter.isEmpty()) fd.selectNameFilter(selFilter);
        ...
        QObject::connect(&fd, SIGNAL(filterSelected(const QString &)), opt,
...
bool StdViewScreenShot::isActive() { return isViewOfType(Gui::View3DInventor::getClassTypeId()); }
...
StdCmdViewCreate::StdCmdViewCreate() : Command("Std_ViewCreate")
{
    sGroup = "Standard-View";
...
bool StdCmdViewCreate::isActive() { return (getActiveGuiDocument() != nullptr); }
...
StdCmdToggleNavigation::StdCmdToggleNavigation() : Command("Std_ToggleNavigation")
{
    sGroup = "Standard-View";
...
StdCmdAxisCross::StdCmdAxisCross() : Command("Std_AxisCross")
{
    sGroup = "Standard-View";
...
StdCmdViewExample1::StdCmdViewExample1() : Command("Std_ViewExample1")
{
    sGroup = "Standard-View";
...
StdCmdViewExample2::StdCmdViewExample2() : Command("Std_ViewExample2")
{
    sGroup = "Standard-View";
...
StdCmdViewExample3::StdCmdViewExample3() : Command("Std_ViewExample3")
{
    sGroup = "Standard-View";
...
StdCmdViewIvStereoOff::StdCmdViewIvStereoOff() : Command("Std_ViewIvStereoOff")
{
    sGroup = "Standard-View";
...
StdCmdViewIvStereoRedGreen::StdCmdViewIvStereoRedGreen() : Command("Std_ViewIvStereoRedGreen")
{
    sGroup = "Standard-View";
...
StdCmdViewIvStereoQuadBuff::StdCmdViewIvStereoQuadBuff() : Command("Std_ViewIvStereoQuadBuff")
{
    sGroup = "Standard-View";
...
StdCmdViewIvIssueCamPos::StdCmdViewIvIssueCamPos() : Command("Std_ViewIvIssueCamPos")
{
    sGroup = "Standard-View";
...
void StdCmdViewIvIssueCamPos::activated(int iMsg)
{
    ...
    // remove all returns
    while ((pos = Temp2.find('\n')) != std::string::npos) Temp2.replace(pos, 1, " ");
...
StdViewZoomIn::StdViewZoomIn() : Command("Std_ViewZoomIn")
{
    sGroup = "Standard-View";
...
StdViewZoomOut::StdViewZoomOut() : Command("Std_ViewZoomOut")
{
    sGroup = "Standard-View";
...
public:
    ...
    static void Create(View3DInventorViewer *viewer,
                       View3DInventorViewer::SelectionMode selectionMode, const QCursor &cursor,
                       FnCb doFunction = nullptr, void *ud = nullptr)
    {
        ...
        currentSelectionHandler =
            std::unique_ptr<SelectionCallbackHandler>(new SelectionCallbackHandler());
        if (viewer) {
...
//===========================================================================
/* XPM */
static const char *cursor_box_zoom[] = {"32 32 3 1",
                                        " 	c None",
                                        ".	c #FFFFFF",
                                        "@	c #FF0000",
                                        "      .                         ",
...
StdViewBoxZoom::StdViewBoxZoom() : Command("Std_ViewBoxZoom")
{
    sGroup = "Standard-View";
...
void StdViewBoxZoom::activated(int iMsg)
{
    ...
    if (view) {
        ...
        if (!viewer->isSelecting()) {
            SelectionCallbackHandler::Create(viewer, View3DInventorViewer::BoxZoom,
...
/* XPM */
static const char *cursor_box_select[] = {"32 32 4 1",
                                          " 	c None",
                                          ".	c #FFFFFF",
                                          "+	c #FF0000",
                                          "@	c #000000",
...
StdBoxSelection::StdBoxSelection() : Command("Std_BoxSelection")
{
    sGroup = "Standard-View";
...
getBoxSelection(ViewProviderDocumentObject *vp, SelectionMode mode, bool selectElement,
                ...
                const Base::Matrix4D &mat, bool transform = true, int depth = 0)
{
    ...
    if (!bbox.Intersect(polygon)) return ret;

    const auto &subs = obj->getSubObjects(App::DocumentObject::GS_SELECT);
    if (subs.empty()) {
        if (!selectElement) {
            if (mode == INTERSECT || polygon.Contains(bbox.GetCenter())) ret.emplace_back("");
            return ret;
        }
        ...
        if (!PyObject_TypeCheck(pyobj, &Data::ComplexGeoDataPy::Type)) return ret;
        ...
        for (auto type : data->getElementTypes()) {
            ...
            for (size_t i = 1; i <= count; ++i) {
                ...
                if (lines.empty()) {
                    ...
                    if (polygon.Contains(Base::Vector2d(v.x, v.y))) ret.push_back(element);
                    continue;
                }
                Base::Polygon2d loop;
                ...
                if (!polygon.Intersect(loop)) continue;
                if (mode == CENTER && !polygon.Contains(loop.CalcBoundBox().GetCenter())) continue;
    ...
    for (auto &sub : subs) {
        ...
        auto sobj = obj->resolve(sub.c_str(), &parent, &childName, nullptr, nullptr, &smat,
                                 transform, depth + 1);
        if (!sobj) continue;
        int vis;
        ...
        if (sels.size() == 1 && sels[0].empty()) ++count;
        for (auto &sel : sels) ret.emplace_back(sub + sel);
    }
    if (count == subs.size()) {
        ret.resize(1);
        ret[0].clear();
...
static void doSelect(void *ud, SoEventCallback *cb)
{
    ...
    if (picked.size() == 2) {
        ...
        for (const auto &it : picked) polygon.Add(Base::Vector2d(it[0], it[1]));
    }
    ...
    if (doc) {
        ...
        if (ev && !ev->wasCtrlDown()) { Gui::Selection().clearSelection(doc->getName()); }

        for (auto obj : doc->getObjects()) {
            if (App::GeoFeatureGroupExtension::getGroupOfObject(obj)) continue;
...
void StdBoxSelection::activated(int iMsg)
{
    ...
    if (view) {
        ...
        if (!viewer->isSelecting()) {
            ...
            SelectionCallbackHandler::Create(viewer, View3DInventorViewer::Rubberband,
                                             QCursor(QPixmap(cursor_box_select), 7, 7), doSelect,
                                             nullptr);
            SoNode *root = viewer->getSceneGraph();
...
//===========================================================================
/* XPM */
static char *cursor_box_element_select[] = {"32 32 6 1",
                                            " 	c None",
                                            ".	c #FFFFFF",
                                            "+	c #00FF1B",
                                            "@	c #19A428",
...
StdBoxElementSelection::StdBoxElementSelection() : Command("Std_BoxElementSelection")
{
    sGroup = "Standard-View";
...
void StdBoxElementSelection::activated(int iMsg)
{
    ...
    if (view) {
        ...
        if (!viewer->isSelecting()) {
            ...
            SelectionCallbackHandler::Create(viewer, View3DInventorViewer::Rubberband,
                                             QCursor(QPixmap(cursor_box_element_select), 7, 7),
                                             doSelect, this);
            SoNode *root = viewer->getSceneGraph();
            static_cast<Gui::SoFCUnifiedSelection *>(root)->selectionRole.setValue(false);
        }
...
StdTreeSelection::StdTreeSelection() : Command("Std_TreeSelection")
{
    sGroup = "TreeView";
...
StdCmdTreeCollapse::StdCmdTreeCollapse() : Command("Std_TreeCollapse")
{
    sGroup = "View";
...
StdCmdTreeExpand::StdCmdTreeExpand() : Command("Std_TreeExpand")
{
    sGroup = "View";
...
StdCmdTreeSelectAllInstances::StdCmdTreeSelectAllInstances() : Command("Std_TreeSelectAllInstances")
{
    sGroup = "View";
...
{
    const auto &sels = Selection().getSelectionEx("*", App::DocumentObject::getClassTypeId(),
...
void StdCmdTreeSelectAllInstances::activated(int iMsg)
{
    ...
    for (auto tree : trees) tree->selectAllInstances(*vpd);
    Selection().selStackPush();
}
...
StdCmdMeasureDistance::StdCmdMeasureDistance() : Command("Std_MeasureDistance")
{
    sGroup = "View";
...
/* XPM */
static const char *cursor_ruler[] = {"32 32 3 1",
                                     " 	c None",
                                     ".	c #FFFFFF",
                                     "+	c #FF0000",
                                     "      .                         ",
...
{
    App::Document *doc = App::GetApplication().getActiveDocument();
    if (!doc || doc->countObjectsOfType(App::GeoFeature::getClassTypeId()) == 0) return false;
...
StdCmdSceneInspector::StdCmdSceneInspector() : Command("Std_SceneInspector")
{
    // setting the
    sGroup = "Tools";
...
void StdCmdSceneInspector::activated(int iMsg)
{
    ...
    if (doc) {
        ...
        if (!dlg) dlg = new Gui::Dialog::DlgInspector(getMainWindow());
        dlg->setDocument(doc);
...
StdCmdTextureMapping::StdCmdTextureMapping() : Command("Std_TextureMapping")
{
    // setting the
    sGroup = "Tools";
...
StdCmdDemoMode::StdCmdDemoMode() : Command("Std_DemoMode")
{
    sGroup = "Standard-View";
...
CmdViewMeasureClearAll::CmdViewMeasureClearAll() : Command("View_Measure_Clear_All")
{
    sGroup = "Measure";
...
void CmdViewMeasureClearAll::activated(int iMsg)
{
    ...
    auto view = dynamic_cast<Gui::View3DInventor *>(
        Gui::Application::Instance->activeDocument()->getActiveView());
    if (!view) return;
    Gui::View3DInventorViewer *viewer = view->getViewer();
    if (!viewer) return;
...
CmdViewMeasureToggleAll::CmdViewMeasureToggleAll() : Command("View_Measure_Toggle_All")
{
    sGroup = "Measure";
...
void CmdViewMeasureToggleAll::activated(int iMsg)
{
    ...
    if (visibility) group->SetBool("DimensionsVisible", false);
    else
...
StdCmdSelBack::StdCmdSelBack() : Command("Std_SelBack")
{
    sGroup = "View";
...
bool StdCmdSelBack::isActive() { return Selection().selStackBackSize() > 1; }
...
StdCmdSelForward::StdCmdSelForward() : Command("Std_SelForward")
{
    sGroup = "View";
...
bool StdCmdSelForward::isActive() { return !!Selection().selStackForwardSize(); }
...
#define TREEVIEW_DOC_CMD_DEF(_name, _v)                                                            \
    ...
    {                                                                                              \
        ...
        if (_pcAction && _pcAction->isChecked() != checked) _pcAction->setChecked(checked, true);  \
        return true;                                                                               \
    }

TREEVIEW_DOC_CMD_DEF(SingleDocument, 0)

StdTreeSingleDocument::StdTreeSingleDocument() : Command("Std_TreeSingleDocument")
{
    sGroup = "TreeView";
...
StdTreeMultiDocument::StdTreeMultiDocument() : Command("Std_TreeMultiDocument")
{
    sGroup = "TreeView";
...
StdTreeCollapseDocument::StdTreeCollapseDocument() : Command("Std_TreeCollapseDocument")
{
    sGroup = "TreeView";
...
StdTreeSyncView::StdTreeSyncView() : Command("Std_TreeSyncView")
{
    sGroup = "TreeView";
...
StdTreeSyncSelection::StdTreeSyncSelection() : Command("Std_TreeSyncSelection")
{
    sGroup = "TreeView";
...
StdTreeSyncPlacement::StdTreeSyncPlacement() : Command("Std_TreeSyncPlacement")
{
    sGroup = "TreeView";
...
StdTreePreSelection::StdTreePreSelection() : Command("Std_TreePreSelection")
{
    sGroup = "TreeView";
...
StdTreeRecordSelection::StdTreeRecordSelection() : Command("Std_TreeRecordSelection")
{
    sGroup = "TreeView";
...
StdTreeDrag::StdTreeDrag() : Command("Std_TreeDrag")
{
    sGroup = "TreeView";
...
{
public:
    StdCmdTreeViewActions() : GroupCommand("Std_TreeViewActions")
    {
        sGroup = "TreeView";
...
StdCmdSelBoundingBox::StdCmdSelBoundingBox() : Command("Std_SelBoundingBox")
{
    sGroup = "View";
