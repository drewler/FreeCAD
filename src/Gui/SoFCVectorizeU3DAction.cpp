...
{
public:
    SoVectorizeTriangle() { this->type = TRIANGLE; }
...
SoU3DVectorOutput::~SoU3DVectorOutput() { closeFile(); }
...
std::fstream &SoU3DVectorOutput::getFileStream() { return this->file; }
...
{
public:
    explicit SoFCVectorizeU3DActionP(SoFCVectorizeU3DAction *p) { this->publ = p; }
...
void SoFCVectorizeU3DActionP::printCircle(const SbVec3f &v, const SbColor &c,
...
void SoFCVectorizeU3DActionP::printSquare(const SbVec3f &v, const SbColor &c,
...
SoFCVectorizeU3DAction::~SoFCVectorizeU3DAction() { delete this->p; }
...
void SoFCVectorizeU3DAction::beginTraversal(SoNode *node) { inherited::beginTraversal(node); }

void SoFCVectorizeU3DAction::endTraversal(SoNode *node) { inherited::endTraversal(node); }
...
void SoFCVectorizeU3DAction::printItem(const SoVectorizeItem *item) const
{
    switch (item->type) {
        ...
        case SoVectorizeItem::IMAGE:
            ...
            break;
        default: assert(0 && "unsupported item"); break;
    }
}
