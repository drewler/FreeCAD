...
AxisOrigin::AxisOrigin() : size(6), pSize(4), dist(2), scale(1), lineSize(2), pointSize(4) {}
...
SoGroup *AxisOrigin::getNode()
{
    ...
    const SbVec3f verts[13] = {
        SbVec3f(0, 0, 0),        SbVec3f(size, 0, 0),     SbVec3f(0, size, 0),
        SbVec3f(0, 0, size),     SbVec3f(dist, dist, 0),  SbVec3f(dist, pSize, 0),
