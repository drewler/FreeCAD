...
StdCmdWorkbench::StdCmdWorkbench() : Command("Std_Workbench")
{
    sGroup = "View";
...
bool StdCmdWorkbench::isActive() { return true; }
...
StdCmdRecentFiles::StdCmdRecentFiles() : Command("Std_RecentFiles")
{
    sGroup = "File";
...
StdCmdRecentMacros::StdCmdRecentMacros() : Command("Std_RecentMacros")
{
    sGroup = "Macro";
...
StdCmdAbout::StdCmdAbout() : Command("Std_About")
{
    sGroup = "Help";
...
bool StdCmdAbout::isActive() { return true; }
...
StdCmdAboutQt::StdCmdAboutQt() : Command("Std_AboutQt")
{
    sGroup = "Help";
...
StdCmdWhatsThis::StdCmdWhatsThis() : Command("Std_WhatsThis")
{
    sGroup = "Help";
...
StdCmdDlgParameter::StdCmdDlgParameter() : Command("Std_DlgParameter")
{
    sGroup = "Tools";
...
StdCmdDlgPreferences::StdCmdDlgPreferences() : Command("Std_DlgPreferences")
{
    sGroup = "Tools";
...
StdCmdDlgCustomize::StdCmdDlgCustomize() : Command("Std_DlgCustomize")
{
    sGroup = "Tools";
...
void StdCmdDlgCustomize::activated(int iMsg)
{
    ...
    if (!dlg) dlg = new Gui::Dialog::DlgCustomizeImp(getMainWindow());
...
StdCmdCommandLine::StdCmdCommandLine() : Command("Std_CommandLine")
{
    sGroup = "Tools";
...
StdCmdOnlineHelp::StdCmdOnlineHelp() : Command("Std_OnlineHelp")
{
    sGroup = "Help";
...
StdCmdOnlineHelpWebsite::StdCmdOnlineHelpWebsite() : Command("Std_OnlineHelpWebsite")
{
    sGroup = "Help";
...
StdCmdFreeCADDonation::StdCmdFreeCADDonation() : Command("Std_FreeCADDonation")
{
    sGroup = "Help";
...
StdCmdFreeCADWebsite::StdCmdFreeCADWebsite() : Command("Std_FreeCADWebsite")
{
    sGroup = "Help";
...
StdCmdFreeCADUserHub::StdCmdFreeCADUserHub() : Command("Std_FreeCADUserHub")
{
    sGroup = "Help";
...
StdCmdFreeCADPowerUserHub::StdCmdFreeCADPowerUserHub() : Command("Std_FreeCADPowerUserHub")
{
    sGroup = "Help";
...
StdCmdFreeCADForum::StdCmdFreeCADForum() : Command("Std_FreeCADForum")
{
    sGroup = "Help";
...
StdCmdFreeCADFAQ::StdCmdFreeCADFAQ() : Command("Std_FreeCADFAQ")
{
    sGroup = "Help";
...
StdCmdPythonWebsite::StdCmdPythonWebsite() : Command("Std_PythonWebsite")
{
    sGroup = "Help";
...
StdCmdReportBug::StdCmdReportBug() : Command("Std_ReportBug")
{
    sGroup = "Help";
...
StdCmdMeasurementSimple::StdCmdMeasurementSimple() : Command("Std_MeasurementSimple")
{
    sGroup = "Tools";
...
void StdCmdMeasurementSimple::activated(int iMsg)
{
    ...
    doCommand(Doc, "_f = App.activeDocument().addObject(\"App::MeasureDistance\",\"%s\")",
              "Measurement");
...
StdCmdTextDocument::StdCmdTextDocument() : Command("Std_TextDocument")
{
    sGroup = "Tools";
...
void StdCmdTextDocument::activated(int iMsg)
{
    ...
    doCommand(Doc, "App.ActiveDocument.addObject(\"App::TextDocument\",\"%s\").Label=\"%s\"",
...
bool StdCmdTextDocument::isActive() { return hasActiveDocument(); }
...
StdCmdUnitsCalculator::StdCmdUnitsCalculator() : Command("Std_UnitsCalculator")
{
    sGroup = "Tools";
...
StdCmdUserEditMode::StdCmdUserEditMode() : Command("Std_UserEditMode")
{
    sGroup = "Edit";
    ...
    this->getGuiApplication()->signalUserEditModeChanged.connect(
        boost::bind(&StdCmdUserEditMode::updateIcon, this, bp::_1));
}
...
void StdCmdUserEditMode::languageChange()
{
    ...
    for (int i = 0; i < a.count(); i++) {
        ...
        a[i]->setText(QCoreApplication::translate("EditMode", qPrintable(modeName)));
...
bool StdCmdUserEditMode::isActive() { return true; }
