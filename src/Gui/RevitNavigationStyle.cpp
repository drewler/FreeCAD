...
const char *RevitNavigationStyle::mouseButtons(ViewerMode mode)
{
    switch (mode) {
        ...
        case NavigationStyle::PANNING: return QT_TR_NOOP("Press middle mouse button");
        case NavigationStyle::DRAGGING: return QT_TR_NOOP("Press SHIFT and middle mouse button");
...
SbBool RevitNavigationStyle::processSoEvent(const SoEvent *const ev)
{
    ...
    switch (combo) {
        ...
        case BUTTON3DOWN: newmode = NavigationStyle::PANNING; break;
