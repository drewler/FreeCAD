...
void View3DInventorPy::init_type()
{
    ...
    add_varargs_method("viewAxometric", &View3DInventorPy::viewIsometric,
    ...
    add_varargs_method("setAnimationEnabled", &View3DInventorPy::setAnimationEnabled,
                       "setAnimationEnabled()");
    add_varargs_method("isAnimationEnabled", &View3DInventorPy::isAnimationEnabled,
                       "isAnimationEnabled()");
    add_varargs_method("setPopupMenuEnabled", &View3DInventorPy::setPopupMenuEnabled,
                       "setPopupMenuEnabled()");
    ...
    add_varargs_method("saveVectorGraphic", &View3DInventorPy::saveVectorGraphic,
                       "saveVectorGraphic()");
    ...
    add_varargs_method("getViewDirection", &View3DInventorPy::getViewDirection,
                       "getViewDirection() --> tuple of floats\n"
                       "returns the direction vector the view is currently pointing at as tuple "
                       "with xyz values\n");
    add_varargs_method(
        "setViewDirection", &View3DInventorPy::setViewDirection,
    ...
    add_varargs_method("setCameraOrientation", &View3DInventorPy::setCameraOrientation,
                       "setCameraOrientation()");
    add_varargs_method("getCameraOrientation", &View3DInventorPy::getCameraOrientation,
    ...
    add_varargs_method(
        "getCursorPos", &View3DInventorPy::getCursorPos,
    ...
    add_varargs_method(
        "getObjectsInfo", &View3DInventorPy::getObjectsInfo,
    ...
    add_varargs_method(
        "getPointOnFocalPlane", &View3DInventorPy::getPointOnFocalPlane,
    ...
    add_varargs_method(
        "projectPointToLine", &View3DInventorPy::projectPointToLine,
        "projectPointToLine(pixel coords (as integer)) -> line defined by two points\n"
        "\n"
        "Return the projecting 3D line to the given 2D point");
    add_varargs_method("addEventCallback", &View3DInventorPy::addEventCallback,
                       "addEventCallback()");
    add_varargs_method("removeEventCallback", &View3DInventorPy::removeEventCallback,
                       "removeEventCallback()");
    add_varargs_method("setAnnotation", &View3DInventorPy::setAnnotation, "setAnnotation()");
    add_varargs_method("removeAnnotation", &View3DInventorPy::removeAnnotation,
                       "removeAnnotation()");
    ...
    add_varargs_method("addEventCallbackPivy", &View3DInventorPy::addEventCallbackPivy,
                       "addEventCallbackPivy()");
    add_varargs_method("removeEventCallbackPivy", &View3DInventorPy::removeEventCallbackPivy,
    ...
    add_varargs_method("listNavigationTypes", &View3DInventorPy::listNavigationTypes,
                       "listNavigationTypes()");
    add_varargs_method("getNavigationType", &View3DInventorPy::getNavigationType,
                       "getNavigationType()");
    add_varargs_method("setNavigationType", &View3DInventorPy::setNavigationType,
                       "setNavigationType()");
    add_varargs_method("setAxisCross", &View3DInventorPy::setAxisCross,
                       "switch the big axis-cross on and off");
    add_varargs_method("hasAxisCross", &View3DInventorPy::hasAxisCross,
                       "check if the big axis-cross is on or off()");
    add_varargs_method(
        "addDraggerCallback", &View3DInventorPy::addDraggerCallback,
    ...
    add_varargs_method("cast_to_base", &View3DInventorPy::cast_to_base,
                       "cast_to_base() cast to MDIView class");
}

View3DInventorPy::View3DInventorPy(View3DInventor *vi) : base(vi) {}
...
Py::Object View3DInventorPy::getattribute(const char *attr)
{
    ...
    if (name == "__dict__" || name == "__class__") {
        ...
        for (const auto &it : dict_base) { dict_self.setItem(it.first, it.second); }
        return dict_self;
    }
...
Py::Object View3DInventorPy::getattr(const char *attr)
{
    if (!getView3DIventorPtr()) {
        ...
        if (docObj) { return Py::Object(docObj->getPyObject(), true); }
        else {
...
{
    double factor = 1.0;
    if (!PyArg_ParseTuple(args.ptr(), "|d", &factor)) throw Py::Exception();
...
Py::Object View3DInventorPy::boxZoom(const Py::Tuple &args, const Py::Dict &kwds)
{
    ...
    if (!PyArg_ParseTupleAndKeywords(args.ptr(), kwds.ptr(), "hhhh", kwds_box, &xmin, &ymin, &xmax,
                                     &ymax))
        throw Py::Exception();
...
{
    switch (view) {
        case Top: return SbRotation(0, 0, 0, 1);
        case Bottom: return SbRotation(1, 0, 0, 0);
        case Front: {
        ...
        case Left: return SbRotation(-0.5, 0.5, 0.5, -0.5);
        case Right: return SbRotation(0.5, 0.5, 0.5, 0.5);
        case Isometric:
        ...
        case Dimetric: return SbRotation(0.567952f, 0.103751f, 0.146726f, 0.803205f);
        case Trimetric: return SbRotation(0.446015f, 0.119509f, 0.229575f, 0.856787f);
        default: return SbRotation(0, 0, 0, 1);
    }
}
...
Py::Object View3DInventorPy::viewDefaultOrientation(const Py::Tuple &args)
{
    char *view = nullptr;
    double scale = -1.0;
    if (!PyArg_ParseTuple(args.ptr(), "|sd", &view, &scale)) throw Py::Exception();

    try {
        std::string newDocView;
        SbRotation rot(0, 0, 0, 1);
        if (view) { newDocView = view; }
        else {
        ...
        if (newDocView == "Top") { rot = Camera::rotation(Camera::Top); }
...
Py::Object View3DInventorPy::setCameraOrientation(const Py::Tuple &args)
{
    PyObject *o;
    PyObject *m = Py_False;
    if (!PyArg_ParseTuple(args.ptr(), "O|O!", &o, &PyBool_Type, &m)) throw Py::Exception();
    ...
    try {
        if (PyTuple_Check(o)) {
            ...
            getView3DIventorPtr()->getViewer()->setCameraOrientation(
                SbRotation((float)q0, (float)q1, (float)q2, (float)q3), Base::asBoolean(m));
        }
        else {
...
Py::Object View3DInventorPy::startAnimating(const Py::Tuple &args)
{
    float x, y, z;
    float velocity;
    if (!PyArg_ParseTuple(args.ptr(), "ffff", &x, &y, &z, &velocity)) throw Py::Exception();
...
{
    int ok;
    if (!PyArg_ParseTuple(args.ptr(), "i", &ok)) throw Py::Exception();
...
Py::Object View3DInventorPy::saveImage(const Py::Tuple &args)
{
    ...
    if (!PyArg_ParseTuple(args.ptr(), "et|iissi", "utf-8", &cFileName, &w, &h, &cColor, &cComment,
                          &s))
        throw Py::Exception();
...
Py::Object View3DInventorPy::saveVectorGraphic(const Py::Tuple &args)
{
    ...
    if (!PyArg_ParseTuple(args.ptr(), "s|is", &filename, &ps, &name)) throw Py::Exception();
...
Py::Object View3DInventorPy::getCameraNode(const Py::Tuple &args)
{
    ...
    try {
        ...
        type += " *";
        proxy =
            Base::Interpreter().createSWIGPointerObj("pivy.coin", type.c_str(), (void *)camera, 1);
        camera->ref();
...
{
    PyObject *object;
    if (!PyArg_ParseTuple(args.ptr(), "O", &object)) throw Py::Exception();
...
{
    char *buffer;
    if (!PyArg_ParseTuple(args.ptr(), "s", &buffer)) throw Py::Exception();
...
Py::Object View3DInventorPy::getCameraType(const Py::Tuple &args)
{
    ...
    SoCamera *cam = getView3DIventorPtr()->getViewer()->getSoRenderManager()->getCamera();
    if (!cam) { throw Py::RuntimeError("No camera set!"); }
...
Py::Object View3DInventorPy::setCameraType(const Py::Tuple &args)
{
    ...
    if (!PyArg_ParseTuple(args.ptr(), "i", &cameratype)) {
        char *modename;
        PyErr_Clear();
        if (!PyArg_ParseTuple(args.ptr(), "s", &modename)) throw Py::Exception();
        for (int i = 0; i < 2; i++) {
    ...
    if (cameratype < 0 || cameratype > 1) throw Py::IndexError("Out of range");
    if (cameratype == 0)
...
Py::Object View3DInventorPy::listCameraTypes(const Py::Tuple &args)
{
    ...
    try {
        Py::List list(2);
        for (int i = 0; i < 2; i++) { list[i] = Py::String(CameraTypeEnums[i]); }
        return list;
    }
    catch (const Base::Exception &e) {
        throw Py::RuntimeError(e.what());
...
Py::Object View3DInventorPy::setStereoType(const Py::Tuple &args)
{
    ...
    try {
        if (stereomode < 0 || stereomode > 4) throw Py::IndexError("Out of range");
...
Py::Object View3DInventorPy::getStereoType(const Py::Tuple &args)
{
    ...
    try {
        ...
        if (mode < 0 || mode > 4) throw Py::ValueError("Invalid stereo mode");
...
Py::Object View3DInventorPy::listStereoTypes(const Py::Tuple &args)
{
    ...
    try {
        Py::List list(5);
        for (int i = 0; i < 5; i++) { list[i] = Py::String(StereoTypeEnums[i]); }
...
Py::Object View3DInventorPy::getObjectInfo(const Py::Tuple &args)
{
    ...
    if (!PyArg_ParseTuple(args.ptr(), "O|f", &object, &r)) throw Py::Exception();
            ...
            if (vp && vp->isDerivedFrom(ViewProviderDocumentObject::getClassTypeId())) {
                ...
                if (vp->useNewSelectionModel()) {
                    ...
                    if (!subname.empty()) {
                        ...
                        subname =
                            !elementName.second.empty() ? elementName.second : elementName.first;
                    }
        ...
        if (pp.getLength() > 0) {
            ...
            for (int i = 0; i < pp.getLength(); i++) {
                ...
                ViewProvider *vp = doc
                    ...
                    : getView3DIventorPtr()->getViewer()->getViewProviderByPath(point->getPath());
                if (vp && vp->isDerivedFrom(ViewProviderDocumentObject::getClassTypeId())) {
                    if (!vp->isSelectable()) continue;
                    auto vpd = static_cast<ViewProviderDocumentObject *>(vp);
                    if (vp->useNewSelectionModel()) {
                        std::string subname;
                        if (!vp->getElementPicked(point, subname)) continue;
                        auto obj = vpd->getObject();
                        if (!obj) continue;
                        if (!subname.empty()) {
                            std::pair<std::string, std::string> elementName;
                            ...
                            subname = !elementName.second.empty() ? elementName.second
                                                                  : elementName.first;
                        }
                        dict.setItem("Document", Py::String(obj->getDocument()->getName()));
                        dict.setItem("Object", Py::String(obj->getNameInDocument()));
...
{
    char *style;
    if (!PyArg_ParseTuple(args.ptr(), "s", &style)) throw Py::Exception();
...
void View3DInventorPy::eventCallback(void *ud, SoEventCallback *n)
{
    ...
    try {
        ...
        if (e->isOfType(SoButtonEvent::getClassTypeId())) {
            ...
            switch (be->getState()) {
                case SoButtonEvent::UP: state = "UP"; break;
                case SoButtonEvent::DOWN: state = "DOWN"; break;
        ...
        if (e->isOfType(SoKeyboardEvent::getClassTypeId())) {
            ...
            switch (ke->getKey()) {
                case SoKeyboardEvent::ANY: dict.setItem("Key", Py::String("ANY")); break;
                case SoKeyboardEvent::UNDEFINED:
                    dict.setItem("Key", Py::String("UNDEFINED"));
                    break;
                case SoKeyboardEvent::LEFT_SHIFT:
                case SoKeyboardEvent::RIGHT_SHIFT: dict.setItem("Key", Py::String("SHIFT")); break;
                case SoKeyboardEvent::LEFT_CONTROL:
                case SoKeyboardEvent::RIGHT_CONTROL:
                    dict.setItem("Key", Py::String("CONTROL"));
                    break;
                case SoKeyboardEvent::LEFT_ALT:
                case SoKeyboardEvent::RIGHT_ALT: dict.setItem("Key", Py::String("ALT")); break;
                case SoKeyboardEvent::HOME: dict.setItem("Key", Py::String("HOME")); break;
                case SoKeyboardEvent::LEFT_ARROW:
                    dict.setItem("Key", Py::String("LEFT_ARROW"));
                    break;
                case SoKeyboardEvent::UP_ARROW: dict.setItem("Key", Py::String("UP_ARROW")); break;
                ...
                case SoKeyboardEvent::DOWN_ARROW:
                    ...
                    break;
                case SoKeyboardEvent::PAGE_UP: dict.setItem("Key", Py::String("PAGE_UP")); break;
                case SoKeyboardEvent::PAGE_DOWN:
                    dict.setItem("Key", Py::String("PAGE_DOWN"));
                    break;
                case SoKeyboardEvent::END: dict.setItem("Key", Py::String("END")); break;
                case SoKeyboardEvent::PAD_ENTER:
                    dict.setItem("Key", Py::String("PAD_ENTER"));
                    break;
                case SoKeyboardEvent::PAD_F1: dict.setItem("Key", Py::String("PAD_F1")); break;
                case SoKeyboardEvent::PAD_F2: dict.setItem("Key", Py::String("PAD_F2")); break;
                case SoKeyboardEvent::PAD_F3: dict.setItem("Key", Py::String("PAD_F3")); break;
                case SoKeyboardEvent::PAD_F4: dict.setItem("Key", Py::String("PAD_F4")); break;
                case SoKeyboardEvent::PAD_0: dict.setItem("Key", Py::String("PAD_0")); break;
                case SoKeyboardEvent::PAD_1: dict.setItem("Key", Py::String("PAD_1")); break;
                case SoKeyboardEvent::PAD_2: dict.setItem("Key", Py::String("PAD_2")); break;
                case SoKeyboardEvent::PAD_3: dict.setItem("Key", Py::String("PAD_3")); break;
                case SoKeyboardEvent::PAD_4: dict.setItem("Key", Py::String("PAD_4")); break;
                case SoKeyboardEvent::PAD_5: dict.setItem("Key", Py::String("PAD_5")); break;
                case SoKeyboardEvent::PAD_6: dict.setItem("Key", Py::String("PAD_6")); break;
                case SoKeyboardEvent::PAD_7: dict.setItem("Key", Py::String("PAD_7")); break;
                case SoKeyboardEvent::PAD_8: dict.setItem("Key", Py::String("PAD_8")); break;
                case SoKeyboardEvent::PAD_9: dict.setItem("Key", Py::String("PAD_9")); break;
                case SoKeyboardEvent::PAD_ADD: dict.setItem("Key", Py::String("PAD_ADD")); break;
                ...
                case SoKeyboardEvent::PAD_DIVIDE:
                    ...
                    break;
                case SoKeyboardEvent::PAD_TAB: dict.setItem("Key", Py::String("PAD_TAB")); break;
                case SoKeyboardEvent::PAD_DELETE:
                    dict.setItem("Key", Py::String("PAD_DELETE"));
                    break;
                case SoKeyboardEvent::F1: dict.setItem("Key", Py::String("F1")); break;
                case SoKeyboardEvent::F2: dict.setItem("Key", Py::String("F2")); break;
                case SoKeyboardEvent::F3: dict.setItem("Key", Py::String("F3")); break;
                case SoKeyboardEvent::F4: dict.setItem("Key", Py::String("F4")); break;
                case SoKeyboardEvent::F5: dict.setItem("Key", Py::String("F5")); break;
                case SoKeyboardEvent::F6: dict.setItem("Key", Py::String("F6")); break;
                case SoKeyboardEvent::F7: dict.setItem("Key", Py::String("F7")); break;
                case SoKeyboardEvent::F8: dict.setItem("Key", Py::String("F8")); break;
                case SoKeyboardEvent::F9: dict.setItem("Key", Py::String("F9")); break;
                case SoKeyboardEvent::F10: dict.setItem("Key", Py::String("F10")); break;
                case SoKeyboardEvent::F11: dict.setItem("Key", Py::String("F11")); break;
                case SoKeyboardEvent::F12: dict.setItem("Key", Py::String("F12")); break;
                case SoKeyboardEvent::BACKSPACE:
                    dict.setItem("Key", Py::String("BACKSPACE"));
                    break;
                case SoKeyboardEvent::TAB: dict.setItem("Key", Py::String("TAB")); break;
                case SoKeyboardEvent::RETURN: dict.setItem("Key", Py::String("RETURN")); break;
                case SoKeyboardEvent::PAUSE: dict.setItem("Key", Py::String("PAUSE")); break;
                case SoKeyboardEvent::SCROLL_LOCK:
                    dict.setItem("Key", Py::String("SCROLL_LOCK"));
                    break;
                case SoKeyboardEvent::ESCAPE: dict.setItem("Key", Py::String("ESCAPE")); break;
                case SoKeyboardEvent::KEY_DELETE: dict.setItem("Key", Py::String("DELETE")); break;
                case SoKeyboardEvent::PRINT: dict.setItem("Key", Py::String("PRINT")); break;
                case SoKeyboardEvent::INSERT: dict.setItem("Key", Py::String("INSERT")); break;
                case SoKeyboardEvent::NUM_LOCK: dict.setItem("Key", Py::String("NUM_LOCK")); break;
                ...
                case SoKeyboardEvent::SHIFT_LOCK:
                    ...
                    break;
                case SoKeyboardEvent::SPACE: dict.setItem("Key", Py::String("SPACE")); break;
                case SoKeyboardEvent::APOSTROPHE:
                    dict.setItem("Key", Py::String("APOSTROPHE"));
                    break;
                case SoKeyboardEvent::COMMA: dict.setItem("Key", Py::String("COMMA")); break;
                case SoKeyboardEvent::MINUS: dict.setItem("Key", Py::String("MINUS")); break;
                case SoKeyboardEvent::PERIOD: dict.setItem("Key", Py::String("PERIOD")); break;
                case SoKeyboardEvent::SLASH: dict.setItem("Key", Py::String("SLASH")); break;
                case SoKeyboardEvent::SEMICOLON:
                    dict.setItem("Key", Py::String("SEMICOLON"));
                    break;
                case SoKeyboardEvent::EQUAL: dict.setItem("Key", Py::String("EQUAL")); break;
                ...
                case SoKeyboardEvent::BRACKETRIGHT:
                    ...
                    break;
                case SoKeyboardEvent::GRAVE: dict.setItem("Key", Py::String("GRAVE")); break;
                default: dict.setItem("Key", Py::Char(ke->getPrintableCharacter())); break;
            }
        }
        if (e->isOfType(SoMouseButtonEvent::getClassTypeId())) {
            ...
            switch (mbe->getButton()) {
                case SoMouseButtonEvent::BUTTON1: button = "BUTTON1"; break;
                case SoMouseButtonEvent::BUTTON2: button = "BUTTON2"; break;
                case SoMouseButtonEvent::BUTTON3: button = "BUTTON3"; break;
                case SoMouseButtonEvent::BUTTON4: button = "BUTTON4"; break;
                case SoMouseButtonEvent::BUTTON5: button = "BUTTON5"; break;
                default: button = "ANY"; break;
            }
        ...
        if (e->isOfType(SoSpaceballButtonEvent::getClassTypeId())) {
            ...
            switch (sbe->getButton()) {
                case SoSpaceballButtonEvent::BUTTON1: button = "BUTTON1"; break;
                case SoSpaceballButtonEvent::BUTTON2: button = "BUTTON2"; break;
                case SoSpaceballButtonEvent::BUTTON3: button = "BUTTON3"; break;
                case SoSpaceballButtonEvent::BUTTON4: button = "BUTTON4"; break;
                case SoSpaceballButtonEvent::BUTTON5: button = "BUTTON5"; break;
                case SoSpaceballButtonEvent::BUTTON6: button = "BUTTON6"; break;
                case SoSpaceballButtonEvent::BUTTON7: button = "BUTTON7"; break;
                default: button = "ANY"; break;
            }
...
Py::Object View3DInventorPy::addEventCallback(const Py::Tuple &args)
{
    char *eventtype;
    PyObject *method;
    if (!PyArg_ParseTuple(args.ptr(), "sO", &eventtype, &method)) throw Py::Exception();
    try {
        if (PyCallable_Check(method) == 0) { throw Py::TypeError("object is not callable"); }
        ...
        getView3DIventorPtr()->getViewer()->addEventCallback(
            eventId, View3DInventorPy::eventCallback, method);
...
Py::Object View3DInventorPy::removeEventCallback(const Py::Tuple &args)
{
    ...
    if (!PyArg_ParseTuple(args.ptr(), "sO", &eventtype, &method)) throw Py::Exception();
    try {
        if (PyCallable_Check(method) == 0) { throw Py::RuntimeError("object is not callable"); }
        SoType eventId = SoType::fromName(eventtype);
        if (eventId.isBad() || !eventId.isDerivedFrom(SoEvent::getClassTypeId())) {
            std::string s;
            std::ostringstream s_out;
        ...
        getView3DIventorPtr()->getViewer()->removeEventCallback(
            eventId, View3DInventorPy::eventCallback, method);
...
Py::Object View3DInventorPy::setAnnotation(const Py::Tuple &args)
{
    ...
    if (!PyArg_ParseTuple(args.ptr(), "ss", &psAnnoName, &psBuffer)) throw Py::Exception();
...
{
    char *psAnnoName;
    if (!PyArg_ParseTuple(args.ptr(), "s", &psAnnoName)) throw Py::Exception();
...
Py::Object View3DInventorPy::getSceneGraph(const Py::Tuple &args)
{
    ...
    try {
        ...
        PyObject *proxy = nullptr;
        proxy = Base::Interpreter().createSWIGPointerObj("pivy.coin", "SoSeparator *",
                                                         (void *)scene, 1);
        scene->ref();
        return Py::Object(proxy, true);
    }
...
Py::Object View3DInventorPy::addEventCallbackPivy(const Py::Tuple &args)
{
    ...
    if (!PyArg_ParseTuple(args.ptr(), "OO|i", &proxy, &method, &ex)) throw Py::Exception();
...
Py::Object View3DInventorPy::addDraggerCallback(const Py::Tuple &args)
{
    ...
    char *type;
    PyObject *method;
    if (!PyArg_ParseTuple(args.ptr(), "OsO", &dragger, &type, &method)) throw Py::Exception();
    ...
    if (PyCallable_Check(method) == 0) { throw Py::TypeError("the method is not callable"); }
...
Py::Object View3DInventorPy::setActiveObject(const Py::Tuple &args)
{
    ...
    if (docObject == Py_None) { getView3DIventorPtr()->setActiveObject(nullptr, name); }
    else {
...
Py::Object View3DInventorPy::getActiveObject(const Py::Tuple &args)
{
    ...
    std::string subname;
    App::DocumentObject *obj =
        getView3DIventorPtr()->getActiveObject<App::DocumentObject *>(name, &parent, &subname);
...
{
    char *name;
    if (!PyArg_ParseTuple(args.ptr(), "s", &name)) throw Py::Exception();

    std::vector<ViewProvider *> vps =
        getView3DIventorPtr()->getViewer()->getViewProvidersOfType(Base::Type::fromName(name));
    Py::List list;
    for (const auto &vp : vps) { list.append(Py::asObject(vp->getPyObject())); }
...
Py::Object View3DInventorPy::toggleClippingPlane(const Py::Tuple &args, const Py::Dict &kwds)
{
    ...
    if (!PyArg_ParseTupleAndKeywords(args.ptr(), kwds.ptr(), "|iO!O!O!", keywords, &toggle,
                                     &PyBool_Type, &beforeEditing, &PyBool_Type, &noManip,
                                     &Base::PlacementPy::Type, &pyPla))
        throw Py::Exception();

    Base::Placement pla;
    if (pyPla != Py_None) pla = *static_cast<Base::PlacementPy *>(pyPla)->getPlacementPtr();
...
{
    int size = 0;
    if (!PyArg_ParseTuple(args.ptr(), "i", &size)) throw Py::Exception();
