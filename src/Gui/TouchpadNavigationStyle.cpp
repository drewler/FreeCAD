...
const char *TouchpadNavigationStyle::mouseButtons(ViewerMode mode)
{
    switch (mode) {
        ...
        case NavigationStyle::PANNING: return QT_TR_NOOP("Press SHIFT button");
        case NavigationStyle::DRAGGING: return QT_TR_NOOP("Press ALT button");
        case NavigationStyle::ZOOMING: return QT_TR_NOOP("Press CTRL and SHIFT buttons");
...
SbBool TouchpadNavigationStyle::processSoEvent(const SoEvent *const ev)
{
    ...
    switch (combo) {
        ...
        case BUTTON1DOWN:
            ...
            if (curmode == NavigationStyle::SPINNING) newmode = NavigationStyle::IDLE;
            else
                newmode = NavigationStyle::SELECTION;
            break;
        case CTRLDOWN: newmode = NavigationStyle::IDLE; break;
        case SHIFTDOWN:
            ...
            if (newmode == NavigationStyle::DRAGGING) { processed = true; }
        ...
        case CTRLDOWN | SHIFTDOWN | BUTTON1DOWN:
            ...
            if (newmode == NavigationStyle::ZOOMING) { processed = true; }
