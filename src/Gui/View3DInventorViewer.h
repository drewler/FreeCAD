...
public:
    ...
    View3DInventorViewer(const QtGLFormat &format, QWidget *parent,
    ...
    void imageFromFramebuffer(int width, int height, int samples, const QColor &bgcolor,
                              QImage &img);
    ...
    void toggleClippingPlane(int toggle = -1, bool beforeEditing = false, bool noManip = false,
